...
class SpeakerApi(object):
    ...
    def speaker_delete(self, speaker_id, **kwargs):  # noqa: E501
        """Delete Speaker  # noqa: E501

        Delete Speaker. If the Speaker was associated with a User then the User will not be deleted.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_delete(speaker_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str speaker_id: Speaker ID (required)
        ...
        return self.speaker_delete_with_http_info(speaker_id, **kwargs)  # noqa: E501

    def speaker_delete_with_http_info(self, speaker_id, **kwargs):  # noqa: E501
        """Delete Speaker  # noqa: E501

        Delete Speaker. If the Speaker was associated with a User then the User will not be deleted.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_delete_with_http_info(speaker_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(SpeakerData, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['speaker_id']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method speaker_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'speaker_id' is set
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_delete`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_delete`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'speaker_id' in local_var_params:
            path_params['speakerId'] = local_var_params['speaker_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SpeakerData',  # noqa: E501
    ...
    def speaker_get(self, speaker_id, **kwargs):  # noqa: E501
        """Get Speaker  # noqa: E501

        Get a specified Speaker     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_get(speaker_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_get_with_http_info(speaker_id, **kwargs)  # noqa: E501

    def speaker_get_with_http_info(self, speaker_id, **kwargs):  # noqa: E501
        """Get Speaker  # noqa: E501

        Get a specified Speaker     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_get_with_http_info(speaker_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_get`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_get`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def speaker_post(self, **kwargs):  # noqa: E501
        """New Speaker  # noqa: E501

        Create new Speaker. It may be a User on the Account but does not have to be.</br> Voice Signatures may be associated with a Speaker.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param SpeakerModifiable speaker_modifiable: Data for the new Speaker
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_post_with_http_info(**kwargs)  # noqa: E501

    def speaker_post_with_http_info(self, **kwargs):  # noqa: E501
        """New Speaker  # noqa: E501

        Create new Speaker. It may be a User on the Account but does not have to be.</br> Voice Signatures may be associated with a Speaker.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['speaker_modifiable']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'speaker_modifiable' in local_var_params:
            body_params = local_var_params['speaker_modifiable']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def speaker_put(self, speaker_id, **kwargs):  # noqa: E501
        """Modify Speaker  # noqa: E501

        Modify an existing speaker.</br> Can be used to modify the name or associate disassociate the speaker from an Account User     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_put(speaker_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str speaker_id: Speaker ID (required)
        :param SpeakerModifiable speaker_modifiable: Data to change in the Speaker
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_put_with_http_info(speaker_id, **kwargs)  # noqa: E501

    def speaker_put_with_http_info(self, speaker_id, **kwargs):  # noqa: E501
        """Modify Speaker  # noqa: E501

        Modify an existing speaker.</br> Can be used to modify the name or associate disassociate the speaker from an Account User     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_put_with_http_info(speaker_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['speaker_id', 'speaker_modifiable']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_put`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def speaker_query(self, **kwargs):  # noqa: E501
        """Query Speakers  # noqa: E501

        Get Speakers. If no query parameters are provided then all speakers will be returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_query(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param bool must_have_signature: set this to true if you want to retrieve only those Speakers who have Voice Signatures
        :param str user_id: If provided then will return the Speaker data for this specific user.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_query_with_http_info(**kwargs)  # noqa: E501

    def speaker_query_with_http_info(self, **kwargs):  # noqa: E501
        """Query Speakers  # noqa: E501

        Get Speakers. If no query parameters are provided then all speakers will be returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_query_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[SpeakerData], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['must_have_signature', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method speaker_query" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and ('user_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['user_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `user_id` when calling `speaker_query`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('user_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['user_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `user_id` when calling `speaker_query`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}

        path_params = {}

        query_params = []
        if 'must_have_signature' in local_var_params and local_var_params['must_have_signature'] is not None:  # noqa: E501
            query_params.append(('mustHaveSignature', local_var_params['must_have_signature']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[SpeakerData]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def speaker_signature_delete(self, speaker_id, uuid, **kwargs):  # noqa: E501
        """Delete Speaker Signature  # noqa: E501

        Delete Speaker Signature.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_delete(speaker_id, uuid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_signature_delete_with_http_info(speaker_id, uuid, **kwargs)  # noqa: E501

    def speaker_signature_delete_with_http_info(self, speaker_id, uuid, **kwargs):  # noqa: E501
        """Delete Speaker Signature  # noqa: E501

        Delete Speaker Signature.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_delete_with_http_info(speaker_id, uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['speaker_id', 'uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method speaker_signature_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'speaker_id' is set
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_signature_delete`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if self.api_client.client_side_validation and ('uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `uuid` when calling `speaker_signature_delete`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_delete`, length must be greater than or equal to `16`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `uuid` when calling `speaker_signature_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['uuid']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `uuid` when calling `speaker_signature_delete`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/speaker/{speakerId}/signature/{uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def speaker_signature_post(self, speaker_id, **kwargs):  # noqa: E501
        """New Voice Signature Item  # noqa: E501

        Add new Voice Signature Item to a Speaker.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_post(speaker_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str speaker_id: Speaker ID (required)
        :param NewVoiceSignatureItem new_voice_signature_item: Data needed to add a new voice signature item.  If `startMsec` and `endMsec` are specified then will extract a selection of the audio to create a signature. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_signature_post_with_http_info(speaker_id, **kwargs)  # noqa: E501

    def speaker_signature_post_with_http_info(self, speaker_id, **kwargs):  # noqa: E501
        """New Voice Signature Item  # noqa: E501

        Add new Voice Signature Item to a Speaker.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_post_with_http_info(speaker_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['speaker_id', 'new_voice_signature_item']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method speaker_signature_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'speaker_id' is set
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_signature_post`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_post`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_post`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'new_voice_signature_item' in local_var_params:
            body_params = local_var_params['new_voice_signature_item']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/speaker/{speakerId}/signature', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def speaker_signature_put(self, speaker_id, uuid, **kwargs):  # noqa: E501
        """Modify Speaker Signature  # noqa: E501

        Modify an Voice Signature item of a Speaker.</br>     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_put(speaker_id, uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str speaker_id: Speaker ID (required)
        :param str uuid: UUID of an object. **Note** - attempt to access objects outside of the Account will return an Error. (required)
        :param VoiceSignatureItem voice_signature_item: Data to change in the Speaker signature
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.speaker_signature_put_with_http_info(speaker_id, uuid, **kwargs)  # noqa: E501

    def speaker_signature_put_with_http_info(self, speaker_id, uuid, **kwargs):  # noqa: E501
        """Modify Speaker Signature  # noqa: E501

        Modify an Voice Signature item of a Speaker.</br>     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speaker_signature_put_with_http_info(speaker_id, uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['speaker_id', 'uuid', 'voice_signature_item']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method speaker_signature_put" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'speaker_id' is set
        if self.api_client.client_side_validation and ('speaker_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['speaker_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `speaker_id` when calling `speaker_signature_put`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if self.api_client.client_side_validation and ('uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `uuid` when calling `speaker_signature_put`")  # noqa: E501

        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('speaker_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['speaker_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `speaker_id` when calling `speaker_signature_put`, length must be greater than or equal to `16`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['uuid']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `uuid` when calling `speaker_signature_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['uuid']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `uuid` when calling `speaker_signature_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'voice_signature_item' in local_var_params:
            body_params = local_var_params['voice_signature_item']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/speaker/{speakerId}/signature/{uuid}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def spk_sig_text_query(self, **kwargs):  # noqa: E501
        """Query Signature Text  # noqa: E501

        Get current text passages that users can select from to read when creating voice signatures.</br> This API does not require any authentication.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.spk_sig_text_query(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[SpeakerSignatureText]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.spk_sig_text_query_with_http_info(**kwargs)  # noqa: E501

    def spk_sig_text_query_with_http_info(self, **kwargs):  # noqa: E501
        """Query Signature Text  # noqa: E501

        Get current text passages that users can select from to read when creating voice signatures.</br> This API does not require any authentication.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.spk_sig_text_query_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[SpeakerSignatureText], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method spk_sig_text_query" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[SpeakerSignatureText]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
