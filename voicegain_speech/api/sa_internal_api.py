...
class SaInternalApi(object):
    ...
    def sa_call_delete_with_http_info(self, call_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(VoiceCall, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('call_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `call_id` when calling `sa_call_delete`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['call_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_delete`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_delete`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='VoiceCall',  # noqa: E501
    ...
    def sa_call_get_with_http_info(self, call_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('call_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['call_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `call_id` when calling `sa_call_get`")  # noqa: E501

        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['call_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_get`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['call_id']) < 1):  # noqa: E501
    ...
    def sa_call_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str context_id: Context Id. Only needed if making a request without JWT but using MAC Access Authentication instead.
        :param VoiceCallModifiableBase voice_call_modifiable_base: Initial data for the call
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def sa_call_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['context_id', 'voice_call_modifiable_base']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_post`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_post`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'voice_call_modifiable_base' in local_var_params:
            body_params = local_var_params['voice_call_modifiable_base']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def sa_call_query_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_query`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) < 16):  # noqa: E501
        ...
        if 'internal_endpoint' in local_var_params and local_var_params['internal_endpoint'] is not None:  # noqa: E501
            query_params.append(('internalEndpoint', local_var_params['internal_endpoint']))  # noqa: E501
            collection_formats['internalEndpoint'] = 'csv'  # noqa: E501
        ...
        if 'voicemail' in local_var_params and local_var_params['voicemail'] is not None:  # noqa: E501
            query_params.append(('voicemail', local_var_params['voicemail']))  # noqa: E501
    ...
    def sa_call_search_fields_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[CallSearchField], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sa_call_search_fields_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[CallSearchField]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def sa_call_search_post(self, **kwargs):  # noqa: E501
        ...
        Search all Speech Analytics call records for the given account using a structured query.</br> The search query is included in the request body (hence POST instead of GET).</br> The query is built as a tree, e.g., OR query to match any of two keywords can be represented like this: <pre> {   \"type\" : \"OrQuery\",   \"disjuncts\" : [     {       \"type\" : \"EqTerm\",       \"field\" : \"KEYWORD\",       \"otherValue\" : \"java\"     },     {       \"type\" : \"EqTerm\",       \"field\" : \"KEYWORD\",       \"otherValue\" : \"python\"     }   ] } </pre>  BTW, the same could be achieved using IN query: <pre> {   \"type\" : \"InTerm\",    \"field\" : \"KEYWORD\",    \"otherValues\" : [\"java\", \"python\"] } </pre>  Instead of relying on extracted Keywords, we can search for java or python using text query: <pre> {   \"type\" : \"OrQuery\",   \"disjuncts\" : [     {       \"type\" : \"TxtSearchTerm\",       \"field\" : \"TEXT\",       \"txtQuery\" : \"java\"     },     {       \"type\" : \"TxtSearchTerm\",       \"field\" : \"TEXT\",       \"txtQuery\" : \"python\"     }   ] } </pre>  To search for calls where a boolean (yes/no) Call Insight has answer **Yes**, use the `CALL_INSIGHT_BOOL` field with the question `name` (case-insensitive) in `otherValue`: <pre> {   \"type\" : \"EqTerm\",   \"field\" : \"CALL_INSIGHT_BOOL\",   \"otherValue\" : \"ESCALATION\" } </pre>  See `CALL_INSIGHT_BOOL` in the `CallField` enum for the supported query types and their semantics.   This method supports [Pagination](#section/Pagination/Direct-pagination).  If you want to retrieve a specific number of results, you can use `page=1` and `per_page=<number>`, this gets translated into sql query with `LIMIT <number>` and `OFFSET 0`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sa_call_search_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sa_call_search_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 10000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `sa_call_search_post`, must be a value less than or equal to `10000`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `sa_call_search_post`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'c_query' in local_var_params:
            body_params = local_var_params['c_query']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'text/csv'])  # noqa: E501
    ...
    def sa_call_tags_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sa_call_tags_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_tags_get`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_tags_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def sa_call_tags_put(self, call_id, **kwargs):  # noqa: E501
        ...
        :param str call_id: Voice Call Id. (required)
        :param str context_id: Context Id. Only needed if making a request without JWT but using MAC Access Authentication instead.
        :param bool merge: If true then new data will be merged with the old, if false then old data will be replaced by new.
        :param list[str] request_body: Tags to be attached to the call
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def sa_call_tags_put_with_http_info(self, call_id, **kwargs):  # noqa: E501
        ...
        all_params = ['call_id', 'context_id', 'merge', 'request_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sa_call_tags_put" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'call_id' is set
        if self.api_client.client_side_validation and ('call_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['call_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `call_id` when calling `sa_call_tags_put`")  # noqa: E501

        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['call_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_tags_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['call_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_tags_put`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_tags_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['context_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `context_id` when calling `sa_call_tags_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
