...
class SaInternalApi(object):
    ...
    def sa_call_get_with_http_info(self, call_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('call_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `call_id` when calling `sa_call_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def sa_call_search_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 250:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `sa_call_search_post`, must be a value less than or equal to `250`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
