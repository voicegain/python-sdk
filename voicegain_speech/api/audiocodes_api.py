...
class AudiocodesApi(object):
    ...
    def stt_generic_data(self, **kwargs):  # noqa: E501
        """sttGenericData payload  # noqa: E501

        This is **not an API method** .</br> This is how we chose to document the allowed payload for the `sttGenericData` parameter in [/ws/asr/{wsToken}](#operation/wsAsrStart) Start message   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stt_generic_data(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param SttGenericData stt_generic_data: The allowed payload for the `sttGenericData` parameter in [/ws/asr/{wsToken}](#operation/wsAsrStart) Start messages.</br> Note that the JSON needs to be serialized to a string in order to be passed as `sttGenericData` 
        ...
        return self.stt_generic_data_with_http_info(**kwargs)  # noqa: E501

    def stt_generic_data_with_http_info(self, **kwargs):  # noqa: E501
        """sttGenericData payload  # noqa: E501

        This is **not an API method** .</br> This is how we chose to document the allowed payload for the `sttGenericData` parameter in [/ws/asr/{wsToken}](#operation/wsAsrStart) Start message   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stt_generic_data_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['stt_generic_data']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method stt_generic_data" % key
                )
        ...
        body_params = None
        if 'stt_generic_data' in local_var_params:
            body_params = local_var_params['stt_generic_data']
    ...
    def ws_asr_start(self, ws_token, **kwargs):  # noqa: E501
        """AudioCodes websocket  # noqa: E501

        Note: because OpenAPI 3.0, does not provide a way to document websocket requests we have to use this HTTP web api spec. Thus the actual request will be to wss:// not to https://.  Also the sent and received messages have to be documented as if thet were http requests and responses.</br> </br> Open a websocket that will accept command and audio according to AudioCodes Voice.AI API specification.</br> Same websocket connection is used for command messages (text) and for binary audio streaming.</br>  Single websocket connection can handle multiple recognitions in sequence - each will need to be started by a separate `start` command.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ws_asr_start(ws_token, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str ws_token: Websocket API token (required)
        :param ACControlMessages ac_control_messages: Messages that may be sent over websocket. + start - start recognition + stop - stop recognition  NOTE: do not send these in the initial request, only after websocket has been established.</br> 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.ws_asr_start_with_http_info(ws_token, **kwargs)  # noqa: E501

    def ws_asr_start_with_http_info(self, ws_token, **kwargs):  # noqa: E501
        """AudioCodes websocket  # noqa: E501

        Note: because OpenAPI 3.0, does not provide a way to document websocket requests we have to use this HTTP web api spec. Thus the actual request will be to wss:// not to https://.  Also the sent and received messages have to be documented as if thet were http requests and responses.</br> </br> Open a websocket that will accept command and audio according to AudioCodes Voice.AI API specification.</br> Same websocket connection is used for command messages (text) and for binary audio streaming.</br>  Single websocket connection can handle multiple recognitions in sequence - each will need to be started by a separate `start` command.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ws_asr_start_with_http_info(ws_token, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ws_token', 'ac_control_messages']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ws_asr_start" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'ws_token' is set
        if self.api_client.client_side_validation and ('ws_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['ws_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ws_token` when calling `ws_asr_start`")  # noqa: E501

        if self.api_client.client_side_validation and ('ws_token' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ws_token']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ws_token` when calling `ws_asr_start`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('ws_token' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ws_token']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ws_token` when calling `ws_asr_start`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'ws_token' in local_var_params:
            path_params['wsToken'] = local_var_params['ws_token']  # noqa: E501
        ...
        body_params = None
        if 'ac_control_messages' in local_var_params:
            body_params = local_var_params['ac_control_messages']
        # HTTP header `Accept`
        ...
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json', 'audio/l16'])  # noqa: E501
