...
class MeetingApi(object):
    ...
    def asr_meeting_result_query_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 250:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `asr_meeting_result_query`, must be a value less than or equal to `250`")  # noqa: E501
    ...
    def asr_meeting_result_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 250:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `asr_meeting_result_search`, must be a value less than or equal to `250`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
    ...
    def asr_meeting_result_search_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 250:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `asr_meeting_result_search_post`, must be a value less than or equal to `250`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
