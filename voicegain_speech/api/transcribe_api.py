...
class TranscribeApi(object):
    ...
    def asr_transcribe_get_data(self, session_id, **kwargs):  # noqa: E501
        ...
        :param bool speakers: If `true` then speaker information like, e.g. gender and age will be returned
        :param bool diarization: If `true` then diarization information will be returned if generated for the transcript
    ...
    def asr_transcribe_get_data_with_http_info(self, session_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(TranscriptData, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['session_id', 'words', 'decibels', 'audio_zones', 'speakers', 'diarization', 'word_cloud', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method asr_transcribe_get_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'session_id' is set
        if self.api_client.client_side_validation and ('session_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['session_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `session_id` when calling `asr_transcribe_get_data`")  # noqa: E501

        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_get_data`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_get_data`, length must be greater than or equal to `16`")  # noqa: E501
        if self.api_client.client_side_validation and 'decibels' in local_var_params and local_var_params['decibels'] < 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `decibels` when calling `asr_transcribe_get_data`, must be a value greater than or equal to `10`")  # noqa: E501
        collection_formats = {}
        ...
        if 'speakers' in local_var_params and local_var_params['speakers'] is not None:  # noqa: E501
            query_params.append(('speakers', local_var_params['speakers']))  # noqa: E501
        if 'diarization' in local_var_params and local_var_params['diarization'] is not None:  # noqa: E501
            query_params.append(('diarization', local_var_params['diarization']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/asr/transcribe/{sessionId}/data', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='TranscriptData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def asr_transcribe_post_data(self, session_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str session_id: ID of the session (required)
        :param ModifiableTranscriptData modifiable_transcript_data: Body with transcript data to be stored
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: ModifiableTranscriptDataResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.asr_transcribe_post_data_with_http_info(session_id, **kwargs)  # noqa: E501
    ...
    def asr_transcribe_post_data_with_http_info(self, session_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ModifiableTranscriptDataResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['session_id', 'modifiable_transcript_data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method asr_transcribe_post_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'session_id' is set
        if self.api_client.client_side_validation and ('session_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['session_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `session_id` when calling `asr_transcribe_post_data`")  # noqa: E501

        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_post_data`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_post_data`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'modifiable_transcript_data' in local_var_params:
            body_params = local_var_params['modifiable_transcript_data']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/asr/transcribe/{sessionId}/data', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ModifiableTranscriptDataResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def asr_transcribe_put_data(self, session_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str session_id: ID of the session (required)
        :param ModifiableTranscriptData modifiable_transcript_data: Body with transcript data to be modified
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def asr_transcribe_put_data_with_http_info(self, session_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method asr_transcribe_put_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'session_id' is set
        if self.api_client.client_side_validation and ('session_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['session_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `session_id` when calling `asr_transcribe_put_data`")  # noqa: E501

        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_put_data`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['session_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `session_id` when calling `asr_transcribe_put_data`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/asr/transcribe/{sessionId}/data', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def asr_transcribe_status_queue_get(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: AsrTranscribeQueueStatus
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.asr_transcribe_status_queue_get_with_http_info(**kwargs)  # noqa: E501
    ...
    def asr_transcribe_status_queue_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AsrTranscribeQueueStatus, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method asr_transcribe_status_queue_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/asr/transcribe/status/queue', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AsrTranscribeQueueStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
