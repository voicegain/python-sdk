...
class SaApi(object):
    ...
    def sa_config_defaults_put(self, sa_config_id, **kwargs):  # noqa: E501
        ...
        return self.sa_config_defaults_put_with_http_info(sa_config_id, **kwargs)  # noqa: E501
    ...
    def sa_config_defaults_put_with_http_info(self, sa_config_id, **kwargs):  # noqa: E501
        ...
        all_params = ['sa_config_id', 'speech_analytics_config_what_defaults']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method sa_config_defaults_put" % key
                )
        ...
        if self.api_client.client_side_validation and ('sa_config_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `sa_config_id` when calling `sa_config_defaults_put`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sa_config_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `sa_config_id` when calling `sa_config_defaults_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('sa_config_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sa_config_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sa_config_id` when calling `sa_config_defaults_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'speech_analytics_config_what_defaults' in local_var_params:
            body_params = local_var_params['speech_analytics_config_what_defaults']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/sa/config/{saConfigId}/defaults', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def sa_data_get(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        :param bool emotion: If `true` then emotion (sentiment) information will be returned
    ...
    def sa_get_transcript(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str sa_session_id: Session ID for Speech Analytics (required)
        :param str format: Specifies the format of the transcript to be returned. Valid values are: - json: complete transcript data with all detail for each word - text: plain text transcript with optional timing information 
    ...
    def sa_post(self, **kwargs):  # noqa: E501
        ...
        Create and launch a new real-time [Speech Analytics](#section/Speech-Analytics-API) Session. It will transcribe and analyze the provided speech audio with results delivered in real time over websocket.</br> For OFFLINE (batch) Speech Analytics use [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost) instead &mdash; the `asyncMode=OFF-LINE` value on this endpoint is **deprecated** and retained only for backward compatibility.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sa_spk_put(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[NamedSpeaker]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.sa_spk_put_with_http_info(sa_session_id, **kwargs)  # noqa: E501
    ...
    def sa_spk_put_with_http_info(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[NamedSpeaker], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('sa_session_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['sa_session_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `sa_session_id` when calling `sa_spk_put`")  # noqa: E501

        if self.api_client.client_side_validation and ('sa_session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sa_session_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sa_session_id` when calling `sa_spk_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('sa_session_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sa_session_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sa_session_id` when calling `sa_spk_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[NamedSpeaker]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
