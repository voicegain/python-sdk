...
class SaOfflineApi(object):
    ...
    def sa_offline_get_data(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        :param bool time_breakdown: If `true` then a call time breakdown (voicebot, agent segments, caller, system, silence, excessive silence) will be returned in the `timeBreakdown` field of the response.
    ...
    def sa_offline_get_data_with_http_info(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        all_params = ['sa_session_id', 'words', 'audio', 'meta', 'word_cloud', 'summary', 'time_breakdown', 'keywords', 'entities', 'phrases', 'words_start_at_ms']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'time_breakdown' in local_var_params and local_var_params['time_breakdown'] is not None:  # noqa: E501
            query_params.append(('timeBreakdown', local_var_params['time_breakdown']))  # noqa: E501
    ...
    def sa_offline_spk_put(self, sa_session_id, **kwargs):  # noqa: E501
        ...
        Modify speakers for a Speech Analytics session.</br> For each speaker (identified by `spk`) you may set/change: + `spkName` - display name + `speakerId` - associate with a known [Speaker](#tag/speaker) profile (voice signature) + `userId` - associate with a Voicegain User on the same Account (see [GET /user/{uuid}](#tag/user/operation/userGet))</br>  `userId` may be set on any speaker, including diarized speakers that did not have an upfront input speaker.</br> When `userId` is provided, the back end validates that the user exists and belongs to the same Account as the SA session's Context, and rejects the request with 400 (`reason: \"Invalid userId\"`) otherwise.</br> Set `userId` to `null` to clear a previously assigned association.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str sa_session_id: Session ID for Speech Analytics (required)
        :param list[NamedSpeaker] named_speaker: Modifications to Speech Analytics speakers. You can set a display name, associate the speaker with a known [Speaker](#tag/speaker) profile for voice signature matching, and/or associate the speaker with a Voicegain User via `userId`. 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
