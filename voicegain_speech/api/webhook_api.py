...
class WebhookApi(object):
    ...
    def example_webhook_call(self, **kwargs):  # noqa: E501
        """Example Webhook Call  # noqa: E501

        Here we show an example of the webhook call that you can expect from Voicegain (we show only the application/json version). </br>  Format of the webhook payload may be either `application/json` or `application/x-www-form-urlencoded` depending on the webhook format configuration: </br>  + `json` will send the payload as application/json content type with the payload as a JSON object. + `form_urlencoded` will send the payload as a application/x-www-form-urlencoded content type (this is the default)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.example_webhook_call(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param WebhookCall webhook_call: Webhook call payload
        ...
        return self.example_webhook_call_with_http_info(**kwargs)  # noqa: E501

    def example_webhook_call_with_http_info(self, **kwargs):  # noqa: E501
        """Example Webhook Call  # noqa: E501

        Here we show an example of the webhook call that you can expect from Voicegain (we show only the application/json version). </br>  Format of the webhook payload may be either `application/json` or `application/x-www-form-urlencoded` depending on the webhook format configuration: </br>  + `json` will send the payload as application/json content type with the payload as a JSON object. + `form_urlencoded` will send the payload as a application/x-www-form-urlencoded content type (this is the default)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.example_webhook_call_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['webhook_call']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method example_webhook_call" % key
                )
        ...
        body_params = None
        if 'webhook_call' in local_var_params:
            body_params = local_var_params['webhook_call']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['plain/text', 'application/json'])  # noqa: E501
    ...
    def webhook_delete(self, webhook_uuid, **kwargs):  # noqa: E501
        """Delete Webhook  # noqa: E501

        Delete webhook configuration.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_delete(webhook_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str webhook_uuid: UUID of the webhook registration.   (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.webhook_delete_with_http_info(webhook_uuid, **kwargs)  # noqa: E501

    def webhook_delete_with_http_info(self, webhook_uuid, **kwargs):  # noqa: E501
        """Delete Webhook  # noqa: E501

        Delete webhook configuration.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_delete_with_http_info(webhook_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['webhook_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'webhook_uuid' is set
        if self.api_client.client_side_validation and ('webhook_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['webhook_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `webhook_uuid` when calling `webhook_delete`")  # noqa: E501

        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_delete`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_delete`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'webhook_uuid' in local_var_params:
            path_params['webhookUuid'] = local_var_params['webhook_uuid']  # noqa: E501
    ...
    def webhook_get(self, webhook_uuid, **kwargs):  # noqa: E501
        """Get Webhook  # noqa: E501

        Retrieve webhook configuration.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_get(webhook_uuid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.webhook_get_with_http_info(webhook_uuid, **kwargs)  # noqa: E501

    def webhook_get_with_http_info(self, webhook_uuid, **kwargs):  # noqa: E501
        """Get Webhook  # noqa: E501

        Retrieve webhook configuration.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_get_with_http_info(webhook_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('webhook_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['webhook_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `webhook_uuid` when calling `webhook_get`")  # noqa: E501

        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_get`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def webhook_post(self, **kwargs):  # noqa: E501
        """Create Webhook  # noqa: E501

        Register a webhook.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param Webhook webhook: New webhook data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.webhook_post_with_http_info(**kwargs)  # noqa: E501

    def webhook_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create Webhook  # noqa: E501

        Register a webhook.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def webhook_put(self, webhook_uuid, **kwargs):  # noqa: E501
        """Modify Webhook  # noqa: E501

        Modify webhook configuration. Only data that is provided in the request will be modified. To turn off webhook for some resource, pass an empty list of events.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_put(webhook_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str webhook_uuid: UUID of the webhook registration.   (required)
        :param Webhook webhook: modified webhook data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.webhook_put_with_http_info(webhook_uuid, **kwargs)  # noqa: E501

    def webhook_put_with_http_info(self, webhook_uuid, **kwargs):  # noqa: E501
        """Modify Webhook  # noqa: E501

        Modify webhook configuration. Only data that is provided in the request will be modified. To turn off webhook for some resource, pass an empty list of events.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_put_with_http_info(webhook_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['webhook_uuid', 'webhook']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('webhook_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['webhook_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `webhook_uuid` when calling `webhook_put`")  # noqa: E501

        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_put`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('webhook_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['webhook_uuid']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_uuid` when calling `webhook_put`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def webhook_query(self, **kwargs):  # noqa: E501
        """Query Webhook  # noqa: E501

        Retrieve all webhooks on the account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_query(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.webhook_query_with_http_info(**kwargs)  # noqa: E501

    def webhook_query_with_http_info(self, **kwargs):  # noqa: E501
        """Query Webhook  # noqa: E501

        Retrieve all webhooks on the account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_query_with_http_info(async_req=True)
        >>> result = thread.get()
