...
class AiOutputApi(object):
    ...
    def ai_output_feedback_post(self, ai_output_id, **kwargs):  # noqa: E501
        ...
        :return: AiOutputFeedback
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.ai_output_feedback_post_with_http_info(ai_output_id, **kwargs)  # noqa: E501
    ...
    def ai_output_feedback_post_with_http_info(self, ai_output_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AiOutputFeedback, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method ai_output_feedback_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('ai_output_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ai_output_id` when calling `ai_output_feedback_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ai_output_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `ai_output_id` when calling `ai_output_feedback_post`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('ai_output_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ai_output_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ai_output_id` when calling `ai_output_feedback_post`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'ai_output_feedback_create' in local_var_params:
            body_params = local_var_params['ai_output_feedback_create']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/aiOutput/{aiOutputId}/feedback', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='AiOutputFeedback',  # noqa: E501
    ...
    def ai_output_get(self, ai_output_id, **kwargs):  # noqa: E501
        """Get AI Output  # noqa: E501

        Get a single AI Output record, including all attached feedback entries (`feedbacks[]`).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ai_output_get(ai_output_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.ai_output_get_with_http_info(ai_output_id, **kwargs)  # noqa: E501

    def ai_output_get_with_http_info(self, ai_output_id, **kwargs):  # noqa: E501
        """Get AI Output  # noqa: E501

        Get a single AI Output record, including all attached feedback entries (`feedbacks[]`).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ai_output_get_with_http_info(ai_output_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ai_output_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('ai_output_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ai_output_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ai_output_id` when calling `ai_output_get`")  # noqa: E501

        if self.api_client.client_side_validation and ('ai_output_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ai_output_id']) > 48):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ai_output_id` when calling `ai_output_get`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('ai_output_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ai_output_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ai_output_id` when calling `ai_output_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
    ...
    def ai_output_post(self, **kwargs):  # noqa: E501
        ...
        Capture a new AI/LLM-generated output (summary, suggestion, sentiment, etc.).</br> The captured `content` is stored verbatim and is **self-contained** — it survives deletion of the original source object.</br> Retention is controlled by the back end (no client-driven delete API).</br> Feedback is attached separately via [POST /aiOutput/{aiOutputId}/feedback](#tag/aiOutput/operation/aiOutputFeedbackPost).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ai_output_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param AiOutputCreate ai_output_create: AI Output to create.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.ai_output_post_with_http_info(**kwargs)  # noqa: E501

    def ai_output_post_with_http_info(self, **kwargs):  # noqa: E501
        """New AI Output  # noqa: E501

        Capture a new AI/LLM-generated output (summary, suggestion, sentiment, etc.).</br> The captured `content` is stored verbatim and is **self-contained** — it survives deletion of the original source object.</br> Retention is controlled by the back end (no client-driven delete API).</br> Feedback is attached separately via [POST /aiOutput/{aiOutputId}/feedback](#tag/aiOutput/operation/aiOutputFeedbackPost).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ai_output_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ai_output_create']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'ai_output_create' in local_var_params:
            body_params = local_var_params['ai_output_create']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def ai_output_query(self, **kwargs):  # noqa: E501
        ...
        :param bool has_feedback: If `true`, returns only records that have at least one feedback entry. If `false`, returns only records with no feedback. Omit to return both. 
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[AiOutput]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.ai_output_query_with_http_info(**kwargs)  # noqa: E501
    ...
    def ai_output_query_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[AiOutput], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `context_id` when calling `ai_output_query`, length must be less than or equal to `48`")  # noqa: E501
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('feedback_user_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['feedback_user_id']) < 16):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `feedback_user_id` when calling `ai_output_query`, length must be greater than or equal to `16`")  # noqa: E501
        if self.api_client.client_side_validation and 'from_epoch' in local_var_params and local_var_params['from_epoch'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `from_epoch` when calling `ai_output_query`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'to_epoch' in local_var_params and local_var_params['to_epoch'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `to_epoch` when calling `ai_output_query`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and ('tag' in local_var_params and  # noqa: E501
                                                        len(local_var_params['tag']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `tag` when calling `ai_output_query`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('tag' in local_var_params and  # noqa: E501
        ...
        if 'sa_session_id' in local_var_params and local_var_params['sa_session_id'] is not None:  # noqa: E501
        ...
        if 'from_epoch' in local_var_params and local_var_params['from_epoch'] is not None:  # noqa: E501
            query_params.append(('fromEpoch', local_var_params['from_epoch']))  # noqa: E501
        if 'to_epoch' in local_var_params and local_var_params['to_epoch'] is not None:  # noqa: E501
            query_params.append(('toEpoch', local_var_params['to_epoch']))  # noqa: E501
        if 'has_feedback' in local_var_params and local_var_params['has_feedback'] is not None:  # noqa: E501
            query_params.append(('hasFeedback', local_var_params['has_feedback']))  # noqa: E501
        if 'thumbs' in local_var_params and local_var_params['thumbs'] is not None:  # noqa: E501
            query_params.append(('thumbs', local_var_params['thumbs']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[AiOutput]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
