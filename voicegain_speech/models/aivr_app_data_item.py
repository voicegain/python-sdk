...
class AIVRAppDataItem(object):
    ...
    @property
    def data_uuid(self):
        """Gets the data_uuid of this AIVRAppDataItem.  # noqa: E501

        (optional) UUID of the data item. The data can be retrieved using the Data API.   # noqa: E501

        :return: The data_uuid of this AIVRAppDataItem.  # noqa: E501
        :rtype: str
        """
        return self._data_uuid

    @data_uuid.setter
    def data_uuid(self, data_uuid):
        """Sets the data_uuid of this AIVRAppDataItem.

        (optional) UUID of the data item. The data can be retrieved using the Data API.   # noqa: E501

        :param data_uuid: The data_uuid of this AIVRAppDataItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key(self):
        """Gets the key of this AIVRAppDataItem.  # noqa: E501

        Key of the data item  # noqa: E501

        :return: The key of this AIVRAppDataItem.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this AIVRAppDataItem.

        Key of the data item  # noqa: E501

        :param key: The key of this AIVRAppDataItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this AIVRAppDataItem.  # noqa: E501

        Value of the data item. This is optional, assuming that if this is not provided then the `dataUUID` will be provided. </br> Values larger than 1024 characters can be stored using Data API, see `dataUUID`.</br>   # noqa: E501

        :return: The value of this AIVRAppDataItem.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this AIVRAppDataItem.

        Value of the data item. This is optional, assuming that if this is not provided then the `dataUUID` will be provided. </br> Values larger than 1024 characters can be stored using Data API, see `dataUUID`.</br>   # noqa: E501

        :param value: The value of this AIVRAppDataItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRAppDataItem):
            return False
