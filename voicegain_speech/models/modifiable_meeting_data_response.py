...
class ModifiableMeetingDataResponse(object):
    ...
    def __init__(self, context=None, label=None, metadata=None, persist_seconds=3600, tags=None, local_vars_configuration=None):  # noqa: E501
        """ModifiableMeetingDataResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def context(self):
        """Gets the context of this ModifiableMeetingDataResponse.  # noqa: E501

        The new context to which the meeting is attached.   # noqa: E501

        :return: The context of this ModifiableMeetingDataResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def context(self, context):
        """Sets the context of this ModifiableMeetingDataResponse.

        The new context to which the meeting is attached.   # noqa: E501

        :param context: The context of this ModifiableMeetingDataResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this ModifiableMeetingDataResponse.  # noqa: E501

        The new meeting label (name).   # noqa: E501

        :return: The label of this ModifiableMeetingDataResponse.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this ModifiableMeetingDataResponse.

        The new meeting label (name).   # noqa: E501

        :param label: The label of this ModifiableMeetingDataResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this ModifiableMeetingDataResponse.  # noqa: E501

        All current metadata.   # noqa: E501

        :return: The metadata of this ModifiableMeetingDataResponse.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this ModifiableMeetingDataResponse.

        All current metadata.   # noqa: E501

        :param metadata: The metadata of this ModifiableMeetingDataResponse.  # noqa: E501
    ...
    def persist_seconds(self):
        """Gets the persist_seconds of this ModifiableMeetingDataResponse.  # noqa: E501

        The new time (in seconds) to retain the result/outcome data after processing has completed.     # noqa: E501

        :return: The persist_seconds of this ModifiableMeetingDataResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def persist_seconds(self, persist_seconds):
        """Sets the persist_seconds of this ModifiableMeetingDataResponse.

        The new time (in seconds) to retain the result/outcome data after processing has completed.     # noqa: E501

        :param persist_seconds: The persist_seconds of this ModifiableMeetingDataResponse.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def tags(self):
        """Gets the tags of this ModifiableMeetingDataResponse.  # noqa: E501

        Tags associated with the Meeting Transcription session. Each tag is a string with max length of 64 characters.   # noqa: E501

        :return: The tags of this ModifiableMeetingDataResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ModifiableMeetingDataResponse.

        Tags associated with the Meeting Transcription session. Each tag is a string with max length of 64 characters.   # noqa: E501

        :param tags: The tags of this ModifiableMeetingDataResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifiableMeetingDataResponse):
            return False
