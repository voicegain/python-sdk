...
class ACStartSttSpeechContexts(object):
    ...
    def __init__(self, boost=None, phrases=None, local_vars_configuration=None):  # noqa: E501
        """ACStartSttSpeechContexts - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def boost(self):
        """Gets the boost of this ACStartSttSpeechContexts.  # noqa: E501

        A boost to be applied to the hints in this list. Values above 20 will be interpreted as if 20 was given. So the practical range is 0-20  # noqa: E501

        :return: The boost of this ACStartSttSpeechContexts.  # noqa: E501
        :rtype: float
        """
        return self._boost
    ...
    def boost(self, boost):
        """Sets the boost of this ACStartSttSpeechContexts.

        A boost to be applied to the hints in this list. Values above 20 will be interpreted as if 20 was given. So the practical range is 0-20  # noqa: E501

        :param boost: The boost of this ACStartSttSpeechContexts.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                boost is not None and boost < 0):  # noqa: E501
            raise ValueError("Invalid value for `boost`, must be a value greater than or equal to `0`")  # noqa: E501

        self._boost = boost

    @property
    def phrases(self):
        """Gets the phrases of this ACStartSttSpeechContexts.  # noqa: E501

        List of hints. A hint is a word or a very short phrase (no more than 3 words).  # noqa: E501

        :return: The phrases of this ACStartSttSpeechContexts.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def phrases(self, phrases):
        """Sets the phrases of this ACStartSttSpeechContexts.

        List of hints. A hint is a word or a very short phrase (no more than 3 words).  # noqa: E501

        :param phrases: The phrases of this ACStartSttSpeechContexts.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ACStartSttSpeechContexts):
            return False
