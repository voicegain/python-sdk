...
class AsrSettingsTranscriptionSA(object):
    ...
    def acoustic_model_non_real_time(self):
        ...
        (Optional) Name of an Acoustic Model that is to be used for offline and semi-real-time processing.  In the Cloud, the currently available offline models are: - **VoiceGain-omega** - the default model - best suited to general transcription tasks, - **VoiceGain-omega-x** - model trained on call-center calls  Only available for **offline [async](#tag/transcribe/operation/asrTranscribeAsyncPost)** transcription: - **whisper:base**   - **whisper:small**,  - **whisper:medium**, also may use **whisper** as a shortcut for \"whisper:medium\" - **whisper:large-v3-turbo** - the largest model, best accuracy  If a model name is not provided (i.e. absent or null), then a model specified on the Context will be used,  and if there is no model specified on the Context then a suitable default will be used.</br> Note, empty string \"\" will be interpreted as a model name and will return an error as there is no model with empty name. </br> In some Edge deployments, may include version number separated by `:` , for example, **VoiceGain-BD_en-us:11**   # noqa: E501
    ...
    def language_detection(self):
        """Gets the language_detection of this AsrSettingsTranscriptionSA.  # noqa: E501


        :return: The language_detection of this AsrSettingsTranscriptionSA.  # noqa: E501
    ...
    def language_detection(self, language_detection):
        """Sets the language_detection of this AsrSettingsTranscriptionSA.


        :param language_detection: The language_detection of this AsrSettingsTranscriptionSA.  # noqa: E501
    ...
    @property
    def languages(self):
        """Gets the languages of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The languages of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: list[Language]
        """
    ...
    def languages(self, languages):
        """Sets the languages of this AsrSettingsTranscriptionSA.

        Language that should be recognized - this is important for acoustic Models that support more than one language.</br> This is a list parameter because we support multiple language recognition -  for those cases where the exact language spoken in the audio is not known up-front.  See [this knowledge base article](https://support.voicegain.ai/hc/en-us/articles/6535757706772-Languages-supported-in-Voicegain-Speech-to-Text) for which languages are supported with which models.   # noqa: E501

        :param languages: The languages of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: list[Language]
        """
    ...
    def optimized_for(self):
        """Gets the optimized_for of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The optimized_for of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def optimized_for(self, optimized_for):
        """Sets the optimized_for of this AsrSettingsTranscriptionSA.

        (Optional) Optimize various back-end settings for a specific use case. </br> If not provided then no specific optimization will be done.   # noqa: E501

        :param optimized_for: The optimized_for of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
    ...
    def decoder_factor(self):
        """Gets the decoder_factor of this AsrSettingsTranscriptionSA.  # noqa: E501


        :return: The decoder_factor of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: float
        """
    ...
    def decoder_factor(self, decoder_factor):
        """Sets the decoder_factor of this AsrSettingsTranscriptionSA.


        :param decoder_factor: The decoder_factor of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def lang_model_factor(self):
        """Gets the lang_model_factor of this AsrSettingsTranscriptionSA.  # noqa: E501


        :return: The lang_model_factor of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: float
        """
    ...
    def lang_model_factor(self, lang_model_factor):
        """Sets the lang_model_factor of this AsrSettingsTranscriptionSA.


        :param lang_model_factor: The lang_model_factor of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def content(self):
        """Gets the content of this AsrSettingsTranscriptionSA.  # noqa: E501

        Determines the granularity of the transcript content returned.</br> + **words** - transcript contains individual words with timestamps (default) + **segments** - transcript contains speaker segments rather than individual words   # noqa: E501

        :return: The content of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def content(self, content):
        """Sets the content of this AsrSettingsTranscriptionSA.

        Determines the granularity of the transcript content returned.</br> + **words** - transcript contains individual words with timestamps (default) + **segments** - transcript contains speaker segments rather than individual words   # noqa: E501

        :param content: The content of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
        allowed_values = ["words", "segments"]  # noqa: E501
