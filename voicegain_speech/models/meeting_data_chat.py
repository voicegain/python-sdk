...
class MeetingDataChat(object):
    ...
    def __init__(self, clock_time=None, msg=None, spk=None, spk_user_id=None, time_msec=None, local_vars_configuration=None):  # noqa: E501
        """MeetingDataChat - a model defined in OpenAPI"""  # noqa: E501
        ...
        if spk is not None:
            self.spk = spk
        if spk_user_id is not None:
            self.spk_user_id = spk_user_id
        if time_msec is not None:
            self.time_msec = time_msec

    @property
    def clock_time(self):
        """Gets the clock_time of this MeetingDataChat.  # noqa: E501

        Time in the meeting when the chat message was sent (as reported by Zoom).  Format is HH:MM:SS       # noqa: E501

        :return: The clock_time of this MeetingDataChat.  # noqa: E501
        :rtype: str
        """
    ...
    def clock_time(self, clock_time):
        """Sets the clock_time of this MeetingDataChat.

        Time in the meeting when the chat message was sent (as reported by Zoom).  Format is HH:MM:SS       # noqa: E501

        :param clock_time: The clock_time of this MeetingDataChat.  # noqa: E501
        :type: str
        """
    ...
    @property
    def msg(self):
        """Gets the msg of this MeetingDataChat.  # noqa: E501

        Chat message text   # noqa: E501

        :return: The msg of this MeetingDataChat.  # noqa: E501
        :rtype: str
        """
        return self._msg
    ...
    @msg.setter
    def msg(self, msg):
        """Sets the msg of this MeetingDataChat.

        Chat message text   # noqa: E501

        :param msg: The msg of this MeetingDataChat.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this MeetingDataChat.  # noqa: E501

        Id of the speaker as used in `words`. Will be absent if chat message was posted by a perticipant that did not speak.   # noqa: E501

        :return: The spk of this MeetingDataChat.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this MeetingDataChat.

        Id of the speaker as used in `words`. Will be absent if chat message was posted by a perticipant that did not speak.   # noqa: E501

        :param spk: The spk of this MeetingDataChat.  # noqa: E501
        :type: int
        """
    ...
    def spk_user_id(self):
        """Gets the spk_user_id of this MeetingDataChat.  # noqa: E501

        Internal ID of the participant who sent the chat message.  This ID references a value of `speakers[].externalUserId` or `nonSpeakingParticipants[].spkUserId` which can be used to find more information about the speaker or participant.   # noqa: E501

        :return: The spk_user_id of this MeetingDataChat.  # noqa: E501
        :rtype: int
        """
    ...
    def spk_user_id(self, spk_user_id):
        """Sets the spk_user_id of this MeetingDataChat.

        Internal ID of the participant who sent the chat message.  This ID references a value of `speakers[].externalUserId` or `nonSpeakingParticipants[].spkUserId` which can be used to find more information about the speaker or participant.   # noqa: E501

        :param spk_user_id: The spk_user_id of this MeetingDataChat.  # noqa: E501
        :type: int
        """
    ...
    @property
    def time_msec(self):
        """Gets the time_msec of this MeetingDataChat.  # noqa: E501

        Time in the meeting (in milliseconds from start of the recording) when the chat message was sent.    # noqa: E501

        :return: The time_msec of this MeetingDataChat.  # noqa: E501
        :rtype: int
        """
    ...
    def time_msec(self, time_msec):
        """Sets the time_msec of this MeetingDataChat.

        Time in the meeting (in milliseconds from start of the recording) when the chat message was sent.    # noqa: E501

        :param time_msec: The time_msec of this MeetingDataChat.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingDataChat):
            return False
