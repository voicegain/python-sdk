...
class AIVRCallbackResponseAllOf(object):
    ...
    @property
    def csid(self):
        """Gets the csid of this AIVRCallbackResponseAllOf.  # noqa: E501

        AIVR session id on Customer's platform. Has to stay consistent for the duration of the telephone call.   # noqa: E501

        :return: The csid of this AIVRCallbackResponseAllOf.  # noqa: E501
        :rtype: str
        """
        return self._csid
    ...
    @csid.setter
    def csid(self, csid):
        """Sets the csid of this AIVRCallbackResponseAllOf.

        AIVR session id on Customer's platform. Has to stay consistent for the duration of the telephone call.   # noqa: E501

        :param csid: The csid of this AIVRCallbackResponseAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sequence(self):
        """Gets the sequence of this AIVRCallbackResponseAllOf.  # noqa: E501

        sequential number within session of this callback, response sequence should match request sequence  # noqa: E501

        :return: The sequence of this AIVRCallbackResponseAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def sequence(self, sequence):
        """Sets the sequence of this AIVRCallbackResponseAllOf.

        sequential number within session of this callback, response sequence should match request sequence  # noqa: E501

        :param sequence: The sequence of this AIVRCallbackResponseAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def sid(self):
        """Gets the sid of this AIVRCallbackResponseAllOf.  # noqa: E501

        AIVR session id on Voicegain platform  # noqa: E501

        :return: The sid of this AIVRCallbackResponseAllOf.  # noqa: E501
        :rtype: str
        """
        return self._sid
    ...
    @sid.setter
    def sid(self, sid):
        """Sets the sid of this AIVRCallbackResponseAllOf.

        AIVR session id on Voicegain platform  # noqa: E501

        :param sid: The sid of this AIVRCallbackResponseAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRCallbackResponseAllOf):
            return False
