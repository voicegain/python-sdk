...
class PerformedRedaction(object):
    ...
    def __init__(self, confidence=None, duration=None, mask=None, options=None, original_value=None, pattern=None, redacted_value=None, spk=None, start=None, type=None, local_vars_configuration=None):  # noqa: E501
    ...
    def original_value(self):
        ...
        Transcript snippet as it looks before the redaction was performed. </br> ** present only if `settings.debug.level` is 5 or higher ** (default debug setting is 3)   # noqa: E501
