...
class PerformedRedaction(object):
    ...
    def __init__(self, confidence=None, duration=None, mask=None, options=None, original_value=None, pattern=None, redacted_value=None, start=None, type=None, local_vars_configuration=None):  # noqa: E501
