...
class PerformedRedaction(object):
    ...
    def __init__(self, duration=None, spk=None, start=None, confidence=None, mask=None, options=None, original_value=None, pattern=None, redacted_value=None, type=None, local_vars_configuration=None):  # noqa: E501
        """PerformedRedaction - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def duration(self):
        """Gets the duration of this PerformedRedaction.  # noqa: E501

        duration of the redaction in milliseconds  # noqa: E501

        :return: The duration of this PerformedRedaction.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this PerformedRedaction.

        duration of the redaction in milliseconds  # noqa: E501

        :param duration: The duration of this PerformedRedaction.  # noqa: E501
        :type: int
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this PerformedRedaction.  # noqa: E501

        (Optional) Used in `two-channel` mode to indicate which channel was redacted. </br> spk:1 for Left channel and spk:2 for the Right channel. </br>   # noqa: E501

        :return: The spk of this PerformedRedaction.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this PerformedRedaction.

        (Optional) Used in `two-channel` mode to indicate which channel was redacted. </br> spk:1 for Left channel and spk:2 for the Right channel. </br>   # noqa: E501

        :param spk: The spk of this PerformedRedaction.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start(self):
        """Gets the start of this PerformedRedaction.  # noqa: E501

        start point of the redaction in milliseconds  # noqa: E501

        :return: The start of this PerformedRedaction.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this PerformedRedaction.

        start point of the redaction in milliseconds  # noqa: E501

        :param start: The start of this PerformedRedaction.  # noqa: E501
        :type: int
        """
    ...
    @property
    def confidence(self):
        """Gets the confidence of this PerformedRedaction.  # noqa: E501

        Confidence of the redaction. </br> In case of ner redaction, the confidence is the confidence of the entity that was redacted.   # noqa: E501

        :return: The confidence of this PerformedRedaction.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence(self, confidence):
        """Sets the confidence of this PerformedRedaction.

        Confidence of the redaction. </br> In case of ner redaction, the confidence is the confidence of the entity that was redacted.   # noqa: E501

        :param confidence: The confidence of this PerformedRedaction.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def mask(self):
        """Gets the mask of this PerformedRedaction.  # noqa: E501

        Mask that was used for the redaction. </br> Possible values are: + \"partial\" + \"full\" + \"[PLACEHOLDER]\" - if a string in in square brackets then it means that a placeholder was used for the redaction   # noqa: E501

        :return: The mask of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
        return self._mask
    ...
    @mask.setter
    def mask(self, mask):
        """Sets the mask of this PerformedRedaction.

        Mask that was used for the redaction. </br> Possible values are: + \"partial\" + \"full\" + \"[PLACEHOLDER]\" - if a string in in square brackets then it means that a placeholder was used for the redaction   # noqa: E501

        :param mask: The mask of this PerformedRedaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def options(self):
        """Gets the options of this PerformedRedaction.  # noqa: E501

        Options that were used for the redaction. </br>   # noqa: E501

        :return: The options of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
    ...
    def options(self, options):
        """Sets the options of this PerformedRedaction.

        Options that were used for the redaction. </br>   # noqa: E501

        :param options: The options of this PerformedRedaction.  # noqa: E501
        :type: str
        """
    ...
    def original_value(self):
        """Gets the original_value of this PerformedRedaction.  # noqa: E501

        Transcript snippet as it looks before the redaction was performed. </br> + present only if in the request the `debug.level` is 5 or higher ** (default debug setting is 3)   # noqa: E501

        :return: The original_value of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
    ...
    def original_value(self, original_value):
        """Sets the original_value of this PerformedRedaction.

        Transcript snippet as it looks before the redaction was performed. </br> + present only if in the request the `debug.level` is 5 or higher ** (default debug setting is 3)   # noqa: E501

        :param original_value: The original_value of this PerformedRedaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pattern(self):
        """Gets the pattern of this PerformedRedaction.  # noqa: E501

        Pattern that was used for the redaction. </br> In case of ner redaction, the pattern is the name of the entity that was redacted.   # noqa: E501

        :return: The pattern of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """Sets the pattern of this PerformedRedaction.

        Pattern that was used for the redaction. </br> In case of ner redaction, the pattern is the name of the entity that was redacted.   # noqa: E501

        :param pattern: The pattern of this PerformedRedaction.  # noqa: E501
        :type: str
        """
    ...
    def redacted_value(self):
        """Gets the redacted_value of this PerformedRedaction.  # noqa: E501

        Transcript snippet as it looks after the redaction was performed. </br>   # noqa: E501

        :return: The redacted_value of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
    ...
    def redacted_value(self, redacted_value):
        """Sets the redacted_value of this PerformedRedaction.

        Transcript snippet as it looks after the redaction was performed. </br>   # noqa: E501

        :param redacted_value: The redacted_value of this PerformedRedaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this PerformedRedaction.  # noqa: E501

        Type of the redaction. `dtmf` means that dtmf tone was redacted. `answer_redact` means the answer to a configured question was redacted (the `pattern` field carries the matched question).   # noqa: E501

        :return: The type of this PerformedRedaction.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PerformedRedaction.

        Type of the redaction. `dtmf` means that dtmf tone was redacted. `answer_redact` means the answer to a configured question was redacted (the `pattern` field carries the matched question).   # noqa: E501

        :param type: The type of this PerformedRedaction.  # noqa: E501
        :type: str
        """
        allowed_values = ["ner", "regex", "dtmf", "answer_redact"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PerformedRedaction):
            return False
