...
class VoiceCallModifiableBaseVoicebotVars(object):
    ...
    def __init__(self, caller_intent=None, caller_type=None, current_step=None, fully_automated=None, lob=None, obh=None, verification_status=None, voicemail=None, local_vars_configuration=None):  # noqa: E501
        """VoiceCallModifiableBaseVoicebotVars - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._caller_intent = None
        self._caller_type = None
        self._current_step = None
        self._fully_automated = None
        self._lob = None
        self._obh = None
        ...
        if fully_automated is not None:
            self.fully_automated = fully_automated
        if lob is not None:
            self.lob = lob
        if obh is not None:
            self.obh = obh
    ...
    def caller_intent(self, caller_intent):
        ...
        if (self.local_vars_configuration.client_side_validation and
                caller_intent is not None and len(caller_intent) > 512):
            raise ValueError("Invalid value for `caller_intent`, length must be less than or equal to `512`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                caller_intent is not None and len(caller_intent) < 1):
            raise ValueError("Invalid value for `caller_intent`, length must be greater than or equal to `1`")  # noqa: E501

        self._caller_intent = caller_intent

    @property
    def caller_type(self):
        """Gets the caller_type of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        The type of caller determined by the app logic, e.g. Member, Provider, etc.  # noqa: E501

        :return: The caller_type of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def caller_type(self, caller_type):
        """Sets the caller_type of this VoiceCallModifiableBaseVoicebotVars.

        The type of caller determined by the app logic, e.g. Member, Provider, etc.  # noqa: E501

        :param caller_type: The caller_type of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                caller_type is not None and len(caller_type) > 128):
            raise ValueError("Invalid value for `caller_type`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                caller_type is not None and len(caller_type) < 1):
            raise ValueError("Invalid value for `caller_type`, length must be greater than or equal to `1`")  # noqa: E501

        self._caller_type = caller_type

    @property
    def current_step(self):
        """Gets the current_step of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        The current step in the app logic, e.g. \"Greeting\", \"Verification\", etc.  # noqa: E501

        :return: The current_step of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def current_step(self, current_step):
        """Sets the current_step of this VoiceCallModifiableBaseVoicebotVars.

        The current step in the app logic, e.g. \"Greeting\", \"Verification\", etc.  # noqa: E501

        :param current_step: The current_step of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                current_step is not None and len(current_step) > 128):
            raise ValueError("Invalid value for `current_step`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                current_step is not None and len(current_step) < 1):
            raise ValueError("Invalid value for `current_step`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def fully_automated(self):
        ...
        :rtype: str
        """
        return self._fully_automated

    @fully_automated.setter
    def fully_automated(self, fully_automated):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fully_automated is not None and len(fully_automated) > 512):
            raise ValueError("Invalid value for `fully_automated`, length must be less than or equal to `512`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                fully_automated is not None and len(fully_automated) < 1):
            raise ValueError("Invalid value for `fully_automated`, length must be greater than or equal to `1`")  # noqa: E501

        self._fully_automated = fully_automated

    @property
    def lob(self):
        """Gets the lob of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        The line of business, e.g. ACME Claims  # noqa: E501

        :return: The lob of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: str
        """
        return self._lob
    ...
    @lob.setter
    def lob(self, lob):
        """Sets the lob of this VoiceCallModifiableBaseVoicebotVars.

        The line of business, e.g. ACME Claims  # noqa: E501

        :param lob: The lob of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                lob is not None and len(lob) > 128):
            raise ValueError("Invalid value for `lob`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                lob is not None and len(lob) < 1):
            raise ValueError("Invalid value for `lob`, length must be greater than or equal to `1`")  # noqa: E501

        self._lob = lob

    @property
    def obh(self):
        """Gets the obh of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        set to true when the app logic used Business Config and determined that it’s outside business hours   # noqa: E501

        :return: The obh of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: bool
        """
        return self._obh
    ...
    @obh.setter
    def obh(self, obh):
        """Sets the obh of this VoiceCallModifiableBaseVoicebotVars.

        set to true when the app logic used Business Config and determined that it’s outside business hours   # noqa: E501

        :param obh: The obh of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: bool
        """
    ...
    def verification_status(self):
        """Gets the verification_status of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        The verification status determined by the app logic.  # noqa: E501

        :return: The verification_status of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def verification_status(self, verification_status):
        """Sets the verification_status of this VoiceCallModifiableBaseVoicebotVars.

        The verification status determined by the app logic.  # noqa: E501

        :param verification_status: The verification_status of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: str
        """
    ...
    @property
    def voicemail(self):
        """Gets the voicemail of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501

        Set to true if a voicemail was left during the call.   # noqa: E501

        :return: The voicemail of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :rtype: bool
        """
    ...
    def voicemail(self, voicemail):
        """Sets the voicemail of this VoiceCallModifiableBaseVoicebotVars.

        Set to true if a voicemail was left during the call.   # noqa: E501

        :param voicemail: The voicemail of this VoiceCallModifiableBaseVoicebotVars.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceCallModifiableBaseVoicebotVars):
            return False
