...
class WebhookCall(object):
    ...
    def __init__(self, data=None, event=None, event_uuid=None, jwt=None, receiver_token=None, resource=None, timestamp=None, webhook_uuid=None, local_vars_configuration=None):  # noqa: E501
        """WebhookCall - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this WebhookCall.  # noqa: E501

        Complete data for the resource (JSON serialized into a string value).  Identical to what a GET method on the resource would return. </br> If the resource is a meeting then to get the full meeting data you can use GET [/asr/meeting/{meetingId}/data](#tag/meeting/operation/asrMeetingGetData) API method, or if you want just the transcript you can use GET [/asr/meeting/{meetingId}/transcript](#tag/meeting/operation/asrMeetingGetTranscript) API method.  If the resource is a transcribe session (async transcription) then the data is the same as returned by the GET [/asr/transcribe/{sessionId}](#operation/asrTranscribeAsyncGet) polling method for that session. When audio capture is in effect it includes the `audio.capturedAudio` DataObject uuid — note that sessions created by the same multi-session request share the same `audio` object, so `audio.capturedAudio` can be used to associate their webhook calls with each other.   # noqa: E501

        :return: The data of this WebhookCall.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this WebhookCall.

        Complete data for the resource (JSON serialized into a string value).  Identical to what a GET method on the resource would return. </br> If the resource is a meeting then to get the full meeting data you can use GET [/asr/meeting/{meetingId}/data](#tag/meeting/operation/asrMeetingGetData) API method, or if you want just the transcript you can use GET [/asr/meeting/{meetingId}/transcript](#tag/meeting/operation/asrMeetingGetTranscript) API method.  If the resource is a transcribe session (async transcription) then the data is the same as returned by the GET [/asr/transcribe/{sessionId}](#operation/asrTranscribeAsyncGet) polling method for that session. When audio capture is in effect it includes the `audio.capturedAudio` DataObject uuid — note that sessions created by the same multi-session request share the same `audio` object, so `audio.capturedAudio` can be used to associate their webhook calls with each other.   # noqa: E501

        :param data: The data of this WebhookCall.  # noqa: E501
        :type: str
        """
    ...
    @property
    def event(self):
        """Gets the event of this WebhookCall.  # noqa: E501

        Event's name for this payload. See webhook registration for possible values.   # noqa: E501

        :return: The event of this WebhookCall.  # noqa: E501
        :rtype: str
        """
        return self._event
    ...
    def event(self, event):
        """Sets the event of this WebhookCall.

        Event's name for this payload. See webhook registration for possible values.   # noqa: E501

        :param event: The event of this WebhookCall.  # noqa: E501
        :type: str
        """
    ...
    @property
    def event_uuid(self):
        """Gets the event_uuid of this WebhookCall.  # noqa: E501

        Unique ID of the event.  It is unique for the webhook event and is used to prevent duplicate processing of the same event.   # noqa: E501

        :return: The event_uuid of this WebhookCall.  # noqa: E501
        :rtype: str
        """
    ...
    def event_uuid(self, event_uuid):
        """Sets the event_uuid of this WebhookCall.

        Unique ID of the event.  It is unique for the webhook event and is used to prevent duplicate processing of the same event.   # noqa: E501

        :param event_uuid: The event_uuid of this WebhookCall.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and event_uuid is None:  # noqa: E501
            raise ValueError("Invalid value for `event_uuid`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                event_uuid is not None and len(event_uuid) > 36):
            raise ValueError("Invalid value for `event_uuid`, length must be less than or equal to `36`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                event_uuid is not None and len(event_uuid) < 36):
            raise ValueError("Invalid value for `event_uuid`, length must be greater than or equal to `36`")  # noqa: E501

        self._event_uuid = event_uuid

    @property
    def jwt(self):
        """Gets the jwt of this WebhookCall.  # noqa: E501

        JWT token that can be used to access the API methods of the resource. The token is short-lived (10 minutes) and is only present if the webhook was registered with `sendJWT` set to true.</br> The token is valid only for the context in which the resource is present and only for the API methods that access the resource.   # noqa: E501

        :return: The jwt of this WebhookCall.  # noqa: E501
        :rtype: str
        """
        return self._jwt
    ...
    @jwt.setter
    def jwt(self, jwt):
        """Sets the jwt of this WebhookCall.

        JWT token that can be used to access the API methods of the resource. The token is short-lived (10 minutes) and is only present if the webhook was registered with `sendJWT` set to true.</br> The token is valid only for the context in which the resource is present and only for the API methods that access the resource.   # noqa: E501

        :param jwt: The jwt of this WebhookCall.  # noqa: E501
        :type: str
        """
    ...
    def receiver_token(self):
        """Gets the receiver_token of this WebhookCall.  # noqa: E501

        Token that was provied when registering the webhook. The receiver can choose to validate the token to ensure that the request is coming from the expected source.   # noqa: E501

        :return: The receiver_token of this WebhookCall.  # noqa: E501
        :rtype: str
        """
        return self._receiver_token

    @receiver_token.setter
    def receiver_token(self, receiver_token):
        """Sets the receiver_token of this WebhookCall.

        Token that was provied when registering the webhook. The receiver can choose to validate the token to ensure that the request is coming from the expected source.   # noqa: E501

        :param receiver_token: The receiver_token of this WebhookCall.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                receiver_token is not None and len(receiver_token) > 128):
            raise ValueError("Invalid value for `receiver_token`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                receiver_token is not None and len(receiver_token) < 1):
            raise ValueError("Invalid value for `receiver_token`, length must be greater than or equal to `1`")  # noqa: E501

        self._receiver_token = receiver_token

    @property
    def resource(self):
        """Gets the resource of this WebhookCall.  # noqa: E501

        Name of the resource for this event.   # noqa: E501

        :return: The resource of this WebhookCall.  # noqa: E501
        :rtype: str
        """
    ...
    def resource(self, resource):
        """Sets the resource of this WebhookCall.

        Name of the resource for this event.   # noqa: E501

        :param resource: The resource of this WebhookCall.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and resource is None:  # noqa: E501
            raise ValueError("Invalid value for `resource`, must not be `None`")  # noqa: E501
        allowed_values = ["meeting", "user", "context", "transcribe", "sa_offline"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and resource not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this WebhookCall.  # noqa: E501

        UNIX timestamp in milliseconds of the event.   # noqa: E501

        :return: The timestamp of this WebhookCall.  # noqa: E501
        :rtype: float
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this WebhookCall.

        UNIX timestamp in milliseconds of the event.   # noqa: E501

        :param timestamp: The timestamp of this WebhookCall.  # noqa: E501
        :type: float
        """
    ...
    @property
    def webhook_uuid(self):
        """Gets the webhook_uuid of this WebhookCall.  # noqa: E501

        UUID of the registered webhook   # noqa: E501

        :return: The webhook_uuid of this WebhookCall.  # noqa: E501
        :rtype: str
        """
        return self._webhook_uuid

    @webhook_uuid.setter
    def webhook_uuid(self, webhook_uuid):
        """Sets the webhook_uuid of this WebhookCall.

        UUID of the registered webhook   # noqa: E501

        :param webhook_uuid: The webhook_uuid of this WebhookCall.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and webhook_uuid is None:  # noqa: E501
            raise ValueError("Invalid value for `webhook_uuid`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                webhook_uuid is not None and len(webhook_uuid) > 36):
            raise ValueError("Invalid value for `webhook_uuid`, length must be less than or equal to `36`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                webhook_uuid is not None and len(webhook_uuid) < 36):
            raise ValueError("Invalid value for `webhook_uuid`, length must be greater than or equal to `36`")  # noqa: E501

        self._webhook_uuid = webhook_uuid
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebhookCall):
            return False
