...
class NamedCallbackUrl(object):
    ...
    def __init__(self, name='default', probability=1.0, url=None, user_app_data=None, local_vars_configuration=None):  # noqa: E501
        """NamedCallbackUrl - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this NamedCallbackUrl.  # noqa: E501

        Name of the callback URL  # noqa: E501

        :return: The name of this NamedCallbackUrl.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NamedCallbackUrl.

        Name of the callback URL  # noqa: E501

        :param name: The name of this NamedCallbackUrl.  # noqa: E501
        :type: str
        """
    ...
    def probability(self):
        """Gets the probability of this NamedCallbackUrl.  # noqa: E501

        Probability that this callback URL will be called.  If not provided then the probability is 1.0   # noqa: E501

        :return: The probability of this NamedCallbackUrl.  # noqa: E501
        :rtype: float
        """
    ...
    def probability(self, probability):
        """Sets the probability of this NamedCallbackUrl.

        Probability that this callback URL will be called.  If not provided then the probability is 1.0   # noqa: E501

        :param probability: The probability of this NamedCallbackUrl.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                probability is not None and probability > 1.0):  # noqa: E501
            raise ValueError("Invalid value for `probability`, must be a value less than or equal to `1.0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                probability is not None and probability < 0.0):  # noqa: E501
            raise ValueError("Invalid value for `probability`, must be a value greater than or equal to `0.0`")  # noqa: E501

        self._probability = probability

    @property
    def url(self):
        """Gets the url of this NamedCallbackUrl.  # noqa: E501

        URL to be called  # noqa: E501

        :return: The url of this NamedCallbackUrl.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this NamedCallbackUrl.

        URL to be called  # noqa: E501

        :param url: The url of this NamedCallbackUrl.  # noqa: E501
        :type: str
        """
    ...
    def user_app_data(self):
        """Gets the user_app_data of this NamedCallbackUrl.  # noqa: E501
        ...
        :return: The user_app_data of this NamedCallbackUrl.  # noqa: E501
        :rtype: str
        """
    ...
    def user_app_data(self, user_app_data):
        """Sets the user_app_data of this NamedCallbackUrl.

        (optional) App specific data that was associated in the AIVR portal with this AIVR number/application.</br> It is a string that is not interpreted by the AIVR and only passed to Customer dialog engine.   # noqa: E501

        :param user_app_data: The user_app_data of this NamedCallbackUrl.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NamedCallbackUrl):
            return False
