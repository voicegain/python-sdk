...
class JoinedMeetingEvent(object):
    ...
    def __init__(self, event_type=None, notes=None, time_msec=None, local_vars_configuration=None):  # noqa: E501
        """JoinedMeetingEvent - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def notes(self):
        """Gets the notes of this JoinedMeetingEvent.  # noqa: E501

        (optional) Additional information about the event. For example, if the event type is **rejected** then the notes may contain the reason for rejection.   # noqa: E501

        :return: The notes of this JoinedMeetingEvent.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this JoinedMeetingEvent.

        (optional) Additional information about the event. For example, if the event type is **rejected** then the notes may contain the reason for rejection.   # noqa: E501

        :param notes: The notes of this JoinedMeetingEvent.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_msec(self):
        """Gets the time_msec of this JoinedMeetingEvent.  # noqa: E501

        Time in the meeting (in milliseconds from start of the Meeting session) when the event happened.   # noqa: E501

        :return: The time_msec of this JoinedMeetingEvent.  # noqa: E501
        :rtype: int
        """
    ...
    def time_msec(self, time_msec):
        """Sets the time_msec of this JoinedMeetingEvent.

        Time in the meeting (in milliseconds from start of the Meeting session) when the event happened.   # noqa: E501

        :param time_msec: The time_msec of this JoinedMeetingEvent.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JoinedMeetingEvent):
            return False
