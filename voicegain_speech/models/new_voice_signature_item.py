...
class NewVoiceSignatureItem(object):
    ...
    def __init__(self, audio_clip=None, end_msec=None, label=None, prepared_text_id=None, start_msec=None, tags=None, local_vars_configuration=None):  # noqa: E501
        """NewVoiceSignatureItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio_clip(self):
        """Gets the audio_clip of this NewVoiceSignatureItem.  # noqa: E501

        Reference to the audio clip that is to be used to compute the signature  # noqa: E501

        :return: The audio_clip of this NewVoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_clip(self, audio_clip):
        """Sets the audio_clip of this NewVoiceSignatureItem.

        Reference to the audio clip that is to be used to compute the signature  # noqa: E501

        :param audio_clip: The audio_clip of this NewVoiceSignatureItem.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and audio_clip is None:  # noqa: E501
            raise ValueError("Invalid value for `audio_clip`, must not be `None`")  # noqa: E501
    ...
    @property
    def end_msec(self):
        """Gets the end_msec of this NewVoiceSignatureItem.  # noqa: E501

        Use it only if a selection from the audio clip is to be used for the signature. Specifies end of the selection. </br> Note: `endMsec` - `startMsec` may not be longer than 60 seconds.   # noqa: E501

        :return: The end_msec of this NewVoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
    ...
    def end_msec(self, end_msec):
        """Sets the end_msec of this NewVoiceSignatureItem.

        Use it only if a selection from the audio clip is to be used for the signature. Specifies end of the selection. </br> Note: `endMsec` - `startMsec` may not be longer than 60 seconds.   # noqa: E501

        :param end_msec: The end_msec of this NewVoiceSignatureItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def label(self):
        """Gets the label of this NewVoiceSignatureItem.  # noqa: E501

        Signature label   # noqa: E501

        :return: The label of this NewVoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this NewVoiceSignatureItem.

        Signature label   # noqa: E501

        :param label: The label of this NewVoiceSignatureItem.  # noqa: E501
        :type: str
        """
    ...
    def prepared_text_id(self):
        """Gets the prepared_text_id of this NewVoiceSignatureItem.  # noqa: E501

        Will be set only if the audio clip is a recording of the specific prepared text that the speaker read.   # noqa: E501

        :return: The prepared_text_id of this NewVoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
    ...
    def prepared_text_id(self, prepared_text_id):
        """Sets the prepared_text_id of this NewVoiceSignatureItem.

        Will be set only if the audio clip is a recording of the specific prepared text that the speaker read.   # noqa: E501

        :param prepared_text_id: The prepared_text_id of this NewVoiceSignatureItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_msec(self):
        """Gets the start_msec of this NewVoiceSignatureItem.  # noqa: E501

        Use it only if a selection from the audio clip is to be used for the signature. Specifies start of the selection. </br> Note: `endMsec` - `startMsec` may not be longer than 60 seconds.   # noqa: E501

        :return: The start_msec of this NewVoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
    ...
    def start_msec(self, start_msec):
        """Sets the start_msec of this NewVoiceSignatureItem.

        Use it only if a selection from the audio clip is to be used for the signature. Specifies start of the selection. </br> Note: `endMsec` - `startMsec` may not be longer than 60 seconds.   # noqa: E501

        :param start_msec: The start_msec of this NewVoiceSignatureItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this NewVoiceSignatureItem.

        List of short strings (tags) that help to distinguish voice signatures.  Either manually or automatically entered.   # noqa: E501

        :param tags: The tags of this NewVoiceSignatureItem.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewVoiceSignatureItem):
            return False
