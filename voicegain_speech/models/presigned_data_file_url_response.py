...
class PresignedDataFileUrlResponse(object):
    ...
    def __init__(self, account_id=None, context_id=None, expire_epoch=None, url=None, uuid=None, local_vars_configuration=None):  # noqa: E501
        """PresignedDataFileUrlResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this PresignedDataFileUrlResponse.  # noqa: E501

        UUID of the account that owns the data object.   # noqa: E501

        :return: The account_id of this PresignedDataFileUrlResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this PresignedDataFileUrlResponse.

        UUID of the account that owns the data object.   # noqa: E501

        :param account_id: The account_id of this PresignedDataFileUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this PresignedDataFileUrlResponse.  # noqa: E501

        If this data object  is associated with a Context then this will be the UUID of the Context.   # noqa: E501

        :return: The context_id of this PresignedDataFileUrlResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this PresignedDataFileUrlResponse.

        If this data object  is associated with a Context then this will be the UUID of the Context.   # noqa: E501

        :param context_id: The context_id of this PresignedDataFileUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    def expire_epoch(self):
        """Gets the expire_epoch of this PresignedDataFileUrlResponse.  # noqa: E501

        Epoch time (to msec accurate) when the presigned URL expires.   # noqa: E501

        :return: The expire_epoch of this PresignedDataFileUrlResponse.  # noqa: E501
        :rtype: int
        """
        return self._expire_epoch

    @expire_epoch.setter
    def expire_epoch(self, expire_epoch):
        """Sets the expire_epoch of this PresignedDataFileUrlResponse.

        Epoch time (to msec accurate) when the presigned URL expires.   # noqa: E501

        :param expire_epoch: The expire_epoch of this PresignedDataFileUrlResponse.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and expire_epoch is None:  # noqa: E501
            raise ValueError("Invalid value for `expire_epoch`, must not be `None`")  # noqa: E501

        self._expire_epoch = expire_epoch

    @property
    def url(self):
        """Gets the url of this PresignedDataFileUrlResponse.  # noqa: E501

        Presigned URL for data file upload.   # noqa: E501

        :return: The url of this PresignedDataFileUrlResponse.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this PresignedDataFileUrlResponse.

        Presigned URL for data file upload.   # noqa: E501

        :param url: The url of this PresignedDataFileUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uuid(self):
        """Gets the uuid of this PresignedDataFileUrlResponse.  # noqa: E501

        UUID of the data object that stores the data file.   # noqa: E501

        :return: The uuid of this PresignedDataFileUrlResponse.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this PresignedDataFileUrlResponse.

        UUID of the data object that stores the data file.   # noqa: E501

        :param uuid: The uuid of this PresignedDataFileUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PresignedDataFileUrlResponse):
            return False
