...
class WordsSectionMeta(object):
    ...
    @property
    def duration(self):
        """Gets the duration of this WordsSectionMeta.  # noqa: E501

        duration of the words section (in msec)  # noqa: E501

        :return: The duration of this WordsSectionMeta.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this WordsSectionMeta.

        duration of the words section (in msec)  # noqa: E501

        :param duration: The duration of this WordsSectionMeta.  # noqa: E501
        :type: float
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this WordsSectionMeta.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501
        ...
        :return: The spk of this WordsSectionMeta.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WordsSectionMeta.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501

        :param spk: The spk of this WordsSectionMeta.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start(self):
        """Gets the start of this WordsSectionMeta.  # noqa: E501

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :return: The start of this WordsSectionMeta.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordsSectionMeta.

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :param start: The start of this WordsSectionMeta.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordsSectionMeta):
            return False
