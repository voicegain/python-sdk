...
class MeetingWordsSectionWithAnnot(object):
    ...
    openapi_types = {
        ...
        'column_pos': 'int',
        'num_columns': 'int',
        'words': 'list[MeetingWordItemTimedWithAnnot]'
    }
    ...
    def __init__(self, duration=None, spk=None, start=None, column_pos=1, num_columns=1, words=None, local_vars_configuration=None):  # noqa: E501
        """MeetingWordsSectionWithAnnot - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def duration(self):
        """Gets the duration of this MeetingWordsSectionWithAnnot.  # noqa: E501

        duration of the words section (in msec)  # noqa: E501

        :return: The duration of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this MeetingWordsSectionWithAnnot.

        duration of the words section (in msec)  # noqa: E501

        :param duration: The duration of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :type: float
        """
    ...
    @property
    def start(self):
        """Gets the start of this MeetingWordsSectionWithAnnot.  # noqa: E501

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :return: The start of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this MeetingWordsSectionWithAnnot.

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :param start: The start of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def column_pos(self):
        """Gets the column_pos of this MeetingWordsSectionWithAnnot.  # noqa: E501
        ...
        :return: The column_pos of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :rtype: int
        """
    ...
    def column_pos(self, column_pos):
        """Sets the column_pos of this MeetingWordsSectionWithAnnot.

        Only relevant if `numColumns` is greater than 1.</br> Indicates into which overlapping column the text of this section should be placed when displayed.</br> Columns are numbered starting from 1.   # noqa: E501

        :param column_pos: The column_pos of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def num_columns(self):
        """Gets the num_columns of this MeetingWordsSectionWithAnnot.  # noqa: E501
        ...
        :return: The num_columns of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :rtype: int
        """
    ...
    def num_columns(self, num_columns):
        """Sets the num_columns of this MeetingWordsSectionWithAnnot.

        Number of columns of overlapping text.  This will be greater than 1 only if this section of text overlaps in time with other section(s) of text.   # noqa: E501

        :param num_columns: The num_columns of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def words(self):
        """Gets the words of this MeetingWordsSectionWithAnnot.  # noqa: E501

        Detailed data for all the words in this section/paragraph  # noqa: E501

        :return: The words of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :rtype: list[MeetingWordItemTimedWithAnnot]
        """
        return self._words

    @words.setter
    def words(self, words):
        """Sets the words of this MeetingWordsSectionWithAnnot.

        Detailed data for all the words in this section/paragraph  # noqa: E501

        :param words: The words of this MeetingWordsSectionWithAnnot.  # noqa: E501
        :type: list[MeetingWordItemTimedWithAnnot]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingWordsSectionWithAnnot):
            return False
