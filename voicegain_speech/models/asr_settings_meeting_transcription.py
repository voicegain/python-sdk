...
class AsrSettingsMeetingTranscription(object):
    ...
    def __init__(self, acoustic_model=None, language_detection=None, languages=None, sensitivity=0.5, speed_vs_accuracy=0.5, local_vars_configuration=None):  # noqa: E501
