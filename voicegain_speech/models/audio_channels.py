...
class AudioChannels(object):
    ...
    allowable_values = [MONO, STEREO]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudioChannels - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioChannels):
            return False
