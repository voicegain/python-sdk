...
class WordsSectionSingleColumn(object):
    ...
    def __init__(self, duration=None, spk=None, start=None, words=None, local_vars_configuration=None):  # noqa: E501
        """WordsSectionSingleColumn - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def duration(self):
        """Gets the duration of this WordsSectionSingleColumn.  # noqa: E501

        duration of the words section (in msec)  # noqa: E501

        :return: The duration of this WordsSectionSingleColumn.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this WordsSectionSingleColumn.

        duration of the words section (in msec)  # noqa: E501

        :param duration: The duration of this WordsSectionSingleColumn.  # noqa: E501
        :type: float
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this WordsSectionSingleColumn.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501
        ...
        :return: The spk of this WordsSectionSingleColumn.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WordsSectionSingleColumn.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501

        :param spk: The spk of this WordsSectionSingleColumn.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start(self):
        """Gets the start of this WordsSectionSingleColumn.  # noqa: E501

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :return: The start of this WordsSectionSingleColumn.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordsSectionSingleColumn.

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :param start: The start of this WordsSectionSingleColumn.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def words(self):
        """Gets the words of this WordsSectionSingleColumn.  # noqa: E501

        Detailed data for all the words in this section/paragraph  # noqa: E501

        :return: The words of this WordsSectionSingleColumn.  # noqa: E501
    ...
    def words(self, words):
        """Sets the words of this WordsSectionSingleColumn.

        Detailed data for all the words in this section/paragraph  # noqa: E501

        :param words: The words of this WordsSectionSingleColumn.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordsSectionSingleColumn):
            return False
