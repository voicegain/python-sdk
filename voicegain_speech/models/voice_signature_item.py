...
class VoiceSignatureItem(object):
    ...
    openapi_types = {
        ...
        'end_msec': 'int',
        'label': 'str',
        'prepared_text_id': 'int',
        'signature': 'str',
        'signature_item_id': 'str',
        'signature_version': 'str',
        'start_msec': 'int',
        'status': 'VoiceSignatureStatus',
        'status_msg': 'str',
        'tags': 'list[str]'
    }
    ...
    attribute_map = {
        ...
        'end_msec': 'endMsec',
        'label': 'label',
        'prepared_text_id': 'preparedTextId',
        'signature': 'signature',
        'signature_item_id': 'signatureItemId',
        'signature_version': 'signatureVersion',
        'start_msec': 'startMsec',
        'status': 'status',
        'status_msg': 'statusMsg',
        'tags': 'tags'
    }

    def __init__(self, audio_clip=None, audio_duration_seconds=None, date_created=None, date_modified=None, end_msec=None, label=None, prepared_text_id=None, signature=None, signature_item_id=None, signature_version=None, start_msec=None, status=None, status_msg=None, tags=None, local_vars_configuration=None):  # noqa: E501
        """VoiceSignatureItem - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._end_msec = None
        self._label = None
        self._prepared_text_id = None
        self._signature = None
        self._signature_item_id = None
        self._signature_version = None
        self._start_msec = None
        self._status = None
        ...
        if label is not None:
            self.label = label
        if prepared_text_id is not None:
            self.prepared_text_id = prepared_text_id
        if signature is not None:
            self.signature = signature
        if signature_item_id is not None:
            self.signature_item_id = signature_item_id
    ...
    @property
    def audio_clip(self):
        """Gets the audio_clip of this VoiceSignatureItem.  # noqa: E501

        Reference to the audio clip (either original or extracted one) that is used to compute the signature  # noqa: E501

        :return: The audio_clip of this VoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_clip(self, audio_clip):
        """Sets the audio_clip of this VoiceSignatureItem.

        Reference to the audio clip (either original or extracted one) that is used to compute the signature  # noqa: E501

        :param audio_clip: The audio_clip of this VoiceSignatureItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                audio_clip is not None and len(audio_clip) > 48):
            raise ValueError("Invalid value for `audio_clip`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                audio_clip is not None and len(audio_clip) < 16):
            raise ValueError("Invalid value for `audio_clip`, length must be greater than or equal to `16`")  # noqa: E501

        self._audio_clip = audio_clip

    @property
    def audio_duration_seconds(self):
        """Gets the audio_duration_seconds of this VoiceSignatureItem.  # noqa: E501

        Duration of the audio clip in seconds  # noqa: E501

        :return: The audio_duration_seconds of this VoiceSignatureItem.  # noqa: E501
        :rtype: float
        """
    ...
    def audio_duration_seconds(self, audio_duration_seconds):
        """Sets the audio_duration_seconds of this VoiceSignatureItem.

        Duration of the audio clip in seconds  # noqa: E501

        :param audio_duration_seconds: The audio_duration_seconds of this VoiceSignatureItem.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                audio_duration_seconds is not None and audio_duration_seconds < 0):  # noqa: E501
            raise ValueError("Invalid value for `audio_duration_seconds`, must be a value greater than or equal to `0`")  # noqa: E501

        self._audio_duration_seconds = audio_duration_seconds

    @property
    def date_created(self):
        """Gets the date_created of this VoiceSignatureItem.  # noqa: E501

        Date/Time when the signature was created  # noqa: E501

        :return: The date_created of this VoiceSignatureItem.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_created(self, date_created):
        """Sets the date_created of this VoiceSignatureItem.

        Date/Time when the signature was created  # noqa: E501

        :param date_created: The date_created of this VoiceSignatureItem.  # noqa: E501
        :type: datetime
        """
    ...
    def date_modified(self):
        """Gets the date_modified of this VoiceSignatureItem.  # noqa: E501

        Date/Time when the signature was last modified.  # noqa: E501

        :return: The date_modified of this VoiceSignatureItem.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified):
        """Sets the date_modified of this VoiceSignatureItem.

        Date/Time when the signature was last modified.  # noqa: E501

        :param date_modified: The date_modified of this VoiceSignatureItem.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end_msec(self):
        """Gets the end_msec of this VoiceSignatureItem.  # noqa: E501

        Used to specify a selection from the audio clip to be used for the signature. Specifies end of the selection. When a selected clip is submitted this value is removed.   # noqa: E501

        :return: The end_msec of this VoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
        return self._end_msec

    @end_msec.setter
    def end_msec(self, end_msec):
        """Sets the end_msec of this VoiceSignatureItem.

        Used to specify a selection from the audio clip to be used for the signature. Specifies end of the selection. When a selected clip is submitted this value is removed.   # noqa: E501

        :param end_msec: The end_msec of this VoiceSignatureItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                end_msec is not None and end_msec < 0):  # noqa: E501
            raise ValueError("Invalid value for `end_msec`, must be a value greater than or equal to `0`")  # noqa: E501

        self._end_msec = end_msec

    @property
    def label(self):
        """Gets the label of this VoiceSignatureItem.  # noqa: E501

        Signature label   # noqa: E501

        :return: The label of this VoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this VoiceSignatureItem.

        Signature label   # noqa: E501

        :param label: The label of this VoiceSignatureItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prepared_text_id(self):
        """Gets the prepared_text_id of this VoiceSignatureItem.  # noqa: E501

        Will be set only if the audio clip is a recording of the specific prepared text that the speaker read.   # noqa: E501

        :return: The prepared_text_id of this VoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
        return self._prepared_text_id

    @prepared_text_id.setter
    def prepared_text_id(self, prepared_text_id):
        """Sets the prepared_text_id of this VoiceSignatureItem.

        Will be set only if the audio clip is a recording of the specific prepared text that the speaker read.   # noqa: E501

        :param prepared_text_id: The prepared_text_id of this VoiceSignatureItem.  # noqa: E501
        :type: int
        """

        self._prepared_text_id = prepared_text_id
    ...
    @property
    def signature_item_id(self):
        """Gets the signature_item_id of this VoiceSignatureItem.  # noqa: E501

        Unique identifier used when manipulating this Voice Signature Item  # noqa: E501

        :return: The signature_item_id of this VoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
        return self._signature_item_id

    @signature_item_id.setter
    def signature_item_id(self, signature_item_id):
        """Sets the signature_item_id of this VoiceSignatureItem.

        Unique identifier used when manipulating this Voice Signature Item  # noqa: E501

        :param signature_item_id: The signature_item_id of this VoiceSignatureItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                signature_item_id is not None and len(signature_item_id) > 48):
            raise ValueError("Invalid value for `signature_item_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                signature_item_id is not None and len(signature_item_id) < 16):
            raise ValueError("Invalid value for `signature_item_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._signature_item_id = signature_item_id

    @property
    def signature_version(self):
        """Gets the signature_version of this VoiceSignatureItem.  # noqa: E501

        Version of the computed signature. May be used to recompute older signature versions.   # noqa: E501

        :return: The signature_version of this VoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
    ...
    def signature_version(self, signature_version):
        """Sets the signature_version of this VoiceSignatureItem.

        Version of the computed signature. May be used to recompute older signature versions.   # noqa: E501

        :param signature_version: The signature_version of this VoiceSignatureItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_msec(self):
        """Gets the start_msec of this VoiceSignatureItem.  # noqa: E501

        Used to specify a selection from the audio clip to be used for the signature. Specifies start of the selection. When a selected clip is submitted this value is removed.   # noqa: E501

        :return: The start_msec of this VoiceSignatureItem.  # noqa: E501
        :rtype: int
        """
        return self._start_msec

    @start_msec.setter
    def start_msec(self, start_msec):
        """Sets the start_msec of this VoiceSignatureItem.

        Used to specify a selection from the audio clip to be used for the signature. Specifies start of the selection. When a selected clip is submitted this value is removed.   # noqa: E501

        :param start_msec: The start_msec of this VoiceSignatureItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                start_msec is not None and start_msec < 0):  # noqa: E501
            raise ValueError("Invalid value for `start_msec`, must be a value greater than or equal to `0`")  # noqa: E501

        self._start_msec = start_msec

    @property
    def status(self):
        """Gets the status of this VoiceSignatureItem.  # noqa: E501


        :return: The status of this VoiceSignatureItem.  # noqa: E501
        :rtype: VoiceSignatureStatus
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this VoiceSignatureItem.


        :param status: The status of this VoiceSignatureItem.  # noqa: E501
        :type: VoiceSignatureStatus
        """
    ...
    @property
    def status_msg(self):
        """Gets the status_msg of this VoiceSignatureItem.  # noqa: E501

        additional information regarding the status  # noqa: E501

        :return: The status_msg of this VoiceSignatureItem.  # noqa: E501
        :rtype: str
        """
    ...
    def status_msg(self, status_msg):
        """Sets the status_msg of this VoiceSignatureItem.

        additional information regarding the status  # noqa: E501

        :param status_msg: The status_msg of this VoiceSignatureItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this VoiceSignatureItem.  # noqa: E501

        List of short strings (tags) that help to distinguish voice signatures.  Either manually or automatically entered.   # noqa: E501

        :return: The tags of this VoiceSignatureItem.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this VoiceSignatureItem.

        List of short strings (tags) that help to distinguish voice signatures.  Either manually or automatically entered.   # noqa: E501

        :param tags: The tags of this VoiceSignatureItem.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceSignatureItem):
            return False
