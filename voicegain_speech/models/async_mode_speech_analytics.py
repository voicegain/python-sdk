...
class AsyncModeSpeechAnalytics(object):
    ...
    allowable_values = [REAL_TIME, OFF_LINE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsyncModeSpeechAnalytics - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncModeSpeechAnalytics):
            return False
