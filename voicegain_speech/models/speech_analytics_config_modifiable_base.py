...
class SpeechAnalyticsConfigModifiableBase(object):
    ...
    @property
    def age(self):
        """Gets the age of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        _(future functionality)_ Set to true to enable speaker age estimation  # noqa: E501

        :return: The age of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
        return self._age
    ...
    @age.setter
    def age(self, age):
        """Sets the age of this SpeechAnalyticsConfigModifiableBase.

        _(future functionality)_ Set to true to enable speaker age estimation  # noqa: E501

        :param age: The age of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    def call_resolution_criteria(self):
        """Gets the call_resolution_criteria of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501
        ...
        :return: The call_resolution_criteria of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def call_resolution_criteria(self, call_resolution_criteria):
        """Sets the call_resolution_criteria of this SpeechAnalyticsConfigModifiableBase.

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :param call_resolution_criteria: The call_resolution_criteria of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def call_resolution_question_id(self):
        """Gets the call_resolution_question_id of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :return: The call_resolution_question_id of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def call_resolution_question_id(self, call_resolution_question_id):
        """Sets the call_resolution_question_id of this SpeechAnalyticsConfigModifiableBase.

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :param call_resolution_question_id: The call_resolution_question_id of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def competitor_keyword_groups(self):
        """Gets the competitor_keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The competitor_keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def competitor_keyword_groups(self, competitor_keyword_groups):
        """Sets the competitor_keyword_groups of this SpeechAnalyticsConfigModifiableBase.

        _(internal use - for Speech Analytics UI)_ Set of one or more keyword group tags that should be interpreted as identifying competitor mentions.    # noqa: E501

        :param competitor_keyword_groups: The competitor_keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def criteria(self):
        ...
        :return: The criteria of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def criteria(self, criteria):
        """Sets the criteria of this SpeechAnalyticsConfigModifiableBase.

        Criteria to be detected</br> Each Criterion cofiguration contains a list of SubCriteria that need to be satisfied.  **All** SubCriteria within the list must be satisfied for the list to return true.</br> Empty SubCriteria list is considered true (satisfies all SubCriteria).</br> Within each SubCriteria all __specified__ properties must return true for the SubCriteria to be true (AND). Except for `dialogElements` all properties are assumed to must match within the same sentence.   # noqa: E501

        :param criteria: The criteria of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def csat_question(self):
        """Gets the csat_question of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def csat_question(self, csat_question):
        """Sets the csat_question of this SpeechAnalyticsConfigModifiableBase.
    ...
    @property
    def entities(self):
        """Gets the entities of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The entities of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def entities(self, entities):
        """Sets the entities of this SpeechAnalyticsConfigModifiableBase.

        Selection of Named Entity types to detect. </br> Entities are different from keywords in that an entity may have a large number of possible values  which do not have to be enumerated in order to be detected. </br> Types of Named Entities: + ADDRESS - Postal address. + CARDINAL - Numerals that do not fall under another type. + CC - Credit Card + CVV - Credit Card CVV + DATE - Absolute or relative dates or periods. + DMY - Full date including all of day, month and year.           + EMAIL - Email address + EVENT - Named hurricanes, battles, wars, sports events, etc. + FAC - Buildings, airports, highways, bridges, etc. + GPE - Countries, cities, states. + LANGUAGE - Any named language. + LAW - Named documents made into laws. + NORP - Nationalities or religious or political groups. + MONEY - Monetary values, including unit. + ORDINAL - \"first\", \"second\", etc. + ORG - Companies, agencies, institutions, etc. + PERCENT - Percentage, including \"%\". + PERSON - People, including fictional. + PHONE - Phone number. + PRODUCT - Objects, vehicles, foods, etc. (Not services.) + QUANTITY - Measurements, as of weight or distance. + SSN - Social Security number + TIME - Times smaller than a day. + WORK_OF_ART - Titles of books, songs, etc. + ZIP - Zip Code (if not part of an Address)  Default is no NERs selected.    # noqa: E501

        :param entities: The entities of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    @property
    def gender(self):
        """Gets the gender of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        _(not available for real-time mode yet)_ Set to true to enable voice gender classifcation  # noqa: E501

        :return: The gender of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
        return self._gender
    ...
    def gender(self, gender):
        """Sets the gender of this SpeechAnalyticsConfigModifiableBase.

        _(not available for real-time mode yet)_ Set to true to enable voice gender classifcation  # noqa: E501

        :param gender: The gender of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    def kb_recommendation(self):
        """Gets the kb_recommendation of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501


        :return: The kb_recommendation of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def kb_recommendation(self, kb_recommendation):
        """Sets the kb_recommendation of this SpeechAnalyticsConfigModifiableBase.


        :param kb_recommendation: The kb_recommendation of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def keyword_groups(self):
        """Gets the keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def keyword_groups(self, keyword_groups):
        """Sets the keyword_groups of this SpeechAnalyticsConfigModifiableBase.

        Keyword groups - Group tags must be different from the tags used for keywords. One use for keyword groups is that the GET /sa/call-stats API supports reporting stats of keywords within a Group.</br> Default - there are no keyword groups.   # noqa: E501

        :param keyword_groups: The keyword_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    @property
    def keywords(self):
        """Gets the keywords of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The keywords of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def keywords(self, keywords):
        """Sets the keywords of this SpeechAnalyticsConfigModifiableBase.

        Configuration that specifies keywords to be detected. The keyword detection algorithm uses text matching with simple text manipulations like e.g. stemming.</br> Keywords are different in that respect from phrases - phrase detection uses NLU algorithm with neural networks which allows for matching based on approximate meaning.</br> Default is not keyword detection.   # noqa: E501

        :param keywords: The keywords of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def meeting_minutes(self):
        """Gets the meeting_minutes of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def meeting_minutes(self, meeting_minutes):
        """Sets the meeting_minutes of this SpeechAnalyticsConfigModifiableBase.
    ...
    @property
    def moods(self):
        """Gets the moods of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        **Deprecated** — mood detection is no longer maintained. Use `sentiment` (and `sentimentFinal` / `sentimentTrend` / `smoothSentiment`) or [Call Insights](#tag/call-insights) instead.</br> Choose the moods to report.</br> Default no moods are reported.   # noqa: E501
        ...
        :return: The moods of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: list[MoodType]
        """
        return self._moods
    ...
    def moods(self, moods):
        """Sets the moods of this SpeechAnalyticsConfigModifiableBase.

        **Deprecated** — mood detection is no longer maintained. Use `sentiment` (and `sentimentFinal` / `sentimentTrend` / `smoothSentiment`) or [Call Insights](#tag/call-insights) instead.</br> Choose the moods to report.</br> Default no moods are reported.   # noqa: E501

        :param moods: The moods of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: list[MoodType]
        """
    ...
    def nps_question(self):
        """Gets the nps_question of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def nps_question(self, nps_question):
        """Sets the nps_question of this SpeechAnalyticsConfigModifiableBase.
    ...
    def phrase_groups(self):
        """Gets the phrase_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The phrase_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def phrase_groups(self, phrase_groups):
        """Sets the phrase_groups of this SpeechAnalyticsConfigModifiableBase.

        Group of phrases/intents. Can be used to detect combinations of phrases in the caller.</br> By default there are no phrase groups.   # noqa: E501

        :param phrase_groups: The phrase_groups of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    @property
    def phrases(self):
        """Gets the phrases of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The phrases of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def phrases(self, phrases):
        """Sets the phrases of this SpeechAnalyticsConfigModifiableBase.

        Phrases/Intents detected in the text. Phrase detection uses NLU algorithm with neural networks which allows for matching based on approximate meaning. Phrase matching is applied to one sentence at a time. To match multiple sentences in a row please use phraseGroups.</br> If you want to match individual words or 2- or 3-word phrases it may be better to use keywords.</br> Default is no phrase detection.   # noqa: E501

        :param phrases: The phrases of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    @property
    def profanity(self):
        """Gets the profanity of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        Set to true to enable detection of profanity. Will be output together with spotted keywords  # noqa: E501

        :return: The profanity of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def profanity(self, profanity):
        """Sets the profanity of this SpeechAnalyticsConfigModifiableBase.

        Set to true to enable detection of profanity. Will be output together with spotted keywords  # noqa: E501

        :param profanity: The profanity of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def published(self):
        """Gets the published of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The published of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def published(self, published):
        """Sets the published of this SpeechAnalyticsConfigModifiableBase.

        Specifies if Speech Analytics configuration can be used outside its context.</br> For built-in configurations, specifies if the configuration is visible to end-users of Voicegain. Only user with \"cmp\" role is able to see built-in configurations that are not published.   # noqa: E501

        :param published: The published of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sentiment(self):
        """Gets the sentiment of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        Set to true to enable sentiment analytics  # noqa: E501

        :return: The sentiment of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def sentiment(self, sentiment):
        """Sets the sentiment of this SpeechAnalyticsConfigModifiableBase.

        Set to true to enable sentiment analytics  # noqa: E501

        :param sentiment: The sentiment of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def summary(self):
        """Gets the summary of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        ...
        :return: The summary of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def summary(self, summary):
        """Sets the summary of this SpeechAnalyticsConfigModifiableBase.

        _(not available for real-time mode yet)_ Set to true to enable output of summary of the transcript (summary is always accross all channels)  # noqa: E501

        :param summary: The summary of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def topics(self):
        """Gets the topics of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
    ...
    def topics(self, topics):
        """Sets the topics of this SpeechAnalyticsConfigModifiableBase.
    ...
    @property
    def word_cloud(self):
        """Gets the word_cloud of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501

        _(not for real-time mode)_ Set to true to enable output of word cloud data  # noqa: E501

        :return: The word_cloud of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this SpeechAnalyticsConfigModifiableBase.

        _(not for real-time mode)_ Set to true to enable output of word cloud data  # noqa: E501

        :param word_cloud: The word_cloud of this SpeechAnalyticsConfigModifiableBase.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsConfigModifiableBase):
            return False
