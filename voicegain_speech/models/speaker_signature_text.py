...
class SpeakerSignatureText(object):
    ...
    def __init__(self, id=None, label=None, text=None, local_vars_configuration=None):  # noqa: E501
        """SpeakerSignatureText - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this SpeakerSignatureText.  # noqa: E501

        unique id used identify and order the signature text  # noqa: E501

        :return: The id of this SpeakerSignatureText.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SpeakerSignatureText.

        unique id used identify and order the signature text  # noqa: E501

        :param id: The id of this SpeakerSignatureText.  # noqa: E501
        :type: int
        """
    ...
    @property
    def label(self):
        """Gets the label of this SpeakerSignatureText.  # noqa: E501

        Signature text label  # noqa: E501

        :return: The label of this SpeakerSignatureText.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this SpeakerSignatureText.

        Signature text label  # noqa: E501

        :param label: The label of this SpeakerSignatureText.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this SpeakerSignatureText.  # noqa: E501

        The text that user can speak to create a signature. Usually about 50 to 70 words.   # noqa: E501

        :return: The text of this SpeakerSignatureText.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this SpeakerSignatureText.

        The text that user can speak to create a signature. Usually about 50 to 70 words.   # noqa: E501

        :param text: The text of this SpeakerSignatureText.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                text is not None and len(text) < 64):
            raise ValueError("Invalid value for `text`, length must be greater than or equal to `64`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeakerSignatureText):
            return False
