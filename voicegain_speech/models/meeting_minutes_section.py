...
class MeetingMinutesSection(object):
    ...
    openapi_types = {
        'end_time': 'int',
        'key_sentences': 'list[TimedSentence]',
        'sentences_by_type': 'list[TypedSentenceWithRejection]',
        'speakers': 'list[SpeakerWithPercentSpoken]',
        'start_time': 'int',
        'summary': 'str',
    ...
    attribute_map = {
        ...
        'sentences_by_type': 'sentencesByType',
        'speakers': 'speakers',
    ...
    def __init__(self, end_time=None, key_sentences=None, sentences_by_type=None, speakers=None, start_time=None, summary=None, topics=None, what_happened=None, local_vars_configuration=None):  # noqa: E501
        """MeetingMinutesSection - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._end_time = None
        self._key_sentences = None
        self._sentences_by_type = None
        self._speakers = None
        self._start_time = None
        self._summary = None
        self._topics = None
        self._what_happened = None
        self.discriminator = None

        if end_time is not None:
            self.end_time = end_time
        if key_sentences is not None:
            self.key_sentences = key_sentences
        if sentences_by_type is not None:
            self.sentences_by_type = sentences_by_type
    ...
    @property
    def end_time(self):
        """Gets the end_time of this MeetingMinutesSection.  # noqa: E501

        end time in msec of this section of the meeting  # noqa: E501

        :return: The end_time of this MeetingMinutesSection.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this MeetingMinutesSection.

        end time in msec of this section of the meeting  # noqa: E501

        :param end_time: The end_time of this MeetingMinutesSection.  # noqa: E501
        :type: int
        """
    ...
    def key_sentences(self):
        """Gets the key_sentences of this MeetingMinutesSection.  # noqa: E501

        key sentences that we want to highlight from this section  # noqa: E501

        :return: The key_sentences of this MeetingMinutesSection.  # noqa: E501
        :rtype: list[TimedSentence]
        """
        return self._key_sentences

    @key_sentences.setter
    def key_sentences(self, key_sentences):
        """Sets the key_sentences of this MeetingMinutesSection.

        key sentences that we want to highlight from this section  # noqa: E501

        :param key_sentences: The key_sentences of this MeetingMinutesSection.  # noqa: E501
        :type: list[TimedSentence]
        """
    ...
    def sentences_by_type(self):
        """Gets the sentences_by_type of this MeetingMinutesSection.  # noqa: E501

        sentences from this section conveying thoughts in the predefiled categories - \"risk\", \"action\", \"issue\", \"decision\", \"requirement\"  or in custom categories   # noqa: E501

        :return: The sentences_by_type of this MeetingMinutesSection.  # noqa: E501
        :rtype: list[TypedSentenceWithRejection]
        """
        return self._sentences_by_type

    @sentences_by_type.setter
    def sentences_by_type(self, sentences_by_type):
        """Sets the sentences_by_type of this MeetingMinutesSection.

        sentences from this section conveying thoughts in the predefiled categories - \"risk\", \"action\", \"issue\", \"decision\", \"requirement\"  or in custom categories   # noqa: E501

        :param sentences_by_type: The sentences_by_type of this MeetingMinutesSection.  # noqa: E501
        :type: list[TypedSentenceWithRejection]
        """

        self._sentences_by_type = sentences_by_type

    @property
    def speakers(self):
        """Gets the speakers of this MeetingMinutesSection.  # noqa: E501

        speakers who participated in this section  # noqa: E501

        :return: The speakers of this MeetingMinutesSection.  # noqa: E501
        :rtype: list[SpeakerWithPercentSpoken]
        """
        return self._speakers

    @speakers.setter
    def speakers(self, speakers):
        """Sets the speakers of this MeetingMinutesSection.

        speakers who participated in this section  # noqa: E501

        :param speakers: The speakers of this MeetingMinutesSection.  # noqa: E501
        :type: list[SpeakerWithPercentSpoken]
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this MeetingMinutesSection.  # noqa: E501

        start time in msec of this section of the meeting  # noqa: E501

        :return: The start_time of this MeetingMinutesSection.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this MeetingMinutesSection.

        start time in msec of this section of the meeting  # noqa: E501

        :param start_time: The start_time of this MeetingMinutesSection.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def summary(self):
        """Gets the summary of this MeetingMinutesSection.  # noqa: E501

        Summary of a section. Longer than `whatHappened`   # noqa: E501

        :return: The summary of this MeetingMinutesSection.  # noqa: E501
        :rtype: str
        """
    ...
    def summary(self, summary):
        """Sets the summary of this MeetingMinutesSection.

        Summary of a section. Longer than `whatHappened`   # noqa: E501

        :param summary: The summary of this MeetingMinutesSection.  # noqa: E501
        :type: str
        """
    ...
    @property
    def topics(self):
        """Gets the topics of this MeetingMinutesSection.  # noqa: E501

        List of Topic Scores - a single call/transcript may have 1 or more identified in it  # noqa: E501

        :return: The topics of this MeetingMinutesSection.  # noqa: E501
    ...
    def topics(self, topics):
        """Sets the topics of this MeetingMinutesSection.

        List of Topic Scores - a single call/transcript may have 1 or more identified in it  # noqa: E501

        :param topics: The topics of this MeetingMinutesSection.  # noqa: E501
    ...
    def what_happened(self):
        """Gets the what_happened of this MeetingMinutesSection.  # noqa: E501

        Short sentence describing what happened in this section, e.g., \"Joe Walker talked to Don Winter about speaker and icon.\" May have speaker placeholders, e.g., \"${spk102} talked to ${spk103} about speaker and icon.\"   # noqa: E501

        :return: The what_happened of this MeetingMinutesSection.  # noqa: E501
        :rtype: str
        """
        return self._what_happened

    @what_happened.setter
    def what_happened(self, what_happened):
        """Sets the what_happened of this MeetingMinutesSection.

        Short sentence describing what happened in this section, e.g., \"Joe Walker talked to Don Winter about speaker and icon.\" May have speaker placeholders, e.g., \"${spk102} talked to ${spk103} about speaker and icon.\"   # noqa: E501

        :param what_happened: The what_happened of this MeetingMinutesSection.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingMinutesSection):
            return False
