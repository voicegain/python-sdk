...
class DataObjectNoSosRef(object):
    ...
    def __init__(self, account_id=None, context_id=None, date_created=None, date_modified=None, object_id=None, content_type=None, description=None, encryption=None, long_persist=False, name=None, tags=None, transcoded=False, local_vars_configuration=None):  # noqa: E501
