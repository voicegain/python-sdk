...
class DataObjectNoSosRef(object):
    ...
    def __init__(self, account_id=None, context_id=None, date_created=None, date_modified=None, object_id=None, content_type=None, description=None, encryption=None, long_persist=False, name=None, tags=None, transcoded=False, user=None, user_group=None, local_vars_configuration=None):  # noqa: E501
        """DataObjectNoSosRef - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this DataObjectNoSosRef.  # noqa: E501

        Account Id  # noqa: E501

        :return: The account_id of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this DataObjectNoSosRef.

        Account Id  # noqa: E501

        :param account_id: The account_id of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    def date_created(self):
        """Gets the date_created of this DataObjectNoSosRef.  # noqa: E501

        Date/Time when the object was created  # noqa: E501

        :return: The date_created of this DataObjectNoSosRef.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_created(self, date_created):
        """Sets the date_created of this DataObjectNoSosRef.

        Date/Time when the object was created  # noqa: E501

        :param date_created: The date_created of this DataObjectNoSosRef.  # noqa: E501
        :type: datetime
        """
    ...
    def date_modified(self):
        """Gets the date_modified of this DataObjectNoSosRef.  # noqa: E501

        Date/Time when the object was last modified.  # noqa: E501

        :return: The date_modified of this DataObjectNoSosRef.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified):
        """Sets the date_modified of this DataObjectNoSosRef.

        Date/Time when the object was last modified.  # noqa: E501

        :param date_modified: The date_modified of this DataObjectNoSosRef.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def object_id(self):
        """Gets the object_id of this DataObjectNoSosRef.  # noqa: E501

        System-generated unique ID of the Data Object  # noqa: E501

        :return: The object_id of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
    ...
    def object_id(self, object_id):
        """Sets the object_id of this DataObjectNoSosRef.

        System-generated unique ID of the Data Object  # noqa: E501

        :param object_id: The object_id of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    def content_type(self):
        """Gets the content_type of this DataObjectNoSosRef.  # noqa: E501
        ...
        :return: The content_type of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this DataObjectNoSosRef.

        Type of the data stored with this Data Object (e.g. audio/wav).  This value will be set in the response Content-Type header when retrieving the data raw.   # noqa: E501

        :param content_type: The content_type of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this DataObjectNoSosRef.  # noqa: E501

        User provided description of the data object (optional).  # noqa: E501

        :return: The description of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DataObjectNoSosRef.

        User provided description of the data object (optional).  # noqa: E501

        :param description: The description of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def encryption(self):
        """Gets the encryption of this DataObjectNoSosRef.  # noqa: E501
        ...
        :return: The encryption of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this DataObjectNoSosRef.

        Controls encryption of the data in storage. Applies mainly to Edge deployments (default encryption setting is specified in the Edge cluster configuration).  + none - do not use encryption in storage + standard - encrypt in storage + enhanced - use JWT as part of the encryption key - this basically allows the client to control encryption of individual Data objects (client can create a unique JWT for accessing each Data object)  For Cloud `standard` is the default - `none` will be treated as `standard` and attempt to use `enhanced` will result in error.   # noqa: E501

        :param encryption: The encryption of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    def long_persist(self):
        """Gets the long_persist of this DataObjectNoSosRef.  # noqa: E501
        ...
        :return: The long_persist of this DataObjectNoSosRef.  # noqa: E501
        :rtype: bool
        """
    ...
    def long_persist(self, long_persist):
        """Sets the long_persist of this DataObjectNoSosRef.

        Default value `false` means that the DataObject will be garbage collected if there are no more references to it and the DataObject is older than `context.ageThresholdForDataObjectCleanup`. If you set value to `true` then the DataObject will **not** be garbage collected. Note, that you may be responsible for storage fees.    # noqa: E501

        :param long_persist: The long_persist of this DataObjectNoSosRef.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this DataObjectNoSosRef.  # noqa: E501
        ...
        :return: The name of this DataObjectNoSosRef.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataObjectNoSosRef.

        Human friendly identifier (does not have to be unique).</br> It is optional, but an object that does not have a name may be difficult to query.</br> Characters **not allowed** in a name are: star `*`, question mark `?`, colon `:`, pipe `|`, slash `/`, backslash `\\`, quote `\"`, any control characters including `NUL`</br> Name may not start with: any whitespace, period `.`, tilde `~`. </br> Name may not end with: any whitespace.</br>   # noqa: E501

        :param name: The name of this DataObjectNoSosRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this DataObjectNoSosRef.  # noqa: E501

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :return: The tags of this DataObjectNoSosRef.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DataObjectNoSosRef.

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :param tags: The tags of this DataObjectNoSosRef.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def transcoded(self):
        """Gets the transcoded of this DataObjectNoSosRef.  # noqa: E501

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :return: The transcoded of this DataObjectNoSosRef.  # noqa: E501
        :rtype: bool
        """
    ...
    def transcoded(self, transcoded):
        """Sets the transcoded of this DataObjectNoSosRef.

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :param transcoded: The transcoded of this DataObjectNoSosRef.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def user(self):
        """Gets the user of this DataObjectNoSosRef.  # noqa: E501

        Users associated with the data object (optional).  # noqa: E501

        :return: The user of this DataObjectNoSosRef.  # noqa: E501
        :rtype: list[str]
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this DataObjectNoSosRef.

        Users associated with the data object (optional).  # noqa: E501

        :param user: The user of this DataObjectNoSosRef.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def user_group(self):
        """Gets the user_group of this DataObjectNoSosRef.  # noqa: E501

        User groups associated with the data object (optional).  # noqa: E501

        :return: The user_group of this DataObjectNoSosRef.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def user_group(self, user_group):
        """Sets the user_group of this DataObjectNoSosRef.

        User groups associated with the data object (optional).  # noqa: E501

        :param user_group: The user_group of this DataObjectNoSosRef.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectNoSosRef):
            return False
