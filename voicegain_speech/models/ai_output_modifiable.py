...
class AiOutputModifiable(object):
    ...
    @property
    def call_id(self):
        """Gets the call_id of this AiOutputModifiable.  # noqa: E501

        ID of the Call or Call Segment this AI output relates to. Send `null` to clear a previously set value. See `AiOutput.callId`.   # noqa: E501

        :return: The call_id of this AiOutputModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def call_id(self, call_id):
        """Sets the call_id of this AiOutputModifiable.

        ID of the Call or Call Segment this AI output relates to. Send `null` to clear a previously set value. See `AiOutput.callId`.   # noqa: E501

        :param call_id: The call_id of this AiOutputModifiable.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def generation(self):
        """Gets the generation of this AiOutputModifiable.  # noqa: E501


        :return: The generation of this AiOutputModifiable.  # noqa: E501
    ...
    def generation(self, generation):
        """Sets the generation of this AiOutputModifiable.


        :param generation: The generation of this AiOutputModifiable.  # noqa: E501
    ...
    def meeting_session_id(self):
        """Gets the meeting_session_id of this AiOutputModifiable.  # noqa: E501

        UUID of the meeting transcribe session this AI output was generated from. Send `null` to clear a previously set value. See `AiOutput.meetingSessionId`.   # noqa: E501

        :return: The meeting_session_id of this AiOutputModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def meeting_session_id(self, meeting_session_id):
        """Sets the meeting_session_id of this AiOutputModifiable.

        UUID of the meeting transcribe session this AI output was generated from. Send `null` to clear a previously set value. See `AiOutput.meetingSessionId`.   # noqa: E501

        :param meeting_session_id: The meeting_session_id of this AiOutputModifiable.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sa_session_id(self):
        """Gets the sa_session_id of this AiOutputModifiable.  # noqa: E501

        UUID of the SA session this AI output was generated from. Send `null` to clear a previously set value. See `AiOutput.saSessionId`.   # noqa: E501

        :return: The sa_session_id of this AiOutputModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_session_id(self, sa_session_id):
        """Sets the sa_session_id of this AiOutputModifiable.

        UUID of the SA session this AI output was generated from. Send `null` to clear a previously set value. See `AiOutput.saSessionId`.   # noqa: E501

        :param sa_session_id: The sa_session_id of this AiOutputModifiable.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def source_ref(self):
        """Gets the source_ref of this AiOutputModifiable.  # noqa: E501


        :return: The source_ref of this AiOutputModifiable.  # noqa: E501
    ...
    def source_ref(self, source_ref):
        """Sets the source_ref of this AiOutputModifiable.


        :param source_ref: The source_ref of this AiOutputModifiable.  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this AiOutputModifiable.  # noqa: E501

        Replaces the full set of tags on the record. Send an empty array to clear. See `AiOutput.tags`.  # noqa: E501

        :return: The tags of this AiOutputModifiable.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this AiOutputModifiable.

        Replaces the full set of tags on the record. Send an empty array to clear. See `AiOutput.tags`.  # noqa: E501

        :param tags: The tags of this AiOutputModifiable.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AiOutputModifiable):
            return False
