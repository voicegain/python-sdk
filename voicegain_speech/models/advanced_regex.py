...
class AdvancedRegex(object):
    ...
    def negative_regex(self):
        ...
        If set to true then this is negative example (what the phrase should not be). Note: this is different from the `negativeRule` which applies only to this regex. `negativeRegex` applies to the entire phrase   # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdvancedRegex):
            return False
