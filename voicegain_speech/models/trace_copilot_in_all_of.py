...
class TraceCopilotInAllOf(object):
    ...
    def __init__(self, action=None, channel=None, detail=None, suggestion_id=None, local_vars_configuration=None):  # noqa: E501
        """TraceCopilotInAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this TraceCopilotInAllOf.  # noqa: E501
        ...
        :return: The action of this TraceCopilotInAllOf.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this TraceCopilotInAllOf.

        Action the Agent performed on the Copilot. Currently used values: + **suggestionDisplayed** - the AI (KB) suggestion card was rendered in the Copilot side panel + **suggestionThumbsUp** / **suggestionThumbsDown** - the agent voted on the suggestion + **suggestionLinkOpened** - the agent opened the suggestion link as a web page + **suggestionSavedToCase** - the suggestion article was saved to a Salesforce Case  More actions may be added in the future.   # noqa: E501

        :param action: The action of this TraceCopilotInAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this TraceCopilotInAllOf.  # noqa: E501

        Channel name identifying the Copilot user, e.g. Agent email address — mirrors `trace_copilot_out.channel`.  # noqa: E501

        :return: The channel of this TraceCopilotInAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this TraceCopilotInAllOf.

        Channel name identifying the Copilot user, e.g. Agent email address — mirrors `trace_copilot_out.channel`.  # noqa: E501

        :param channel: The channel of this TraceCopilotInAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def detail(self):
        """Gets the detail of this TraceCopilotInAllOf.  # noqa: E501

        Additional action-specific data. Not used by the current actions; room for future ones.  # noqa: E501

        :return: The detail of this TraceCopilotInAllOf.  # noqa: E501
        :rtype: object
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this TraceCopilotInAllOf.

        Additional action-specific data. Not used by the current actions; room for future ones.  # noqa: E501

        :param detail: The detail of this TraceCopilotInAllOf.  # noqa: E501
        :type: object
        """
    ...
    def suggestion_id(self):
        """Gets the suggestion_id of this TraceCopilotInAllOf.  # noqa: E501
        ...
        :return: The suggestion_id of this TraceCopilotInAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def suggestion_id(self, suggestion_id):
        """Sets the suggestion_id of this TraceCopilotInAllOf.

        Id of the AI (KB) suggestion the action relates to. Equals `customUniqueId` of the AI Output record that captured the suggestion — joins this trace entry to the AI Output record.   # noqa: E501

        :param suggestion_id: The suggestion_id of this TraceCopilotInAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TraceCopilotInAllOf):
            return False
