...
class CTxtSearchTermAllOf(object):
    ...
    def __init__(self, field=None, options=None, txt_query=None, local_vars_configuration=None):  # noqa: E501
        """CTxtSearchTermAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def field(self):
        """Gets the field of this CTxtSearchTermAllOf.  # noqa: E501


        :return: The field of this CTxtSearchTermAllOf.  # noqa: E501
        :rtype: CallFieldForTxtSearch
        """
        return self._field

    @field.setter
    def field(self, field):
        """Sets the field of this CTxtSearchTermAllOf.


        :param field: The field of this CTxtSearchTermAllOf.  # noqa: E501
        :type: CallFieldForTxtSearch
        """
    ...
    @property
    def options(self):
        """Gets the options of this CTxtSearchTermAllOf.  # noqa: E501


        :return: The options of this CTxtSearchTermAllOf.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def options(self, options):
        """Sets the options of this CTxtSearchTermAllOf.


        :param options: The options of this CTxtSearchTermAllOf.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["case-insensitive"]  # noqa: E501
    ...
    @property
    def txt_query(self):
        """Gets the txt_query of this CTxtSearchTermAllOf.  # noqa: E501

        Text query string to search the values of the field.   # noqa: E501

        :return: The txt_query of this CTxtSearchTermAllOf.  # noqa: E501
        :rtype: str
        """
        return self._txt_query

    @txt_query.setter
    def txt_query(self, txt_query):
        """Sets the txt_query of this CTxtSearchTermAllOf.

        Text query string to search the values of the field.   # noqa: E501

        :param txt_query: The txt_query of this CTxtSearchTermAllOf.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and txt_query is None:  # noqa: E501
            raise ValueError("Invalid value for `txt_query`, must not be `None`")  # noqa: E501

        self._txt_query = txt_query
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CTxtSearchTermAllOf):
            return False
