...
class CopilotDisplayResolvedValue(object):
    ...
    def __init__(self, annotation=None, id=None, value=None, local_vars_configuration=None):  # noqa: E501
        """CopilotDisplayResolvedValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def annotation(self):
        """Gets the annotation of this CopilotDisplayResolvedValue.  # noqa: E501

        Decoded verification state; absent/null means no annotation or state 'none'.  # noqa: E501

        :return: The annotation of this CopilotDisplayResolvedValue.  # noqa: E501
        :rtype: str
        """
    ...
    def annotation(self, annotation):
        """Sets the annotation of this CopilotDisplayResolvedValue.

        Decoded verification state; absent/null means no annotation or state 'none'.  # noqa: E501

        :param annotation: The annotation of this CopilotDisplayResolvedValue.  # noqa: E501
        :type: str
        """
        allowed_values = [None,"verified", "partial", "unverified"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and annotation not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `annotation` ({0}), must be one of {1}"  # noqa: E501
                .format(annotation, allowed_values)
            )
    ...
    @property
    def id(self):
        """Gets the id of this CopilotDisplayResolvedValue.  # noqa: E501


        :return: The id of this CopilotDisplayResolvedValue.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CopilotDisplayResolvedValue.


        :param id: The id of this CopilotDisplayResolvedValue.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this CopilotDisplayResolvedValue.  # noqa: E501


        :return: The value of this CopilotDisplayResolvedValue.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this CopilotDisplayResolvedValue.


        :param value: The value of this CopilotDisplayResolvedValue.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopilotDisplayResolvedValue):
            return False
