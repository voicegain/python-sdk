...
class ModifiableMeetingData(object):
    ...
    openapi_types = {
        'context': 'str',
        'joined_meeting_event': 'JoinedMeetingEvent',
        'label': 'str',
    ...
    def __init__(self, context=None, joined_meeting_event=None, label=None, metadata=None, persist_seconds=3600, tags=None, local_vars_configuration=None):  # noqa: E501
        """ModifiableMeetingData - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._context = None
        self._joined_meeting_event = None
        self._label = None
        self._metadata = None
        ...
        if joined_meeting_event is not None:
            self.joined_meeting_event = joined_meeting_event
    ...
    @property
    def context(self):
        """Gets the context of this ModifiableMeetingData.  # noqa: E501

        You can move the meeting to a different context by modifying the context id.  The following checks are done before moving: + the dst Context has to be of the same type as the src Context + the users having access to src Context have to overlap with the users having access to the dst Context   # noqa: E501

        :return: The context of this ModifiableMeetingData.  # noqa: E501
        :rtype: str
        """
    ...
    def context(self, context):
        """Sets the context of this ModifiableMeetingData.

        You can move the meeting to a different context by modifying the context id.  The following checks are done before moving: + the dst Context has to be of the same type as the src Context + the users having access to src Context have to overlap with the users having access to the dst Context   # noqa: E501

        :param context: The context of this ModifiableMeetingData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                context is not None and len(context) > 48):
            raise ValueError("Invalid value for `context`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                context is not None and len(context) < 16):
            raise ValueError("Invalid value for `context`, length must be greater than or equal to `16`")  # noqa: E501

        self._context = context

    @property
    def joined_meeting_event(self):
        """Gets the joined_meeting_event of this ModifiableMeetingData.  # noqa: E501


        :return: The joined_meeting_event of this ModifiableMeetingData.  # noqa: E501
        :rtype: JoinedMeetingEvent
        """
        return self._joined_meeting_event

    @joined_meeting_event.setter
    def joined_meeting_event(self, joined_meeting_event):
        """Sets the joined_meeting_event of this ModifiableMeetingData.


        :param joined_meeting_event: The joined_meeting_event of this ModifiableMeetingData.  # noqa: E501
        :type: JoinedMeetingEvent
        """

        self._joined_meeting_event = joined_meeting_event

    @property
    def label(self):
        """Gets the label of this ModifiableMeetingData.  # noqa: E501
        ...
        :return: The label of this ModifiableMeetingData.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this ModifiableMeetingData.

        Label for the result so that it can be easily identified e.g. in the Web UI. </br> Generally follows the same limitations as a file name. </br> Can contain any unicode character except control characters and except < > : \" / \\ |  ? * </br> Moreover, spaces and dots in front and at the end are not allowed.    # noqa: E501

        :param label: The label of this ModifiableMeetingData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this ModifiableMeetingData.  # noqa: E501
        ...
        :return: The metadata of this ModifiableMeetingData.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this ModifiableMeetingData.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this ModifiableMeetingData.  # noqa: E501
    ...
    def persist_seconds(self):
        """Gets the persist_seconds of this ModifiableMeetingData.  # noqa: E501

        Time (in seconds) to retain the result/outcome data after processing has completed. For Cloud, maximum persistence is 31 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.  </br> NOTE 1: You can modify this only for sessions that have comppleted processing. </br> NOTE 2: You cannot change this after the session has already expired.   # noqa: E501

        :return: The persist_seconds of this ModifiableMeetingData.  # noqa: E501
        :rtype: float
        """
    ...
    def persist_seconds(self, persist_seconds):
        """Sets the persist_seconds of this ModifiableMeetingData.

        Time (in seconds) to retain the result/outcome data after processing has completed. For Cloud, maximum persistence is 31 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.  </br> NOTE 1: You can modify this only for sessions that have comppleted processing. </br> NOTE 2: You cannot change this after the session has already expired.   # noqa: E501

        :param persist_seconds: The persist_seconds of this ModifiableMeetingData.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def tags(self):
        """Gets the tags of this ModifiableMeetingData.  # noqa: E501

        Tags associated with the Meeting Transcription session. Each tag is a string with max length of 64 characters. All existing tags will be replaced with the provided tags.   # noqa: E501

        :return: The tags of this ModifiableMeetingData.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ModifiableMeetingData.

        Tags associated with the Meeting Transcription session. Each tag is a string with max length of 64 characters. All existing tags will be replaced with the provided tags.   # noqa: E501

        :param tags: The tags of this ModifiableMeetingData.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifiableMeetingData):
            return False
