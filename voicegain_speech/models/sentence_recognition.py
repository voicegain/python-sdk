...
class SentenceRecognition(object):
    ...
    def __init__(self, alternatives=None, duration=None, spk=None, time=None, local_vars_configuration=None):  # noqa: E501
        """SentenceRecognition - a model defined in OpenAPI"""  # noqa: E501
    ...
    def alternatives(self):
        """Gets the alternatives of this SentenceRecognition.  # noqa: E501
    ...
    def alternatives(self, alternatives):
        """Sets the alternatives of this SentenceRecognition.
    ...
    @property
    def spk(self):
        """Gets the spk of this SentenceRecognition.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this session. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.              # noqa: E501
        ...
        :return: The spk of this SentenceRecognition.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this SentenceRecognition.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this session. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.              # noqa: E501

        :param spk: The spk of this SentenceRecognition.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SentenceRecognition):
            return False
