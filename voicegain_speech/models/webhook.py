...
class Webhook(object):
    ...
    def __init__(self, contexts=None, failed=None, format='form_urlencoded', jwt_ttl=600, name=None, receiver_token=None, resources=None, send_jwt=False, url=None, webhook_uuid=None, local_vars_configuration=None):  # noqa: E501
        ...
        if send_jwt is not None:
            self.send_jwt = send_jwt
        if url is not None:
            self.url = url
    ...
    @property
    def failed(self):
        """Gets the failed of this Webhook.  # noqa: E501

        Will be true if 50 webhook calls in a row have failed. Once that happens the webhook needs to be reset manually for it to function again.   # noqa: E501

        :return: The failed of this Webhook.  # noqa: E501
        :rtype: bool
        """
        return self._failed
    ...
    def failed(self, failed):
        """Sets the failed of this Webhook.

        Will be true if 50 webhook calls in a row have failed. Once that happens the webhook needs to be reset manually for it to function again.   # noqa: E501

        :param failed: The failed of this Webhook.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def format(self):
        """Gets the format of this Webhook.  # noqa: E501

        Format of the webhook payload.  + `json` will send the payload as application/json content type with the payload as a JSON object. + `form_urlencoded` will send the payload as a application/x-www-form-urlencoded content type (this is the default)   # noqa: E501

        :return: The format of this Webhook.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this Webhook.

        Format of the webhook payload.  + `json` will send the payload as application/json content type with the payload as a JSON object. + `form_urlencoded` will send the payload as a application/x-www-form-urlencoded content type (this is the default)   # noqa: E501

        :param format: The format of this Webhook.  # noqa: E501
        :type: str
        """
        allowed_values = ["json", "form_urlencoded"]  # noqa: E501
    ...
    @property
    def jwt_ttl(self):
        """Gets the jwt_ttl of this Webhook.  # noqa: E501

        Time-to-live in seconds for the JWT token that is sent with the webhook call. Default is 10 minutes.   # noqa: E501

        :return: The jwt_ttl of this Webhook.  # noqa: E501
        :rtype: int
        """
    ...
    def jwt_ttl(self, jwt_ttl):
        """Sets the jwt_ttl of this Webhook.

        Time-to-live in seconds for the JWT token that is sent with the webhook call. Default is 10 minutes.   # noqa: E501

        :param jwt_ttl: The jwt_ttl of this Webhook.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                jwt_ttl is not None and jwt_ttl > 3600):  # noqa: E501
            raise ValueError("Invalid value for `jwt_ttl`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                jwt_ttl is not None and jwt_ttl < 15):  # noqa: E501
            raise ValueError("Invalid value for `jwt_ttl`, must be a value greater than or equal to `15`")  # noqa: E501
    ...
    def receiver_token(self):
        """Gets the receiver_token of this Webhook.  # noqa: E501

        (optional) Token that is passed in the webhook requests.  The receiver can choose to validate the token to ensure that the request is coming from the expected source.   # noqa: E501

        :return: The receiver_token of this Webhook.  # noqa: E501
        :rtype: str
        """
    ...
    def receiver_token(self, receiver_token):
        """Sets the receiver_token of this Webhook.

        (optional) Token that is passed in the webhook requests.  The receiver can choose to validate the token to ensure that the request is coming from the expected source.   # noqa: E501

        :param receiver_token: The receiver_token of this Webhook.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def resources(self):
        """Gets the resources of this Webhook.  # noqa: E501


        :return: The resources of this Webhook.  # noqa: E501
        :rtype: WebhookResources
        """
        return self._resources

    @resources.setter
    def resources(self, resources):
        """Sets the resources of this Webhook.


        :param resources: The resources of this Webhook.  # noqa: E501
    ...
    @property
    def send_jwt(self):
        """Gets the send_jwt of this Webhook.  # noqa: E501

        If true then each webhook call will contain a short-lived (default 10 minutes) JWT token that can be used to access the API methods of the resource.   # noqa: E501

        :return: The send_jwt of this Webhook.  # noqa: E501
        :rtype: bool
        """
        return self._send_jwt

    @send_jwt.setter
    def send_jwt(self, send_jwt):
        """Sets the send_jwt of this Webhook.

        If true then each webhook call will contain a short-lived (default 10 minutes) JWT token that can be used to access the API methods of the resource.   # noqa: E501

        :param send_jwt: The send_jwt of this Webhook.  # noqa: E501
        :type: bool
        """

        self._send_jwt = send_jwt

    @property
    def url(self):
        """Gets the url of this Webhook.  # noqa: E501

        URL to which the webhook will be sent   # noqa: E501
    ...
    def url(self, url):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                url is not None and len(url) < 9):
            raise ValueError("Invalid value for `url`, length must be greater than or equal to `9`")  # noqa: E501

        self._url = url

    @property
    def webhook_uuid(self):
        """Gets the webhook_uuid of this Webhook.  # noqa: E501

        UUID of the webhook   # noqa: E501

        :return: The webhook_uuid of this Webhook.  # noqa: E501
        :rtype: str
        """
    ...
    def webhook_uuid(self, webhook_uuid):
        """Sets the webhook_uuid of this Webhook.

        UUID of the webhook   # noqa: E501

        :param webhook_uuid: The webhook_uuid of this Webhook.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
