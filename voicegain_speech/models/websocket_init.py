...
class WebsocketInit(object):
    ...
    def ad_hoc(self):
        ...
        Use `mode` parameter instead.  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this WebsocketInit.  # noqa: E501


        :return: The mode of this WebsocketInit.  # noqa: E501
        :rtype: ResultsWebsocketMode
        """
        return self._mode

    @mode.setter
    def mode(self, mode):
        """Sets the mode of this WebsocketInit.


        :param mode: The mode of this WebsocketInit.  # noqa: E501
        :type: ResultsWebsocketMode
        """
    ...
    def name(self):
        ...
        Provide name of the predefined websocket (only if mode==predefined).</br> **IMPORTANT:** If the name **is** provided, it must correspond to previously defined websocket.</br> If not provided (i.e. missing, null, or \"\") then a Default websocket specified for the account will be used.   # noqa: E501
    ...
    @property
    def protocol(self):
        """Gets the protocol of this WebsocketInit.  # noqa: E501


        :return: The protocol of this WebsocketInit.  # noqa: E501
        :rtype: WebsocketProtocol
        """
        return self._protocol

    @protocol.setter
    def protocol(self, protocol):
        """Sets the protocol of this WebsocketInit.


        :param protocol: The protocol of this WebsocketInit.  # noqa: E501
