...
class AsrSettingsTranscriptionAllOf(object):
    ...
    def __init__(self, diarization=None, hints=None, lang_model=None, no_input_timeout=15000, speech_analytics_config=None, topic_discovery_config=None, local_vars_configuration=None):  # noqa: E501
