...
class SpeechAnalyticsConfig(object):
    ...
    @property
    def created_by(self):
        """Gets the created_by of this SpeechAnalyticsConfig.  # noqa: E501

        `userId` of the user who created this Speech Analytics configuration.</br> May be absent on older SA Configurations created before this field was introduced, or when the configuration was created by back-end processing rather than by a user (e.g. a Built-In configuration).   # noqa: E501

        :return: The created_by of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def created_by(self, created_by):
        """Sets the created_by of this SpeechAnalyticsConfig.

        `userId` of the user who created this Speech Analytics configuration.</br> May be absent on older SA Configurations created before this field was introduced, or when the configuration was created by back-end processing rather than by a user (e.g. a Built-In configuration).   # noqa: E501

        :param created_by: The created_by of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                created_by is not None and len(created_by) > 48):
            raise ValueError("Invalid value for `created_by`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                created_by is not None and len(created_by) < 16):
            raise ValueError("Invalid value for `created_by`, length must be greater than or equal to `16`")  # noqa: E501

        self._created_by = created_by

    @property
    def date_created(self):
        """Gets the date_created of this SpeechAnalyticsConfig.  # noqa: E501

        Date/Time when this Speech Analytics configuration was created.</br> May be absent on older SA Configurations created before this field was introduced.   # noqa: E501

        :return: The date_created of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_created(self, date_created):
        """Sets the date_created of this SpeechAnalyticsConfig.

        Date/Time when this Speech Analytics configuration was created.</br> May be absent on older SA Configurations created before this field was introduced.   # noqa: E501

        :param date_created: The date_created of this SpeechAnalyticsConfig.  # noqa: E501
        :type: datetime
        """
    ...
    def date_modified(self):
        """Gets the date_modified of this SpeechAnalyticsConfig.  # noqa: E501

        Date/Time when this Speech Analytics configuration was last modified.</br> May be absent on older SA Configurations that have not been modified since this field was introduced.   # noqa: E501

        :return: The date_modified of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified):
        """Sets the date_modified of this SpeechAnalyticsConfig.

        Date/Time when this Speech Analytics configuration was last modified.</br> May be absent on older SA Configurations that have not been modified since this field was introduced.   # noqa: E501

        :param date_modified: The date_modified of this SpeechAnalyticsConfig.  # noqa: E501
        :type: datetime
        """
    ...
    def last_modified_by(self):
        """Gets the last_modified_by of this SpeechAnalyticsConfig.  # noqa: E501

        `userId` of the user who last modified this Speech Analytics configuration.</br> May be absent on older SA Configurations that have not been modified since this field was introduced, or when the last modification was made by back-end processing rather than by a user.   # noqa: E501

        :return: The last_modified_by of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def last_modified_by(self, last_modified_by):
        """Sets the last_modified_by of this SpeechAnalyticsConfig.

        `userId` of the user who last modified this Speech Analytics configuration.</br> May be absent on older SA Configurations that have not been modified since this field was introduced, or when the last modification was made by back-end processing rather than by a user.   # noqa: E501

        :param last_modified_by: The last_modified_by of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                last_modified_by is not None and len(last_modified_by) > 48):
            raise ValueError("Invalid value for `last_modified_by`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                last_modified_by is not None and len(last_modified_by) < 16):
            raise ValueError("Invalid value for `last_modified_by`, length must be greater than or equal to `16`")  # noqa: E501
    ...
    @property
    def criteria(self):
        """Gets the criteria of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The criteria of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def criteria(self, criteria):
        """Sets the criteria of this SpeechAnalyticsConfig.

        Criteria to be detected</br> Each Criterion cofiguration contains a list of SubCriteria that need to be satisfied.  **All** SubCriteria within the list must be satisfied for the list to return true.</br> Empty SubCriteria list is considered true (satisfies all SubCriteria).</br> Within each SubCriteria all __specified__ properties must return true for the SubCriteria to be true (AND). Except for `dialogElements` all properties are assumed to must match within the same sentence.   # noqa: E501

        :param criteria: The criteria of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def csat_question(self):
        """Gets the csat_question of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def csat_question(self, csat_question):
        """Sets the csat_question of this SpeechAnalyticsConfig.
    ...
    def kb_recommendation(self):
        """Gets the kb_recommendation of this SpeechAnalyticsConfig.  # noqa: E501


        :return: The kb_recommendation of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def kb_recommendation(self, kb_recommendation):
        """Sets the kb_recommendation of this SpeechAnalyticsConfig.


        :param kb_recommendation: The kb_recommendation of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def llm_copilot_notes_prompt(self):
        """Gets the llm_copilot_notes_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The llm_copilot_notes_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def llm_copilot_notes_prompt(self, llm_copilot_notes_prompt):
        """Sets the llm_copilot_notes_prompt of this SpeechAnalyticsConfig.

        _(internal use)_ LLM Prompt that is used to generate the copilot notes.  These are the notes that the Agent would normally enter into the CRM system at the end of the call. They ignore anything that is not relevant for the future record on the caller account. The copilot notes are generated immediately after the call ends.   # noqa: E501

        :param llm_copilot_notes_prompt: The llm_copilot_notes_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
    ...
    def llm_summary_prompt(self):
        """Gets the llm_summary_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The llm_summary_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def llm_summary_prompt(self, llm_summary_prompt):
        """Sets the llm_summary_prompt of this SpeechAnalyticsConfig.

        LLM Prompt used to generate the summary of the transcript - stored in the `summary` field. (In SA Call use cases, used to populate the notes field on the call and call segment.)   # noqa: E501

        :param llm_summary_prompt: The llm_summary_prompt of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
    ...
    def meeting_minutes(self):
        """Gets the meeting_minutes of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def meeting_minutes(self, meeting_minutes):
        """Sets the meeting_minutes of this SpeechAnalyticsConfig.
