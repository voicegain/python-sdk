...
class AudioInputAsyncWithCallback(object):
    ...
    openapi_types = {
        ...
        'format': 'AudioFormat',
        'rate': 'SampleRate',
        'callback': 'AudioInputCallbackCallback'
    }
    ...
    def __init__(self, source=None, capture=False, channels=None, format=None, rate=None, callback=None, local_vars_configuration=None):  # noqa: E501
        """AudioInputAsyncWithCallback - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def source(self):
        """Gets the source of this AudioInputAsyncWithCallback.  # noqa: E501


        :return: The source of this AudioInputAsyncWithCallback.  # noqa: E501
    ...
    def source(self, source):
        """Sets the source of this AudioInputAsyncWithCallback.


        :param source: The source of this AudioInputAsyncWithCallback.  # noqa: E501
    ...
    @property
    def capture(self):
        """Gets the capture of this AudioInputAsyncWithCallback.  # noqa: E501

        If **true** then Audio data will be captured, exactly as it was sent to ASR. The captured audio is **not** PII-redacted, even if `redact` formatters are configured — to obtain PII-redacted audio see `audio.callback` (supported only for OFF-LINE transcription with a `fromUrl` source).  The captured audio data can be retrieved using a **uuid** of a DataObject, which will be returned in the **response** to this request in a field **audio.capturedAudio**  **Note:** the Context (Configuration Group) provides a default for this field (`audioCapture`). Moreover, if the Context has `audioCaptureOverride` set to **true**, then the Context `audioCapture` value takes precedence over any value provided here.   # noqa: E501

        :return: The capture of this AudioInputAsyncWithCallback.  # noqa: E501
        :rtype: bool
        """
    ...
    def capture(self, capture):
        """Sets the capture of this AudioInputAsyncWithCallback.

        If **true** then Audio data will be captured, exactly as it was sent to ASR. The captured audio is **not** PII-redacted, even if `redact` formatters are configured — to obtain PII-redacted audio see `audio.callback` (supported only for OFF-LINE transcription with a `fromUrl` source).  The captured audio data can be retrieved using a **uuid** of a DataObject, which will be returned in the **response** to this request in a field **audio.capturedAudio**  **Note:** the Context (Configuration Group) provides a default for this field (`audioCapture`). Moreover, if the Context has `audioCaptureOverride` set to **true**, then the Context `audioCapture` value takes precedence over any value provided here.   # noqa: E501

        :param capture: The capture of this AudioInputAsyncWithCallback.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def channels(self):
        """Gets the channels of this AudioInputAsyncWithCallback.  # noqa: E501


        :return: The channels of this AudioInputAsyncWithCallback.  # noqa: E501
        :rtype: AudioChannels
        """
    ...
    def channels(self, channels):
        """Sets the channels of this AudioInputAsyncWithCallback.


        :param channels: The channels of this AudioInputAsyncWithCallback.  # noqa: E501
        :type: AudioChannels
        """
    ...
    @property
    def format(self):
        """Gets the format of this AudioInputAsyncWithCallback.  # noqa: E501


        :return: The format of this AudioInputAsyncWithCallback.  # noqa: E501
        :rtype: AudioFormat
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this AudioInputAsyncWithCallback.


        :param format: The format of this AudioInputAsyncWithCallback.  # noqa: E501
        :type: AudioFormat
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this AudioInputAsyncWithCallback.  # noqa: E501


        :return: The rate of this AudioInputAsyncWithCallback.  # noqa: E501
        :rtype: SampleRate
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this AudioInputAsyncWithCallback.


        :param rate: The rate of this AudioInputAsyncWithCallback.  # noqa: E501
        :type: SampleRate
        """
    ...
    @property
    def callback(self):
        """Gets the callback of this AudioInputAsyncWithCallback.  # noqa: E501


        :return: The callback of this AudioInputAsyncWithCallback.  # noqa: E501
        :rtype: AudioInputCallbackCallback
        """
        return self._callback

    @callback.setter
    def callback(self, callback):
        """Sets the callback of this AudioInputAsyncWithCallback.


        :param callback: The callback of this AudioInputAsyncWithCallback.  # noqa: E501
        :type: AudioInputCallbackCallback
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioInputAsyncWithCallback):
            return False
