...
class VoiceCallAllOfVoicebotVars(object):
    ...
    def __init__(self, caller_intent=None, caller_type=None, current_step=None, fully_automated=None, lob=None, obh=None, verification_status=None, voicemail=None, local_vars_configuration=None):  # noqa: E501
        """VoiceCallAllOfVoicebotVars - a model defined in OpenAPI"""  # noqa: E501
    ...
    def caller_intent(self):
        """Gets the caller_intent of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        ...
        :return: The caller_intent of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def caller_intent(self, caller_intent):
        """Sets the caller_intent of this VoiceCallAllOfVoicebotVars.

        The intent of the caller determined by the app logic, e.g. Claims, Benefits, etc. Multiple intents are separated by commas.  # noqa: E501

        :param caller_intent: The caller_intent of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
    ...
    def caller_type(self):
        """Gets the caller_type of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        The type of caller determined by the app logic, e.g. Member, Provider, etc.  # noqa: E501

        :return: The caller_type of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def caller_type(self, caller_type):
        """Sets the caller_type of this VoiceCallAllOfVoicebotVars.

        The type of caller determined by the app logic, e.g. Member, Provider, etc.  # noqa: E501

        :param caller_type: The caller_type of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def current_step(self):
        """Gets the current_step of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        The current step in the app logic, e.g. \"Greeting\", \"Verification\", etc.  # noqa: E501

        :return: The current_step of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def current_step(self, current_step):
        """Sets the current_step of this VoiceCallAllOfVoicebotVars.

        The current step in the app logic, e.g. \"Greeting\", \"Verification\", etc.  # noqa: E501

        :param current_step: The current_step of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def fully_automated(self):
        """Gets the fully_automated of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        ...
        :return: The fully_automated of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def fully_automated(self, fully_automated):
        """Sets the fully_automated of this VoiceCallAllOfVoicebotVars.

        Set this value if voicebot managed to fully automate a task and as a result caller will not have to be transferred (unless they have other questions), e.g. “eligibility”. Multiple automated tasks are separated by commas.   # noqa: E501

        :param fully_automated: The fully_automated of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def lob(self):
        """Gets the lob of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        The line of business, e.g. ACME Claims  # noqa: E501

        :return: The lob of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
        return self._lob
    ...
    @lob.setter
    def lob(self, lob):
        """Sets the lob of this VoiceCallAllOfVoicebotVars.

        The line of business, e.g. ACME Claims  # noqa: E501

        :param lob: The lob of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def obh(self):
        """Gets the obh of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        set to true when the app logic used Business Config and determined that it’s outside business hours   # noqa: E501

        :return: The obh of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: bool
        """
        return self._obh
    ...
    @obh.setter
    def obh(self, obh):
        """Sets the obh of this VoiceCallAllOfVoicebotVars.

        set to true when the app logic used Business Config and determined that it’s outside business hours   # noqa: E501

        :param obh: The obh of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: bool
        """
    ...
    def verification_status(self):
        """Gets the verification_status of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        The verification status determined by the app logic.  # noqa: E501

        :return: The verification_status of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: str
        """
    ...
    def verification_status(self, verification_status):
        """Sets the verification_status of this VoiceCallAllOfVoicebotVars.

        The verification status determined by the app logic.  # noqa: E501

        :param verification_status: The verification_status of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: str
        """
    ...
    @property
    def voicemail(self):
        """Gets the voicemail of this VoiceCallAllOfVoicebotVars.  # noqa: E501

        Set to true if a voicemail was left during the call.   # noqa: E501

        :return: The voicemail of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :rtype: bool
        """
    ...
    def voicemail(self, voicemail):
        """Sets the voicemail of this VoiceCallAllOfVoicebotVars.

        Set to true if a voicemail was left during the call.   # noqa: E501

        :param voicemail: The voicemail of this VoiceCallAllOfVoicebotVars.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceCallAllOfVoicebotVars):
            return False
