...
class TranscribeMeetingRequestAudio(object):
    ...
    def __init__(self, diarization=None, source=None, speakers=None, local_vars_configuration=None):  # noqa: E501
        """TranscribeMeetingRequestAudio - a model defined in OpenAPI"""  # noqa: E501
    ...
    def diarization(self):
        """Gets the diarization of this TranscribeMeetingRequestAudio.  # noqa: E501


        :return: The diarization of this TranscribeMeetingRequestAudio.  # noqa: E501
    ...
    def diarization(self, diarization):
        """Sets the diarization of this TranscribeMeetingRequestAudio.


        :param diarization: The diarization of this TranscribeMeetingRequestAudio.  # noqa: E501
    ...
    @property
    def source(self):
        """Gets the source of this TranscribeMeetingRequestAudio.  # noqa: E501


        :return: The source of this TranscribeMeetingRequestAudio.  # noqa: E501
    ...
    def source(self, source):
        """Sets the source of this TranscribeMeetingRequestAudio.


        :param source: The source of this TranscribeMeetingRequestAudio.  # noqa: E501
    ...
    @property
    def speakers(self):
        """Gets the speakers of this TranscribeMeetingRequestAudio.  # noqa: E501
        ...
        :return: The speakers of this TranscribeMeetingRequestAudio.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def speakers(self, speakers):
        """Sets the speakers of this TranscribeMeetingRequestAudio.

        (optional) IDs of the speakers in this audio channel. They reference `speakers[].spkUserId` If absent then assume that there is just one speaker (unless diarization is turned on).</br> In the current version of this API, `speakers` should not be provided together with `diarization`. You can specify either one or the other but not both for a single audio.   # noqa: E501

        :param speakers: The speakers of this TranscribeMeetingRequestAudio.  # noqa: E501
        :type: list[float]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TranscribeMeetingRequestAudio):
            return False
