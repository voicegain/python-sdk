...
class MeetingMinutes(object):
    ...
    """
    openapi_types = {
        'key_sentences_by_type': 'list[TypedSentence]',
        'key_sentences_rejected_by_type': 'list[TypedSentenceWithRejection]',
        'sections': 'list[MeetingMinutesSection]'
    }

    attribute_map = {
        'key_sentences_by_type': 'keySentencesByType',
        'key_sentences_rejected_by_type': 'keySentencesRejectedByType',
        'sections': 'sections'
    }

    def __init__(self, key_sentences_by_type=None, key_sentences_rejected_by_type=None, sections=None, local_vars_configuration=None):  # noqa: E501
        """MeetingMinutes - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._key_sentences_by_type = None
        self._key_sentences_rejected_by_type = None
        self._sections = None
        self.discriminator = None

        if key_sentences_by_type is not None:
            self.key_sentences_by_type = key_sentences_by_type
        if key_sentences_rejected_by_type is not None:
            self.key_sentences_rejected_by_type = key_sentences_rejected_by_type
        if sections is not None:
            self.sections = sections

    @property
    def key_sentences_by_type(self):
        """Gets the key_sentences_by_type of this MeetingMinutes.  # noqa: E501

        key sentences from the meeting conveying thoughts in predefined categories - \"risk\", \"action\", \"issue\", \"decision\", \"requirement\"  or in custom categories   # noqa: E501

        :return: The key_sentences_by_type of this MeetingMinutes.  # noqa: E501
        :rtype: list[TypedSentence]
        """
        return self._key_sentences_by_type

    @key_sentences_by_type.setter
    def key_sentences_by_type(self, key_sentences_by_type):
        """Sets the key_sentences_by_type of this MeetingMinutes.

        key sentences from the meeting conveying thoughts in predefined categories - \"risk\", \"action\", \"issue\", \"decision\", \"requirement\"  or in custom categories   # noqa: E501

        :param key_sentences_by_type: The key_sentences_by_type of this MeetingMinutes.  # noqa: E501
        :type: list[TypedSentence]
        """

        self._key_sentences_by_type = key_sentences_by_type

    @property
    def key_sentences_rejected_by_type(self):
        """Gets the key_sentences_rejected_by_type of this MeetingMinutes.  # noqa: E501

        key sentences from the meeting that have been rejected   # noqa: E501

        :return: The key_sentences_rejected_by_type of this MeetingMinutes.  # noqa: E501
        :rtype: list[TypedSentenceWithRejection]
        """
        return self._key_sentences_rejected_by_type

    @key_sentences_rejected_by_type.setter
    def key_sentences_rejected_by_type(self, key_sentences_rejected_by_type):
        """Sets the key_sentences_rejected_by_type of this MeetingMinutes.

        key sentences from the meeting that have been rejected   # noqa: E501

        :param key_sentences_rejected_by_type: The key_sentences_rejected_by_type of this MeetingMinutes.  # noqa: E501
        :type: list[TypedSentenceWithRejection]
        """

        self._key_sentences_rejected_by_type = key_sentences_rejected_by_type

    @property
    def sections(self):
        """Gets the sections of this MeetingMinutes.  # noqa: E501

        summaries of sections from the meeting arranged by time  # noqa: E501

        :return: The sections of this MeetingMinutes.  # noqa: E501
        :rtype: list[MeetingMinutesSection]
        """
        return self._sections

    @sections.setter
    def sections(self, sections):
        """Sets the sections of this MeetingMinutes.

        summaries of sections from the meeting arranged by time  # noqa: E501

        :param sections: The sections of this MeetingMinutes.  # noqa: E501
        :type: list[MeetingMinutesSection]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingMinutes):
            return False
