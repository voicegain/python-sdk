...
class CallSearchField(object):
    ...
    @property
    def field(self):
        """Gets the field of this CallSearchField.  # noqa: E501


        :return: The field of this CallSearchField.  # noqa: E501
        :rtype: CallField
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this CallSearchField.


        :param field: The field of this CallSearchField.  # noqa: E501
        :type: CallField
        """
    ...
    def intermediate_values(self):
        ...
        List of intermediate values for the field (values between `minValue` and `maxValue`). </br> Present only if the field returns `minValue` and `maxValue` and if the `minValue` is **different** from the `maxValue`. </br> The `intermediateValues` array will contain the values of the 20th, 40th, 60th, and 80th percentiles computed over  the set of **distinct** field values. </br> After computing the percentile values, if the percentile values are floating point values, they will be rounded to nearest integer. </br>  The values are expressed as strings. The field `type` determines the type and conversion from string. Returned for: DURATION, SCORE   # noqa: E501

        :return: The intermediate_values of this CallSearchField.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def intermediate_values(self, intermediate_values):
        """Sets the intermediate_values of this CallSearchField.

        List of intermediate values for the field (values between `minValue` and `maxValue`). </br> Present only if the field returns `minValue` and `maxValue` and if the `minValue` is **different** from the `maxValue`. </br> The `intermediateValues` array will contain the values of the 20th, 40th, 60th, and 80th percentiles computed over  the set of **distinct** field values. </br> After computing the percentile values, if the percentile values are floating point values, they will be rounded to nearest integer. </br>  The values are expressed as strings. The field `type` determines the type and conversion from string. Returned for: DURATION, SCORE   # noqa: E501

        :param intermediate_values: The intermediate_values of this CallSearchField.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this CallSearchField.  # noqa: E501
        ...
        :return: The type of this CallSearchField.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CallSearchField.

        Value Type of the field.  + uuid - id value + datetime - date and time value + string - string value + number - number value + duration - duration value, e.g. 1m3s + size - byte size value, e.g. 1.5M   # noqa: E501

        :param type: The type of this CallSearchField.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallSearchField):
            return False
