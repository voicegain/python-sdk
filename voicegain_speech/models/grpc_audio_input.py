...
class GrpcAudioInput(object):
    ...
    def __init__(self, call_id=None, platform=None, trust_token=None, local_vars_configuration=None):  # noqa: E501
        """GrpcAudioInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def call_id(self):
        """Gets the call_id of this GrpcAudioInput.  # noqa: E501

        The id of the call on the platform that Voicegain should listen for.</br> For `five9VoiceStream` this is the Five9 `vcc_call_id`.   # noqa: E501

        :return: The call_id of this GrpcAudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def call_id(self, call_id):
        """Sets the call_id of this GrpcAudioInput.

        The id of the call on the platform that Voicegain should listen for.</br> For `five9VoiceStream` this is the Five9 `vcc_call_id`.   # noqa: E501

        :param call_id: The call_id of this GrpcAudioInput.  # noqa: E501
        :type: str
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
                call_id is not None and len(call_id) > 256):
            raise ValueError("Invalid value for `call_id`, length must be less than or equal to `256`")  # noqa: E501

        self._call_id = call_id

    @property
    def platform(self):
        """Gets the platform of this GrpcAudioInput.  # noqa: E501

        Platform delivering the audio stream over gRPC.</br> - `five9VoiceStream` - audio delivered via Five9 Voice Stream.</br>   We will have 2 or 3 separate gRPC streams for the same call: AGENT / CUSTOMER / SUPERVISOR.   For now we will ignore the Supervisor stream.</br>   `speakerChannels` is currently ignored and the left channel will have audio from the AGENT call_leg.   # noqa: E501

        :return: The platform of this GrpcAudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def platform(self, platform):
        """Sets the platform of this GrpcAudioInput.

        Platform delivering the audio stream over gRPC.</br> - `five9VoiceStream` - audio delivered via Five9 Voice Stream.</br>   We will have 2 or 3 separate gRPC streams for the same call: AGENT / CUSTOMER / SUPERVISOR.   For now we will ignore the Supervisor stream.</br>   `speakerChannels` is currently ignored and the left channel will have audio from the AGENT call_leg.   # noqa: E501

        :param platform: The platform of this GrpcAudioInput.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and platform is None:  # noqa: E501
            raise ValueError("Invalid value for `platform`, must not be `None`")  # noqa: E501
        allowed_values = ["five9VoiceStream"]  # noqa: E501
    ...
    def trust_token(self):
        """Gets the trust_token of this GrpcAudioInput.  # noqa: E501

        Token used to verify that the incoming stream comes from a trusted source.   # noqa: E501

        :return: The trust_token of this GrpcAudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def trust_token(self, trust_token):
        """Sets the trust_token of this GrpcAudioInput.

        Token used to verify that the incoming stream comes from a trusted source.   # noqa: E501

        :param trust_token: The trust_token of this GrpcAudioInput.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and trust_token is None:  # noqa: E501
            raise ValueError("Invalid value for `trust_token`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                trust_token is not None and len(trust_token) > 4096):
            raise ValueError("Invalid value for `trust_token`, length must be less than or equal to `4096`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GrpcAudioInput):
            return False
