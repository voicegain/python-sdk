...
class DataObjectNoSosRefPresignedS3(object):
    ...
    @property
    def account_id(self):
        """Gets the account_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        Account Id  # noqa: E501

        :return: The account_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this DataObjectNoSosRefPresignedS3.

        Account Id  # noqa: E501

        :param account_id: The account_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        ...
        :return: The context_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this DataObjectNoSosRefPresignedS3.

        Context Id - if specified then this DataObject is associated with a given context;  if not then the DataObject is associated with the Account.</br> Note: If contextId is specified then when a Context is deleted, this object will be deleted if all references to it are from within the Context. If it is referenced from outside the Context, then this object becomes read-only when Context is deleted.   # noqa: E501

        :param context_id: The context_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    def date_created(self):
        """Gets the date_created of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        Date/Time when the object was created  # noqa: E501

        :return: The date_created of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_created(self, date_created):
        """Sets the date_created of this DataObjectNoSosRefPresignedS3.

        Date/Time when the object was created  # noqa: E501

        :param date_created: The date_created of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: datetime
        """
    ...
    def date_modified(self):
        """Gets the date_modified of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        Date/Time when the object was last modified.  # noqa: E501

        :return: The date_modified of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified):
        """Sets the date_modified of this DataObjectNoSosRefPresignedS3.

        Date/Time when the object was last modified.  # noqa: E501

        :param date_modified: The date_modified of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def object_id(self):
        """Gets the object_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        System-generated unique ID of the Data Object  # noqa: E501

        :return: The object_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def object_id(self, object_id):
        """Sets the object_id of this DataObjectNoSosRefPresignedS3.

        System-generated unique ID of the Data Object  # noqa: E501

        :param object_id: The object_id of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    def content_type(self):
        """Gets the content_type of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        ...
        :return: The content_type of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this DataObjectNoSosRefPresignedS3.

        Type of the data stored with this Data Object (e.g. audio/wav).  This value will be set in the response Content-Type header when retrieving the data raw.   # noqa: E501

        :param content_type: The content_type of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        User provided description of the data object (optional).  # noqa: E501

        :return: The description of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DataObjectNoSosRefPresignedS3.

        User provided description of the data object (optional).  # noqa: E501

        :param description: The description of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    @property
    def encryption(self):
        """Gets the encryption of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        ...
        :return: The encryption of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this DataObjectNoSosRefPresignedS3.

        Controls encryption of the data in storage. Applies mainly to Edge deployments (default encryption setting is specified in the Edge cluster configuration).  + none - do not use encryption in storage + standard - encrypt in storage + enhanced - use JWT as part of the encryption key - this basically allows the client to control encryption of individual Data objects (client can create a unique JWT for accessing each Data object)  For Cloud `standard` is the default - `none` will be treated as `standard` and attempt to use `enhanced` will result in error.   # noqa: E501

        :param encryption: The encryption of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    def long_persist(self):
        """Gets the long_persist of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        ...
        :return: The long_persist of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: bool
        """
    ...
    def long_persist(self, long_persist):
        """Sets the long_persist of this DataObjectNoSosRefPresignedS3.

        Default value `false` means that the DataObject will be garbage collected if there are no more references to it and the DataObject is older than `context.ageThresholdForDataObjectCleanup`. If you set value to `true` then the DataObject will **not** be garbage collected. Note, that you may be responsible for storage fees.    # noqa: E501

        :param long_persist: The long_persist of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        ...
        :return: The name of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataObjectNoSosRefPresignedS3.

        Human friendly identifier (does not have to be unique).</br> It is optional, but an object that does not have a name may be difficult to query.</br> Characters **not allowed** in a name are: star `*`, question mark `?`, colon `:`, pipe `|`, slash `/`, backslash `\\`, quote `\"`, any control characters including `NUL`</br> Name may not start with: any whitespace, period `.`, tilde `~`. </br> Name may not end with: any whitespace.</br>   # noqa: E501

        :param name: The name of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :return: The tags of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DataObjectNoSosRefPresignedS3.

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :param tags: The tags of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def transcoded(self):
        """Gets the transcoded of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :return: The transcoded of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: bool
        """
    ...
    def transcoded(self, transcoded):
        """Sets the transcoded of this DataObjectNoSosRefPresignedS3.

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :param transcoded: The transcoded of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: bool
        """
    ...
    def presigned_url(self):
        """Gets the presigned_url of this DataObjectNoSosRefPresignedS3.  # noqa: E501

        S3 compatible URL for direct upload. Available only in this response (not stored).   # noqa: E501

        :return: The presigned_url of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: str
        """
    ...
    def presigned_url(self, presigned_url):
        """Sets the presigned_url of this DataObjectNoSosRefPresignedS3.

        S3 compatible URL for direct upload. Available only in this response (not stored).   # noqa: E501

        :param presigned_url: The presigned_url of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sos_ref(self):
        """Gets the sos_ref of this DataObjectNoSosRefPresignedS3.  # noqa: E501


        :return: The sos_ref of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :rtype: SosRef
        """
    ...
    def sos_ref(self, sos_ref):
        """Sets the sos_ref of this DataObjectNoSosRefPresignedS3.


        :param sos_ref: The sos_ref of this DataObjectNoSosRefPresignedS3.  # noqa: E501
        :type: SosRef
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectNoSosRefPresignedS3):
            return False
