...
class CLeTerm(object):
    ...
    def __init__(self, field=None, key=None, options=None, other_value=None, local_vars_configuration=None):  # noqa: E501
        """CLeTerm - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def field(self):
        """Gets the field of this CLeTerm.  # noqa: E501


        :return: The field of this CLeTerm.  # noqa: E501
        :rtype: CallField
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this CLeTerm.


        :param field: The field of this CLeTerm.  # noqa: E501
        :type: CallField
        """
    ...
    @property
    def options(self):
        """Gets the options of this CLeTerm.  # noqa: E501
        ...
        :return: The options of this CLeTerm.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def options(self, options):
        """Sets the options of this CLeTerm.

        + case-insensitive - if present, the query will be case-insensitive + key-match - (applicable only if the field is of type **map**) if present, the query will match if the **key** matches the `otherValue` (instead of the value). If `key` is missing and `options` contains `key-match` then the query will match if any of the keys in the map matches the `otherValue`.   # noqa: E501

        :param options: The options of this CLeTerm.  # noqa: E501
        :type: list[str]
        """
    ...
    def other_value(self):
        """Gets the other_value of this CLeTerm.  # noqa: E501
        ...
        :return: The other_value of this CLeTerm.  # noqa: E501
        :rtype: str
        """
    ...
    def other_value(self, other_value):
        """Sets the other_value of this CLeTerm.

        Other value to compare to see if this<=other</br> Value is expressed as string. The field determines the type and conversion from string. Dates should be in ISO format, e.g.: \"2019-09-18T17:57:43.110Z\". </br> Note: when applied to fields that are sets of values, the query will match if **any** of the values in the set is less-than or equal to the `otherValue`.                # noqa: E501

        :param other_value: The other_value of this CLeTerm.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CLeTerm):
            return False
