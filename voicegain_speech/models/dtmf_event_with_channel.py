...
class DtmfEventWithChannel(object):
    ...
    def __init__(self, dtmf=None, timestamp=None, channel=None, local_vars_configuration=None):  # noqa: E501
        """DtmfEventWithChannel - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def dtmf(self):
        """Gets the dtmf of this DtmfEventWithChannel.  # noqa: E501

        DTMF digit. Note, in the future, outbound DTMF may be recorded as sequences of DTMF digits. Right now, we record only inbound DTMF as single digits.  # noqa: E501

        :return: The dtmf of this DtmfEventWithChannel.  # noqa: E501
        :rtype: str
        """
        return self._dtmf
    ...
    @dtmf.setter
    def dtmf(self, dtmf):
        """Sets the dtmf of this DtmfEventWithChannel.

        DTMF digit. Note, in the future, outbound DTMF may be recorded as sequences of DTMF digits. Right now, we record only inbound DTMF as single digits.  # noqa: E501

        :param dtmf: The dtmf of this DtmfEventWithChannel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this DtmfEventWithChannel.  # noqa: E501

        Time when the DTMF tone was detected in milliseconds since start of recording  # noqa: E501

        :return: The timestamp of this DtmfEventWithChannel.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this DtmfEventWithChannel.

        Time when the DTMF tone was detected in milliseconds since start of recording  # noqa: E501

        :param timestamp: The timestamp of this DtmfEventWithChannel.  # noqa: E501
        :type: int
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this DtmfEventWithChannel.  # noqa: E501

        (optional) Which channel in the audio corresponds to the channel where the DTMF was detected  # noqa: E501

        :return: The channel of this DtmfEventWithChannel.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this DtmfEventWithChannel.

        (optional) Which channel in the audio corresponds to the channel where the DTMF was detected  # noqa: E501

        :param channel: The channel of this DtmfEventWithChannel.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DtmfEventWithChannel):
            return False
