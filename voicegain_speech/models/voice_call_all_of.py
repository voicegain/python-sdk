...
class VoiceCallAllOf(object):
    ...
    def call_resolved(self):
        """Gets the call_resolved of this VoiceCallAllOf.  # noqa: E501
        ...
        :return: The call_resolved of this VoiceCallAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def call_resolved(self, call_resolved):
        """Sets the call_resolved of this VoiceCallAllOf.

        Set to true if Call Review determined that the call successfully resolved/handled the problem/issues of the call.  # noqa: E501

        :param call_resolved: The call_resolved of this VoiceCallAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def cr_answers_id(self):
        """Gets the cr_answers_id of this VoiceCallAllOf.  # noqa: E501

        unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :return: The cr_answers_id of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def cr_answers_id(self, cr_answers_id):
        """Sets the cr_answers_id of this VoiceCallAllOf.

        unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :param cr_answers_id: The cr_answers_id of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def incidents(self):
        ...
        :return: The incidents of this VoiceCallAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def incidents(self, incidents):
        """Sets the incidents of this VoiceCallAllOf.

        Number of silence and overtalk incidents on a call  # noqa: E501

        :param incidents: The incidents of this VoiceCallAllOf.  # noqa: E501
        :type: float
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this VoiceCallAllOf.

        All keywords detected in the call. Complete set of keywords and all details can be retrieved using `saSessionId`   # noqa: E501

        :param keywords: The keywords of this VoiceCallAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    def merged_call_audio(self):
        """Gets the merged_call_audio of this VoiceCallAllOf.  # noqa: E501
        ...
        :return: The merged_call_audio of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def merged_call_audio(self, merged_call_audio):
        """Sets the merged_call_audio of this VoiceCallAllOf.

        Data UUID - reference to the merged call audio in Voicegain Data Store. This comes from the mergedAudio field in Speech Analytics session. If PII redaction was enbabled on the SA session then this audio will be redacted. This field will be absent if Speech Analytics has not been run on the call.   # noqa: E501

        :param merged_call_audio: The merged_call_audio of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
    ...
    def notes(self):
        ...
        :return: The notes of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this VoiceCallAllOf.

        Brief notes about the call. May be submitted to the CRM.</br> Typically, generated using LLM prompt taken from `llmCopilotNotesPrompt` in saConfig   # noqa: E501

        :param notes: The notes of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
    ...
    def review_notes(self):
        """Gets the review_notes of this VoiceCallAllOf.  # noqa: E501

        Notes about the call taken during a review.</br> TODO: make them structured   # noqa: E501

        :return: The review_notes of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def review_notes(self, review_notes):
        """Sets the review_notes of this VoiceCallAllOf.

        Notes about the call taken during a review.</br> TODO: make them structured   # noqa: E501

        :param review_notes: The review_notes of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def score(self):
        """Gets the score of this VoiceCallAllOf.  # noqa: E501

        Call score - computed from Call Review  # noqa: E501

        :return: The score of this VoiceCallAllOf.  # noqa: E501
        :rtype: float
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this VoiceCallAllOf.

        Call score - computed from Call Review  # noqa: E501

        :param score: The score of this VoiceCallAllOf.  # noqa: E501
        :type: float
        """
    ...
    def topics(self, topics):
        """Sets the topics of this VoiceCallAllOf.

        All topics discovered from the call. Complete set of topics and all details can be retrieved using `saSessionId`   # noqa: E501

        :param topics: The topics of this VoiceCallAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    def voicemail_duration(self):
        ...
        :return: The voicemail_duration of this VoiceCallAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def voicemail_duration(self, voicemail_duration):
        """Sets the voicemail_duration of this VoiceCallAllOf.

        Present only if a voicemail was left during the call.</br> Duration of the voicemail in seconds.   # noqa: E501

        :param voicemail_duration: The voicemail_duration of this VoiceCallAllOf.  # noqa: E501
        :type: float
        """
    ...
    def voicemail_transcript(self):
        """Gets the voicemail_transcript of this VoiceCallAllOf.  # noqa: E501

        Present only if a voicemail was left during the call.</br> Transcription of the voicemail.   # noqa: E501

        :return: The voicemail_transcript of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_transcript(self, voicemail_transcript):
        """Sets the voicemail_transcript of this VoiceCallAllOf.

        Present only if a voicemail was left during the call.</br> Transcription of the voicemail.   # noqa: E501

        :param voicemail_transcript: The voicemail_transcript of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
    ...
    def voicemail_uuid(self):
        """Gets the voicemail_uuid of this VoiceCallAllOf.  # noqa: E501
        ...
        :return: The voicemail_uuid of this VoiceCallAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_uuid(self, voicemail_uuid):
        """Sets the voicemail_uuid of this VoiceCallAllOf.

        Present only if a voicemail was left during the call.</br> Reference to the data object with the voicemail recording.  Use /data API to retrieve the voicemail recording.   # noqa: E501

        :param voicemail_uuid: The voicemail_uuid of this VoiceCallAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this VoiceCallAllOf.

        Top 100 words from the transcript with their frequencies. Complete wordcloud can be retrieved using `saSessionId`   # noqa: E501

        :param word_cloud: The word_cloud of this VoiceCallAllOf.  # noqa: E501
