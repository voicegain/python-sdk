...
class VoiceCallAllOf(object):
    ...
    def __init__(self, account_id=None, call_id=None, call_resolved=None, context_id=None, cr_answers_id=None, duration=None, incidents=None, keywords=None, notes=None, review_status=None, sa_session_id=None, score=None, sentiment=None, topics=None, version=1, word_cloud=None, local_vars_configuration=None):  # noqa: E501
