...
class MultipartFormDataField(object):
    ...
    def __init__(self, content_type=None, name=None, value=None, local_vars_configuration=None):  # noqa: E501
        """MultipartFormDataField - a model defined in OpenAPI"""  # noqa: E501
    ...
    def content_type(self):
        """Gets the content_type of this MultipartFormDataField.  # noqa: E501

        (Optional) Content type of the field. If missing then \"text/plain\" is assumed.   # noqa: E501

        :return: The content_type of this MultipartFormDataField.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this MultipartFormDataField.

        (Optional) Content type of the field. If missing then \"text/plain\" is assumed.   # noqa: E501

        :param content_type: The content_type of this MultipartFormDataField.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                content_type is not None and len(content_type) > 32):
            raise ValueError("Invalid value for `content_type`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def name(self):
        """Gets the name of this MultipartFormDataField.  # noqa: E501

        (Required) Name of the field.   # noqa: E501

        :return: The name of this MultipartFormDataField.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MultipartFormDataField.

        (Required) Name of the field.   # noqa: E501

        :param name: The name of this MultipartFormDataField.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def value(self):
        """Gets the value of this MultipartFormDataField.  # noqa: E501

        (Required) Value of the field.   # noqa: E501

        :return: The value of this MultipartFormDataField.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this MultipartFormDataField.

        (Required) Value of the field.   # noqa: E501

        :param value: The value of this MultipartFormDataField.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MultipartFormDataField):
            return False
