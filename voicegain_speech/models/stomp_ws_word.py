...
class StompWsWord(object):
    ...
    def __init__(self, conf=None, gap=None, start=None, utt=None, spk=None, ss_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def ss_id(self):
        """Gets the ss_id of this StompWsWord.  # noqa: E501
        ...
        :return: The ss_id of this StompWsWord.  # noqa: E501
        :rtype: str
        """
        return self._ss_id
    ...
    def ss_id(self, ss_id):
        """Sets the ss_id of this StompWsWord.

        A short string that is relevant only to scenarios where: - there is more than 1 session for transcription - websocket mode is transceiver or predefined   This string is put in the messages to distinguish between results generated from different sessions. Some example values would be: \"left\"/\"right\", \"inbound\"/\"outbound\".             # noqa: E501

        :param ss_id: The ss_id of this StompWsWord.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
