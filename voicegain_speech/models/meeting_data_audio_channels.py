...
class MeetingDataAudioChannels(object):
    ...
    def __init__(self, audio_id=None, audio_zones=None, decibels=None, speakers=None, spks=None, local_vars_configuration=None):  # noqa: E501
        """MeetingDataAudioChannels - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio_id(self):
        """Gets the audio_id of this MeetingDataAudioChannels.  # noqa: E501

        DataObject id of the input audio  # noqa: E501

        :return: The audio_id of this MeetingDataAudioChannels.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_id(self, audio_id):
        """Sets the audio_id of this MeetingDataAudioChannels.

        DataObject id of the input audio  # noqa: E501

        :param audio_id: The audio_id of this MeetingDataAudioChannels.  # noqa: E501
        :type: str
        """
    ...
    def audio_zones(self):
        """Gets the audio_zones of this MeetingDataAudioChannels.  # noqa: E501

        (Available Later in Future Versions) Audio classes and time information for the audio zones   # noqa: E501

        :return: The audio_zones of this MeetingDataAudioChannels.  # noqa: E501
    ...
    def audio_zones(self, audio_zones):
        """Sets the audio_zones of this MeetingDataAudioChannels.

        (Available Later in Future Versions) Audio classes and time information for the audio zones   # noqa: E501

        :param audio_zones: The audio_zones of this MeetingDataAudioChannels.  # noqa: E501
    ...
    @property
    def decibels(self):
        """Gets the decibels of this MeetingDataAudioChannels.  # noqa: E501

        (Available in Future Versions) List of X Y coordinates representing time (X) and decibel value (Y)</br> Samples where signal was zero (dB negative infinity) the Y value is set to **null**   # noqa: E501

        :return: The decibels of this MeetingDataAudioChannels.  # noqa: E501
        :rtype: list[list]
        """
    ...
    def decibels(self, decibels):
        """Sets the decibels of this MeetingDataAudioChannels.

        (Available in Future Versions) List of X Y coordinates representing time (X) and decibel value (Y)</br> Samples where signal was zero (dB negative infinity) the Y value is set to **null**   # noqa: E501

        :param decibels: The decibels of this MeetingDataAudioChannels.  # noqa: E501
        :type: list[list]
        """
    ...
    @property
    def speakers(self):
        """Gets the speakers of this MeetingDataAudioChannels.  # noqa: E501

        External IDs of the speakers in this channel.  Each ID references a value of `speakers[].externalUserId` which can be used to find more information about the speaker.   # noqa: E501

        :return: The speakers of this MeetingDataAudioChannels.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def speakers(self, speakers):
        """Sets the speakers of this MeetingDataAudioChannels.

        External IDs of the speakers in this channel.  Each ID references a value of `speakers[].externalUserId` which can be used to find more information about the speaker.   # noqa: E501

        :param speakers: The speakers of this MeetingDataAudioChannels.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def spks(self):
        """Gets the spks of this MeetingDataAudioChannels.  # noqa: E501

        Internal IDs of the speakers in this channel.  Each ID references a value of `speakers[].spk` which can be used to find more information about the speaker.   # noqa: E501

        :return: The spks of this MeetingDataAudioChannels.  # noqa: E501
        :rtype: list[int]
        """
        return self._spks
    ...
    @spks.setter
    def spks(self, spks):
        """Sets the spks of this MeetingDataAudioChannels.

        Internal IDs of the speakers in this channel.  Each ID references a value of `speakers[].spk` which can be used to find more information about the speaker.   # noqa: E501

        :param spks: The spks of this MeetingDataAudioChannels.  # noqa: E501
        :type: list[int]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingDataAudioChannels):
            return False
