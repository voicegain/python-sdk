...
class PhraseSpotGroup(object):
    ...
    def group_tag(self):
        ...
        Tag used to identify Phrase group  # noqa: E501
    ...
    def phrase_tags(self):
        ...
        Set of phrase tags from this group  # noqa: E501
    ...
    def relation(self):
        ...
        How the match of individual phrases will be interpreted to trigger a match of the group: + any - any listed phrase will trigger group + all - all listed phrases have to be detected + sequence - all listed phrases have to be detected in the call in the given sequence   # noqa: E501
