...
class SpeakerActivity(object):
    ...
    def __init__(self, is_talking=None, spk_user_id=None, time=None, local_vars_configuration=None):  # noqa: E501
        """SpeakerActivity - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def is_talking(self):
        """Gets the is_talking of this SpeakerActivity.  # noqa: E501

        true if the speaker is talking, false if the speaker stopped talking  # noqa: E501

        :return: The is_talking of this SpeakerActivity.  # noqa: E501
        :rtype: bool
        """
        return self._is_talking

    @is_talking.setter
    def is_talking(self, is_talking):
        """Sets the is_talking of this SpeakerActivity.

        true if the speaker is talking, false if the speaker stopped talking  # noqa: E501

        :param is_talking: The is_talking of this SpeakerActivity.  # noqa: E501
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and is_talking is None:  # noqa: E501
            raise ValueError("Invalid value for `is_talking`, must not be `None`")  # noqa: E501

        self._is_talking = is_talking

    @property
    def spk_user_id(self):
        """Gets the spk_user_id of this SpeakerActivity.  # noqa: E501

        id of the speaking user (not the Voicegain User Id). Must map to some value of `speakers[].spkUserId`  # noqa: E501

        :return: The spk_user_id of this SpeakerActivity.  # noqa: E501
        :rtype: float
        """
    ...
    def spk_user_id(self, spk_user_id):
        """Sets the spk_user_id of this SpeakerActivity.

        id of the speaking user (not the Voicegain User Id). Must map to some value of `speakers[].spkUserId`  # noqa: E501

        :param spk_user_id: The spk_user_id of this SpeakerActivity.  # noqa: E501
        :type: float
        """
    ...
    @property
    def time(self):
        """Gets the time of this SpeakerActivity.  # noqa: E501

        time in msec since start of audio recording  # noqa: E501

        :return: The time of this SpeakerActivity.  # noqa: E501
        :rtype: float
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this SpeakerActivity.

        time in msec since start of audio recording  # noqa: E501

        :param time: The time of this SpeakerActivity.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeakerActivity):
            return False
