...
class AIVRAllOf(object):
    ...
    def __init__(self, aivr_apps=None, display_jwt=None, jwt=None, local_vars_configuration=None):  # noqa: E501
        """AIVRAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def aivr_apps(self):
        """Gets the aivr_apps of this AIVRAllOf.  # noqa: E501

        List of AIVR apps that are part of this integration  # noqa: E501

        :return: The aivr_apps of this AIVRAllOf.  # noqa: E501
        :rtype: list[AIVRAllOfAivrApps]
        """
        return self._aivr_apps

    @aivr_apps.setter
    def aivr_apps(self, aivr_apps):
        """Sets the aivr_apps of this AIVRAllOf.

        List of AIVR apps that are part of this integration  # noqa: E501

        :param aivr_apps: The aivr_apps of this AIVRAllOf.  # noqa: E501
        :type: list[AIVRAllOfAivrApps]
        """
    ...
    def display_jwt(self):
        """Gets the display_jwt of this AIVRAllOf.  # noqa: E501

        Masked-out JWT that is to be used for display purposes in the Web UI.   # noqa: E501

        :return: The display_jwt of this AIVRAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def display_jwt(self, display_jwt):
        """Sets the display_jwt of this AIVRAllOf.

        Masked-out JWT that is to be used for display purposes in the Web UI.   # noqa: E501

        :param display_jwt: The display_jwt of this AIVRAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def jwt(self):
        """Gets the jwt of this AIVRAllOf.  # noqa: E501

        JWT token that will be used to configure the Integration in the selected AIVR Apps in the Developer environment.</br> JWT token contains Account and Context, so these values do not have to be separately specified. This also means that AIVR integration can only tie one Developer Context to one Speech Analytics Project (context). However, multiple AIVR apps from the same Developer context can be part of that integration.   # noqa: E501

        :return: The jwt of this AIVRAllOf.  # noqa: E501
        :rtype: str
        """
        return self._jwt
    ...
    @jwt.setter
    def jwt(self, jwt):
        """Sets the jwt of this AIVRAllOf.

        JWT token that will be used to configure the Integration in the selected AIVR Apps in the Developer environment.</br> JWT token contains Account and Context, so these values do not have to be separately specified. This also means that AIVR integration can only tie one Developer Context to one Speech Analytics Project (context). However, multiple AIVR apps from the same Developer context can be part of that integration.   # noqa: E501

        :param jwt: The jwt of this AIVRAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRAllOf):
            return False
