...
class StreamSetup(object):
    ...
    attribute_map = {
        ...
        'no_audio_timeout': 'noAudioTimeout',
        'protocol': 'protocol'
    }

    def __init__(self, auth_conf=None, control_websocket=None, no_audio_timeout=30000, protocol=None, local_vars_configuration=None):  # noqa: E501
        ...
        if no_audio_timeout is not None:
            self.no_audio_timeout = no_audio_timeout
    ...
    @property
    def no_audio_timeout(self):
        """Gets the no_audio_timeout of this StreamSetup.  # noqa: E501

        Timeout in milliseconds after which the session will be closed if no audio is received. This timeout applies before the first audio packet is received and also to the gaps between audio packets. This meains that if there is a gap of more than `noAudioTimeout` milliseconds between two audio packets, the session will be closed.</br> Default is 30 seconds, and maximum allowed is 30 minutes.</br> Note, the billing charges apply even if no audio is being streamed in real-time mode. You will be billed for max(session time, audio time).   # noqa: E501

        :return: The no_audio_timeout of this StreamSetup.  # noqa: E501
        :rtype: int
        """
        return self._no_audio_timeout

    @no_audio_timeout.setter
    def no_audio_timeout(self, no_audio_timeout):
        """Sets the no_audio_timeout of this StreamSetup.

        Timeout in milliseconds after which the session will be closed if no audio is received. This timeout applies before the first audio packet is received and also to the gaps between audio packets. This meains that if there is a gap of more than `noAudioTimeout` milliseconds between two audio packets, the session will be closed.</br> Default is 30 seconds, and maximum allowed is 30 minutes.</br> Note, the billing charges apply even if no audio is being streamed in real-time mode. You will be billed for max(session time, audio time).   # noqa: E501

        :param no_audio_timeout: The no_audio_timeout of this StreamSetup.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                no_audio_timeout is not None and no_audio_timeout > 1800000):  # noqa: E501
            raise ValueError("Invalid value for `no_audio_timeout`, must be a value less than or equal to `1800000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                no_audio_timeout is not None and no_audio_timeout < 5000):  # noqa: E501
            raise ValueError("Invalid value for `no_audio_timeout`, must be a value greater than or equal to `5000`")  # noqa: E501

        self._no_audio_timeout = no_audio_timeout
