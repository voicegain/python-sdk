...
class OfflineSASpeakerResult(object):
    ...
    openapi_types = {
        ...
        'spk': 'int',
        'user_id': 'str',
        'emotion': 'OfflineSpeechAnalyticsEmotionData',
        'estimated_age': 'str',
    ...
    def __init__(self, external_user_id=None, from_diarization=None, is_agent=None, metadata=None, name=None, speaker_id=None, spk=None, user_id=None, emotion=None, estimated_age=None, estimated_gender=None, overtalk=None, talk=None, local_vars_configuration=None):  # noqa: E501
        ...
        if from_diarization is not None:
        ...
        if estimated_gender is not None:
            self.estimated_gender = estimated_gender
    ...
    def external_user_id(self):
        """Gets the external_user_id of this OfflineSASpeakerResult.  # noqa: E501

        (optional) External id of the speaking user. Corresponds to `speakers[].skpUserId` in POST /sa/offline   # noqa: E501

        :return: The external_user_id of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: float
        """
    ...
    def external_user_id(self, external_user_id):
        """Sets the external_user_id of this OfflineSASpeakerResult.

        (optional) External id of the speaking user. Corresponds to `speakers[].skpUserId` in POST /sa/offline   # noqa: E501

        :param external_user_id: The external_user_id of this OfflineSASpeakerResult.  # noqa: E501
        :type: float
        """
    ...
    @property
    def from_diarization(self):
        """Gets the from_diarization of this OfflineSASpeakerResult.  # noqa: E501

        (optional) True if the speaker was output from diarization.   # noqa: E501

        :return: The from_diarization of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: bool
        """
        return self._from_diarization

    @from_diarization.setter
    def from_diarization(self, from_diarization):
        """Sets the from_diarization of this OfflineSASpeakerResult.

        (optional) True if the speaker was output from diarization.   # noqa: E501

        :param from_diarization: The from_diarization of this OfflineSASpeakerResult.  # noqa: E501
        :type: bool
        """

        self._from_diarization = from_diarization

    @property
    def is_agent(self):
        """Gets the is_agent of this OfflineSASpeakerResult.  # noqa: E501

        (optional) True if the speaker is a Call Center Agent   # noqa: E501

        :return: The is_agent of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_agent(self, is_agent):
        """Sets the is_agent of this OfflineSASpeakerResult.

        (optional) True if the speaker is a Call Center Agent   # noqa: E501

        :param is_agent: The is_agent of this OfflineSASpeakerResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this OfflineSASpeakerResult.  # noqa: E501

        (optional) Name of the speaker. May be modified using PUT /sa/offline/{saSessionId}/spk    # noqa: E501

        :return: The name of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OfflineSASpeakerResult.

        (optional) Name of the speaker. May be modified using PUT /sa/offline/{saSessionId}/spk    # noqa: E501

        :param name: The name of this OfflineSASpeakerResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def speaker_id(self):
        """Gets the speaker_id of this OfflineSASpeakerResult.  # noqa: E501

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI.   # noqa: E501

        :return: The speaker_id of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: str
        """
    ...
    def speaker_id(self, speaker_id):
        """Sets the speaker_id of this OfflineSASpeakerResult.

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI.   # noqa: E501

        :param speaker_id: The speaker_id of this OfflineSASpeakerResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                speaker_id is not None and len(speaker_id) > 48):
            raise ValueError("Invalid value for `speaker_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                speaker_id is not None and len(speaker_id) < 16):
            raise ValueError("Invalid value for `speaker_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._speaker_id = speaker_id

    @property
    def spk(self):
        """Gets the spk of this OfflineSASpeakerResult.  # noqa: E501

        Speaker id that will be used in `words` output (associates each word with a speaker)</br> Range from 1 to 99 corresponds to speakers that were provided in the POST /sa/offline requests in the `speakers` array. (It is the index into that array, with first element having index 1.)</br> Range 100 and above corresponds to Speakers not identified up-font  (either single speaker per audio or diarized speaker).</br>   `floor( spk / 100 )` will identify the input audio file.</br> `spk modulo 100` will be speaker id within single audio file</br>   # noqa: E501

        :return: The spk of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this OfflineSASpeakerResult.

        Speaker id that will be used in `words` output (associates each word with a speaker)</br> Range from 1 to 99 corresponds to speakers that were provided in the POST /sa/offline requests in the `speakers` array. (It is the index into that array, with first element having index 1.)</br> Range 100 and above corresponds to Speakers not identified up-font  (either single speaker per audio or diarized speaker).</br>   `floor( spk / 100 )` will identify the input audio file.</br> `spk modulo 100` will be speaker id within single audio file</br>   # noqa: E501

        :param spk: The spk of this OfflineSASpeakerResult.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                spk is not None and spk > 2099):  # noqa: E501
            raise ValueError("Invalid value for `spk`, must be a value less than or equal to `2099`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def user_id(self):
        """Gets the user_id of this OfflineSASpeakerResult.  # noqa: E501

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature).</br> Set initially from `speakers[].userId` provided in the [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost) request, or assigned/changed later via [PUT /sa/offline/{saSessionId}/spk](#tag/sa-offline/operation/saOfflineSpkPut).</br> For diarized speakers (no input speaker upfront), `userId` will be absent unless set later via PUT spk.   # noqa: E501

        :return: The user_id of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this OfflineSASpeakerResult.

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature).</br> Set initially from `speakers[].userId` provided in the [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost) request, or assigned/changed later via [PUT /sa/offline/{saSessionId}/spk](#tag/sa-offline/operation/saOfflineSpkPut).</br> For diarized speakers (no input speaker upfront), `userId` will be absent unless set later via PUT spk.   # noqa: E501

        :param user_id: The user_id of this OfflineSASpeakerResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                user_id is not None and len(user_id) > 48):
            raise ValueError("Invalid value for `user_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                user_id is not None and len(user_id) < 16):
            raise ValueError("Invalid value for `user_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._user_id = user_id

    @property
    def emotion(self):
        """Gets the emotion of this OfflineSASpeakerResult.  # noqa: E501


        :return: The emotion of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: OfflineSpeechAnalyticsEmotionData
        """
        return self._emotion

    @emotion.setter
    def emotion(self, emotion):
        """Sets the emotion of this OfflineSASpeakerResult.


        :param emotion: The emotion of this OfflineSASpeakerResult.  # noqa: E501
        :type: OfflineSpeechAnalyticsEmotionData
        """
    ...
    def estimated_age(self):
        """Gets the estimated_age of this OfflineSASpeakerResult.  # noqa: E501
        ...
        :return: The estimated_age of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: str
        """
    ...
    def estimated_age(self, estimated_age):
        """Sets the estimated_age of this OfflineSASpeakerResult.

        (Future Functionality) Most likely speaker age category based on the voice characteristics.</br> Possible age categories that will be identified are: + young-adult - up to about 30-35 years old + senior - over about 60-65 years old + unknown - it is impossible to determine age category based on voice alone         # noqa: E501

        :param estimated_age: The estimated_age of this OfflineSASpeakerResult.  # noqa: E501
        :type: str
        """
        allowed_values = ["young-adult", "senior", "unknown"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and estimated_age not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `estimated_age` ({0}), must be one of {1}"  # noqa: E501
                .format(estimated_age, allowed_values)
            )
    ...
    def estimated_gender(self):
        """Gets the estimated_gender of this OfflineSASpeakerResult.  # noqa: E501
        ...
        :return: The estimated_gender of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: str
        """
        return self._estimated_gender

    @estimated_gender.setter
    def estimated_gender(self, estimated_gender):
        """Sets the estimated_gender of this OfflineSASpeakerResult.

        (optional) Most likely speaker gender based on the voice characteristics.</br> Capable of recognizing only two genders: male and female.   # noqa: E501

        :param estimated_gender: The estimated_gender of this OfflineSASpeakerResult.  # noqa: E501
        :type: str
        """
        allowed_values = ["male", "female"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and estimated_gender not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `estimated_gender` ({0}), must be one of {1}"  # noqa: E501
                .format(estimated_gender, allowed_values)
            )

        self._estimated_gender = estimated_gender

    @property
    def overtalk(self):
        """Gets the overtalk of this OfflineSASpeakerResult.  # noqa: E501


        :return: The overtalk of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: Overtalk
        """
    ...
    def overtalk(self, overtalk):
        """Sets the overtalk of this OfflineSASpeakerResult.


        :param overtalk: The overtalk of this OfflineSASpeakerResult.  # noqa: E501
        :type: Overtalk
        """
    ...
    @property
    def talk(self):
        """Gets the talk of this OfflineSASpeakerResult.  # noqa: E501


        :return: The talk of this OfflineSASpeakerResult.  # noqa: E501
        :rtype: TalkTime
        """
        return self._talk
    ...
    @talk.setter
    def talk(self, talk):
        """Sets the talk of this OfflineSASpeakerResult.


        :param talk: The talk of this OfflineSASpeakerResult.  # noqa: E501
        :type: TalkTime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineSASpeakerResult):
            return False
