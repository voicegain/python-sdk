...
class CallAnalyticsBase(object):
    ...
    def __init__(self, call_resolved=None, ci_answers_id=None, cr_answers_id=None, incidents=None, keywords=None, notes=None, review_notes=None, score=None, sentiments=None, topics=None, voicemail_duration=None, voicemail_transcript=None, voicemail_uuid=None, word_cloud=None, local_vars_configuration=None):  # noqa: E501
        """CallAnalyticsBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    def call_resolved(self):
        """Gets the call_resolved of this CallAnalyticsBase.  # noqa: E501

        Set to true if Call Review determined that the call/segment successfully resolved/handled the problem/issues  # noqa: E501

        :return: The call_resolved of this CallAnalyticsBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def call_resolved(self, call_resolved):
        """Sets the call_resolved of this CallAnalyticsBase.

        Set to true if Call Review determined that the call/segment successfully resolved/handled the problem/issues  # noqa: E501

        :param call_resolved: The call_resolved of this CallAnalyticsBase.  # noqa: E501
        :type: bool
        """
    ...
    def ci_answers_id(self):
        """Gets the ci_answers_id of this CallAnalyticsBase.  # noqa: E501

        Unique id referencing the call insights answers - these are initially populated by speech analytics  # noqa: E501

        :return: The ci_answers_id of this CallAnalyticsBase.  # noqa: E501
        :rtype: str
        """
    ...
    def ci_answers_id(self, ci_answers_id):
        """Sets the ci_answers_id of this CallAnalyticsBase.

        Unique id referencing the call insights answers - these are initially populated by speech analytics  # noqa: E501

        :param ci_answers_id: The ci_answers_id of this CallAnalyticsBase.  # noqa: E501
        :type: str
        """
    ...
    def cr_answers_id(self):
        """Gets the cr_answers_id of this CallAnalyticsBase.  # noqa: E501

        Unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :return: The cr_answers_id of this CallAnalyticsBase.  # noqa: E501
        :rtype: str
        """
    ...
    def cr_answers_id(self, cr_answers_id):
        """Sets the cr_answers_id of this CallAnalyticsBase.

        Unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :param cr_answers_id: The cr_answers_id of this CallAnalyticsBase.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def incidents(self):
        """Gets the incidents of this CallAnalyticsBase.  # noqa: E501

        Number of silence and overtalk incidents  # noqa: E501

        :return: The incidents of this CallAnalyticsBase.  # noqa: E501
        :rtype: int
        """
    ...
    def incidents(self, incidents):
        """Sets the incidents of this CallAnalyticsBase.

        Number of silence and overtalk incidents  # noqa: E501

        :param incidents: The incidents of this CallAnalyticsBase.  # noqa: E501
        :type: int
        """
    ...
    @property
    def keywords(self):
        """Gets the keywords of this CallAnalyticsBase.  # noqa: E501

        All keywords detected  # noqa: E501

        :return: The keywords of this CallAnalyticsBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this CallAnalyticsBase.

        All keywords detected  # noqa: E501

        :param keywords: The keywords of this CallAnalyticsBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def review_notes(self):
        """Gets the review_notes of this CallAnalyticsBase.  # noqa: E501

        Notes taken during review  # noqa: E501

        :return: The review_notes of this CallAnalyticsBase.  # noqa: E501
        :rtype: str
        """
    ...
    def review_notes(self, review_notes):
        """Sets the review_notes of this CallAnalyticsBase.

        Notes taken during review  # noqa: E501

        :param review_notes: The review_notes of this CallAnalyticsBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def score(self):
        """Gets the score of this CallAnalyticsBase.  # noqa: E501

        Score computed from Call Review  # noqa: E501

        :return: The score of this CallAnalyticsBase.  # noqa: E501
        :rtype: float
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this CallAnalyticsBase.

        Score computed from Call Review  # noqa: E501

        :param score: The score of this CallAnalyticsBase.  # noqa: E501
        :type: float
        """
    ...
    @property
    def sentiments(self):
        """Gets the sentiments of this CallAnalyticsBase.  # noqa: E501

        Sentiment values for speakers. Only one value for each speaker type is present.  # noqa: E501

        :return: The sentiments of this CallAnalyticsBase.  # noqa: E501
    ...
    def sentiments(self, sentiments):
        """Sets the sentiments of this CallAnalyticsBase.

        Sentiment values for speakers. Only one value for each speaker type is present.  # noqa: E501

        :param sentiments: The sentiments of this CallAnalyticsBase.  # noqa: E501
    ...
    @property
    def topics(self):
        """Gets the topics of this CallAnalyticsBase.  # noqa: E501

        All topics discovered  # noqa: E501

        :return: The topics of this CallAnalyticsBase.  # noqa: E501
        :rtype: list[str]
        """
        return self._topics
    ...
    def topics(self, topics):
        """Sets the topics of this CallAnalyticsBase.

        All topics discovered  # noqa: E501

        :param topics: The topics of this CallAnalyticsBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def voicemail_duration(self):
        """Gets the voicemail_duration of this CallAnalyticsBase.  # noqa: E501

        Present only if a voicemail was left.</br> Duration of the voicemail in seconds.   # noqa: E501

        :return: The voicemail_duration of this CallAnalyticsBase.  # noqa: E501
        :rtype: float
        """
    ...
    def voicemail_duration(self, voicemail_duration):
        """Sets the voicemail_duration of this CallAnalyticsBase.

        Present only if a voicemail was left.</br> Duration of the voicemail in seconds.   # noqa: E501

        :param voicemail_duration: The voicemail_duration of this CallAnalyticsBase.  # noqa: E501
        :type: float
        """
    ...
    def voicemail_transcript(self):
        """Gets the voicemail_transcript of this CallAnalyticsBase.  # noqa: E501

        Present only if a voicemail was left.</br> Transcription of the voicemail.   # noqa: E501

        :return: The voicemail_transcript of this CallAnalyticsBase.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_transcript(self, voicemail_transcript):
        """Sets the voicemail_transcript of this CallAnalyticsBase.

        Present only if a voicemail was left.</br> Transcription of the voicemail.   # noqa: E501

        :param voicemail_transcript: The voicemail_transcript of this CallAnalyticsBase.  # noqa: E501
        :type: str
        """
    ...
    def voicemail_uuid(self):
        """Gets the voicemail_uuid of this CallAnalyticsBase.  # noqa: E501
        ...
        :return: The voicemail_uuid of this CallAnalyticsBase.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_uuid(self, voicemail_uuid):
        """Sets the voicemail_uuid of this CallAnalyticsBase.

        Present only if a voicemail was left.</br> Reference to the data object with the voicemail recording. Use /data API to retrieve the voicemail recording.   # noqa: E501

        :param voicemail_uuid: The voicemail_uuid of this CallAnalyticsBase.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def word_cloud(self):
        """Gets the word_cloud of this CallAnalyticsBase.  # noqa: E501

        Top words from the transcript with their frequencies  # noqa: E501

        :return: The word_cloud of this CallAnalyticsBase.  # noqa: E501
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this CallAnalyticsBase.

        Top words from the transcript with their frequencies  # noqa: E501

        :param word_cloud: The word_cloud of this CallAnalyticsBase.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallAnalyticsBase):
            return False
