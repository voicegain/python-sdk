...
class SegmentAnalyticsConfig(object):
    ...
    def __init__(self, call_review_config=None, insights_config=None, sa_config=None, segment_type=None, local_vars_configuration=None):  # noqa: E501
        """SegmentAnalyticsConfig - a model defined in OpenAPI"""  # noqa: E501
    ...
    def call_review_config(self):
        """Gets the call_review_config of this SegmentAnalyticsConfig.  # noqa: E501

        (optional) id of the Call Review configuration to use for this segment type.</br> If not provided, the `callReviewConfig` from the main request body will be used.   # noqa: E501

        :return: The call_review_config of this SegmentAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def call_review_config(self, call_review_config):
        """Sets the call_review_config of this SegmentAnalyticsConfig.

        (optional) id of the Call Review configuration to use for this segment type.</br> If not provided, the `callReviewConfig` from the main request body will be used.   # noqa: E501

        :param call_review_config: The call_review_config of this SegmentAnalyticsConfig.  # noqa: E501
        :type: str
        """
    ...
    def insights_config(self):
        """Gets the insights_config of this SegmentAnalyticsConfig.  # noqa: E501

        (optional) id of the Call Insights configuration to use for this segment type.</br> If not provided, the `insightsConfig` from the main request body will be used.   # noqa: E501

        :return: The insights_config of this SegmentAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def insights_config(self, insights_config):
        """Sets the insights_config of this SegmentAnalyticsConfig.

        (optional) id of the Call Insights configuration to use for this segment type.</br> If not provided, the `insightsConfig` from the main request body will be used.   # noqa: E501

        :param insights_config: The insights_config of this SegmentAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def sa_config(self):
        """Gets the sa_config of this SegmentAnalyticsConfig.  # noqa: E501

        (optional) id of the Speech Analytics configuration to use for this segment type.</br> If not provided, the `saConfig` from the main request body will be used.   # noqa: E501

        :return: The sa_config of this SegmentAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_config(self, sa_config):
        """Sets the sa_config of this SegmentAnalyticsConfig.

        (optional) id of the Speech Analytics configuration to use for this segment type.</br> If not provided, the `saConfig` from the main request body will be used.   # noqa: E501

        :param sa_config: The sa_config of this SegmentAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def segment_type(self):
        """Gets the segment_type of this SegmentAnalyticsConfig.  # noqa: E501


        :return: The segment_type of this SegmentAnalyticsConfig.  # noqa: E501
        :rtype: SegmentType
        """
    ...
    def segment_type(self, segment_type):
        """Sets the segment_type of this SegmentAnalyticsConfig.


        :param segment_type: The segment_type of this SegmentAnalyticsConfig.  # noqa: E501
        :type: SegmentType
        """
        if self.local_vars_configuration.client_side_validation and segment_type is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SegmentAnalyticsConfig):
            return False
