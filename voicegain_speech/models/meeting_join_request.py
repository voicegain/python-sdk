...
class MeetingJoinRequest(object):
    ...
    @property
    def creator(self):
        """Gets the creator of this MeetingJoinRequest.  # noqa: E501
        ...
        :return: The creator of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this MeetingJoinRequest.

        (optional) Id of the user who starts this Meeting session. If invoked from Web UI then we will use identity of the logged-in user.             # noqa: E501

        :param creator: The creator of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
    ...
    def meeting_code(self):
        """Gets the meeting_code of this MeetingJoinRequest.  # noqa: E501

        Meeting code.   # noqa: E501

        :return: The meeting_code of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def meeting_code(self, meeting_code):
        """Sets the meeting_code of this MeetingJoinRequest.

        Meeting code.   # noqa: E501

        :param meeting_code: The meeting_code of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
    ...
    def meeting_password(self):
        """Gets the meeting_password of this MeetingJoinRequest.  # noqa: E501

        Meeting password - provide if the meeting requires a password.   # noqa: E501

        :return: The meeting_password of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def meeting_password(self, meeting_password):
        """Sets the meeting_password of this MeetingJoinRequest.

        Meeting password - provide if the meeting requires a password.   # noqa: E501

        :param meeting_password: The meeting_password of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
    ...
    def meeting_platform(self):
        """Gets the meeting_platform of this MeetingJoinRequest.  # noqa: E501

        Meeting platform. NOTE: Currently, only MS Teams meetings are supported.</br> If `debug` is used then no meeting will be joined, but the **/asr/meeting** session will be created. This is meant for debug/test purposes only.   # noqa: E501

        :return: The meeting_platform of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
        return self._meeting_platform

    @meeting_platform.setter
    def meeting_platform(self, meeting_platform):
        """Sets the meeting_platform of this MeetingJoinRequest.

        Meeting platform. NOTE: Currently, only MS Teams meetings are supported.</br> If `debug` is used then no meeting will be joined, but the **/asr/meeting** session will be created. This is meant for debug/test purposes only.   # noqa: E501

        :param meeting_platform: The meeting_platform of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["zoom", "ms-teams", "webex", "google-meet", "debug"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and meeting_platform not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `meeting_platform` ({0}), must be one of {1}"  # noqa: E501
                .format(meeting_platform, allowed_values)
            )

        self._meeting_platform = meeting_platform

    @property
    def meeting_url(self):
        """Gets the meeting_url of this MeetingJoinRequest.  # noqa: E501

        URL that can be used to join the meeting online.  Must contain password if meeting requires password.</br> If the meeting platform allows for it (e.g. Zoom) then instead of a URL you can provide meeting code and password as separate fields.   # noqa: E501

        :return: The meeting_url of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
        return self._meeting_url

    @meeting_url.setter
    def meeting_url(self, meeting_url):
        """Sets the meeting_url of this MeetingJoinRequest.

        URL that can be used to join the meeting online.  Must contain password if meeting requires password.</br> If the meeting platform allows for it (e.g. Zoom) then instead of a URL you can provide meeting code and password as separate fields.   # noqa: E501

        :param meeting_url: The meeting_url of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this MeetingJoinRequest.  # noqa: E501
        ...
        :return: The metadata of this MeetingJoinRequest.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this MeetingJoinRequest.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this MeetingJoinRequest.  # noqa: E501
    ...
    def participant_name(self):
        """Gets the participant_name of this MeetingJoinRequest.  # noqa: E501

        Name of the participant joining the meeting (if the meeting platform requires it).  # noqa: E501

        :return: The participant_name of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def participant_name(self, participant_name):
        """Sets the participant_name of this MeetingJoinRequest.

        Name of the participant joining the meeting (if the meeting platform requires it).  # noqa: E501

        :param participant_name: The participant_name of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                participant_name is not None and len(participant_name) > 64):
            raise ValueError("Invalid value for `participant_name`, length must be less than or equal to `64`")  # noqa: E501

        self._participant_name = participant_name

    @property
    def persist_seconds(self):
        """Gets the persist_seconds of this MeetingJoinRequest.  # noqa: E501
        ...
        :return: The persist_seconds of this MeetingJoinRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def persist_seconds(self, persist_seconds):
        """Sets the persist_seconds of this MeetingJoinRequest.

        Time (in seconds) to retain the result/outcome data after processing has completed. For Cloud, maximum persistence is 31 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.         # noqa: E501

        :param persist_seconds: The persist_seconds of this MeetingJoinRequest.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def sa_config(self):
        """Gets the sa_config of this MeetingJoinRequest.  # noqa: E501
        ...
        :return: The sa_config of this MeetingJoinRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_config(self, sa_config):
        """Sets the sa_config of this MeetingJoinRequest.

        id of the Speech Analytics configuration to use. If not provided then default SA Config for the context will be used.             # noqa: E501

        :param sa_config: The sa_config of this MeetingJoinRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def settings(self):
        """Gets the settings of this MeetingJoinRequest.  # noqa: E501


        :return: The settings of this MeetingJoinRequest.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this MeetingJoinRequest.


        :param settings: The settings of this MeetingJoinRequest.  # noqa: E501
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this MeetingJoinRequest.

        Tags associated with the Meeting Transcription session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :param tags: The tags of this MeetingJoinRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def voice_signature_speakers(self):
        """Gets the voice_signature_speakers of this MeetingJoinRequest.  # noqa: E501

        Optional list of Speakers with voice signatures to be used in processing this meeting.  # noqa: E501

        :return: The voice_signature_speakers of this MeetingJoinRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def voice_signature_speakers(self, voice_signature_speakers):
        """Sets the voice_signature_speakers of this MeetingJoinRequest.

        Optional list of Speakers with voice signatures to be used in processing this meeting.  # noqa: E501

        :param voice_signature_speakers: The voice_signature_speakers of this MeetingJoinRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingJoinRequest):
            return False
