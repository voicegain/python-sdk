...
class AsrProcessingStatusAdditional(object):
    ...
    allowable_values = [INPROGRESS, INPUT_STARTED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsrProcessingStatusAdditional - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrProcessingStatusAdditional):
            return False
