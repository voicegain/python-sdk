...
class AIVRLogic(object):
    ...
    openapi_types = {
        'callback_url': 'str',
        'callback_urls': 'list[NamedCallbackUrl]',
    ...
    def __init__(self, callback_url=None, callback_urls=None, media=None, type=None, user_app_data=None, local_vars_configuration=None):  # noqa: E501
    ...
    def callback_urls(self):
        """Gets the callback_urls of this AIVRLogic.  # noqa: E501

        List of named callback URLs.  The AIVR will randomly select one of the URLs to call using the provided probabilities. If probabilities do not add up to 1.0 then they will be normalized.   # noqa: E501

        :return: The callback_urls of this AIVRLogic.  # noqa: E501
        :rtype: list[NamedCallbackUrl]
        """
        return self._callback_urls

    @callback_urls.setter
    def callback_urls(self, callback_urls):
        """Sets the callback_urls of this AIVRLogic.

        List of named callback URLs.  The AIVR will randomly select one of the URLs to call using the provided probabilities. If probabilities do not add up to 1.0 then they will be normalized.   # noqa: E501

        :param callback_urls: The callback_urls of this AIVRLogic.  # noqa: E501
        :type: list[NamedCallbackUrl]
        """
