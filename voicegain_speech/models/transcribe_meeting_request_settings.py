...
class TranscribeMeetingRequestSettings(object):
    ...
    """
    openapi_types = {
        'asr': 'AsrSettingsMeetingTranscription',
    ...
    def __init__(self, asr=None, compliance=None, formatters=None, local_vars_configuration=None):  # noqa: E501
        """TranscribeMeetingRequestSettings - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def asr(self):
        """Gets the asr of this TranscribeMeetingRequestSettings.  # noqa: E501


        :return: The asr of this TranscribeMeetingRequestSettings.  # noqa: E501
        :rtype: AsrSettingsMeetingTranscription
        """
        return self._asr

    @asr.setter
    def asr(self, asr):
        """Sets the asr of this TranscribeMeetingRequestSettings.


        :param asr: The asr of this TranscribeMeetingRequestSettings.  # noqa: E501
        :type: AsrSettingsMeetingTranscription
        """
    ...
    @property
    def compliance(self):
        """Gets the compliance of this TranscribeMeetingRequestSettings.  # noqa: E501


        :return: The compliance of this TranscribeMeetingRequestSettings.  # noqa: E501
    ...
    def compliance(self, compliance):
        """Sets the compliance of this TranscribeMeetingRequestSettings.


        :param compliance: The compliance of this TranscribeMeetingRequestSettings.  # noqa: E501
    ...
    @property
    def formatters(self):
        """Gets the formatters of this TranscribeMeetingRequestSettings.  # noqa: E501

        (optional) Configuration for text formatters.  Currently 6 types of formatters are available: + **basic** punctuation/capitalization formatter, + **enhanced** formatter (email, url, etc.) + **digits** formatter (incl. currency), + **profanity** masking formatter, + English US/GB **spelling** enforcer, + **redact** (PII redaction for CC, SSN, etc.)  + **regex** (redaction using regex expressions)         </br>  More types of formatters with various options will be added in the future.</br> Some formatters, like e.g. \"basic\" are **default formatters**, which means that they can be considered as always included with their default parameter values. You need to explicitly specify them only if you need to override the default parameters or provide parameters which do nor have defaults. For example, to disable punctuation/capitalization you can provide  ``` [{\"type\" : \"basic\", \"parameters\" : {\"enabled\" : \"false\"}}] ``` Notice that all parameters values must be strings.</br> Enhanced formatter implies basic formatter turned on. Attempt to enable enhanced and disable basic will result in an error.   # noqa: E501

        :return: The formatters of this TranscribeMeetingRequestSettings.  # noqa: E501
    ...
    def formatters(self, formatters):
        """Sets the formatters of this TranscribeMeetingRequestSettings.

        (optional) Configuration for text formatters.  Currently 6 types of formatters are available: + **basic** punctuation/capitalization formatter, + **enhanced** formatter (email, url, etc.) + **digits** formatter (incl. currency), + **profanity** masking formatter, + English US/GB **spelling** enforcer, + **redact** (PII redaction for CC, SSN, etc.)  + **regex** (redaction using regex expressions)         </br>  More types of formatters with various options will be added in the future.</br> Some formatters, like e.g. \"basic\" are **default formatters**, which means that they can be considered as always included with their default parameter values. You need to explicitly specify them only if you need to override the default parameters or provide parameters which do nor have defaults. For example, to disable punctuation/capitalization you can provide  ``` [{\"type\" : \"basic\", \"parameters\" : {\"enabled\" : \"false\"}}] ``` Notice that all parameters values must be strings.</br> Enhanced formatter implies basic formatter turned on. Attempt to enable enhanced and disable basic will result in an error.   # noqa: E501

        :param formatters: The formatters of this TranscribeMeetingRequestSettings.  # noqa: E501
        :type: list[Formatter]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TranscribeMeetingRequestSettings):
            return False
