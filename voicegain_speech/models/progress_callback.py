...
class ProgressCallback(object):
    ...
    @property
    def code(self):
        """Gets the code of this ProgressCallback.  # noqa: E501

        HTTP code that was received as result of submitting the results to callback  # noqa: E501

        :return: The code of this ProgressCallback.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ProgressCallback.

        HTTP code that was received as result of submitting the results to callback  # noqa: E501

        :param code: The code of this ProgressCallback.  # noqa: E501
        :type: int
        """
    ...
    @property
    def url(self):
        """Gets the url of this ProgressCallback.  # noqa: E501

        actual url to which the callback was made  # noqa: E501

        :return: The url of this ProgressCallback.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ProgressCallback.

        actual url to which the callback was made  # noqa: E501

        :param url: The url of this ProgressCallback.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProgressCallback):
            return False
