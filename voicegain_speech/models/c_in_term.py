...
class CInTerm(object):
    ...
    def __init__(self, field=None, key=None, options=None, other_values=None, local_vars_configuration=None):  # noqa: E501
        """CInTerm - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def field(self):
        """Gets the field of this CInTerm.  # noqa: E501


        :return: The field of this CInTerm.  # noqa: E501
        :rtype: CallField
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this CInTerm.


        :param field: The field of this CInTerm.  # noqa: E501
        :type: CallField
        """
    ...
    @property
    def key(self):
        """Gets the key of this CInTerm.  # noqa: E501
        ...
        :return: The key of this CInTerm.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this CInTerm.

        (optional) Applicable only if the field is of type **map**. If present, specifies value of which key should be matched in the query. If the field is of type **map** and the key is missing then the field will be treated ss if it was a set of values of the map.   # noqa: E501

        :param key: The key of this CInTerm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def options(self):
        """Gets the options of this CInTerm.  # noqa: E501

        + case-insensitive - if present, the query will be case-insensitive + key-match - (applicable only if the field is of type **map**) if present, the query will match if the **key** matches the `otherValue` (instead of the value). If `key` is missing and `options` contains `key-match` then the query will match if any of the keys in the map matches the `otherValue`.   # noqa: E501

        :return: The options of this CInTerm.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def options(self, options):
        """Sets the options of this CInTerm.

        + case-insensitive - if present, the query will be case-insensitive + key-match - (applicable only if the field is of type **map**) if present, the query will match if the **key** matches the `otherValue` (instead of the value). If `key` is missing and `options` contains `key-match` then the query will match if any of the keys in the map matches the `otherValue`.   # noqa: E501

        :param options: The options of this CInTerm.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["case-insensitive", "key-match"]  # noqa: E501
    ...
    def other_values(self):
        """Gets the other_values of this CInTerm.  # noqa: E501

        List of other values to match. `this` needs to match just one of the `otherValues`</br> Values are expressed as string. The field determines the type and conversion from string. Dates should be in ISO format, e.g.: \"2019-09-18T17:57:43.110Z\". </br> Note: when applied to fields that are sets of values, the query will match if **any** of the values in the set is equal to any of the `otherValue`.                # noqa: E501

        :return: The other_values of this CInTerm.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def other_values(self, other_values):
        """Sets the other_values of this CInTerm.

        List of other values to match. `this` needs to match just one of the `otherValues`</br> Values are expressed as string. The field determines the type and conversion from string. Dates should be in ISO format, e.g.: \"2019-09-18T17:57:43.110Z\". </br> Note: when applied to fields that are sets of values, the query will match if **any** of the values in the set is equal to any of the `otherValue`.                # noqa: E501

        :param other_values: The other_values of this CInTerm.  # noqa: E501
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and other_values is None:  # noqa: E501
            raise ValueError("Invalid value for `other_values`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CInTerm):
            return False
