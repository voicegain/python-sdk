...
class CallSegment(object):
    ...
    def call_resolved(self, call_resolved):
        """Sets the call_resolved of this CallSegment.

        Set to true if Call Review determined that the call/segment successfully resolved/handled the problem/issues  # noqa: E501

        :param call_resolved: The call_resolved of this CallSegment.  # noqa: E501
        :type: bool
        """
    ...
    def ci_answers_id(self, ci_answers_id):
        """Sets the ci_answers_id of this CallSegment.

        Unique id referencing the call insights answers - these are initially populated by speech analytics  # noqa: E501

        :param ci_answers_id: The ci_answers_id of this CallSegment.  # noqa: E501
        :type: str
        """
    ...
    def cr_answers_id(self):
        """Gets the cr_answers_id of this CallSegment.  # noqa: E501

        Unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :return: The cr_answers_id of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def cr_answers_id(self, cr_answers_id):
        """Sets the cr_answers_id of this CallSegment.

        Unique id referencing the call review answers - these are initially populated by speech analytics  # noqa: E501

        :param cr_answers_id: The cr_answers_id of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def incidents(self):
        """Gets the incidents of this CallSegment.  # noqa: E501

        Number of silence and overtalk incidents  # noqa: E501

        :return: The incidents of this CallSegment.  # noqa: E501
        :rtype: int
        """
    ...
    def incidents(self, incidents):
        """Sets the incidents of this CallSegment.

        Number of silence and overtalk incidents  # noqa: E501

        :param incidents: The incidents of this CallSegment.  # noqa: E501
        :type: int
        """
    ...
    @property
    def keywords(self):
        """Gets the keywords of this CallSegment.  # noqa: E501

        All keywords detected  # noqa: E501

        :return: The keywords of this CallSegment.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this CallSegment.

        All keywords detected  # noqa: E501

        :param keywords: The keywords of this CallSegment.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this CallSegment.  # noqa: E501

        General notes for this segment  # noqa: E501

        :return: The notes of this CallSegment.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this CallSegment.

        General notes for this segment  # noqa: E501

        :param notes: The notes of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def review_notes(self):
        """Gets the review_notes of this CallSegment.  # noqa: E501

        Review notes for this segment  # noqa: E501

        :return: The review_notes of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def review_notes(self, review_notes):
        """Sets the review_notes of this CallSegment.

        Review notes for this segment  # noqa: E501

        :param review_notes: The review_notes of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def sentiments(self):
        """Gets the sentiments of this CallSegment.  # noqa: E501

        Sentiment values for speakers. Only one value for each speaker type is present.  # noqa: E501

        :return: The sentiments of this CallSegment.  # noqa: E501
    ...
    def sentiments(self, sentiments):
        """Sets the sentiments of this CallSegment.

        Sentiment values for speakers. Only one value for each speaker type is present.  # noqa: E501

        :param sentiments: The sentiments of this CallSegment.  # noqa: E501
    ...
    @property
    def topics(self):
        """Gets the topics of this CallSegment.  # noqa: E501

        All topics discovered  # noqa: E501

        :return: The topics of this CallSegment.  # noqa: E501
        :rtype: list[str]
        """
        return self._topics
    ...
    def topics(self, topics):
        """Sets the topics of this CallSegment.

        All topics discovered  # noqa: E501

        :param topics: The topics of this CallSegment.  # noqa: E501
        :type: list[str]
        """
    ...
    def voicemail_duration(self):
        """Gets the voicemail_duration of this CallSegment.  # noqa: E501

        Present only if a voicemail was left.</br> Duration of the voicemail in seconds.   # noqa: E501

        :return: The voicemail_duration of this CallSegment.  # noqa: E501
        :rtype: float
        """
    ...
    def voicemail_duration(self, voicemail_duration):
        """Sets the voicemail_duration of this CallSegment.

        Present only if a voicemail was left.</br> Duration of the voicemail in seconds.   # noqa: E501

        :param voicemail_duration: The voicemail_duration of this CallSegment.  # noqa: E501
        :type: float
        """
    ...
    def voicemail_transcript(self):
        """Gets the voicemail_transcript of this CallSegment.  # noqa: E501

        Transcription of voicemail (if applicable)  # noqa: E501

        :return: The voicemail_transcript of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_transcript(self, voicemail_transcript):
        """Sets the voicemail_transcript of this CallSegment.

        Transcription of voicemail (if applicable)  # noqa: E501

        :param voicemail_transcript: The voicemail_transcript of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def voicemail_uuid(self):
        """Gets the voicemail_uuid of this CallSegment.  # noqa: E501
        ...
        :return: The voicemail_uuid of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def voicemail_uuid(self, voicemail_uuid):
        """Sets the voicemail_uuid of this CallSegment.

        Present only if a voicemail was left.</br> Reference to the data object with the voicemail recording. Use /data API to retrieve the voicemail recording.   # noqa: E501

        :param voicemail_uuid: The voicemail_uuid of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def word_cloud(self):
        """Gets the word_cloud of this CallSegment.  # noqa: E501

        Top words from the transcript with their frequencies  # noqa: E501

        :return: The word_cloud of this CallSegment.  # noqa: E501
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this CallSegment.

        Top words from the transcript with their frequencies  # noqa: E501

        :param word_cloud: The word_cloud of this CallSegment.  # noqa: E501
    ...
    def agent_feedback(self):
        """Gets the agent_feedback of this CallSegment.  # noqa: E501


        :return: The agent_feedback of this CallSegment.  # noqa: E501
        :rtype: CallSegmentAllOfAgentFeedback
        """
        return self._agent_feedback

    @agent_feedback.setter
    def agent_feedback(self, agent_feedback):
        """Sets the agent_feedback of this CallSegment.


        :param agent_feedback: The agent_feedback of this CallSegment.  # noqa: E501
        :type: CallSegmentAllOfAgentFeedback
        """
    ...
    @property
    def aivr_vars(self):
        """Gets the aivr_vars of this CallSegment.  # noqa: E501

        AIVR variables (only present if segment type is 'bot')   # noqa: E501

        :return: The aivr_vars of this CallSegment.  # noqa: E501
    ...
    def aivr_vars(self, aivr_vars):
        """Sets the aivr_vars of this CallSegment.

        AIVR variables (only present if segment type is 'bot')   # noqa: E501

        :param aivr_vars: The aivr_vars of this CallSegment.  # noqa: E501
    ...
    def answering_endpoint(self):
        """Gets the answering_endpoint of this CallSegment.  # noqa: E501
        ...
        :return: The answering_endpoint of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def answering_endpoint(self, answering_endpoint):
        """Sets the answering_endpoint of this CallSegment.

        The DNIS or extension that the main call was transferred to at the start of this segment.</br> Each segment typically starts with a call transfer.   # noqa: E501

        :param answering_endpoint: The answering_endpoint of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def audit_status(self, audit_status):
        """Sets the audit_status of this CallSegment.

        State of the manual Call Review **audit** of this segment — `not_started` when the segment has never been audited, so the field is always present.</br> Set when an audit is created from the Call Review Answers attached to this segment (`crAnswersId`), and advanced to `complete` when that audit is completed. Also rolls up to the parent call's `auditStatus`.</br> Use this to filter an audit worklist — see the `AUDIT_STATUS` field of [POST /sa/call/segment/search](#tag/sa-internal/operation/saCallSegmentSearchPost).</br> Returns to `not_started` when the last in-progress audit of this segment is discarded via [DELETE /sa/call/review/answers/{crAnswersId}](#tag/call-review/operation/saCallReviewAnswersDelete); the parent call's `auditStatus` is recomputed with it.</br> **Note:** reset when the call is reprocessed (recompute / rerun re-creates the segments), in the same way as `score`. The audit records themselves are unaffected.   # noqa: E501

        :param audit_status: The audit_status of this CallSegment.  # noqa: E501
        :type: AuditStatus
        """
    ...
    def business_open_state(self):
        """Gets the business_open_state of this CallSegment.  # noqa: E501

        Business open state during this segment (only present if segment type is 'bot')   # noqa: E501

        :return: The business_open_state of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def business_open_state(self, business_open_state):
        """Sets the business_open_state of this CallSegment.

        Business open state during this segment (only present if segment type is 'bot')   # noqa: E501

        :param business_open_state: The business_open_state of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def call_center_call_segment_id(self):
        """Gets the call_center_call_segment_id of this CallSegment.  # noqa: E501

        Special call ID for this segment assigned by the CCaaS platform (if applicable)   # noqa: E501

        :return: The call_center_call_segment_id of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def call_center_call_segment_id(self, call_center_call_segment_id):
        """Sets the call_center_call_segment_id of this CallSegment.

        Special call ID for this segment assigned by the CCaaS platform (if applicable)   # noqa: E501

        :param call_center_call_segment_id: The call_center_call_segment_id of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def duration(self):
        """Gets the duration of this CallSegment.  # noqa: E501

        Duration of the segment in seconds  # noqa: E501

        :return: The duration of this CallSegment.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this CallSegment.

        Duration of the segment in seconds  # noqa: E501

        :param duration: The duration of this CallSegment.  # noqa: E501
        :type: float
        """
    ...
    @property
    def end_ms(self):
        """Gets the end_ms of this CallSegment.  # noqa: E501

        End time in milliseconds from the beginning of the overall call  # noqa: E501

        :return: The end_ms of this CallSegment.  # noqa: E501
        :rtype: int
        """
        return self._end_ms
    ...
    def end_ms(self, end_ms):
        """Sets the end_ms of this CallSegment.

        End time in milliseconds from the beginning of the overall call  # noqa: E501

        :param end_ms: The end_ms of this CallSegment.  # noqa: E501
        :type: int
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this CallSegment.  # noqa: E501

        End time of segment (UTC)  # noqa: E501

        :return: The end_time of this CallSegment.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this CallSegment.

        End time of segment (UTC)  # noqa: E501

        :param end_time: The end_time of this CallSegment.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def markers(self):
        """Gets the markers of this CallSegment.  # noqa: E501

        Markers within this segment  # noqa: E501

        :return: The markers of this CallSegment.  # noqa: E501
    ...
    def markers(self, markers):
        """Sets the markers of this CallSegment.

        Markers within this segment  # noqa: E501

        :param markers: The markers of this CallSegment.  # noqa: E501
    ...
    def modifiable_note(self):
        """Gets the modifiable_note of this CallSegment.  # noqa: E501

        User-editable note for this segment  # noqa: E501

        :return: The modifiable_note of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def modifiable_note(self, modifiable_note):
        """Sets the modifiable_note of this CallSegment.

        User-editable note for this segment  # noqa: E501

        :param modifiable_note: The modifiable_note of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def review_status(self):
        """Gets the review_status of this CallSegment.  # noqa: E501

        Review status for this segment  # noqa: E501

        :return: The review_status of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def review_status(self, review_status):
        """Sets the review_status of this CallSegment.

        Review status for this segment  # noqa: E501

        :param review_status: The review_status of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sa_session_id(self):
        """Gets the sa_session_id of this CallSegment.  # noqa: E501

        Reference to the Speech Analytics session ID  # noqa: E501

        :return: The sa_session_id of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_session_id(self, sa_session_id):
        """Sets the sa_session_id of this CallSegment.

        Reference to the Speech Analytics session ID  # noqa: E501

        :param sa_session_id: The sa_session_id of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sa_session_segment_seq(self):
        """Gets the sa_session_segment_seq of this CallSegment.  # noqa: E501
        ...
        :return: The sa_session_segment_seq of this CallSegment.  # noqa: E501
        :rtype: int
        """
    ...
    def sa_session_segment_seq(self, sa_session_segment_seq):
        """Sets the sa_session_segment_seq of this CallSegment.

        Segment sequence number within the SA offline session.</br> Corresponds to the sequence field in SegmentAnalyticsResult.   # noqa: E501

        :param sa_session_segment_seq: The sa_session_segment_seq of this CallSegment.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def segment_seq(self):
        """Gets the segment_seq of this CallSegment.  # noqa: E501

        Segment sequence number for the specified call.   # noqa: E501

        :return: The segment_seq of this CallSegment.  # noqa: E501
        :rtype: int
        """
    ...
    def segment_seq(self, segment_seq):
        """Sets the segment_seq of this CallSegment.

        Segment sequence number for the specified call.   # noqa: E501

        :param segment_seq: The segment_seq of this CallSegment.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start_ms(self):
        """Gets the start_ms of this CallSegment.  # noqa: E501

        Start time in milliseconds from the beginning of the overall call  # noqa: E501

        :return: The start_ms of this CallSegment.  # noqa: E501
        :rtype: int
        """
    ...
    def start_ms(self, start_ms):
        """Sets the start_ms of this CallSegment.

        Start time in milliseconds from the beginning of the overall call  # noqa: E501

        :param start_ms: The start_ms of this CallSegment.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this CallSegment.  # noqa: E501

        Start time of segment (UTC)  # noqa: E501

        :return: The start_time of this CallSegment.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this CallSegment.

        Start time of segment (UTC)  # noqa: E501

        :param start_time: The start_time of this CallSegment.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CallSegment.  # noqa: E501

        Tags associated with this segment  # noqa: E501

        :return: The tags of this CallSegment.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CallSegment.

        Tags associated with this segment  # noqa: E501

        :param tags: The tags of this CallSegment.  # noqa: E501
        :type: list[str]
        """
    ...
    def transfer_dest(self, transfer_dest):
        """Sets the transfer_dest of this CallSegment.

        Transfer destination (e.g., phone number or extension).</br> May be null if the call ended on this segment.   # noqa: E501

        :param transfer_dest: The transfer_dest of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def transfer_dest_type(self):
        """Gets the transfer_dest_type of this CallSegment.  # noqa: E501

        Type of transfer destination: \"internal\" or \"external\"   # noqa: E501

        :return: The transfer_dest_type of this CallSegment.  # noqa: E501
        :rtype: str
        """
    ...
    def transfer_dest_type(self, transfer_dest_type):
        """Sets the transfer_dest_type of this CallSegment.

        Type of transfer destination: \"internal\" or \"external\"   # noqa: E501

        :param transfer_dest_type: The transfer_dest_type of this CallSegment.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def type(self):
        """Gets the type of this CallSegment.  # noqa: E501


        :return: The type of this CallSegment.  # noqa: E501
        :rtype: SegmentType
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CallSegment.


        :param type: The type of this CallSegment.  # noqa: E501
        :type: SegmentType
        """
    ...
    def voicebot_vars(self):
        """Gets the voicebot_vars of this CallSegment.  # noqa: E501

        Voicebot variables (only present if segment type is 'bot')   # noqa: E501

        :return: The voicebot_vars of this CallSegment.  # noqa: E501
        :rtype: dict(str, object)
        """
    ...
    def voicebot_vars(self, voicebot_vars):
        """Sets the voicebot_vars of this CallSegment.

        Voicebot variables (only present if segment type is 'bot')   # noqa: E501

        :param voicebot_vars: The voicebot_vars of this CallSegment.  # noqa: E501
        :type: dict(str, object)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallSegment):
            return False
