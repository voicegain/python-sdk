...
class AiOutputSourceRef(object):
    ...
    def __init__(self, kind=None, object_id=None, path=None, question_name=None, local_vars_configuration=None):  # noqa: E501
        """AiOutputSourceRef - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def kind(self):
        """Gets the kind of this AiOutputSourceRef.  # noqa: E501

        Free-form label for the kind of source object. Common values include `summary`, `callInsightAnswer`, `callReviewAnswer`, `segmentAnalytics`, `keyword`, `phrase`, `topic`. Not restricted — clients may use other labels as needed.   # noqa: E501

        :return: The kind of this AiOutputSourceRef.  # noqa: E501
        :rtype: str
        """
        return self._kind
    ...
    @kind.setter
    def kind(self, kind):
        """Sets the kind of this AiOutputSourceRef.

        Free-form label for the kind of source object. Common values include `summary`, `callInsightAnswer`, `callReviewAnswer`, `segmentAnalytics`, `keyword`, `phrase`, `topic`. Not restricted — clients may use other labels as needed.   # noqa: E501

        :param kind: The kind of this AiOutputSourceRef.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                kind is not None and len(kind) > 64):
            raise ValueError("Invalid value for `kind`, length must be less than or equal to `64`")  # noqa: E501

        self._kind = kind

    @property
    def object_id(self):
        """Gets the object_id of this AiOutputSourceRef.  # noqa: E501

        (optional) UUID of the source object that produced this AI output (e.g., `ciAnswersId` for a Call Insights answers object, `crAnswersId` for a Call Review answers object, or a segment analytics result id).   # noqa: E501

        :return: The object_id of this AiOutputSourceRef.  # noqa: E501
        :rtype: str
        """
    ...
    def object_id(self, object_id):
        """Sets the object_id of this AiOutputSourceRef.

        (optional) UUID of the source object that produced this AI output (e.g., `ciAnswersId` for a Call Insights answers object, `crAnswersId` for a Call Review answers object, or a segment analytics result id).   # noqa: E501

        :param object_id: The object_id of this AiOutputSourceRef.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                object_id is not None and len(object_id) > 48):
            raise ValueError("Invalid value for `object_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                object_id is not None and len(object_id) < 16):
            raise ValueError("Invalid value for `object_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._object_id = object_id

    @property
    def path(self):
        """Gets the path of this AiOutputSourceRef.  # noqa: E501

        (optional) JSON pointer / dot-path locating the specific element inside the source object. Combined with `objectId` and `kind` this uniquely identifies a sub-element of the source (e.g. `summary[0]` for the first sentence of an SA summary).   # noqa: E501

        :return: The path of this AiOutputSourceRef.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this AiOutputSourceRef.

        (optional) JSON pointer / dot-path locating the specific element inside the source object. Combined with `objectId` and `kind` this uniquely identifies a sub-element of the source (e.g. `summary[0]` for the first sentence of an SA summary).   # noqa: E501

        :param path: The path of this AiOutputSourceRef.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                path is not None and len(path) > 256):
            raise ValueError("Invalid value for `path`, length must be less than or equal to `256`")  # noqa: E501

        self._path = path

    @property
    def question_name(self):
        """Gets the question_name of this AiOutputSourceRef.  # noqa: E501

        For `callInsightAnswer` / `callReviewAnswer` — the name of the question whose answer this AI output corresponds to.   # noqa: E501

        :return: The question_name of this AiOutputSourceRef.  # noqa: E501
        :rtype: str
        """
    ...
    def question_name(self, question_name):
        """Sets the question_name of this AiOutputSourceRef.

        For `callInsightAnswer` / `callReviewAnswer` — the name of the question whose answer this AI output corresponds to.   # noqa: E501

        :param question_name: The question_name of this AiOutputSourceRef.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                question_name is not None and len(question_name) > 128):
            raise ValueError("Invalid value for `question_name`, length must be less than or equal to `128`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AiOutputSourceRef):
            return False
