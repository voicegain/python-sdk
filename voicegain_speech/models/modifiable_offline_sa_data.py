...
class ModifiableOfflineSAData(object):
    ...
    def __init__(self, context=None, label=None, persist_seconds=3600, local_vars_configuration=None):  # noqa: E501
        """ModifiableOfflineSAData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def context(self):
        """Gets the context of this ModifiableOfflineSAData.  # noqa: E501

        You can move the speech analytics session to a different context by modifying the context id.  The following checks are done before moving: + the dst Context has to be of the same type as the src Context + the users having access to src Context have to overlap with the users having access to the dst Context               # noqa: E501

        :return: The context of this ModifiableOfflineSAData.  # noqa: E501
        :rtype: str
        """
    ...
    def context(self, context):
        """Sets the context of this ModifiableOfflineSAData.

        You can move the speech analytics session to a different context by modifying the context id.  The following checks are done before moving: + the dst Context has to be of the same type as the src Context + the users having access to src Context have to overlap with the users having access to the dst Context               # noqa: E501

        :param context: The context of this ModifiableOfflineSAData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this ModifiableOfflineSAData.  # noqa: E501
        ...
        :return: The label of this ModifiableOfflineSAData.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this ModifiableOfflineSAData.

        Label for the result so that it can be easily identified e.g. in the Web UI. </br> Generally follows the same limitations as a file name. </br> Can contain any unicode character except control characters and except < > : \" / \\ |  ? * </br> Moreover, spaces and dots in front and at the end are not allowed.    # noqa: E501

        :param label: The label of this ModifiableOfflineSAData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def persist_seconds(self):
        """Gets the persist_seconds of this ModifiableOfflineSAData.  # noqa: E501
        ...
        :return: The persist_seconds of this ModifiableOfflineSAData.  # noqa: E501
        :rtype: float
        """
    ...
    def persist_seconds(self, persist_seconds):
        """Sets the persist_seconds of this ModifiableOfflineSAData.

        Time (in seconds) to retain the result/outcome data after processing has completed. For Cloud, maximum persistence is 31 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.  </br> NOTE 1: You can modify this only for sessions that have comppleted processing. </br> NOTE 2: You cannot change this after the session has already expired.   # noqa: E501

        :param persist_seconds: The persist_seconds of this ModifiableOfflineSAData.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifiableOfflineSAData):
            return False
