...
class AIVRTransferLegB(object):
    ...
    @property
    def loop(self):
        """Gets the loop of this AIVRTransferLegB.  # noqa: E501

        If true then the whisper prompt will be looped until the called party hangs up or DTMF terminators are pressed.   # noqa: E501

        :return: The loop of this AIVRTransferLegB.  # noqa: E501
        :rtype: bool
        """
        return self._loop
    ...
    @loop.setter
    def loop(self, loop):
        """Sets the loop of this AIVRTransferLegB.

        If true then the whisper prompt will be looped until the called party hangs up or DTMF terminators are pressed.   # noqa: E501

        :param loop: The loop of this AIVRTransferLegB.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRTransferLegB):
            return False
