...
class SpeakerData(object):
    ...
    openapi_types = {
        ...
        'account_id': 'str',
        'speaker_id': 'str',
        'voice_signatures': 'list[VoiceSignatureItem]'
    }
    ...
    def __init__(self, creator=None, name=None, user_id=None, account_id=None, speaker_id=None, voice_signatures=None, local_vars_configuration=None):  # noqa: E501
        """SpeakerData - a model defined in OpenAPI"""  # noqa: E501
        ...
        if voice_signatures is not None:
            self.voice_signatures = voice_signatures

    @property
    def creator(self):
        """Gets the creator of this SpeakerData.  # noqa: E501

        UUID of the user who created this Speaker.  If not provided then will be set based on the user who submitted the request (from MAC session).   # noqa: E501

        :return: The creator of this SpeakerData.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this SpeakerData.

        UUID of the user who created this Speaker.  If not provided then will be set based on the user who submitted the request (from MAC session).   # noqa: E501

        :param creator: The creator of this SpeakerData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SpeakerData.  # noqa: E501

        Speaker name (full). Only needs to be set if the `userId` is not specified. If `userId` is provided then will use the name of the user.   # noqa: E501

        :return: The name of this SpeakerData.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SpeakerData.

        Speaker name (full). Only needs to be set if the `userId` is not specified. If `userId` is provided then will use the name of the user.   # noqa: E501

        :param name: The name of this SpeakerData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this SpeakerData.  # noqa: E501

        Optional userId. If provided then the speaker is tied to the specified user on the Account.   # noqa: E501

        :return: The user_id of this SpeakerData.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this SpeakerData.

        Optional userId. If provided then the speaker is tied to the specified user on the Account.   # noqa: E501

        :param user_id: The user_id of this SpeakerData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def account_id(self):
        """Gets the account_id of this SpeakerData.  # noqa: E501

        Account id   # noqa: E501

        :return: The account_id of this SpeakerData.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this SpeakerData.

        Account id   # noqa: E501

        :param account_id: The account_id of this SpeakerData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def speaker_id(self):
        """Gets the speaker_id of this SpeakerData.  # noqa: E501

        Unique Speaker ID         # noqa: E501

        :return: The speaker_id of this SpeakerData.  # noqa: E501
        :rtype: str
        """
    ...
    def speaker_id(self, speaker_id):
        """Sets the speaker_id of this SpeakerData.

        Unique Speaker ID         # noqa: E501

        :param speaker_id: The speaker_id of this SpeakerData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def voice_signatures(self):
        """Gets the voice_signatures of this SpeakerData.  # noqa: E501

        Voice Signature items  # noqa: E501

        :return: The voice_signatures of this SpeakerData.  # noqa: E501
        :rtype: list[VoiceSignatureItem]
        """
        return self._voice_signatures

    @voice_signatures.setter
    def voice_signatures(self, voice_signatures):
        """Sets the voice_signatures of this SpeakerData.

        Voice Signature items  # noqa: E501

        :param voice_signatures: The voice_signatures of this SpeakerData.  # noqa: E501
        :type: list[VoiceSignatureItem]
        """

        self._voice_signatures = voice_signatures
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeakerData):
            return False
