...
class NewSpeechAnalyticsSessionResponse(object):
    ...
    def __init__(self, audio=None, cr_answers_id=None, metadata=None, poll=None, sa_session_id=None, speaker_channels=None, websocket=None, local_vars_configuration=None):  # noqa: E501
