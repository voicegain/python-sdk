...
class NewSpeechAnalyticsSessionResponse(object):
    ...
    """
    openapi_types = {
        'audio': 'NewSpeechAnalyticsSessionResponseAudio',
        'ci_answers_id': 'str',
        'cr_answers_id': 'str',
    ...
    def __init__(self, audio=None, ci_answers_id=None, cr_answers_id=None, metadata=None, poll=None, sa_session_id=None, speaker_channels=None, websocket=None, local_vars_configuration=None):  # noqa: E501
    ...
    def audio(self):
        ...
        :rtype: NewSpeechAnalyticsSessionResponseAudio
        """
        return self._audio
    ...
    def audio(self, audio):
        ...
        :type: NewSpeechAnalyticsSessionResponseAudio
        """
    ...
    def ci_answers_id(self):
        """Gets the ci_answers_id of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
        ...
        :return: The ci_answers_id of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def ci_answers_id(self, ci_answers_id):
        """Sets the ci_answers_id of this NewSpeechAnalyticsSessionResponse.

        id of the call insights answers. Set only if `insightsConfig` was provided in the SA session request.</br> Initially the answers will not be populated. The autopopulated answers will be filled in at the end of SA session.   # noqa: E501

        :param ci_answers_id: The ci_answers_id of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
        ...
        :return: The metadata of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this NewSpeechAnalyticsSessionResponse.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this NewSpeechAnalyticsSessionResponse.  # noqa: E501
