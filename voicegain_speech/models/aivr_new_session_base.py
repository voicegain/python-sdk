...
class AIVRNewSessionBase(object):
    ...
    def __init__(self, aivr_app_id=None, ani=None, app_data=None, auth_token=None, call_is_being_recorded=False, dnis=None, sequence=None, sid=None, start_time=None, temp_code=None, to_be_transcribed=False, user_app_data=None, vars=None, local_vars_configuration=None):  # noqa: E501
        """AIVRNewSessionBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    def aivr_app_id(self):
        """Gets the aivr_app_id of this AIVRNewSessionBase.  # noqa: E501

        AIVR application id on Voicegain platform  # noqa: E501

        :return: The aivr_app_id of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
    ...
    def aivr_app_id(self, aivr_app_id):
        """Sets the aivr_app_id of this AIVRNewSessionBase.

        AIVR application id on Voicegain platform  # noqa: E501

        :param aivr_app_id: The aivr_app_id of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ani(self):
        """Gets the ani of this AIVRNewSessionBase.  # noqa: E501
        ...
        :return: The ani of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
        return self._ani
    ...
    @ani.setter
    def ani(self, ani):
        """Sets the ani of this AIVRNewSessionBase.

        (only if session originated over phone) </br> For inbound call: the caller phone number or sip address (calling number)</br> For outbound call: the number that was dialed (called number)</br>   # noqa: E501

        :param ani: The ani of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
    ...
    def app_data(self, app_data):
        """Sets the app_data of this AIVRNewSessionBase.

        List of data items that have been configured on the AIVR App and are made available to the AIVR App logic. </br>   # noqa: E501

        :param app_data: The app_data of this AIVRNewSessionBase.  # noqa: E501
    ...
    @property
    def auth_token(self):
        """Gets the auth_token of this AIVRNewSessionBase.  # noqa: E501
        ...
        :return: The auth_token of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_token(self, auth_token):
        """Sets the auth_token of this AIVRNewSessionBase.

        Unique token that can be used to authenticate session related API requests outside of the callback or websocket. The token is valid while a session is in progress plus 5 minutes.</br> Example methods that can be invoked using the token: + [PUT /aivr/{ivrSid}/vars](#tag/aivr/operation/aivrVarsPut) + [GET /aivr-app/{aivrAppId}/business](#tag/aivr-app/operation/aivrAppBusinessGetByToken) + [GET /aivr-app/{aivrAppId}/jwt](#tag/aivr-app/operation/aivrAppJwtGetByToken)   # noqa: E501

        :param auth_token: The auth_token of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
    ...
    def call_is_being_recorded(self):
        """Gets the call_is_being_recorded of this AIVRNewSessionBase.  # noqa: E501

        Whether this call is being recorded.  # noqa: E501

        :return: The call_is_being_recorded of this AIVRNewSessionBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def call_is_being_recorded(self, call_is_being_recorded):
        """Sets the call_is_being_recorded of this AIVRNewSessionBase.

        Whether this call is being recorded.  # noqa: E501

        :param call_is_being_recorded: The call_is_being_recorded of this AIVRNewSessionBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def dnis(self):
        """Gets the dnis of this AIVRNewSessionBase.  # noqa: E501
        ...
        :return: The dnis of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
        return self._dnis
    ...
    @dnis.setter
    def dnis(self, dnis):
        """Sets the dnis of this AIVRNewSessionBase.

        (only if session originated over phone) </br> For inbound call: Called phone number or sip address (the number assigned to the AIVR App)</br> For outbound call: then number from which the call was made</br>   # noqa: E501

        :param dnis: The dnis of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sequence(self):
        """Gets the sequence of this AIVRNewSessionBase.  # noqa: E501

        sequential number within session of this callback or websocket message  # noqa: E501

        :return: The sequence of this AIVRNewSessionBase.  # noqa: E501
        :rtype: int
        """
    ...
    def sequence(self, sequence):
        """Sets the sequence of this AIVRNewSessionBase.

        sequential number within session of this callback or websocket message  # noqa: E501

        :param sequence: The sequence of this AIVRNewSessionBase.  # noqa: E501
        :type: int
        """
    ...
    @property
    def sid(self):
        """Gets the sid of this AIVRNewSessionBase.  # noqa: E501

        AIVR session id on Voicegain platform  # noqa: E501

        :return: The sid of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
        return self._sid
    ...
    @sid.setter
    def sid(self, sid):
        """Sets the sid of this AIVRNewSessionBase.

        AIVR session id on Voicegain platform  # noqa: E501

        :param sid: The sid of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this AIVRNewSessionBase.  # noqa: E501

        Start time of the AIVR session  # noqa: E501

        :return: The start_time of this AIVRNewSessionBase.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this AIVRNewSessionBase.

        Start time of the AIVR session  # noqa: E501

        :param start_time: The start_time of this AIVRNewSessionBase.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def temp_code(self):
        """Gets the temp_code of this AIVRNewSessionBase.  # noqa: E501
        ...
        :return: The temp_code of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
    ...
    def temp_code(self, temp_code):
        """Sets the temp_code of this AIVRNewSessionBase.

        Temporary random code that can be used to lookup this session. This code is generated when the session is created and is valid during the life of the session and then for 30 minutes after the AIVR session ends. Within that time period it can be used to query the session.</br> The code, while valid, is guaranteed to be unique within an Account. The code is a random combination of 4 digits or letters (upper case).</br> Note: The time the code is valid and the code length may change in future version of this API.   # noqa: E501

        :param temp_code: The temp_code of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def to_be_transcribed(self):
        """Gets the to_be_transcribed of this AIVRNewSessionBase.  # noqa: E501

        Whether this call is to have a transcript.  # noqa: E501

        :return: The to_be_transcribed of this AIVRNewSessionBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def to_be_transcribed(self, to_be_transcribed):
        """Sets the to_be_transcribed of this AIVRNewSessionBase.

        Whether this call is to have a transcript.  # noqa: E501

        :param to_be_transcribed: The to_be_transcribed of this AIVRNewSessionBase.  # noqa: E501
        :type: bool
        """
    ...
    def user_app_data(self):
        """Gets the user_app_data of this AIVRNewSessionBase.  # noqa: E501
        ...
        :return: The user_app_data of this AIVRNewSessionBase.  # noqa: E501
        :rtype: str
        """
    ...
    def user_app_data(self, user_app_data):
        """Sets the user_app_data of this AIVRNewSessionBase.

        Data that was associated in the AIVR portal with AIVR CallBack URL.</br> It is a string that is not interpreted by the AIVR and only passed to Customer dialog engine.</br> The name is a bit misleading due to historical reasons.  The difference between `userAppData` and `appData` is that the former is associated with the Logic callback URL, while the latter is associated with the AIVR App and can be accesses by any logic associated with the AIVR App.</br>   # noqa: E501

        :param user_app_data: The user_app_data of this AIVRNewSessionBase.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def vars(self):
        """Gets the vars of this AIVRNewSessionBase.  # noqa: E501
    ...
    @vars.setter
    def vars(self, vars):
        """Sets the vars of this AIVRNewSessionBase.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRNewSessionBase):
            return False
