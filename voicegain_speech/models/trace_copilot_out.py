...
class TraceCopilotOut(object):
    ...
    def __init__(self, channel=None, event=None, message=None, rcv_ack=None, local_vars_configuration=None):  # noqa: E501
        """TraceCopilotOut - a model defined in OpenAPI"""  # noqa: E501
        ...
        if rcv_ack is not None:
            self.rcv_ack = rcv_ack

    @property
    def channel(self):
        """Gets the channel of this TraceCopilotOut.  # noqa: E501

        Channel name used to send the message to Copilot, e.g. via Pusher we use Agent email address as channel name.  # noqa: E501

        :return: The channel of this TraceCopilotOut.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this TraceCopilotOut.

        Channel name used to send the message to Copilot, e.g. via Pusher we use Agent email address as channel name.  # noqa: E501

        :param channel: The channel of this TraceCopilotOut.  # noqa: E501
        :type: str
        """
    ...
    @property
    def event(self):
        """Gets the event of this TraceCopilotOut.  # noqa: E501
        ...
        :return: The event of this TraceCopilotOut.  # noqa: E501
        :rtype: str
        """
        return self._event
    ...
    def event(self, event):
        """Sets the event of this TraceCopilotOut.

        Event sent to Copilot, e.g. via Pusher. Note, event can be considered as the type for the message. Knowing the Event name we can interpret the message.   # noqa: E501

        :param event: The event of this TraceCopilotOut.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this TraceCopilotOut.  # noqa: E501
        ...
        :return: The message of this TraceCopilotOut.  # noqa: E501
        :rtype: object
        """
    ...
    def message(self, message):
        """Sets the message of this TraceCopilotOut.

        Complete message sent to Copilot, for example, via Pusher.</br> Each Message will contain at least: + msgUuid field that will be used to uniquely identify the message, for example, for the purpose of `rcv_ack`. + aivrSid field that will be used to identify the AIVR session that the message is related to.   # noqa: E501

        :param message: The message of this TraceCopilotOut.  # noqa: E501
        :type: object
        """
    ...
    @property
    def rcv_ack(self):
        """Gets the rcv_ack of this TraceCopilotOut.  # noqa: E501

        Acknowledgement received from Copilot of receipt of the message  # noqa: E501

        :return: The rcv_ack of this TraceCopilotOut.  # noqa: E501
        :rtype: bool
        """
        return self._rcv_ack

    @rcv_ack.setter
    def rcv_ack(self, rcv_ack):
        """Sets the rcv_ack of this TraceCopilotOut.

        Acknowledgement received from Copilot of receipt of the message  # noqa: E501

        :param rcv_ack: The rcv_ack of this TraceCopilotOut.  # noqa: E501
        :type: bool
        """

        self._rcv_ack = rcv_ack
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TraceCopilotOut):
            return False
