...
class WordsSectionMetaMeeting(object):
    ...
    def __init__(self, duration=None, spk=None, start=None, local_vars_configuration=None):  # noqa: E501
        """WordsSectionMetaMeeting - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def duration(self):
        """Gets the duration of this WordsSectionMetaMeeting.  # noqa: E501

        duration of the words section (in msec)  # noqa: E501

        :return: The duration of this WordsSectionMetaMeeting.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this WordsSectionMetaMeeting.

        duration of the words section (in msec)  # noqa: E501

        :param duration: The duration of this WordsSectionMetaMeeting.  # noqa: E501
        :type: float
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this WordsSectionMetaMeeting.  # noqa: E501
        ...
        :return: The spk of this WordsSectionMetaMeeting.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WordsSectionMetaMeeting.

        Speaker id. Range from 1 to 99 corresponds to speakers that were provided in the POST /asr/meeting  (or POST /sa/offline) requests in the `speakers` array.  (It is the index into that array, with first element having index 1.) </br> Range 100 and above corresponds to Speakers not identified up-font (either single speaker per audio or diarized speaker).   # noqa: E501

        :param spk: The spk of this WordsSectionMetaMeeting.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start(self):
        """Gets the start of this WordsSectionMetaMeeting.  # noqa: E501

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :return: The start of this WordsSectionMetaMeeting.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordsSectionMetaMeeting.

        start time (in msec) of this section/paragraph since the beginning of the audio  # noqa: E501

        :param start: The start of this WordsSectionMetaMeeting.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordsSectionMetaMeeting):
            return False
