...
class AsrTranscribeQueueStatus(object):
    ...
    openapi_types = {
        ...
        'queue_size_limit_reached': 'bool',
        'queue_size_limit_reached_at': 'datetime',
        'queue_size_limit_used': 'int'
    }

    attribute_map = {
        'queue_size_limit': 'queueSizeLimit',
        'queue_size_limit_reached': 'queueSizeLimitReached',
        'queue_size_limit_reached_at': 'queueSizeLimitReachedAt',
        'queue_size_limit_used': 'queueSizeLimitUsed'
    }

    def __init__(self, queue_size_limit=None, queue_size_limit_reached=None, queue_size_limit_reached_at=None, queue_size_limit_used=None, local_vars_configuration=None):  # noqa: E501
        """AsrTranscribeQueueStatus - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._queue_size_limit = None
        self._queue_size_limit_reached = None
        self._queue_size_limit_reached_at = None
        self._queue_size_limit_used = None
        self.discriminator = None

        self.queue_size_limit = queue_size_limit
        if queue_size_limit_reached is not None:
            self.queue_size_limit_reached = queue_size_limit_reached
        if queue_size_limit_reached_at is not None:
            self.queue_size_limit_reached_at = queue_size_limit_reached_at
        self.queue_size_limit_used = queue_size_limit_used

    @property
    def queue_size_limit(self):
        """Gets the queue_size_limit of this AsrTranscribeQueueStatus.  # noqa: E501

        Maximum number of items that can be waiting in the queue plus items being processed   # noqa: E501

        :return: The queue_size_limit of this AsrTranscribeQueueStatus.  # noqa: E501
        :rtype: int
        """
        return self._queue_size_limit

    @queue_size_limit.setter
    def queue_size_limit(self, queue_size_limit):
        """Sets the queue_size_limit of this AsrTranscribeQueueStatus.

        Maximum number of items that can be waiting in the queue plus items being processed   # noqa: E501

        :param queue_size_limit: The queue_size_limit of this AsrTranscribeQueueStatus.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and queue_size_limit is None:  # noqa: E501
            raise ValueError("Invalid value for `queue_size_limit`, must not be `None`")  # noqa: E501

        self._queue_size_limit = queue_size_limit

    @property
    def queue_size_limit_reached(self):
        """Gets the queue_size_limit_reached of this AsrTranscribeQueueStatus.  # noqa: E501

        Indicates whether the queue size limit has been reached   # noqa: E501

        :return: The queue_size_limit_reached of this AsrTranscribeQueueStatus.  # noqa: E501
        :rtype: bool
        """
        return self._queue_size_limit_reached

    @queue_size_limit_reached.setter
    def queue_size_limit_reached(self, queue_size_limit_reached):
        """Sets the queue_size_limit_reached of this AsrTranscribeQueueStatus.

        Indicates whether the queue size limit has been reached   # noqa: E501

        :param queue_size_limit_reached: The queue_size_limit_reached of this AsrTranscribeQueueStatus.  # noqa: E501
        :type: bool
        """

        self._queue_size_limit_reached = queue_size_limit_reached

    @property
    def queue_size_limit_reached_at(self):
        """Gets the queue_size_limit_reached_at of this AsrTranscribeQueueStatus.  # noqa: E501

        Timestamp when the queue size limit was reached   # noqa: E501

        :return: The queue_size_limit_reached_at of this AsrTranscribeQueueStatus.  # noqa: E501
        :rtype: datetime
        """
        return self._queue_size_limit_reached_at

    @queue_size_limit_reached_at.setter
    def queue_size_limit_reached_at(self, queue_size_limit_reached_at):
        """Sets the queue_size_limit_reached_at of this AsrTranscribeQueueStatus.

        Timestamp when the queue size limit was reached   # noqa: E501

        :param queue_size_limit_reached_at: The queue_size_limit_reached_at of this AsrTranscribeQueueStatus.  # noqa: E501
        :type: datetime
        """

        self._queue_size_limit_reached_at = queue_size_limit_reached_at

    @property
    def queue_size_limit_used(self):
        """Gets the queue_size_limit_used of this AsrTranscribeQueueStatus.  # noqa: E501

        Number of items that are pending in the queue plus items currently being processed   # noqa: E501

        :return: The queue_size_limit_used of this AsrTranscribeQueueStatus.  # noqa: E501
        :rtype: int
        """
        return self._queue_size_limit_used

    @queue_size_limit_used.setter
    def queue_size_limit_used(self, queue_size_limit_used):
        """Sets the queue_size_limit_used of this AsrTranscribeQueueStatus.

        Number of items that are pending in the queue plus items currently being processed   # noqa: E501

        :param queue_size_limit_used: The queue_size_limit_used of this AsrTranscribeQueueStatus.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and queue_size_limit_used is None:  # noqa: E501
            raise ValueError("Invalid value for `queue_size_limit_used`, must not be `None`")  # noqa: E501

        self._queue_size_limit_used = queue_size_limit_used
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrTranscribeQueueStatus):
            return False
