...
"""
    ...
    The version of the OpenAPI document: 1.90.0 - updated September 19, 2023
...
class CallReviewConfigQuestionBaseWithAnswer(object):
    ...
    openapi_types = {
        ...
        'answer_type': 'CallReviewAnswerType',
        'max_value': 'float',
        'question': 'str',
        'cr_question_id': 'str',
    ...
    def __init__(self, answer_mapping=None, answer_type=None, max_value=10, question=None, cr_question_id=None, ai_justification=None, answer_choice=None, answer_value=None, answered_by=None, not_applicable=False, notes=None, local_vars_configuration=None):  # noqa: E501
        """CallReviewConfigQuestionBaseWithAnswer - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._answer_mapping = None
        self._answer_type = None
        self._max_value = None
        self._question = None
        self._cr_question_id = None
        self._ai_justification = None
        ...
        if cr_question_id is not None:
            self.cr_question_id = cr_question_id
    ...
    def answer_mapping(self):
        """Gets the answer_mapping of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        List of available choices together with the values corresponding to each choice.  # noqa: E501

        :return: The answer_mapping of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: list[AnswerMapEntry]
        """
        return self._answer_mapping

    @answer_mapping.setter
    def answer_mapping(self, answer_mapping):
        """Sets the answer_mapping of this CallReviewConfigQuestionBaseWithAnswer.

        List of available choices together with the values corresponding to each choice.  # noqa: E501

        :param answer_mapping: The answer_mapping of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: list[AnswerMapEntry]
        """
    ...
    def answer_type(self):
        """Gets the answer_type of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501


        :return: The answer_type of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: CallReviewAnswerType
        """
        return self._answer_type

    @answer_type.setter
    def answer_type(self, answer_type):
        """Sets the answer_type of this CallReviewConfigQuestionBaseWithAnswer.


        :param answer_type: The answer_type of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: CallReviewAnswerType
        """
    ...
    @property
    def max_value(self):
        """Gets the max_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        max score/value that can be given to the question  # noqa: E501

        :return: The max_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: float
        """
    ...
    def max_value(self, max_value):
        """Sets the max_value of this CallReviewConfigQuestionBaseWithAnswer.

        max score/value that can be given to the question  # noqa: E501

        :param max_value: The max_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                max_value is not None and max_value < 1):  # noqa: E501
    ...
    @property
    def question(self):
        """Gets the question of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        question to ask/answer during review  # noqa: E501

        :return: The question of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def question(self, question):
        """Sets the question of this CallReviewConfigQuestionBaseWithAnswer.

        question to ask/answer during review  # noqa: E501

        :param question: The question of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: str
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
                question is not None and len(question) > 256):
            raise ValueError("Invalid value for `question`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                question is not None and len(question) < 4):
            raise ValueError("Invalid value for `question`, length must be greater than or equal to `4`")  # noqa: E501

        self._question = question

    @property
    def cr_question_id(self):
        """Gets the cr_question_id of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        unique id that identifies this specific question - it will be referenced when storing the answer  # noqa: E501

        :return: The cr_question_id of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: str
        """
        return self._cr_question_id

    @cr_question_id.setter
    def cr_question_id(self, cr_question_id):
        """Sets the cr_question_id of this CallReviewConfigQuestionBaseWithAnswer.

        unique id that identifies this specific question - it will be referenced when storing the answer  # noqa: E501

        :param cr_question_id: The cr_question_id of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                cr_question_id is not None and len(cr_question_id) > 48):
            raise ValueError("Invalid value for `cr_question_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                cr_question_id is not None and len(cr_question_id) < 16):
            raise ValueError("Invalid value for `cr_question_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._cr_question_id = cr_question_id

    @property
    def ai_justification(self):
        """Gets the ai_justification of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
    ...
    @ai_justification.setter
    def ai_justification(self, ai_justification):
        """Sets the ai_justification of this CallReviewConfigQuestionBaseWithAnswer.
    ...
    def answer_choice(self):
        """Gets the answer_choice of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        Needs to be provided if `answerType` is `choice`.  If setting value from UI, there is no need to then set `answerValue` because that will be set by the back-end based on `answerChoice`   # noqa: E501

        :return: The answer_choice of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: str
        """
        return self._answer_choice

    @answer_choice.setter
    def answer_choice(self, answer_choice):
        """Sets the answer_choice of this CallReviewConfigQuestionBaseWithAnswer.

        Needs to be provided if `answerType` is `choice`.  If setting value from UI, there is no need to then set `answerValue` because that will be set by the back-end based on `answerChoice`   # noqa: E501

        :param answer_choice: The answer_choice of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: str
        """
    ...
    def answer_value(self):
        """Gets the answer_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        value assigned to the answer, may nor exceed the maxValue for the question  # noqa: E501

        :return: The answer_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: float
        """
    ...
    def answer_value(self, answer_value):
        """Sets the answer_value of this CallReviewConfigQuestionBaseWithAnswer.

        value assigned to the answer, may nor exceed the maxValue for the question  # noqa: E501

        :param answer_value: The answer_value of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                answer_value is not None and answer_value < 0):  # noqa: E501
            raise ValueError("Invalid value for `answer_value`, must be a value greater than or equal to `0`")  # noqa: E501

        self._answer_value = answer_value

    @property
    def answered_by(self):
        """Gets the answered_by of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        Specifies how the answer was obtained.  When setting the answer from UI it is fine to always set the value to `human` as the back-end will modify it to `humanOverrideAI` if applicable.   # noqa: E501

        :return: The answered_by of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def answered_by(self, answered_by):
        """Sets the answered_by of this CallReviewConfigQuestionBaseWithAnswer.

        Specifies how the answer was obtained.  When setting the answer from UI it is fine to always set the value to `human` as the back-end will modify it to `humanOverrideAI` if applicable.   # noqa: E501

        :param answered_by: The answered_by of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: str
        """
        allowed_values = ["AI", "human", "humanOverrideAI"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and answered_by not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `answered_by` ({0}), must be one of {1}"  # noqa: E501
    ...
    def not_applicable(self):
        """Gets the not_applicable of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        set this to true if the question was not applicable to a given call  # noqa: E501

        :return: The not_applicable of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def not_applicable(self, not_applicable):
        """Sets the not_applicable of this CallReviewConfigQuestionBaseWithAnswer.

        set this to true if the question was not applicable to a given call  # noqa: E501

        :param not_applicable: The not_applicable of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501

        notes related to this question/answer  # noqa: E501

        :return: The notes of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this CallReviewConfigQuestionBaseWithAnswer.

        notes related to this question/answer  # noqa: E501

        :param notes: The notes of this CallReviewConfigQuestionBaseWithAnswer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                notes is not None and len(notes) > 512):
            raise ValueError("Invalid value for `notes`, length must be less than or equal to `512`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallReviewConfigQuestionBaseWithAnswer):
            return False
