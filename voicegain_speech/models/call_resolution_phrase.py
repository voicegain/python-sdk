...
class CallResolutionPhrase(object):
    ...
    def __init__(self, phrase_text=None, phrase_type=None, local_vars_configuration=None):  # noqa: E501
        """CallResolutionPhrase - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._phrase_text = None
    ...
    def phrase_text(self):
        """Gets the phrase_text of this CallResolutionPhrase.  # noqa: E501

        the phrase  # noqa: E501

        :return: The phrase_text of this CallResolutionPhrase.  # noqa: E501
        :rtype: str
        """
        return self._phrase_text

    @phrase_text.setter
    def phrase_text(self, phrase_text):
        """Sets the phrase_text of this CallResolutionPhrase.

        the phrase  # noqa: E501

        :param phrase_text: The phrase_text of this CallResolutionPhrase.  # noqa: E501
        :type: str
        """

        self._phrase_text = phrase_text

    @property
    def phrase_type(self):
        """Gets the phrase_type of this CallResolutionPhrase.  # noqa: E501

        Phrases can be either questions that require confirmation, or simple statements that do not require confirmation.  # noqa: E501

        :return: The phrase_type of this CallResolutionPhrase.  # noqa: E501
        :rtype: str
        """
        return self._phrase_type

    @phrase_type.setter
    def phrase_type(self, phrase_type):
        """Sets the phrase_type of this CallResolutionPhrase.

        Phrases can be either questions that require confirmation, or simple statements that do not require confirmation.  # noqa: E501

        :param phrase_type: The phrase_type of this CallResolutionPhrase.  # noqa: E501
        :type: str
        """
        allowed_values = ["statement", "question"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and phrase_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `phrase_type` ({0}), must be one of {1}"  # noqa: E501
                .format(phrase_type, allowed_values)
            )

        self._phrase_type = phrase_type
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallResolutionPhrase):
            return False
