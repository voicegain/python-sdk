...
class SpeechAnalyticsAudioInput(object):
    ...
    openapi_types = {
        ...
        'audio_offset': 'int',
        'diarization': 'SpeechAnalyticsAudioInputDiarization',
        'mask': 'list[SpeechAnalyticsAudioInputMask]',
        'merged_stereo_channel': 'str',
    ...
    attribute_map = {
        ...
        'mask': 'mask',
        'merged_stereo_channel': 'mergedStereoChannel',
        'source': 'source',
        'speakers': 'speakers',
        'vad_mode': 'vadMode'
    }

    def __init__(self, audio_channel_selector=None, audio_offset=None, diarization=None, mask=None, merged_stereo_channel=None, source=None, speakers=None, vad_mode=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsAudioInput - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._mask = None
        self._merged_stereo_channel = None
        self._source = None
        self._speakers = None
        self._vad_mode = None
        ...
        if mask is not None:
            self.mask = mask
        if merged_stereo_channel is not None:
            self.merged_stereo_channel = merged_stereo_channel
    ...
    def audio_channel_selector(self):
        """Gets the audio_channel_selector of this SpeechAnalyticsAudioInput.  # noqa: E501


        :return: The audio_channel_selector of this SpeechAnalyticsAudioInput.  # noqa: E501
    ...
    def audio_channel_selector(self, audio_channel_selector):
        """Sets the audio_channel_selector of this SpeechAnalyticsAudioInput.


        :param audio_channel_selector: The audio_channel_selector of this SpeechAnalyticsAudioInput.  # noqa: E501
    ...
    def audio_offset(self):
        """Gets the audio_offset of this SpeechAnalyticsAudioInput.  # noqa: E501
        ...
        :return: The audio_offset of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: int
        """
    ...
    def audio_offset(self, audio_offset):
        """Sets the audio_offset of this SpeechAnalyticsAudioInput.

        (optional) Offset in milliseconds that will be added to the words transcribed from this audio. This is useful if the audio channels do not start at the same time.   # noqa: E501

        :param audio_offset: The audio_offset of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: int
        """
    ...
    def diarization(self):
        """Gets the diarization of this SpeechAnalyticsAudioInput.  # noqa: E501


        :return: The diarization of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: SpeechAnalyticsAudioInputDiarization
        """
        return self._diarization

    @diarization.setter
    def diarization(self, diarization):
        """Sets the diarization of this SpeechAnalyticsAudioInput.


        :param diarization: The diarization of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: SpeechAnalyticsAudioInputDiarization
        """
    ...
    @property
    def mask(self):
        """Gets the mask of this SpeechAnalyticsAudioInput.  # noqa: E501
        ...
        :return: The mask of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: list[SpeechAnalyticsAudioInputMask]
        """
        return self._mask

    @mask.setter
    def mask(self, mask):
        """Sets the mask of this SpeechAnalyticsAudioInput.

        (optional) Array of time intervals that will be masked in the audio. The masked audio will not be transcribed.</br> This is useful for e.g. cases where 4 channels from a warm transfer are provided and there is duplication in the audio.   # noqa: E501

        :param mask: The mask of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: list[SpeechAnalyticsAudioInputMask]
        """

        self._mask = mask

    @property
    def merged_stereo_channel(self):
        """Gets the merged_stereo_channel of this SpeechAnalyticsAudioInput.  # noqa: E501

        (optional) Determines spatial position of this audio channel in the merged audio. </br> If not specified then `audioChannelSelector` value will be used (`mix` -> `mid`)   # noqa: E501

        :return: The merged_stereo_channel of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: str
        """
        return self._merged_stereo_channel

    @merged_stereo_channel.setter
    def merged_stereo_channel(self, merged_stereo_channel):
        """Sets the merged_stereo_channel of this SpeechAnalyticsAudioInput.

        (optional) Determines spatial position of this audio channel in the merged audio. </br> If not specified then `audioChannelSelector` value will be used (`mix` -> `mid`)   # noqa: E501

        :param merged_stereo_channel: The merged_stereo_channel of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: str
        """
        allowed_values = ["left", "right", "mid"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and merged_stereo_channel not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `merged_stereo_channel` ({0}), must be one of {1}"  # noqa: E501
                .format(merged_stereo_channel, allowed_values)
            )

        self._merged_stereo_channel = merged_stereo_channel

    @property
    def source(self):
        """Gets the source of this SpeechAnalyticsAudioInput.  # noqa: E501


        :return: The source of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: TranscribeMeetingRequestSource
        """
        return self._source

    @source.setter
    def source(self, source):
        """Sets the source of this SpeechAnalyticsAudioInput.


        :param source: The source of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: TranscribeMeetingRequestSource
        """
    ...
    @property
    def speakers(self):
        """Gets the speakers of this SpeechAnalyticsAudioInput.  # noqa: E501
        ...
        :return: The speakers of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def speakers(self, speakers):
        """Sets the speakers of this SpeechAnalyticsAudioInput.

        (optional) IDs of the speakers in this audio channel. They reference `speakers[].spkUserId` If absent then assume that there is just one speaker (unless diarization is turned on).</br> In the current version of this API, `speakers` should not be provided together with `diarization`. You can specify either one or the other but not both for a single audio.</br> Note: currently multiple speakers values are poorly supported - this value is an array to support future functionality.   # noqa: E501

        :param speakers: The speakers of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def vad_mode(self):
        """Gets the vad_mode of this SpeechAnalyticsAudioInput.  # noqa: E501


        :return: The vad_mode of this SpeechAnalyticsAudioInput.  # noqa: E501
        :rtype: VadMode
        """
    ...
    def vad_mode(self, vad_mode):
        """Sets the vad_mode of this SpeechAnalyticsAudioInput.


        :param vad_mode: The vad_mode of this SpeechAnalyticsAudioInput.  # noqa: E501
        :type: VadMode
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsAudioInput):
            return False
