...
class ContinuousRecognition(object):
    ...
    openapi_types = {
        'enable': 'bool',
        'no_callback_for': 'list[AsrProcessingStatus]',
        'stop_on': 'list[AsrProcessingStatus]'
    }
    ...
    def __init__(self, enable=False, no_callback_for=["INPROGRESS","INPUT-STARTED"], stop_on=["MATCH"], local_vars_configuration=None):  # noqa: E501
    ...
    def no_callback_for(self):
        ...
        :rtype: list[AsrProcessingStatus]
        """
