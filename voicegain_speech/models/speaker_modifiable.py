...
class SpeakerModifiable(object):
    ...
    def __init__(self, creator=None, name=None, user_id=None, local_vars_configuration=None):  # noqa: E501
        """SpeakerModifiable - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def creator(self):
        """Gets the creator of this SpeakerModifiable.  # noqa: E501
        ...
        :return: The creator of this SpeakerModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this SpeakerModifiable.

        UUID of the user who created this Speaker.  If not provided then will be set based on the user who submitted the request (from MAC session).   # noqa: E501

        :param creator: The creator of this SpeakerModifiable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SpeakerModifiable.  # noqa: E501
        ...
        :return: The name of this SpeakerModifiable.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SpeakerModifiable.

        Speaker name (full). Only needs to be set if the `userId` is not specified. If `userId` is provided then will use the name of the user.   # noqa: E501

        :param name: The name of this SpeakerModifiable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this SpeakerModifiable.  # noqa: E501

        Optional userId. If provided then the speaker is tied to the specified user on the Account.   # noqa: E501

        :return: The user_id of this SpeakerModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this SpeakerModifiable.

        Optional userId. If provided then the speaker is tied to the specified user on the Account.   # noqa: E501

        :param user_id: The user_id of this SpeakerModifiable.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeakerModifiable):
            return False
