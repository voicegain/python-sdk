...
class AsrSettingsTranscriptionAsync(object):
    ...
    def __init__(self, acoustic_model_non_real_time=None, acoustic_model_real_time=None, confidence_threshold=0.01, languages=None, max_alternatives=1, sensitivity=0.5, speech_context='normal', speed_vs_accuracy=0.5, decoder_factor=None, hints=None, lang_model=None, lang_model_factor=None, diarization=None, identify_speaker_age=None, identify_speaker_gender=None, complete_timeout=-1, no_input_timeout=15000, start_input_timers=False, local_vars_configuration=None):  # noqa: E501
