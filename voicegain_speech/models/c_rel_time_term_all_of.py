...
class CRelTimeTermAllOf(object):
    ...
    def __init__(self, field=None, relationship=None, unit=None, value=1, local_vars_configuration=None):  # noqa: E501
        """CRelTimeTermAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def field(self):
        """Gets the field of this CRelTimeTermAllOf.  # noqa: E501


        :return: The field of this CRelTimeTermAllOf.  # noqa: E501
        :rtype: CallFieldForTime
        """
        return self._field

    @field.setter
    def field(self, field):
        """Sets the field of this CRelTimeTermAllOf.


        :param field: The field of this CRelTimeTermAllOf.  # noqa: E501
        :type: CallFieldForTime
        """
    ...
    def relationship(self):
        """Gets the relationship of this CRelTimeTermAllOf.  # noqa: E501

        Relationship of the time to the current time: + current - Generally used with value=1, e.g., \"current 1 week\" means the current week (week-to-date). If the value is greater than 1 then it means the current and the previous weeks, e.g., \"current 2 weeks\" means the current week and the previous 1 week. + previous - means previous time unit, e.g., \"previous 2 weeks\" means previous 2 weeks (not including current week)   # noqa: E501

        :return: The relationship of this CRelTimeTermAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def relationship(self, relationship):
        """Sets the relationship of this CRelTimeTermAllOf.

        Relationship of the time to the current time: + current - Generally used with value=1, e.g., \"current 1 week\" means the current week (week-to-date). If the value is greater than 1 then it means the current and the previous weeks, e.g., \"current 2 weeks\" means the current week and the previous 1 week. + previous - means previous time unit, e.g., \"previous 2 weeks\" means previous 2 weeks (not including current week)   # noqa: E501

        :param relationship: The relationship of this CRelTimeTermAllOf.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and relationship is None:  # noqa: E501
            raise ValueError("Invalid value for `relationship`, must not be `None`")  # noqa: E501
        allowed_values = ["current", "previous"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and relationship not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    @property
    def unit(self):
        """Gets the unit of this CRelTimeTermAllOf.  # noqa: E501

        Time unit for this query   # noqa: E501

        :return: The unit of this CRelTimeTermAllOf.  # noqa: E501
        :rtype: str
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        """Sets the unit of this CRelTimeTermAllOf.

        Time unit for this query   # noqa: E501

        :param unit: The unit of this CRelTimeTermAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this CRelTimeTermAllOf.  # noqa: E501

        Value of the time unit, see `relationship` for how it is interpreted.   # noqa: E501

        :return: The value of this CRelTimeTermAllOf.  # noqa: E501
        :rtype: int
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this CRelTimeTermAllOf.

        Value of the time unit, see `relationship` for how it is interpreted.   # noqa: E501

        :param value: The value of this CRelTimeTermAllOf.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CRelTimeTermAllOf):
            return False
