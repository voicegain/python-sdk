...
class WordItemAnnotation(object):
    ...
    def __init__(self, start=False, tag=None, type=None, local_vars_configuration=None):  # noqa: E501
        """WordItemAnnotation - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def start(self):
        """Gets the start of this WordItemAnnotation.  # noqa: E501

        If false then it means that this is a continuation of an annotation that applies to multiple words. In the UI, if false, should hightlight also the space between this word and the previous word,  unless this is a first word in a section.   # noqa: E501

        :return: The start of this WordItemAnnotation.  # noqa: E501
        :rtype: bool
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordItemAnnotation.

        If false then it means that this is a continuation of an annotation that applies to multiple words. In the UI, if false, should hightlight also the space between this word and the previous word,  unless this is a first word in a section.   # noqa: E501

        :param start: The start of this WordItemAnnotation.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this WordItemAnnotation.  # noqa: E501

        The tag to show with the word. For example, if annotation is `ner` then the tag will show the type of NER, e.g. `TIME`. In the UI, the tag can be shown in a tool tip (if a word has multiple annotations then show them in a single tooltip).   # noqa: E501

        :return: The tag of this WordItemAnnotation.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this WordItemAnnotation.

        The tag to show with the word. For example, if annotation is `ner` then the tag will show the type of NER, e.g. `TIME`. In the UI, the tag can be shown in a tool tip (if a word has multiple annotations then show them in a single tooltip).   # noqa: E501

        :param tag: The tag of this WordItemAnnotation.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this WordItemAnnotation.  # noqa: E501

        The type of annotation. In the UI it will determine the color or type of word highlight.</br> Words with `dtmf` annotation, were obviously not spoken, but represent DTMF tone value in the channel corresponding to the given speaker.   # noqa: E501

        :return: The type of this WordItemAnnotation.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WordItemAnnotation.

        The type of annotation. In the UI it will determine the color or type of word highlight.</br> Words with `dtmf` annotation, were obviously not spoken, but represent DTMF tone value in the channel corresponding to the given speaker.   # noqa: E501

        :param type: The type of this WordItemAnnotation.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["keyword", "ner", "phrase", "dtmf"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordItemAnnotation):
            return False
