...
class OfflineSpeechAnalyticsBaseRequestWithoutSpeakers(object):
    ...
    @property
    def label(self):
        """Gets the label of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        ...
        :return: The label of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.

        Label for the result so that it can be easily identified e.g. in the Web UI. </br> Generally follows the same limitations as a file name. </br> Can contain any unicode character except control characters and except < > : \" / \\ |  ? * </br> Moreover, spaces and dots in front and at the end are not allowed.   # noqa: E501

        :param label: The label of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        ...
        :return: The metadata of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
    ...
    @property
    def settings(self):
        """Gets the settings of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501


        :return: The settings of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.


        :param settings: The settings of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :return: The tags of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :param tags: The tags of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :type: list[str]
        """
    ...
    def voice_signature_speakers(self):
        """Gets the voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501

        Optional list of Speakers (Agents) with voice signatures to be used in processing this call.  # noqa: E501

        :return: The voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def voice_signature_speakers(self, voice_signature_speakers):
        """Sets the voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.

        Optional list of Speakers (Agents) with voice signatures to be used in processing this call.  # noqa: E501

        :param voice_signature_speakers: The voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequestWithoutSpeakers.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineSpeechAnalyticsBaseRequestWithoutSpeakers):
            return False
