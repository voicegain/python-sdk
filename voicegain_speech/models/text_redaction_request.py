...
class TextRedactionRequest(object):
    ...
    @property
    def debug(self):
        """Gets the debug of this TextRedactionRequest.  # noqa: E501


        :return: The debug of this TextRedactionRequest.  # noqa: E501
        :rtype: DebugSettings
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this TextRedactionRequest.


        :param debug: The debug of this TextRedactionRequest.  # noqa: E501
        :type: DebugSettings
        """
    ...
    @property
    def formatters(self):
        """Gets the formatters of this TextRedactionRequest.  # noqa: E501

        (optional) Configuration for text redaction.  Currently 3 types of redactors are available: + **redact** (PII redaction for CC, SSN, etc.) + **regex** (redaction using regex expressions) + **answer_redact** (redaction of the answer following a configured question) </br>  Notice that all parameters values must be strings.</br>   # noqa: E501

        :return: The formatters of this TextRedactionRequest.  # noqa: E501
        :rtype: list[Redactor]
        """
    ...
    def formatters(self, formatters):
        """Sets the formatters of this TextRedactionRequest.

        (optional) Configuration for text redaction.  Currently 3 types of redactors are available: + **redact** (PII redaction for CC, SSN, etc.) + **regex** (redaction using regex expressions) + **answer_redact** (redaction of the answer following a configured question) </br>  Notice that all parameters values must be strings.</br>   # noqa: E501

        :param formatters: The formatters of this TextRedactionRequest.  # noqa: E501
        :type: list[Redactor]
        """
    ...
    def pii_redaction(self):
        """Gets the pii_redaction of this TextRedactionRequest.  # noqa: E501

        List specifying the types of entities to be redacted from the text.   # noqa: E501

        :return: The pii_redaction of this TextRedactionRequest.  # noqa: E501
        :rtype: list[PIITextRedactionConf]
        """
        return self._pii_redaction

    @pii_redaction.setter
    def pii_redaction(self, pii_redaction):
        """Sets the pii_redaction of this TextRedactionRequest.

        List specifying the types of entities to be redacted from the text.   # noqa: E501

        :param pii_redaction: The pii_redaction of this TextRedactionRequest.  # noqa: E501
        :type: list[PIITextRedactionConf]
        """
    ...
    @property
    def speakers(self):
        """Gets the speakers of this TextRedactionRequest.  # noqa: E501

        (optional) Known active speakers involved in the text. If absent then will asume that the whole text is from a single speaker, or that speaker identification is not relevant to redaction.   # noqa: E501

        :return: The speakers of this TextRedactionRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def speakers(self, speakers):
        """Sets the speakers of this TextRedactionRequest.

        (optional) Known active speakers involved in the text. If absent then will asume that the whole text is from a single speaker, or that speaker identification is not relevant to redaction.   # noqa: E501

        :param speakers: The speakers of this TextRedactionRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextRedactionRequest):
            return False
