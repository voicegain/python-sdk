...
class TextRedactionRequest(object):
    ...
    def formatters(self):
        ...
        (optional) Configuration for text redaction.  Currently 2 types of redactors are available: + **redact** (PII redaction for CC, SSN, etc.)  + **regex** (redaction using regex expressions)         </br>  Notice that all parameters values must be strings.</br>   # noqa: E501
