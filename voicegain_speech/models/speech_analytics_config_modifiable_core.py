...
class SpeechAnalyticsConfigModifiableCore(object):
    ...
    def __init__(self, age=False, call_resolution_criteria=None, call_resolution_question_id=None, competitor_keyword_groups=None, criteria=None, csat_question=None, entities=None, gender=False, kb_recommendation=None, keyword_groups=None, keywords=None, llm_copilot_notes_prompt='Generate brief notes for the record of this call in the CRM.', llm_summary_prompt='Generate a one-sentence summary of the call.', meeting_minutes=None, moods=None, nps_question=None, overtalk_single_duration_maximum_threshold=1000, overtalk_total_percentage_threshold=2.5, phrase_groups=None, phrases=None, pii_redaction=None, profanity=False, published=False, sentiment=False, silence_single_duration_maximum_threshold=10000, silence_total_percentage_threshold=10.0, summary=False, topics=None, word_cloud=False, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsConfigModifiableCore - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def age(self):
        """Gets the age of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        _(future functionality)_ Set to true to enable speaker age estimation  # noqa: E501

        :return: The age of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
        return self._age
    ...
    @age.setter
    def age(self, age):
        """Sets the age of this SpeechAnalyticsConfigModifiableCore.

        _(future functionality)_ Set to true to enable speaker age estimation  # noqa: E501

        :param age: The age of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    def call_resolution_criteria(self):
        """Gets the call_resolution_criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501
        ...
        :return: The call_resolution_criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def call_resolution_criteria(self, call_resolution_criteria):
        """Sets the call_resolution_criteria of this SpeechAnalyticsConfigModifiableCore.

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :param call_resolution_criteria: The call_resolution_criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: list[str]
        """
    ...
    def call_resolution_question_id(self):
        """Gets the call_resolution_question_id of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :return: The call_resolution_question_id of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: str
        """
    ...
    def call_resolution_question_id(self, call_resolution_question_id):
        """Sets the call_resolution_question_id of this SpeechAnalyticsConfigModifiableCore.

        **Deprecated** — this functionality has been replaced by Call Insight with name `RESOLVED`. Use a Call Insights question with name `RESOLVED` to determine call resolution instead.</br> Any currently set value of this field is ignored.   # noqa: E501

        :param call_resolution_question_id: The call_resolution_question_id of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: str
        """
    ...
    def competitor_keyword_groups(self):
        """Gets the competitor_keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The competitor_keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def competitor_keyword_groups(self, competitor_keyword_groups):
        """Sets the competitor_keyword_groups of this SpeechAnalyticsConfigModifiableCore.

        _(internal use - for Speech Analytics UI)_ Set of one or more keyword group tags that should be interpreted as identifying competitor mentions.    # noqa: E501

        :param competitor_keyword_groups: The competitor_keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def criteria(self):
        """Gets the criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def criteria(self, criteria):
        """Sets the criteria of this SpeechAnalyticsConfigModifiableCore.

        Criteria to be detected</br> Each Criterion cofiguration contains a list of SubCriteria that need to be satisfied.  **All** SubCriteria within the list must be satisfied for the list to return true.</br> Empty SubCriteria list is considered true (satisfies all SubCriteria).</br> Within each SubCriteria all __specified__ properties must return true for the SubCriteria to be true (AND). Except for `dialogElements` all properties are assumed to must match within the same sentence.   # noqa: E501

        :param criteria: The criteria of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def csat_question(self):
        """Gets the csat_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501


        :return: The csat_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def csat_question(self, csat_question):
        """Sets the csat_question of this SpeechAnalyticsConfigModifiableCore.


        :param csat_question: The csat_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def entities(self):
        """Gets the entities of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The entities of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def entities(self, entities):
        """Sets the entities of this SpeechAnalyticsConfigModifiableCore.

        Selection of Named Entity types to detect. </br> Entities are different from keywords in that an entity may have a large number of possible values  which do not have to be enumerated in order to be detected. </br> Types of Named Entities: + ADDRESS - Postal address. + CARDINAL - Numerals that do not fall under another type. + CC - Credit Card + CVV - Credit Card CVV + DATE - Absolute or relative dates or periods. + DMY - Full date including all of day, month and year.           + EMAIL - Email address + EVENT - Named hurricanes, battles, wars, sports events, etc. + FAC - Buildings, airports, highways, bridges, etc. + GPE - Countries, cities, states. + LANGUAGE - Any named language. + LAW - Named documents made into laws. + NORP - Nationalities or religious or political groups. + MONEY - Monetary values, including unit. + ORDINAL - \"first\", \"second\", etc. + ORG - Companies, agencies, institutions, etc. + PERCENT - Percentage, including \"%\". + PERSON - People, including fictional. + PHONE - Phone number. + PRODUCT - Objects, vehicles, foods, etc. (Not services.) + QUANTITY - Measurements, as of weight or distance. + SSN - Social Security number + TIME - Times smaller than a day. + WORK_OF_ART - Titles of books, songs, etc. + ZIP - Zip Code (if not part of an Address)  Default is no NERs selected.    # noqa: E501

        :param entities: The entities of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def gender(self):
        """Gets the gender of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        _(not available for real-time mode yet)_ Set to true to enable voice gender classifcation  # noqa: E501

        :return: The gender of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
        return self._gender
    ...
    def gender(self, gender):
        """Sets the gender of this SpeechAnalyticsConfigModifiableCore.

        _(not available for real-time mode yet)_ Set to true to enable voice gender classifcation  # noqa: E501

        :param gender: The gender of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    def kb_recommendation(self):
        """Gets the kb_recommendation of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501


        :return: The kb_recommendation of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def kb_recommendation(self, kb_recommendation):
        """Sets the kb_recommendation of this SpeechAnalyticsConfigModifiableCore.


        :param kb_recommendation: The kb_recommendation of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def keyword_groups(self):
        """Gets the keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def keyword_groups(self, keyword_groups):
        """Sets the keyword_groups of this SpeechAnalyticsConfigModifiableCore.

        Keyword groups - Group tags must be different from the tags used for keywords. One use for keyword groups is that the GET /sa/call-stats API supports reporting stats of keywords within a Group.</br> Default - there are no keyword groups.   # noqa: E501

        :param keyword_groups: The keyword_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def keywords(self):
        """Gets the keywords of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The keywords of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def keywords(self, keywords):
        """Sets the keywords of this SpeechAnalyticsConfigModifiableCore.

        Configuration that specifies keywords to be detected. The keyword detection algorithm uses text matching with simple text manipulations like e.g. stemming.</br> Keywords are different in that respect from phrases - phrase detection uses NLU algorithm with neural networks which allows for matching based on approximate meaning.</br> Default is not keyword detection.   # noqa: E501

        :param keywords: The keywords of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def llm_copilot_notes_prompt(self):
        """Gets the llm_copilot_notes_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The llm_copilot_notes_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: str
        """
    ...
    def llm_copilot_notes_prompt(self, llm_copilot_notes_prompt):
        """Sets the llm_copilot_notes_prompt of this SpeechAnalyticsConfigModifiableCore.

        _(internal use)_ LLM Prompt that is used to generate the copilot notes.  These are the notes that the Agent would normally enter into the CRM system at the end of the call. They ignore anything that is not relevant for the future record on the caller account. The copilot notes are generated immediately after the call ends.   # noqa: E501

        :param llm_copilot_notes_prompt: The llm_copilot_notes_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: str
        """
    ...
    def llm_summary_prompt(self):
        """Gets the llm_summary_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        LLM Prompt used to generate the summary of the transcript - stored in the `summary` field. (In SA Call use cases, used to populate the notes field on the call and call segment.)   # noqa: E501

        :return: The llm_summary_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: str
        """
    ...
    def llm_summary_prompt(self, llm_summary_prompt):
        """Sets the llm_summary_prompt of this SpeechAnalyticsConfigModifiableCore.

        LLM Prompt used to generate the summary of the transcript - stored in the `summary` field. (In SA Call use cases, used to populate the notes field on the call and call segment.)   # noqa: E501

        :param llm_summary_prompt: The llm_summary_prompt of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: str
        """
    ...
    def meeting_minutes(self):
        """Gets the meeting_minutes of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501


        :return: The meeting_minutes of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def meeting_minutes(self, meeting_minutes):
        """Sets the meeting_minutes of this SpeechAnalyticsConfigModifiableCore.


        :param meeting_minutes: The meeting_minutes of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def moods(self):
        """Gets the moods of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        **Deprecated** — mood detection is no longer maintained. Use `sentiment` (and `sentimentFinal` / `sentimentTrend` / `smoothSentiment`) or [Call Insights](#tag/call-insights) instead.</br> Choose the moods to report.</br> Default no moods are reported.   # noqa: E501
        ...
        :return: The moods of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: list[MoodType]
        """
        return self._moods
    ...
    def moods(self, moods):
        """Sets the moods of this SpeechAnalyticsConfigModifiableCore.

        **Deprecated** — mood detection is no longer maintained. Use `sentiment` (and `sentimentFinal` / `sentimentTrend` / `smoothSentiment`) or [Call Insights](#tag/call-insights) instead.</br> Choose the moods to report.</br> Default no moods are reported.   # noqa: E501

        :param moods: The moods of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: list[MoodType]
        """
    ...
    def nps_question(self):
        """Gets the nps_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501


        :return: The nps_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def nps_question(self, nps_question):
        """Sets the nps_question of this SpeechAnalyticsConfigModifiableCore.


        :param nps_question: The nps_question of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def overtalk_single_duration_maximum_threshold(self):
        """Gets the overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: float
        """
    ...
    def overtalk_single_duration_maximum_threshold(self, overtalk_single_duration_maximum_threshold):
        """Sets the overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.

        Duration-based threshold (in milliseconds) used to determine if an overtalk incident has occurred.  Applies to maximun duration of single/individual cases of overtalk.   # noqa: E501

        :param overtalk_single_duration_maximum_threshold: The overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def overtalk_total_percentage_threshold(self):
        """Gets the overtalk_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The overtalk_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: float
        """
    ...
    def overtalk_total_percentage_threshold(self, overtalk_total_percentage_threshold):
        """Sets the overtalk_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.

        Percentage-based threshold used to determine if an overtalk incident has occurred.  Applies to total overtalk expressed as percentage of the call duration.   # noqa: E501

        :param overtalk_total_percentage_threshold: The overtalk_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def phrase_groups(self):
        """Gets the phrase_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The phrase_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def phrase_groups(self, phrase_groups):
        """Sets the phrase_groups of this SpeechAnalyticsConfigModifiableCore.

        Group of phrases/intents. Can be used to detect combinations of phrases in the caller.</br> By default there are no phrase groups.   # noqa: E501

        :param phrase_groups: The phrase_groups of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def phrases(self):
        """Gets the phrases of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The phrases of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def phrases(self, phrases):
        """Sets the phrases of this SpeechAnalyticsConfigModifiableCore.

        Phrases/Intents detected in the text. Phrase detection uses NLU algorithm with neural networks which allows for matching based on approximate meaning. Phrase matching is applied to one sentence at a time. To match multiple sentences in a row please use phraseGroups.</br> If you want to match individual words or 2- or 3-word phrases it may be better to use keywords.</br> Default is no phrase detection.   # noqa: E501

        :param phrases: The phrases of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def pii_redaction(self):
        """Gets the pii_redaction of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The pii_redaction of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def pii_redaction(self, pii_redaction):
        """Sets the pii_redaction of this SpeechAnalyticsConfigModifiableCore.

        _(optional, not for real-time mode yet)_ List specifying the types of entities to be redacted from the transcript and/or audio</br> Default no PII redaction is performed.   # noqa: E501

        :param pii_redaction: The pii_redaction of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def profanity(self):
        """Gets the profanity of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        Set to true to enable detection of profanity. Will be output together with spotted keywords  # noqa: E501

        :return: The profanity of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
    ...
    def profanity(self, profanity):
        """Sets the profanity of this SpeechAnalyticsConfigModifiableCore.

        Set to true to enable detection of profanity. Will be output together with spotted keywords  # noqa: E501

        :param profanity: The profanity of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def published(self):
        """Gets the published of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The published of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
    ...
    def published(self, published):
        """Sets the published of this SpeechAnalyticsConfigModifiableCore.

        Specifies if Speech Analytics configuration can be used outside its context.</br> For built-in configurations, specifies if the configuration is visible to end-users of Voicegain. Only user with \"cmp\" role is able to see built-in configurations that are not published.   # noqa: E501

        :param published: The published of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sentiment(self):
        """Gets the sentiment of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        Set to true to enable sentiment analytics  # noqa: E501

        :return: The sentiment of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
    ...
    def sentiment(self, sentiment):
        """Sets the sentiment of this SpeechAnalyticsConfigModifiableCore.

        Set to true to enable sentiment analytics  # noqa: E501

        :param sentiment: The sentiment of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    def silence_single_duration_maximum_threshold(self):
        """Gets the silence_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The silence_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: float
        """
    ...
    def silence_single_duration_maximum_threshold(self, silence_single_duration_maximum_threshold):
        """Sets the silence_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.

        Duration-based threshold (in milliseconds) used to determine if a silence incident has occurred.  Applies to maximun duration of single/individual cases of silence.   # noqa: E501

        :param silence_single_duration_maximum_threshold: The silence_single_duration_maximum_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def silence_total_percentage_threshold(self):
        """Gets the silence_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The silence_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: float
        """
    ...
    def silence_total_percentage_threshold(self, silence_total_percentage_threshold):
        """Sets the silence_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.

        Percentage-based threshold used to determine if a silence incident has occurred.  Applies to total silence expressed as percentage of the call duration.   # noqa: E501

        :param silence_total_percentage_threshold: The silence_total_percentage_threshold of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def summary(self):
        """Gets the summary of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        ...
        :return: The summary of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
    ...
    def summary(self, summary):
        """Sets the summary of this SpeechAnalyticsConfigModifiableCore.

        _(not available for real-time mode yet)_ Set to true to enable output of summary of the transcript (summary is always accross all channels)  # noqa: E501

        :param summary: The summary of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def topics(self):
        """Gets the topics of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501


        :return: The topics of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    def topics(self, topics):
        """Sets the topics of this SpeechAnalyticsConfigModifiableCore.


        :param topics: The topics of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
    ...
    @property
    def word_cloud(self):
        """Gets the word_cloud of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501

        _(not for real-time mode)_ Set to true to enable output of word cloud data  # noqa: E501

        :return: The word_cloud of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :rtype: bool
        """
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this SpeechAnalyticsConfigModifiableCore.

        _(not for real-time mode)_ Set to true to enable output of word cloud data  # noqa: E501

        :param word_cloud: The word_cloud of this SpeechAnalyticsConfigModifiableCore.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsConfigModifiableCore):
            return False
