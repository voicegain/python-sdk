...
class SpeakerSentimentItem(object):
    ...
    def trend(self):
        ...
        Difference between `final` and `average`.</br> Positive values indicate sentiment improved towards the end, negative values indicate it worsened.</br> Ranges from -2.0 to +2.0.   # noqa: E501
