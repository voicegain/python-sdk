...
class AsrSettingsSaOfflineTranscription(object):
    ...
    openapi_types = {
        'hints': 'list[str]',
        'acoustic_model': 'str',
        'language_detection': 'AsrSettingsMeetingTranscriptionLanguageDetection',
    ...
    def __init__(self, hints=None, acoustic_model=None, language_detection=None, languages=None, optimized_for=None, sensitivity=0.5, speed_vs_accuracy=0.5, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsSaOfflineTranscription - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def hints(self):
        """Gets the hints of this AsrSettingsSaOfflineTranscription.  # noqa: E501

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input.</br> It is possible to provide a weight for a hint - it is a value from 1 to 10 (with 5 being the default) - the higher the value the more likely the hint is to be picked up but also more likely that it will be picked up by mistake. The weight value is separated from hint by `:`, e.g. \"Arioch:10\" </br> Up to 50 hints may be provided per request. </br> No special characters allowed except for '_' which is used in phrases.</br> You can also provide misspellings for hints e.g. \"HIPAA_policies[h_i_p_a_a_policies|hippa_policies|hi_pa_policies]:10\"</br> Currently, hint misspellings work in following output:  a) results of sync transcription,  b) response of polling async transcription with content set to transcript </br> For more info about hints see [this Knowledge Base article](https://support.voicegain.ai/hc/en-us/articles/4407993206548-Using-Hints)   # noqa: E501

        :return: The hints of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: list[str]
        """
        return self._hints
    ...
    def hints(self, hints):
        """Sets the hints of this AsrSettingsSaOfflineTranscription.

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input.</br> It is possible to provide a weight for a hint - it is a value from 1 to 10 (with 5 being the default) - the higher the value the more likely the hint is to be picked up but also more likely that it will be picked up by mistake. The weight value is separated from hint by `:`, e.g. \"Arioch:10\" </br> Up to 50 hints may be provided per request. </br> No special characters allowed except for '_' which is used in phrases.</br> You can also provide misspellings for hints e.g. \"HIPAA_policies[h_i_p_a_a_policies|hippa_policies|hi_pa_policies]:10\"</br> Currently, hint misspellings work in following output:  a) results of sync transcription,  b) response of polling async transcription with content set to transcript </br> For more info about hints see [this Knowledge Base article](https://support.voicegain.ai/hc/en-us/articles/4407993206548-Using-Hints)   # noqa: E501

        :param hints: The hints of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: list[str]
        """
    ...
    def acoustic_model(self):
        """Gets the acoustic_model of this AsrSettingsSaOfflineTranscription.  # noqa: E501

        (Optional) Name of an Acoustic Model that is to be used for offline processing. </br> If not provided a suitable default will be used.   # noqa: E501

        :return: The acoustic_model of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model(self, acoustic_model):
        """Sets the acoustic_model of this AsrSettingsSaOfflineTranscription.

        (Optional) Name of an Acoustic Model that is to be used for offline processing. </br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model: The acoustic_model of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: str
        """
    ...
    def language_detection(self):
        """Gets the language_detection of this AsrSettingsSaOfflineTranscription.  # noqa: E501


        :return: The language_detection of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: AsrSettingsMeetingTranscriptionLanguageDetection
        """
        return self._language_detection

    @language_detection.setter
    def language_detection(self, language_detection):
        """Sets the language_detection of this AsrSettingsSaOfflineTranscription.


        :param language_detection: The language_detection of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: AsrSettingsMeetingTranscriptionLanguageDetection
        """
    ...
    @property
    def languages(self):
        """Gets the languages of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        ...
        :return: The languages of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: list[Language]
        """
    ...
    def languages(self, languages):
        """Sets the languages of this AsrSettingsSaOfflineTranscription.

        Language that should be recognized - this is important for acousticModels that support more than one language.</br> This is a list parameter because in the future we will support multiple language recognition - for those cases where the exact language spoken in the audio is not known up-front.    # noqa: E501

        :param languages: The languages of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: list[Language]
        """
    ...
    def optimized_for(self):
        """Gets the optimized_for of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        ...
        :return: The optimized_for of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: str
        """
    ...
    def optimized_for(self, optimized_for):
        """Sets the optimized_for of this AsrSettingsSaOfflineTranscription.

        (Optional) Optimize various back-end settings for a specific use case. </br> If not provided then no specific optimization will be done.   # noqa: E501

        :param optimized_for: The optimized_for of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: str
        """
    ...
    def sensitivity(self):
        """Gets the sensitivity of this AsrSettingsSaOfflineTranscription.  # noqa: E501

        Determines the threshold for rejection of low volume background speech (or bleed-through from other channels). </br> 1 is most sensitive (least rejection) and corresponds to -90 dbFS </br> 0 is least sensitive (most rejection) and corresponds to -50 dbFS </br>   # noqa: E501

        :return: The sensitivity of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: float
        """
    ...
    def sensitivity(self, sensitivity):
        """Sets the sensitivity of this AsrSettingsSaOfflineTranscription.

        Determines the threshold for rejection of low volume background speech (or bleed-through from other channels). </br> 1 is most sensitive (least rejection) and corresponds to -90 dbFS </br> 0 is least sensitive (most rejection) and corresponds to -50 dbFS </br>   # noqa: E501

        :param sensitivity: The sensitivity of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: float
        """
    ...
    def speed_vs_accuracy(self):
        """Gets the speed_vs_accuracy of this AsrSettingsSaOfflineTranscription.  # noqa: E501

        Between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use.</br> For Edge deployment use only.   # noqa: E501

        :return: The speed_vs_accuracy of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :rtype: float
        """
    ...
    def speed_vs_accuracy(self, speed_vs_accuracy):
        """Sets the speed_vs_accuracy of this AsrSettingsSaOfflineTranscription.

        Between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use.</br> For Edge deployment use only.   # noqa: E501

        :param speed_vs_accuracy: The speed_vs_accuracy of this AsrSettingsSaOfflineTranscription.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsSaOfflineTranscription):
            return False
