...
class MeetingSpeakerResult(object):
    ...
    def __init__(self, email=None, external_user_id=None, from_diarization=None, is_host=None, is_phone=None, name=None, original_name=None, speaker_id=None, speech_duration_seconds=None, spk=None, vs_conf=None, local_vars_configuration=None):  # noqa: E501
        """MeetingSpeakerResult - a model defined in OpenAPI"""  # noqa: E501
        ...
        if spk is not None:
            self.spk = spk
        if vs_conf is not None:
            self.vs_conf = vs_conf

    @property
    def email(self):
        """Gets the email of this MeetingSpeakerResult.  # noqa: E501

        (optional) Email of the speaker. If present then it was obtained in one of 2 ways: + via the `speakerId` and then via `userId` in the Speaker - in this case this is the email of the User on the system + using the data from Zoom Meeting retrieved using `zoomMeetingId` from the meeting metadata (if present). </br> In this case we will first try to match `externalUserId` with the `user_id` of the participant of the meeting. </br> If that fails, we will try to match the `originalName` with the `name` of the participant of the meeting.   # noqa: E501

        :return: The email of this MeetingSpeakerResult.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this MeetingSpeakerResult.

        (optional) Email of the speaker. If present then it was obtained in one of 2 ways: + via the `speakerId` and then via `userId` in the Speaker - in this case this is the email of the User on the system + using the data from Zoom Meeting retrieved using `zoomMeetingId` from the meeting metadata (if present). </br> In this case we will first try to match `externalUserId` with the `user_id` of the participant of the meeting. </br> If that fails, we will try to match the `originalName` with the `name` of the participant of the meeting.   # noqa: E501

        :param email: The email of this MeetingSpeakerResult.  # noqa: E501
        :type: str
        """
    ...
    def from_diarization(self):
        """Gets the from_diarization of this MeetingSpeakerResult.  # noqa: E501

        (optional) True if the speaker was output from diarization.            # noqa: E501

        :return: The from_diarization of this MeetingSpeakerResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def from_diarization(self, from_diarization):
        """Sets the from_diarization of this MeetingSpeakerResult.

        (optional) True if the speaker was output from diarization.            # noqa: E501

        :param from_diarization: The from_diarization of this MeetingSpeakerResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def is_host(self):
        """Gets the is_host of this MeetingSpeakerResult.  # noqa: E501

        (optional) True if the speaker is the host of the meeting    # noqa: E501

        :return: The is_host of this MeetingSpeakerResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_host(self, is_host):
        """Sets the is_host of this MeetingSpeakerResult.

        (optional) True if the speaker is the host of the meeting    # noqa: E501

        :param is_host: The is_host of this MeetingSpeakerResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def is_phone(self):
        """Gets the is_phone of this MeetingSpeakerResult.  # noqa: E501

        (optional) True if the speaker joined the meeting by phone    # noqa: E501

        :return: The is_phone of this MeetingSpeakerResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_phone(self, is_phone):
        """Sets the is_phone of this MeetingSpeakerResult.

        (optional) True if the speaker joined the meeting by phone    # noqa: E501

        :param is_phone: The is_phone of this MeetingSpeakerResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this MeetingSpeakerResult.  # noqa: E501

        (optional) Name of the speaker. May be modified using PUT /asr/meeting/{mid}/spk    # noqa: E501

        :return: The name of this MeetingSpeakerResult.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MeetingSpeakerResult.

        (optional) Name of the speaker. May be modified using PUT /asr/meeting/{mid}/spk    # noqa: E501

        :param name: The name of this MeetingSpeakerResult.  # noqa: E501
        :type: str
        """
    ...
    def original_name(self):
        """Gets the original_name of this MeetingSpeakerResult.  # noqa: E501

        (optional) The first value that was assigned to the `name`.   Once set it should not change.   # noqa: E501

        :return: The original_name of this MeetingSpeakerResult.  # noqa: E501
        :rtype: str
        """
    ...
    def original_name(self, original_name):
        """Sets the original_name of this MeetingSpeakerResult.

        (optional) The first value that was assigned to the `name`.   Once set it should not change.   # noqa: E501

        :param original_name: The original_name of this MeetingSpeakerResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def speaker_id(self):
        """Gets the speaker_id of this MeetingSpeakerResult.  # noqa: E501
        ...
        :return: The speaker_id of this MeetingSpeakerResult.  # noqa: E501
        :rtype: str
        """
    ...
    def speaker_id(self, speaker_id):
        """Sets the speaker_id of this MeetingSpeakerResult.

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI.   # noqa: E501

        :param speaker_id: The speaker_id of this MeetingSpeakerResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def speech_duration_seconds(self):
        """Gets the speech_duration_seconds of this MeetingSpeakerResult.  # noqa: E501

        Total duration of the speaker speech in seconds.  Sum of the duration of the words sections for this speaker.   # noqa: E501

        :return: The speech_duration_seconds of this MeetingSpeakerResult.  # noqa: E501
        :rtype: float
        """
        return self._speech_duration_seconds

    @speech_duration_seconds.setter
    def speech_duration_seconds(self, speech_duration_seconds):
        """Sets the speech_duration_seconds of this MeetingSpeakerResult.

        Total duration of the speaker speech in seconds.  Sum of the duration of the words sections for this speaker.   # noqa: E501

        :param speech_duration_seconds: The speech_duration_seconds of this MeetingSpeakerResult.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                speech_duration_seconds is not None and speech_duration_seconds < 0.0):  # noqa: E501
            raise ValueError("Invalid value for `speech_duration_seconds`, must be a value greater than or equal to `0.0`")  # noqa: E501

        self._speech_duration_seconds = speech_duration_seconds

    @property
    def spk(self):
        """Gets the spk of this MeetingSpeakerResult.  # noqa: E501
        ...
        :return: The spk of this MeetingSpeakerResult.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this MeetingSpeakerResult.

        Speaker id that will be used in `words` output (associates each word with a speaker)</br> Range from 1 to 99 corresponds to speakers that were provided in the POST /asr/meeting requests in the `speakers` array. (It is the index into that array, with first element having index 1.)</br> Range 100 and above corresponds to Speakers not identified up-font  (either single speaker per audio or diarized speaker).</br>   `floor( spk / 100 )` will identify the input audio file.</br> `spk modulo 100` will be speaker id within single audio file</br>   # noqa: E501

        :param spk: The spk of this MeetingSpeakerResult.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def vs_conf(self):
        """Gets the vs_conf of this MeetingSpeakerResult.  # noqa: E501

        Voice Signature confidence - present only if `speakerId` was set based on a Voice Signature match. Will be absent otherwise.   # noqa: E501

        :return: The vs_conf of this MeetingSpeakerResult.  # noqa: E501
        :rtype: float
        """
        return self._vs_conf

    @vs_conf.setter
    def vs_conf(self, vs_conf):
        """Sets the vs_conf of this MeetingSpeakerResult.

        Voice Signature confidence - present only if `speakerId` was set based on a Voice Signature match. Will be absent otherwise.   # noqa: E501

        :param vs_conf: The vs_conf of this MeetingSpeakerResult.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                vs_conf is not None and vs_conf > 1.0):  # noqa: E501
            raise ValueError("Invalid value for `vs_conf`, must be a value less than or equal to `1.0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                vs_conf is not None and vs_conf < 0.0):  # noqa: E501
            raise ValueError("Invalid value for `vs_conf`, must be a value greater than or equal to `0.0`")  # noqa: E501

        self._vs_conf = vs_conf
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingSpeakerResult):
            return False
