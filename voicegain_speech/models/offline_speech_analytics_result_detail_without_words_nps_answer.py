...
class OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer(object):
    ...
    def __init__(self, answer_choice=None, answer_value=None, llm_justification=None, not_applicable=False, notes=None, local_vars_configuration=None):  # noqa: E501
        """OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer - a model defined in OpenAPI"""  # noqa: E501
    ...
    def answer_choice(self):
        """Gets the answer_choice of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501

        Makes sense only if in the Call Review Config the `answerType` is `choice` and `answerMapping` is defined.</br> If this is provided then there is no need to also set `answerValue` because that will be set by the back-end based on `answerChoice` and `answerMapping`.</br>   # noqa: E501

        :return: The answer_choice of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def answer_choice(self, answer_choice):
        """Sets the answer_choice of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.

        Makes sense only if in the Call Review Config the `answerType` is `choice` and `answerMapping` is defined.</br> If this is provided then there is no need to also set `answerValue` because that will be set by the back-end based on `answerChoice` and `answerMapping`.</br>   # noqa: E501

        :param answer_choice: The answer_choice of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :type: str
        """
    ...
    def answer_value(self):
        """Gets the answer_value of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501

        Value assigned to the answer, may nor exceed the maxValue for the question.</br> This takes precendence over `answerChoice` if both are provided.</br>  # noqa: E501

        :return: The answer_value of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :rtype: float
        """
    ...
    def answer_value(self, answer_value):
        """Sets the answer_value of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.

        Value assigned to the answer, may nor exceed the maxValue for the question.</br> This takes precendence over `answerChoice` if both are provided.</br>  # noqa: E501

        :param answer_value: The answer_value of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :type: float
        """
    ...
    @property
    def llm_justification(self):
        """Gets the llm_justification of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501

        Justification for the answer provided by LLM. We aim for the justification to be 3 to 5 sentences long.</br>   # noqa: E501

        :return: The llm_justification of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :rtype: str
        """
        return self._llm_justification

    @llm_justification.setter
    def llm_justification(self, llm_justification):
        """Sets the llm_justification of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.

        Justification for the answer provided by LLM. We aim for the justification to be 3 to 5 sentences long.</br>   # noqa: E501

        :param llm_justification: The llm_justification of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                llm_justification is not None and len(llm_justification) > 1024):
    ...
    def not_applicable(self):
        """Gets the not_applicable of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        ...
        :return: The not_applicable of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def not_applicable(self, not_applicable):
        """Sets the not_applicable of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.

        Set this to true if the question about CSAT as not applicable to a given call, e.g. if the call was abandoned in the early stage.  # noqa: E501

        :param not_applicable: The not_applicable of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501

        notes related to this question/answer  # noqa: E501

        :return: The notes of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.

        notes related to this question/answer  # noqa: E501

        :param notes: The notes of this OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineSpeechAnalyticsResultDetailWithoutWordsNpsAnswer):
            return False
