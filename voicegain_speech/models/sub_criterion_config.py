...
class SubCriterionConfig(object):
    ...
    def __init__(self, call_location=None, channel=None, dialog_elements=None, keywords=None, metrics=None, negation=None, ner=None, phrases=None, regex=None, local_vars_configuration=None):  # noqa: E501
        """SubCriterionConfig - a model defined in OpenAPI"""  # noqa: E501
    ...
    def call_location(self):
        """Gets the call_location of this SubCriterionConfig.  # noqa: E501
        ...
        :return: The call_location of this SubCriterionConfig.  # noqa: E501
        :rtype: int
        """
    ...
    def call_location(self, call_location):
        """Sets the call_location of this SubCriterionConfig.

        If defined then specifies additional restriction on where timewise in the call the match has to happen. If positive then specifies seconds from the start of the call. If negative then specifies seconds from the end of the call.    # noqa: E501

        :param call_location: The call_location of this SubCriterionConfig.  # noqa: E501
        :type: int
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this SubCriterionConfig.  # noqa: E501

        If present then specifies which channel the condition is to be appied to.   # noqa: E501

        :return: The channel of this SubCriterionConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this SubCriterionConfig.

        If present then specifies which channel the condition is to be appied to.   # noqa: E501

        :param channel: The channel of this SubCriterionConfig.  # noqa: E501
        :type: str
        """
    ...
    def dialog_elements(self):
        """Gets the dialog_elements of this SubCriterionConfig.  # noqa: E501
        ...
        :return: The dialog_elements of this SubCriterionConfig.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def dialog_elements(self, dialog_elements):
        """Sets the dialog_elements of this SubCriterionConfig.

        Tags referencing predefined dialog elements.      </br> At least one element from array must match for the match to be true (OR).      # noqa: E501

        :param dialog_elements: The dialog_elements of this SubCriterionConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def keywords(self):
        """Gets the keywords of this SubCriterionConfig.  # noqa: E501
        ...
        :return: The keywords of this SubCriterionConfig.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this SubCriterionConfig.

        Tags referencing keywords or keyword groups.   </br> At least one element from array must match for the match to be true (OR).                # noqa: E501

        :param keywords: The keywords of this SubCriterionConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def metrics(self):
        """Gets the metrics of this SubCriterionConfig.  # noqa: E501
        ...
        :return: The metrics of this SubCriterionConfig.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def metrics(self, metrics):
        """Sets the metrics of this SubCriterionConfig.

        Expressions referencing metrics (silence, overtalk, energy, pitch). Exact syntax is TBD. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param metrics: The metrics of this SubCriterionConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def negation(self):
        """Gets the negation of this SubCriterionConfig.  # noqa: E501

        If true then failure to satisfy the condition will be interpreted as true outcome.  # noqa: E501

        :return: The negation of this SubCriterionConfig.  # noqa: E501
        :rtype: bool
        """
    ...
    def negation(self, negation):
        """Sets the negation of this SubCriterionConfig.

        If true then failure to satisfy the condition will be interpreted as true outcome.  # noqa: E501

        :param negation: The negation of this SubCriterionConfig.  # noqa: E501
        :type: bool
        """
    ...
    @ner.setter
    def ner(self, ner):
        """Sets the ner of this SubCriterionConfig.

        Named entities to match.   </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param ner: The ner of this SubCriterionConfig.  # noqa: E501
    ...
    def phrases(self, phrases):
        """Sets the phrases of this SubCriterionConfig.

        Tags referencing predefined phrases.    </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param phrases: The phrases of this SubCriterionConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def regex(self):
        """Gets the regex of this SubCriterionConfig.  # noqa: E501
        ...
        :return: The regex of this SubCriterionConfig.  # noqa: E501
        :rtype: list[str]
        """
        return self._regex
    ...
    def regex(self, regex):
        """Sets the regex of this SubCriterionConfig.

        Regex expressions that match the transcript text. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param regex: The regex of this SubCriterionConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubCriterionConfig):
            return False
