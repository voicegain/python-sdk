...
class AsrProcessingStatusForCallback(object):
    ...
    allowable_values = [INPUT_STARTED, NOINPUT, NOMATCH, MATCH, ERROR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsrProcessingStatusForCallback - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrProcessingStatusForCallback):
            return False
