...
class NonSpeakingParticipantWithOptionalEmail(object):
    ...
    def __init__(self, is_host=None, is_phone=None, name=None, spk_user_id=None, email=None, local_vars_configuration=None):  # noqa: E501
        """NonSpeakingParticipantWithOptionalEmail - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def is_host(self):
        """Gets the is_host of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501

        true if the participant is the host of the meeting  # noqa: E501

        :return: The is_host of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_host(self, is_host):
        """Sets the is_host of this NonSpeakingParticipantWithOptionalEmail.

        true if the participant is the host of the meeting  # noqa: E501

        :param is_host: The is_host of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def is_phone(self):
        """Gets the is_phone of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501

        true if the participant joined the meeting by phone  # noqa: E501

        :return: The is_phone of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_phone(self, is_phone):
        """Sets the is_phone of this NonSpeakingParticipantWithOptionalEmail.

        true if the participant joined the meeting by phone  # noqa: E501

        :param is_phone: The is_phone of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501

        Name of the participant  # noqa: E501

        :return: The name of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NonSpeakingParticipantWithOptionalEmail.

        Name of the participant  # noqa: E501

        :param name: The name of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk_user_id(self):
        """Gets the spk_user_id of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501

        External ID of a user who was a meeting participant but who did not speak at all   # noqa: E501

        :return: The spk_user_id of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :rtype: float
        """
        return self._spk_user_id

    @spk_user_id.setter
    def spk_user_id(self, spk_user_id):
        """Sets the spk_user_id of this NonSpeakingParticipantWithOptionalEmail.

        External ID of a user who was a meeting participant but who did not speak at all   # noqa: E501

        :param spk_user_id: The spk_user_id of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and spk_user_id is None:  # noqa: E501
            raise ValueError("Invalid value for `spk_user_id`, must not be `None`")  # noqa: E501

        self._spk_user_id = spk_user_id

    @property
    def email(self):
        """Gets the email of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        ...
        :return: The email of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this NonSpeakingParticipantWithOptionalEmail.

        (optional) Email of the speaker. If present then it was obtained in one of 2 ways: + via the `speakerId` and then via `userId` in the Speaker - in this case this is the email of the User on the system + using the data from Zoom Meeting retrieved using `zoomMeetingId` from the meeting metadata (if present). </br> In this case we will first try to match `externalUserId` with the `user_id` of the participant of the meeting. </br> If that fails, we will try to match the `originalName` with the `name` of the participant of the meeting.   # noqa: E501

        :param email: The email of this NonSpeakingParticipantWithOptionalEmail.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NonSpeakingParticipantWithOptionalEmail):
            return False
