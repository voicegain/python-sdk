...
class DataObjectFileBase64(object):
    ...
    def __init__(self, content_type=None, description=None, encryption=None, long_persist=False, name=None, tags=None, transcoded=False, user=None, user_group=None, file_base64=None, local_vars_configuration=None):  # noqa: E501
        """DataObjectFileBase64 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def content_type(self):
        """Gets the content_type of this DataObjectFileBase64.  # noqa: E501
        ...
        :return: The content_type of this DataObjectFileBase64.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this DataObjectFileBase64.

        Type of the data stored with this Data Object (e.g. audio/wav).  This value will be set in the response Content-Type header when retrieving the data raw.   # noqa: E501

        :param content_type: The content_type of this DataObjectFileBase64.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this DataObjectFileBase64.  # noqa: E501

        User provided description of the data object (optional).  # noqa: E501

        :return: The description of this DataObjectFileBase64.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DataObjectFileBase64.

        User provided description of the data object (optional).  # noqa: E501

        :param description: The description of this DataObjectFileBase64.  # noqa: E501
        :type: str
        """
    ...
    @property
    def encryption(self):
        """Gets the encryption of this DataObjectFileBase64.  # noqa: E501
        ...
        :return: The encryption of this DataObjectFileBase64.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this DataObjectFileBase64.

        Controls encryption of the data in storage. Applies mainly to Edge deployments (default encryption setting is specified in the Edge cluster configuration).  + none - do not use encryption in storage + standard - encrypt in storage + enhanced - use JWT as part of the encryption key - this basically allows the client to control encryption of individual Data objects (client can create a unique JWT for accessing each Data object)  For Cloud `standard` is the default - `none` will be treated as `standard` and attempt to use `enhanced` will result in error.   # noqa: E501

        :param encryption: The encryption of this DataObjectFileBase64.  # noqa: E501
        :type: str
        """
    ...
    def long_persist(self):
        """Gets the long_persist of this DataObjectFileBase64.  # noqa: E501
        ...
        :return: The long_persist of this DataObjectFileBase64.  # noqa: E501
        :rtype: bool
        """
    ...
    def long_persist(self, long_persist):
        """Sets the long_persist of this DataObjectFileBase64.

        Default value `false` means that the DataObject will be garbage collected if there are no more references to it and the DataObject is older than `context.ageThresholdForDataObjectCleanup`. If you set value to `true` then the DataObject will **not** be garbage collected. Note, that you may be responsible for storage fees.    # noqa: E501

        :param long_persist: The long_persist of this DataObjectFileBase64.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this DataObjectFileBase64.  # noqa: E501
        ...
        :return: The name of this DataObjectFileBase64.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataObjectFileBase64.

        Human friendly identifier (does not have to be unique).</br> It is optional, but an object that does not have a name may be difficult to query.</br> Characters **not allowed** in a name are: star `*`, question mark `?`, colon `:`, pipe `|`, slash `/`, backslash `\\`, quote `\"`, any control characters including `NUL`</br> Name may not start with: any whitespace, period `.`, tilde `~`. </br> Name may not end with: any whitespace.</br>   # noqa: E501

        :param name: The name of this DataObjectFileBase64.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this DataObjectFileBase64.  # noqa: E501

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :return: The tags of this DataObjectFileBase64.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DataObjectFileBase64.

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :param tags: The tags of this DataObjectFileBase64.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def transcoded(self):
        """Gets the transcoded of this DataObjectFileBase64.  # noqa: E501

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :return: The transcoded of this DataObjectFileBase64.  # noqa: E501
        :rtype: bool
        """
    ...
    def transcoded(self, transcoded):
        """Sets the transcoded of this DataObjectFileBase64.

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :param transcoded: The transcoded of this DataObjectFileBase64.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def user(self):
        """Gets the user of this DataObjectFileBase64.  # noqa: E501

        Users associated with the data object (optional).  # noqa: E501

        :return: The user of this DataObjectFileBase64.  # noqa: E501
        :rtype: list[str]
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this DataObjectFileBase64.

        Users associated with the data object (optional).  # noqa: E501

        :param user: The user of this DataObjectFileBase64.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def user_group(self):
        """Gets the user_group of this DataObjectFileBase64.  # noqa: E501

        User groups associated with the data object (optional).  # noqa: E501

        :return: The user_group of this DataObjectFileBase64.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def user_group(self, user_group):
        """Sets the user_group of this DataObjectFileBase64.

        User groups associated with the data object (optional).  # noqa: E501

        :param user_group: The user_group of this DataObjectFileBase64.  # noqa: E501
        :type: list[str]
        """
    ...
    def file_base64(self):
        """Gets the file_base64 of this DataObjectFileBase64.  # noqa: E501

        (Optional) base64-encoded data. If provided, the data will base64 decoded and stored in SOS. You can alternatively use [multipart/form-data upload](#tag/data/operation/dataFilePut).  # noqa: E501

        :return: The file_base64 of this DataObjectFileBase64.  # noqa: E501
        :rtype: str
        """
    ...
    def file_base64(self, file_base64):
        """Sets the file_base64 of this DataObjectFileBase64.

        (Optional) base64-encoded data. If provided, the data will base64 decoded and stored in SOS. You can alternatively use [multipart/form-data upload](#tag/data/operation/dataFilePut).  # noqa: E501

        :param file_base64: The file_base64 of this DataObjectFileBase64.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectFileBase64):
            return False
