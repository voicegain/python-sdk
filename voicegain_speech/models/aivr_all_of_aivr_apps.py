...
class AIVRAllOfAivrApps(object):
    ...
    openapi_types = {
        'aivr_app_id': 'str',
        'allow_access_from_dev_console': 'bool',
        'persist_days': 'int'
    }

    attribute_map = {
        'aivr_app_id': 'aivrAppId',
        'allow_access_from_dev_console': 'allowAccessFromDevConsole',
        'persist_days': 'persistDays'
    }

    def __init__(self, aivr_app_id=None, allow_access_from_dev_console=False, persist_days=30, local_vars_configuration=None):  # noqa: E501
        """AIVRAllOfAivrApps - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._aivr_app_id = None
        self._allow_access_from_dev_console = None
        self._persist_days = None
        self.discriminator = None

        if aivr_app_id is not None:
            self.aivr_app_id = aivr_app_id
        if allow_access_from_dev_console is not None:
            self.allow_access_from_dev_console = allow_access_from_dev_console
        if persist_days is not None:
            self.persist_days = persist_days

    @property
    def aivr_app_id(self):
        """Gets the aivr_app_id of this AIVRAllOfAivrApps.  # noqa: E501

        UUID of an AIVR app  # noqa: E501

        :return: The aivr_app_id of this AIVRAllOfAivrApps.  # noqa: E501
        :rtype: str
        """
    ...
    def aivr_app_id(self, aivr_app_id):
        """Sets the aivr_app_id of this AIVRAllOfAivrApps.

        UUID of an AIVR app  # noqa: E501

        :param aivr_app_id: The aivr_app_id of this AIVRAllOfAivrApps.  # noqa: E501
        :type: str
        """
    ...
    @property
    def allow_access_from_dev_console(self):
        """Gets the allow_access_from_dev_console of this AIVRAllOfAivrApps.  # noqa: E501

        If true then the recording, /sa/call/, and /sa/offline session stored in the Speech Analytics context will be accessible from the Dev Console.</br> We are not duplicating that data in the Developer context, but we are providing a way to access it. Note that the AIVR Session does stay in the Developer context. If needed Speech Analytics app can access that data using the JWT token.   # noqa: E501

        :return: The allow_access_from_dev_console of this AIVRAllOfAivrApps.  # noqa: E501
        :rtype: bool
        """
        return self._allow_access_from_dev_console

    @allow_access_from_dev_console.setter
    def allow_access_from_dev_console(self, allow_access_from_dev_console):
        """Sets the allow_access_from_dev_console of this AIVRAllOfAivrApps.

        If true then the recording, /sa/call/, and /sa/offline session stored in the Speech Analytics context will be accessible from the Dev Console.</br> We are not duplicating that data in the Developer context, but we are providing a way to access it. Note that the AIVR Session does stay in the Developer context. If needed Speech Analytics app can access that data using the JWT token.   # noqa: E501

        :param allow_access_from_dev_console: The allow_access_from_dev_console of this AIVRAllOfAivrApps.  # noqa: E501
        :type: bool
        """

        self._allow_access_from_dev_console = allow_access_from_dev_console

    @property
    def persist_days(self):
        """Gets the persist_days of this AIVRAllOfAivrApps.  # noqa: E501

        Number of days to retain the data in the SpeechAnalytics context after the call has been processed.</br> If not provided then the default value of 30 days will be used.   # noqa: E501

        :return: The persist_days of this AIVRAllOfAivrApps.  # noqa: E501
        :rtype: int
        """
        return self._persist_days

    @persist_days.setter
    def persist_days(self, persist_days):
        """Sets the persist_days of this AIVRAllOfAivrApps.

        Number of days to retain the data in the SpeechAnalytics context after the call has been processed.</br> If not provided then the default value of 30 days will be used.   # noqa: E501

        :param persist_days: The persist_days of this AIVRAllOfAivrApps.  # noqa: E501
        :type: int
        """

        self._persist_days = persist_days
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRAllOfAivrApps):
            return False
