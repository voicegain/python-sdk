...
class Formatter(object):
    ...
    def __init__(self, parameters=None, type=None, local_vars_configuration=None):  # noqa: E501
        """Formatter - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this Formatter.  # noqa: E501

        Type of formatter: + digits - outputs numbers and digits using digits rather then using the default method of spelling them out as words.  Has one parameter `enabled` with the default value being true  (note, the default true means that if `enabled` is missing then it is assumed to be true, not that digits formatting is enabled by default) + spelling - ensures that output follows specific English spelling. Specify desired spelling in parameters as either \"lang\" : \"en-US\" or \"lang\" : \"en-GB\" + profanity - masks any profanities contained in the transcribed text.  Two types of masking are available to be specified in parameters, either \"mask\" : \"full\" (e.g. \\*\\*\\*\\*) or \"mask\" : \"partial\" (e.g. s\\*\\*t). If \"parameters\" is not provided, then \"mask\" : \"partial\" is assumed. If you want to use a custom profanity list, please contact us and we will help you make it available. Custom list can be chosen by specifying the \"source\" parameter, e.g., \"source\" : \"custom.acme.com\" + basic - **default formatter** - provides punctuation and capitalization, has one parameter `enabled` with the default value being true   # noqa: E501

        :return: The type of this Formatter.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Formatter.

        Type of formatter: + digits - outputs numbers and digits using digits rather then using the default method of spelling them out as words.  Has one parameter `enabled` with the default value being true  (note, the default true means that if `enabled` is missing then it is assumed to be true, not that digits formatting is enabled by default) + spelling - ensures that output follows specific English spelling. Specify desired spelling in parameters as either \"lang\" : \"en-US\" or \"lang\" : \"en-GB\" + profanity - masks any profanities contained in the transcribed text.  Two types of masking are available to be specified in parameters, either \"mask\" : \"full\" (e.g. \\*\\*\\*\\*) or \"mask\" : \"partial\" (e.g. s\\*\\*t). If \"parameters\" is not provided, then \"mask\" : \"partial\" is assumed. If you want to use a custom profanity list, please contact us and we will help you make it available. Custom list can be chosen by specifying the \"source\" parameter, e.g., \"source\" : \"custom.acme.com\" + basic - **default formatter** - provides punctuation and capitalization, has one parameter `enabled` with the default value being true   # noqa: E501

        :param type: The type of this Formatter.  # noqa: E501
        :type: str
        """
