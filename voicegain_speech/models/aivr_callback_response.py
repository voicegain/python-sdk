...
class AIVRCallbackResponse(object):
    ...
    def __init__(self, csid=None, sequence=None, sid=None, disconnect=None, prompt=None, question=None, transfer=None, vars=None, local_vars_configuration=None):  # noqa: E501
