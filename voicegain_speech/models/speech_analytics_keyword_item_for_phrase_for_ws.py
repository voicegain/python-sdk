...
class SpeechAnalyticsKeywordItemForPhraseForWS(object):
    ...
    def __init__(self, end=None, start=None, phrase=None, tag=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsKeywordItemForPhraseForWS - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end(self):
        """Gets the end of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :rtype: int
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this SpeechAnalyticsKeywordItemForPhraseForWS.

        end time in msec since start of audio  # noqa: E501

        :param end: The end of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start(self):
        """Gets the start of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501

        start time in msec since start of audio  # noqa: E501

        :return: The start of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this SpeechAnalyticsKeywordItemForPhraseForWS.

        start time in msec since start of audio  # noqa: E501

        :param start: The start of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :type: int
        """
    ...
    @property
    def phrase(self):
        """Gets the phrase of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501

        Sequence of words that constitute this keyword match  # noqa: E501

        :return: The phrase of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :rtype: str
        """
        return self._phrase
    ...
    def phrase(self, phrase):
        """Sets the phrase of this SpeechAnalyticsKeywordItemForPhraseForWS.

        Sequence of words that constitute this keyword match  # noqa: E501

        :param phrase: The phrase of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501

        Tag associated with the keyword  # noqa: E501

        :return: The tag of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this SpeechAnalyticsKeywordItemForPhraseForWS.

        Tag associated with the keyword  # noqa: E501

        :param tag: The tag of this SpeechAnalyticsKeywordItemForPhraseForWS.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsKeywordItemForPhraseForWS):
            return False
