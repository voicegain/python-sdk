...
class VoiceCallModifiableBase(object):
    ...
    @property
    def agent(self):
        """Gets the agent of this VoiceCallModifiableBase.  # noqa: E501


        :return: The agent of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: Agent
        """
        return self._agent
    ...
    def agent(self, agent):
        """Sets the agent of this VoiceCallModifiableBase.


        :param agent: The agent of this VoiceCallModifiableBase.  # noqa: E501
        :type: Agent
        """
    ...
    def aivr_app_id(self):
        """Gets the aivr_app_id of this VoiceCallModifiableBase.  # noqa: E501

        Id of the AIVR application that handled the call. Will be absent if the call did not come from an AIVR App.   # noqa: E501

        :return: The aivr_app_id of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def aivr_app_id(self, aivr_app_id):
        """Sets the aivr_app_id of this VoiceCallModifiableBase.

        Id of the AIVR application that handled the call. Will be absent if the call did not come from an AIVR App.   # noqa: E501

        :param aivr_app_id: The aivr_app_id of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def aivr_session_id(self):
        """Gets the aivr_session_id of this VoiceCallModifiableBase.  # noqa: E501

        Id of the AIVR session that handled the call. Will be absent if the call did not come from an AIVR Session.     # noqa: E501

        :return: The aivr_session_id of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def aivr_session_id(self, aivr_session_id):
        """Sets the aivr_session_id of this VoiceCallModifiableBase.

        Id of the AIVR session that handled the call. Will be absent if the call did not come from an AIVR Session.     # noqa: E501

        :param aivr_session_id: The aivr_session_id of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def aivr_vars(self):
        """Gets the aivr_vars of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The aivr_vars of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def aivr_vars(self, aivr_vars):
        """Sets the aivr_vars of this VoiceCallModifiableBase.

        (optional) Map with variables collected during AIVR session. </br> This is a copy from AIVR Session (the `vars` field) and we store it in the Call as JSON object (so this is not just a flat map).   # noqa: E501

        :param aivr_vars: The aivr_vars of this VoiceCallModifiableBase.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def business_open_state(self):
        """Gets the business_open_state of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The business_open_state of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def business_open_state(self, business_open_state):
        """Sets the business_open_state of this VoiceCallModifiableBase.

        State of the business open/close status.  This is determined using the business hours defined in the AIVR App (Business Config). If missing (or null) then the business hours were not defined in the AIVR App. + open - business is open + off_hours - business was closed when the call was placed but was open at other times that day + closed - business is closed the whole day   # noqa: E501

        :param business_open_state: The business_open_state of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def call_center_call_id(self):
        """Gets the call_center_call_id of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The call_center_call_id of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def call_center_call_id(self, call_center_call_id):
        """Sets the call_center_call_id of this VoiceCallModifiableBase.

        Id of the call in the call center system, e.g., Aircall. </br>  This is used to correlate the call with the call center system.   # noqa: E501

        :param call_center_call_id: The call_center_call_id of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def daily_repeat_calls(self):
        """Gets the daily_repeat_calls of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The daily_repeat_calls of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: int
        """
    ...
    def daily_repeat_calls(self, daily_repeat_calls):
        """Sets the daily_repeat_calls of this VoiceCallModifiableBase.

        Number of repeat calls. A repeat call is a call between the same `externalEndpoint` and the same `internalEndpoint` within a 24 hour window. We compute it while inserting the new call record - we do a count of other calls with the same endpoints in the period between `startTime` and `startTime - 24h`.  Note this is a repeat call count, so if there is only one call between the same endpoints within 24 hours then this will be 0.   # noqa: E501

        :param daily_repeat_calls: The daily_repeat_calls of this VoiceCallModifiableBase.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def direction(self):
        """Gets the direction of this VoiceCallModifiableBase.  # noqa: E501

        direction of the call  # noqa: E501

        :return: The direction of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def direction(self, direction):
        """Sets the direction of this VoiceCallModifiableBase.

        direction of the call  # noqa: E501

        :param direction: The direction of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def dtmf_events(self):
        """Gets the dtmf_events of this VoiceCallModifiableBase.  # noqa: E501

        List of DTMF events detected in the call  # noqa: E501

        :return: The dtmf_events of this VoiceCallModifiableBase.  # noqa: E501
    ...
    def dtmf_events(self, dtmf_events):
        """Sets the dtmf_events of this VoiceCallModifiableBase.

        List of DTMF events detected in the call  # noqa: E501

        :param dtmf_events: The dtmf_events of this VoiceCallModifiableBase.  # noqa: E501
    ...
    @property
    def end_time(self):
        """Gets the end_time of this VoiceCallModifiableBase.  # noqa: E501

        end time of the call (UTC)  # noqa: E501

        :return: The end_time of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this VoiceCallModifiableBase.

        end time of the call (UTC)  # noqa: E501

        :param end_time: The end_time of this VoiceCallModifiableBase.  # noqa: E501
        :type: datetime
        """
    ...
    def expiry_time(self):
        """Gets the expiry_time of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The expiry_time of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiry_time(self, expiry_time):
        """Sets the expiry_time of this VoiceCallModifiableBase.

        Expiration time of the call (UTC). The call and all call associated data will be deleted within 24-48 hours after this date-time.   # noqa: E501

        :param expiry_time: The expiry_time of this VoiceCallModifiableBase.  # noqa: E501
        :type: datetime
        """
    ...
    def external_endpoint(self):
        """Gets the external_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The external_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def external_endpoint(self, external_endpoint):
        """Sets the external_endpoint of this VoiceCallModifiableBase.

        Caller (for inbound) or callee (for outbound) identifier. For phone calls it will be a caller id (ANI) in E.164 format. For WebRTC it will be some TBD identifier.   # noqa: E501

        :param external_endpoint: The external_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def internal_endpoint(self):
        """Gets the internal_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The internal_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_endpoint(self, internal_endpoint):
        """Sets the internal_endpoint of this VoiceCallModifiableBase.

        Identifier of the internal endpoint that received inbound call or originated outbound call. For phone calls it will be DNIS or caller id. For WebRTC it will be some TBD identifier.   # noqa: E501

        :param internal_endpoint: The internal_endpoint of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def language(self):
        """Gets the language of this VoiceCallModifiableBase.  # noqa: E501


        :return: The language of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: Language
        """
    ...
    def language(self, language):
        """Sets the language of this VoiceCallModifiableBase.


        :param language: The language of this VoiceCallModifiableBase.  # noqa: E501
        :type: Language
        """
    ...
    @property
    def markers(self):
        """Gets the markers of this VoiceCallModifiableBase.  # noqa: E501

        Call timeline markers attached to the call  # noqa: E501

        :return: The markers of this VoiceCallModifiableBase.  # noqa: E501
    ...
    def markers(self, markers):
        """Sets the markers of this VoiceCallModifiableBase.

        Call timeline markers attached to the call  # noqa: E501

        :param markers: The markers of this VoiceCallModifiableBase.  # noqa: E501
    ...
    def num_audio_channels(self):
        """Gets the num_audio_channels of this VoiceCallModifiableBase.  # noqa: E501

        Number of audio channels in the `recording`. 1 is mono, 2 is stereo  # noqa: E501

        :return: The num_audio_channels of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: int
        """
    ...
    def num_audio_channels(self, num_audio_channels):
        """Sets the num_audio_channels of this VoiceCallModifiableBase.

        Number of audio channels in the `recording`. 1 is mono, 2 is stereo  # noqa: E501

        :param num_audio_channels: The num_audio_channels of this VoiceCallModifiableBase.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def num_spk_channels(self):
        """Gets the num_spk_channels of this VoiceCallModifiableBase.  # noqa: E501
        ...
        :return: The num_spk_channels of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: int
        """
    ...
    def num_spk_channels(self, num_spk_channels):
        """Sets the num_spk_channels of this VoiceCallModifiableBase.

        Number of speaker channels in the `recording`. 1 means that there is only one speaker, 2 means that there are 2 speakers. Note that: + if `numSpkChannels` is 1 then we will need to mix the recording down to mono if `numAudioChannels` is 2 (that is not a normal scenario) + if `numSpkChannels` is 2 then we will need to use diarization if `numAudioChannels` is 1   # noqa: E501

        :param num_spk_channels: The num_spk_channels of this VoiceCallModifiableBase.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def queue(self):
        """Gets the queue of this VoiceCallModifiableBase.  # noqa: E501


        :return: The queue of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: Queue
        """
        return self._queue
    ...
    def queue(self, queue):
        """Sets the queue of this VoiceCallModifiableBase.


        :param queue: The queue of this VoiceCallModifiableBase.  # noqa: E501
        :type: Queue
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this VoiceCallModifiableBase.  # noqa: E501

        start time of the call (UTC)  # noqa: E501

        :return: The start_time of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this VoiceCallModifiableBase.

        start time of the call (UTC)  # noqa: E501

        :param start_time: The start_time of this VoiceCallModifiableBase.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this VoiceCallModifiableBase.  # noqa: E501

        Tags attached to the call  # noqa: E501

        :return: The tags of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this VoiceCallModifiableBase.

        Tags attached to the call  # noqa: E501

        :param tags: The tags of this VoiceCallModifiableBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def voicebot_vars(self):
        """Gets the voicebot_vars of this VoiceCallModifiableBase.  # noqa: E501


        :return: The voicebot_vars of this VoiceCallModifiableBase.  # noqa: E501
    ...
    def voicebot_vars(self, voicebot_vars):
        """Sets the voicebot_vars of this VoiceCallModifiableBase.


        :param voicebot_vars: The voicebot_vars of this VoiceCallModifiableBase.  # noqa: E501
    ...
    def who_hung_up(self):
        """Gets the who_hung_up of this VoiceCallModifiableBase.  # noqa: E501

        Who hung up the call  # noqa: E501

        :return: The who_hung_up of this VoiceCallModifiableBase.  # noqa: E501
        :rtype: str
        """
    ...
    def who_hung_up(self, who_hung_up):
        """Sets the who_hung_up of this VoiceCallModifiableBase.

        Who hung up the call  # noqa: E501

        :param who_hung_up: The who_hung_up of this VoiceCallModifiableBase.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceCallModifiableBase):
            return False
