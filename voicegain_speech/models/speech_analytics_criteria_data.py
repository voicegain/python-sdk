...
class SpeechAnalyticsCriteriaData(object):
    ...
    def __init__(self, counts=None, list=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsCriteriaData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def counts(self):
        """Gets the counts of this SpeechAnalyticsCriteriaData.  # noqa: E501

        Map from from criteria tag to the count of number satisfied  # noqa: E501

        :return: The counts of this SpeechAnalyticsCriteriaData.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._counts
    ...
    def counts(self, counts):
        """Sets the counts of this SpeechAnalyticsCriteriaData.

        Map from from criteria tag to the count of number satisfied  # noqa: E501

        :param counts: The counts of this SpeechAnalyticsCriteriaData.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def list(self):
        """Gets the list of this SpeechAnalyticsCriteriaData.  # noqa: E501

        List of all Criteria detected with their locations in recording and transcript.  # noqa: E501

        :return: The list of this SpeechAnalyticsCriteriaData.  # noqa: E501
    ...
    @list.setter
    def list(self, list):
        """Sets the list of this SpeechAnalyticsCriteriaData.

        List of all Criteria detected with their locations in recording and transcript.  # noqa: E501

        :param list: The list of this SpeechAnalyticsCriteriaData.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsCriteriaData):
            return False
