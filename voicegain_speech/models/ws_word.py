...
class WsWord(object):
    ...
    def __init__(self, conf=None, end=None, spk=None, start=None, utt=None, local_vars_configuration=None):  # noqa: E501
        """WsWord - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def conf(self):
        """Gets the conf of this WsWord.  # noqa: E501

        confidence of the utterance  # noqa: E501

        :return: The conf of this WsWord.  # noqa: E501
        :rtype: float
        """
        return self._conf
    ...
    @conf.setter
    def conf(self, conf):
        """Sets the conf of this WsWord.

        confidence of the utterance  # noqa: E501

        :param conf: The conf of this WsWord.  # noqa: E501
        :type: float
        """
    ...
    @property
    def end(self):
        """Gets the end of this WsWord.  # noqa: E501

        position of the end of the utterance in milliseconds from start of audio  # noqa: E501

        :return: The end of this WsWord.  # noqa: E501
        :rtype: int
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this WsWord.

        position of the end of the utterance in milliseconds from start of audio  # noqa: E501

        :param end: The end of this WsWord.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def spk(self):
        """Gets the spk of this WsWord.  # noqa: E501
        ...
        :return: The spk of this WsWord.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WsWord.

        Speaker id - see separate speaker messages on how the spk related to channel and if it is an Agent. If this word is part of an Edit then spk value may be absent (redundant).   # noqa: E501

        :param spk: The spk of this WsWord.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def start(self, start):
        """Sets the start of this WsWord.

        position of the start of the utterance in milliseconds from start of audio  # noqa: E501

        :param start: The start of this WsWord.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def utt(self):
        """Gets the utt of this WsWord.  # noqa: E501

        utterance - the word that was recognized  # noqa: E501

        :return: The utt of this WsWord.  # noqa: E501
        :rtype: str
        """
        return self._utt
    ...
    @utt.setter
    def utt(self, utt):
        """Sets the utt of this WsWord.

        utterance - the word that was recognized  # noqa: E501

        :param utt: The utt of this WsWord.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WsWord):
            return False
