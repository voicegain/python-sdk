...
class SttGenericDataSettingsAsr(object):
    ...
    openapi_types = {
        ...
        'interpretation': 'SttGenericDataSettingsAsrInterpretation',
    ...
    def __init__(self, complete_timeout=2000, grammars=None, incomplete_timeout=5000, interpretation=None, max_alternatives=1, no_input_timeout=10000, local_vars_configuration=None):  # noqa: E501
        """SttGenericDataSettingsAsr - a model defined in OpenAPI"""  # noqa: E501
    ...
    def complete_timeout(self):
        """Gets the complete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        ...
        :return: The complete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: int
        """
    ...
    def complete_timeout(self, complete_timeout):
        """Sets the complete_timeout of this SttGenericDataSettingsAsr.

        ASR complete timeout (in msec). The length of silence required following user speech before the speech recognizer finalizes a result  (either accepting it or throwing a nomatch event).  The `completeTimeout` is used when the speech is a complete match of an active grammar and no further words can be spoken that would match the grammar. </br>There is an internal minimum of 500ms needed for detection of end-of-speech so setting value between 1 and 500 will result in effectively the value being 500.                 # noqa: E501

        :param complete_timeout: The complete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: int
        """
    ...
    @property
    def grammars(self):
        """Gets the grammars of this SttGenericDataSettingsAsr.  # noqa: E501
        ...
        :return: The grammars of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: list[Grammar]
        """
    ...
    def grammars(self, grammars):
        """Sets the grammars of this SttGenericDataSettingsAsr.

        (for grammar-based recognition only) </br> List of grammars to be used.  More than one grammar may be used e.g. 1) normal grammar + universal grammar  2) separate speech and dtmf grammars                 # noqa: E501

        :param grammars: The grammars of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: list[Grammar]
        """
    ...
    def incomplete_timeout(self):
        """Gets the incomplete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        ...
        :return: The incomplete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: int
        """
    ...
    def incomplete_timeout(self, incomplete_timeout):
        """Sets the incomplete_timeout of this SttGenericDataSettingsAsr.

        ASR incomplete timeout (in msec).  The length of silence required following user speech before the speech recognizer finalizes a result  (by either accepting it or throwing a nomatch event).  In contrast to `completeTimeout`, the `incompleteTimeout` is used when the speech is an incomplete match to an active grammar,  **or** when the speech is a match but it is possible to speak further and match the grammar.</br> A too short incomplete timeout may lead to an utterance being broken up inappropriately, or throwing a nomatch while user has still not finished speaking.  A too long incomplete timeout value delays the result completion and therefore makes the system responses feel slow to the user.  </br>There is an internal minimum of 500ms needed for detection of end-of-speech so setting value between 1 and 500 will result in effectively the value being 500.   # noqa: E501

        :param incomplete_timeout: The incomplete_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def interpretation(self):
        """Gets the interpretation of this SttGenericDataSettingsAsr.  # noqa: E501


        :return: The interpretation of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: SttGenericDataSettingsAsrInterpretation
        """
        return self._interpretation

    @interpretation.setter
    def interpretation(self, interpretation):
        """Sets the interpretation of this SttGenericDataSettingsAsr.


        :param interpretation: The interpretation of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: SttGenericDataSettingsAsrInterpretation
        """
    ...
    def max_alternatives(self):
        """Gets the max_alternatives of this SttGenericDataSettingsAsr.  # noqa: E501

        Maximum number of recognition hypotheses to return as result (top N-Best) Note, this is a maximum so fewer than the specified maxAlternatives results may be returned   # noqa: E501

        :return: The max_alternatives of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: int
        """
    ...
    def max_alternatives(self, max_alternatives):
        """Sets the max_alternatives of this SttGenericDataSettingsAsr.

        Maximum number of recognition hypotheses to return as result (top N-Best) Note, this is a maximum so fewer than the specified maxAlternatives results may be returned   # noqa: E501

        :param max_alternatives: The max_alternatives of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                max_alternatives is not None and max_alternatives > 10):  # noqa: E501
            raise ValueError("Invalid value for `max_alternatives`, must be a value less than or equal to `10`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this SttGenericDataSettingsAsr.  # noqa: E501

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :return: The no_input_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this SttGenericDataSettingsAsr.

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :param no_input_timeout: The no_input_timeout of this SttGenericDataSettingsAsr.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SttGenericDataSettingsAsr):
            return False
