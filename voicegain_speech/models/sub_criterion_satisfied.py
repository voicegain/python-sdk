...
class SubCriterionSatisfied(object):
    ...
    openapi_types = {
        'call_location': 'int',
        'channel': 'str',
        'dialog_elements': 'list[str]',
        'keywords': 'list[str]',
        'metrics': 'list[str]',
        'negation': 'bool',
        'ner': 'list[NamedEntityType]',
        'phrases': 'list[str]',
        'regex': 'list[str]',
        'end_time': 'int',
        'start_time': 'int'
    ...
    def __init__(self, call_location=None, channel=None, dialog_elements=None, keywords=None, metrics=None, negation=None, ner=None, phrases=None, regex=None, end_time=None, start_time=None, local_vars_configuration=None):  # noqa: E501
        """SubCriterionSatisfied - a model defined in OpenAPI"""  # noqa: E501
        ...
        if dialog_elements is not None:
            self.dialog_elements = dialog_elements
    ...
    def call_location(self):
        """Gets the call_location of this SubCriterionSatisfied.  # noqa: E501

        If defined then specifies additional restriction on where timewise in the call the match has to happen. If positive then specifies seconds from the start of the call. If negative then specifies seconds from the end of the call.    # noqa: E501

        :return: The call_location of this SubCriterionSatisfied.  # noqa: E501
        :rtype: int
        """
        return self._call_location

    @call_location.setter
    def call_location(self, call_location):
        """Sets the call_location of this SubCriterionSatisfied.

        If defined then specifies additional restriction on where timewise in the call the match has to happen. If positive then specifies seconds from the start of the call. If negative then specifies seconds from the end of the call.    # noqa: E501

        :param call_location: The call_location of this SubCriterionSatisfied.  # noqa: E501
        :type: int
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this SubCriterionSatisfied.  # noqa: E501

        If present then specifies which channel the condition is to be appied to.   # noqa: E501

        :return: The channel of this SubCriterionSatisfied.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this SubCriterionSatisfied.

        If present then specifies which channel the condition is to be appied to.   # noqa: E501

        :param channel: The channel of this SubCriterionSatisfied.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dialog_elements(self):
        """Gets the dialog_elements of this SubCriterionSatisfied.  # noqa: E501

        Tags referencing predefined dialog elements.      </br> At least one element from array must match for the match to be true (OR).      # noqa: E501

        :return: The dialog_elements of this SubCriterionSatisfied.  # noqa: E501
        :rtype: list[str]
        """
        return self._dialog_elements

    @dialog_elements.setter
    def dialog_elements(self, dialog_elements):
        """Sets the dialog_elements of this SubCriterionSatisfied.

        Tags referencing predefined dialog elements.      </br> At least one element from array must match for the match to be true (OR).      # noqa: E501

        :param dialog_elements: The dialog_elements of this SubCriterionSatisfied.  # noqa: E501
        :type: list[str]
        """

        self._dialog_elements = dialog_elements

    @property
    def keywords(self):
        """Gets the keywords of this SubCriterionSatisfied.  # noqa: E501

        Tags referencing keywords or keyword groups.   </br> At least one element from array must match for the match to be true (OR).                # noqa: E501

        :return: The keywords of this SubCriterionSatisfied.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def keywords(self, keywords):
        """Sets the keywords of this SubCriterionSatisfied.

        Tags referencing keywords or keyword groups.   </br> At least one element from array must match for the match to be true (OR).                # noqa: E501

        :param keywords: The keywords of this SubCriterionSatisfied.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def metrics(self):
        """Gets the metrics of this SubCriterionSatisfied.  # noqa: E501

        Expressions referencing metrics (silence, overtalk, energy, pitch). Exact syntax is TBD. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :return: The metrics of this SubCriterionSatisfied.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def metrics(self, metrics):
        """Sets the metrics of this SubCriterionSatisfied.

        Expressions referencing metrics (silence, overtalk, energy, pitch). Exact syntax is TBD. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param metrics: The metrics of this SubCriterionSatisfied.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def negation(self):
        """Gets the negation of this SubCriterionSatisfied.  # noqa: E501

        If true then failure to satisfy the condition will be interpreted as true outcome.  # noqa: E501

        :return: The negation of this SubCriterionSatisfied.  # noqa: E501
        :rtype: bool
        """
    ...
    def negation(self, negation):
        """Sets the negation of this SubCriterionSatisfied.

        If true then failure to satisfy the condition will be interpreted as true outcome.  # noqa: E501

        :param negation: The negation of this SubCriterionSatisfied.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def ner(self):
        """Gets the ner of this SubCriterionSatisfied.  # noqa: E501

        Named entities to match.   </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :return: The ner of this SubCriterionSatisfied.  # noqa: E501
    ...
    @ner.setter
    def ner(self, ner):
        """Sets the ner of this SubCriterionSatisfied.

        Named entities to match.   </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param ner: The ner of this SubCriterionSatisfied.  # noqa: E501
    ...
    @property
    def phrases(self):
        """Gets the phrases of this SubCriterionSatisfied.  # noqa: E501

        Tags referencing predefined phrases.    </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :return: The phrases of this SubCriterionSatisfied.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def phrases(self, phrases):
        """Sets the phrases of this SubCriterionSatisfied.

        Tags referencing predefined phrases.    </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param phrases: The phrases of this SubCriterionSatisfied.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def regex(self):
        """Gets the regex of this SubCriterionSatisfied.  # noqa: E501

        Regex expressions that match the transcript text. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :return: The regex of this SubCriterionSatisfied.  # noqa: E501
        :rtype: list[str]
        """
        return self._regex
    ...
    def regex(self, regex):
        """Sets the regex of this SubCriterionSatisfied.

        Regex expressions that match the transcript text. </br> At least one element from array must match for the match to be true (OR).    # noqa: E501

        :param regex: The regex of this SubCriterionSatisfied.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this SubCriterionSatisfied.  # noqa: E501

        end of the location in audio where the codition was met  # noqa: E501

        :return: The end_time of this SubCriterionSatisfied.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this SubCriterionSatisfied.

        end of the location in audio where the codition was met  # noqa: E501

        :param end_time: The end_time of this SubCriterionSatisfied.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this SubCriterionSatisfied.  # noqa: E501

        start of the location in audio where the codition was met  # noqa: E501

        :return: The start_time of this SubCriterionSatisfied.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this SubCriterionSatisfied.

        start of the location in audio where the codition was met  # noqa: E501

        :param start_time: The start_time of this SubCriterionSatisfied.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubCriterionSatisfied):
            return False
