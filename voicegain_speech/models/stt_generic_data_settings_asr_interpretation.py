...
class SttGenericDataSettingsAsrInterpretation(object):
    ...
    def __init__(self, literal_tag=True, return_format='first', semantic_tags=None, local_vars_configuration=None):  # noqa: E501
        """SttGenericDataSettingsAsrInterpretation - a model defined in OpenAPI"""  # noqa: E501
    ...
    def literal_tag(self):
        """Gets the literal_tag of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501

        (Optional) If provided and true, then the value of the literal tag will be returned if there is a literal tag in the interpretation.   # noqa: E501

        :return: The literal_tag of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :rtype: bool
        """
    ...
    def literal_tag(self, literal_tag):
        """Sets the literal_tag of this SttGenericDataSettingsAsrInterpretation.

        (Optional) If provided and true, then the value of the literal tag will be returned if there is a literal tag in the interpretation.   # noqa: E501

        :param literal_tag: The literal_tag of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :type: bool
        """
    ...
    def return_format(self):
        """Gets the return_format of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501

        How the tag values will be returned: + first - first matching literalTag or listed sematic tag will be returned. Use this if you want simple format of the return result (the name of the tag will not be returned, so not `zip=75038`, but only `75038`). + all - will return all values of the semantic tags listed in `semanticTags` (and the literal tag if applicable) encoded in url format. If `semanticTags` is missing then will return all semantic tags returned from the recognizer. For example: `zip=76234&state=TX`. Literal tag value will have a name \"literalTag\".   # noqa: E501

        :return: The return_format of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :rtype: str
        """
    ...
    def return_format(self, return_format):
        """Sets the return_format of this SttGenericDataSettingsAsrInterpretation.

        How the tag values will be returned: + first - first matching literalTag or listed sematic tag will be returned. Use this if you want simple format of the return result (the name of the tag will not be returned, so not `zip=75038`, but only `75038`). + all - will return all values of the semantic tags listed in `semanticTags` (and the literal tag if applicable) encoded in url format. If `semanticTags` is missing then will return all semantic tags returned from the recognizer. For example: `zip=76234&state=TX`. Literal tag value will have a name \"literalTag\".   # noqa: E501

        :param return_format: The return_format of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :type: str
        """
        allowed_values = ["first", "all"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and return_format not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `return_format` ({0}), must be one of {1}"  # noqa: E501
                .format(return_format, allowed_values)
            )
    ...
    def semantic_tags(self):
        """Gets the semantic_tags of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501

        (Optional) List of semantic tag names to be considered (see `returnFormat`).   # noqa: E501

        :return: The semantic_tags of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def semantic_tags(self, semantic_tags):
        """Sets the semantic_tags of this SttGenericDataSettingsAsrInterpretation.

        (Optional) List of semantic tag names to be considered (see `returnFormat`).   # noqa: E501

        :param semantic_tags: The semantic_tags of this SttGenericDataSettingsAsrInterpretation.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SttGenericDataSettingsAsrInterpretation):
            return False
