...
class DataObject(object):
    ...
    def __init__(self, account_id=None, context_id=None, date_created=None, date_modified=None, object_id=None, content_type=None, description=None, encryption=None, long_persist=False, name=None, tags=None, transcoded=False, user=None, user_group=None, sos_ref=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def encryption(self):
        """Gets the encryption of this DataObject.  # noqa: E501
        ...
        :return: The encryption of this DataObject.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this DataObject.

        Controls encryption of the data in storage. Applies mainly to Edge deployments (default encryption setting is specified in the Edge cluster configuration).  + none - do not use encryption in storage + standard - encrypt in storage + enhanced - use JWT as part of the encryption key - this basically allows the client to control encryption of individual Data objects (client can create a unique JWT for accessing each Data object)  For Cloud `standard` is the default - `none` will be treated as `standard` and attempt to use `enhanced` will result in error.   # noqa: E501

        :param encryption: The encryption of this DataObject.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user(self):
        """Gets the user of this DataObject.  # noqa: E501

        Users associated with the data object (optional).  # noqa: E501

        :return: The user of this DataObject.  # noqa: E501
        :rtype: list[str]
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this DataObject.

        Users associated with the data object (optional).  # noqa: E501

        :param user: The user of this DataObject.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def user_group(self):
        """Gets the user_group of this DataObject.  # noqa: E501

        User groups associated with the data object (optional).  # noqa: E501

        :return: The user_group of this DataObject.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def user_group(self, user_group):
        """Sets the user_group of this DataObject.

        User groups associated with the data object (optional).  # noqa: E501

        :param user_group: The user_group of this DataObject.  # noqa: E501
        :type: list[str]
        """
