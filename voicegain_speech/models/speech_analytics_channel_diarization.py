...
class SpeechAnalyticsChannelDiarization(object):
    ...
    def __init__(self, max_speakers=None, min_speakers=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsChannelDiarization - a model defined in OpenAPI"""  # noqa: E501
    ...
    def max_speakers(self):
        """Gets the max_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501

        This value will determine the maximum number of speakers that the diarization algorithm will attempt to recognize in the audio.   # noqa: E501

        :return: The max_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501
        :rtype: int
        """
    ...
    def max_speakers(self, max_speakers):
        """Sets the max_speakers of this SpeechAnalyticsChannelDiarization.

        This value will determine the maximum number of speakers that the diarization algorithm will attempt to recognize in the audio.   # noqa: E501

        :param max_speakers: The max_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and max_speakers is None:  # noqa: E501
            raise ValueError("Invalid value for `max_speakers`, must not be `None`")  # noqa: E501
    ...
    def min_speakers(self):
        """Gets the min_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501

        Hint to the diarization algorithm regarding the minimum number of the speakers present in the audio.    # noqa: E501

        :return: The min_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501
        :rtype: int
        """
    ...
    def min_speakers(self, min_speakers):
        """Sets the min_speakers of this SpeechAnalyticsChannelDiarization.

        Hint to the diarization algorithm regarding the minimum number of the speakers present in the audio.    # noqa: E501

        :param min_speakers: The min_speakers of this SpeechAnalyticsChannelDiarization.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and min_speakers is None:  # noqa: E501
            raise ValueError("Invalid value for `min_speakers`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsChannelDiarization):
            return False
