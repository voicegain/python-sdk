...
"""
    ...
    The version of the OpenAPI document: 1.32.3 - updated June 10, 2021
...
class CallAttributes(object):
    ...
    allowable_values = [STARTTIME, ENDTIME, DIRECTION, EXTERNALENDPOINT, INTERNALENDPOINT, AGENT_ID, AGENT_NAME, AGENT_EMAIL, QUEUE_ID, QUEUE_NAME]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CallAttributes - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallAttributes):
            return False
