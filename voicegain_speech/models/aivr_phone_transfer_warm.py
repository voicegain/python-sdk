...
class AIVRPhoneTransferWarm(object):
    ...
    def phone_number(self):
        """Gets the phone_number of this AIVRPhoneTransferWarm.  # noqa: E501

        E.164 formatted phone number or a SIP URI to transfer to. </br> SIP URI may include transport type and headers, e.g., sip:edfe769d-3c83-4320-b9e4-27f7e3@fs.acme.com:5080;transport=tcp?x-mycustomheader=foo</br>   # noqa: E501

        :return: The phone_number of this AIVRPhoneTransferWarm.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this AIVRPhoneTransferWarm.

        E.164 formatted phone number or a SIP URI to transfer to. </br> SIP URI may include transport type and headers, e.g., sip:edfe769d-3c83-4320-b9e4-27f7e3@fs.acme.com:5080;transport=tcp?x-mycustomheader=foo</br>   # noqa: E501

        :param phone_number: The phone_number of this AIVRPhoneTransferWarm.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRPhoneTransferWarm):
            return False
