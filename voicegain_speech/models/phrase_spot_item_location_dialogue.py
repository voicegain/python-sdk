...
class PhraseSpotItemLocationDialogue(object):
    ...
    def built_in(self, built_in):
        ...
        :type: str
        """
        allowed_values = ["CallerIntent", "Statement", "Question", "Answer", "YesNoQuestion", "YesNoAnswer"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and built_in not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `built_in` ({0}), must be one of {1}"  # noqa: E501
                .format(built_in, allowed_values)
            )
