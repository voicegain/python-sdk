...
class WordTreeItem(object):
    ...
    def __init__(self, confidence=None, dtmf=None, spk=None, utterance=None, duration=None, start=None, id=None, parent=None, local_vars_configuration=None):  # noqa: E501
