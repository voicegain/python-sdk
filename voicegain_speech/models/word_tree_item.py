...
class WordTreeItem(object):
    ...
    def __init__(self, confidence=None, dtmf=None, utterance=None, spk=None, duration=None, start=None, id=None, parent=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def dtmf(self):
        """Gets the dtmf of this WordTreeItem.  # noqa: E501
        ...
        :return: The dtmf of this WordTreeItem.  # noqa: E501
        :rtype: bool
        """
        return self._dtmf
    ...
    @dtmf.setter
    def dtmf(self, dtmf):
        """Sets the dtmf of this WordTreeItem.

        If true then this word (digit or symbol) represents a DTMF tone value that was detected. To reduce the amount of data in the response, `dtmf` field is not present if the word is not a DTMF tone.   # noqa: E501

        :param dtmf: The dtmf of this WordTreeItem.  # noqa: E501
        :type: bool
        """
