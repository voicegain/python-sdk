...
class SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm(object):
    ...
    def __init__(self, custom_response_format_json=None, prompt=None, response_format=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm - a model defined in OpenAPI"""  # noqa: E501
    ...
    def custom_response_format_json(self):
        """Gets the custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501

        (future) Must only be provided when `responseFormat` is set to `custom`.   # noqa: E501

        :return: The custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_response_format_json(self, custom_response_format_json):
        """Sets the custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.

        (future) Must only be provided when `responseFormat` is set to `custom`.   # noqa: E501

        :param custom_response_format_json: The custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prompt(self):
        """Gets the prompt of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501

        LLM prompt to be used to answer the question.   # noqa: E501

        :return: The prompt of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
        :rtype: str
        """
        return self._prompt
    ...
    def prompt(self, prompt):
        """Sets the prompt of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.

        LLM prompt to be used to answer the question.   # noqa: E501

        :param prompt: The prompt of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def response_format(self):
        """Gets the response_format of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501


        :return: The response_format of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
    ...
    def response_format(self, response_format):
        """Sets the response_format of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.


        :param response_format: The response_format of this SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsConfigModifiableBaseNpsQuestionLlm):
            return False
