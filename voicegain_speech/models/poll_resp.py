...
class PollResp(object):
    ...
    def persist(self, persist):
        ...
        if (self.local_vars_configuration.client_side_validation and
                persist is not None and persist > 31536000000):  # noqa: E501
            raise ValueError("Invalid value for `persist`, must be a value less than or equal to `31536000000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
