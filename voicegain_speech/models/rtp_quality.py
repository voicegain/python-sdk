...
class RtpQuality(object):
    ...
    """
    openapi_types = {
        'in_jitter_loss': 'float',
        'in_mos': 'float',
        'in_packet_count': 'int',
        'in_quality_pct': 'float',
        'in_skip_count': 'int',
        'out_jitter_loss': 'float',
        'out_mos': 'float',
        'out_packet_count': 'int',
        'out_quality_pct': 'float',
        'out_skip_count': 'int'
    }

    attribute_map = {
        'in_jitter_loss': 'in_jitter_loss',
        'in_mos': 'in_mos',
        'in_packet_count': 'in_packet_count',
        'in_quality_pct': 'in_quality_pct',
        'in_skip_count': 'in_skip_count',
        'out_jitter_loss': 'out_jitter_loss',
        'out_mos': 'out_mos',
        'out_packet_count': 'out_packet_count',
        'out_quality_pct': 'out_quality_pct',
        'out_skip_count': 'out_skip_count'
    }

    def __init__(self, in_jitter_loss=None, in_mos=None, in_packet_count=None, in_quality_pct=None, in_skip_count=None, out_jitter_loss=None, out_mos=None, out_packet_count=None, out_quality_pct=None, out_skip_count=None, local_vars_configuration=None):  # noqa: E501
        """RtpQuality - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._in_jitter_loss = None
        self._in_mos = None
        self._in_packet_count = None
        self._in_quality_pct = None
        self._in_skip_count = None
        self._out_jitter_loss = None
        self._out_mos = None
        self._out_packet_count = None
        self._out_quality_pct = None
        self._out_skip_count = None
        self.discriminator = None

        if in_jitter_loss is not None:
            self.in_jitter_loss = in_jitter_loss
        if in_mos is not None:
            self.in_mos = in_mos
        if in_packet_count is not None:
            self.in_packet_count = in_packet_count
        if in_quality_pct is not None:
            self.in_quality_pct = in_quality_pct
        if in_skip_count is not None:
            self.in_skip_count = in_skip_count
        if out_jitter_loss is not None:
            self.out_jitter_loss = out_jitter_loss
        if out_mos is not None:
            self.out_mos = out_mos
        if out_packet_count is not None:
            self.out_packet_count = out_packet_count
        if out_quality_pct is not None:
            self.out_quality_pct = out_quality_pct
        if out_skip_count is not None:
            self.out_skip_count = out_skip_count

    @property
    def in_jitter_loss(self):
        """Gets the in_jitter_loss of this RtpQuality.  # noqa: E501

        Inbound jitter loss rate  # noqa: E501

        :return: The in_jitter_loss of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._in_jitter_loss

    @in_jitter_loss.setter
    def in_jitter_loss(self, in_jitter_loss):
        """Sets the in_jitter_loss of this RtpQuality.

        Inbound jitter loss rate  # noqa: E501

        :param in_jitter_loss: The in_jitter_loss of this RtpQuality.  # noqa: E501
        :type: float
        """

        self._in_jitter_loss = in_jitter_loss

    @property
    def in_mos(self):
        """Gets the in_mos of this RtpQuality.  # noqa: E501

        Inbound Mean Opinion Score (MOS).</br>   # noqa: E501

        :return: The in_mos of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._in_mos

    @in_mos.setter
    def in_mos(self, in_mos):
        """Sets the in_mos of this RtpQuality.

        Inbound Mean Opinion Score (MOS).</br>   # noqa: E501

        :param in_mos: The in_mos of this RtpQuality.  # noqa: E501
        :type: float
        """
    ...
    def in_packet_count(self):
        """Gets the in_packet_count of this RtpQuality.  # noqa: E501

        Total number of packets received on inbound stream  # noqa: E501

        :return: The in_packet_count of this RtpQuality.  # noqa: E501
        :rtype: int
        """
        return self._in_packet_count

    @in_packet_count.setter
    def in_packet_count(self, in_packet_count):
        """Sets the in_packet_count of this RtpQuality.

        Total number of packets received on inbound stream  # noqa: E501

        :param in_packet_count: The in_packet_count of this RtpQuality.  # noqa: E501
        :type: int
        """
    ...
    @property
    def in_quality_pct(self):
        """Gets the in_quality_pct of this RtpQuality.  # noqa: E501

        Inbound audio quality percentage  # noqa: E501

        :return: The in_quality_pct of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._in_quality_pct

    @in_quality_pct.setter
    def in_quality_pct(self, in_quality_pct):
        """Sets the in_quality_pct of this RtpQuality.

        Inbound audio quality percentage  # noqa: E501

        :param in_quality_pct: The in_quality_pct of this RtpQuality.  # noqa: E501
        :type: float
        """

        self._in_quality_pct = in_quality_pct

    @property
    def in_skip_count(self):
        """Gets the in_skip_count of this RtpQuality.  # noqa: E501

        Number of skipped packets on inbound stream  # noqa: E501

        :return: The in_skip_count of this RtpQuality.  # noqa: E501
        :rtype: int
        """
        return self._in_skip_count

    @in_skip_count.setter
    def in_skip_count(self, in_skip_count):
        """Sets the in_skip_count of this RtpQuality.

        Number of skipped packets on inbound stream  # noqa: E501

        :param in_skip_count: The in_skip_count of this RtpQuality.  # noqa: E501
        :type: int
        """

        self._in_skip_count = in_skip_count

    @property
    def out_jitter_loss(self):
        """Gets the out_jitter_loss of this RtpQuality.  # noqa: E501

        Outbound jitter loss rate  # noqa: E501

        :return: The out_jitter_loss of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._out_jitter_loss

    @out_jitter_loss.setter
    def out_jitter_loss(self, out_jitter_loss):
        """Sets the out_jitter_loss of this RtpQuality.

        Outbound jitter loss rate  # noqa: E501

        :param out_jitter_loss: The out_jitter_loss of this RtpQuality.  # noqa: E501
        :type: float
        """

        self._out_jitter_loss = out_jitter_loss

    @property
    def out_mos(self):
        """Gets the out_mos of this RtpQuality.  # noqa: E501

        Outbound Mean Opinion Score (MOS).</br>   # noqa: E501

        :return: The out_mos of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._out_mos

    @out_mos.setter
    def out_mos(self, out_mos):
        """Sets the out_mos of this RtpQuality.

        Outbound Mean Opinion Score (MOS).</br>   # noqa: E501

        :param out_mos: The out_mos of this RtpQuality.  # noqa: E501
        :type: float
        """

        self._out_mos = out_mos

    @property
    def out_packet_count(self):
        """Gets the out_packet_count of this RtpQuality.  # noqa: E501

        Total number of packets sent on outbound stream  # noqa: E501

        :return: The out_packet_count of this RtpQuality.  # noqa: E501
        :rtype: int
        """
        return self._out_packet_count

    @out_packet_count.setter
    def out_packet_count(self, out_packet_count):
        """Sets the out_packet_count of this RtpQuality.

        Total number of packets sent on outbound stream  # noqa: E501

        :param out_packet_count: The out_packet_count of this RtpQuality.  # noqa: E501
        :type: int
        """
    ...
    @property
    def out_quality_pct(self):
        """Gets the out_quality_pct of this RtpQuality.  # noqa: E501

        Outbound audio quality percentage  # noqa: E501

        :return: The out_quality_pct of this RtpQuality.  # noqa: E501
        :rtype: float
        """
        return self._out_quality_pct

    @out_quality_pct.setter
    def out_quality_pct(self, out_quality_pct):
        """Sets the out_quality_pct of this RtpQuality.

        Outbound audio quality percentage  # noqa: E501

        :param out_quality_pct: The out_quality_pct of this RtpQuality.  # noqa: E501
        :type: float
        """

        self._out_quality_pct = out_quality_pct

    @property
    def out_skip_count(self):
        """Gets the out_skip_count of this RtpQuality.  # noqa: E501

        Number of skipped packets on outbound stream  # noqa: E501

        :return: The out_skip_count of this RtpQuality.  # noqa: E501
        :rtype: int
        """
        return self._out_skip_count

    @out_skip_count.setter
    def out_skip_count(self, out_skip_count):
        """Sets the out_skip_count of this RtpQuality.

        Number of skipped packets on outbound stream  # noqa: E501

        :param out_skip_count: The out_skip_count of this RtpQuality.  # noqa: E501
        :type: int
        """

        self._out_skip_count = out_skip_count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RtpQuality):
            return False
