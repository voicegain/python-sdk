...
class SpeechAnalyticsPhraseItemforPhrase(object):
    ...
    def __init__(self, channel=None, end_idx=None, end_time=None, start_idx=None, start_time=None, phrase=None, slots=None, tag=None, local_vars_configuration=None):  # noqa: E501
