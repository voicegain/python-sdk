...
class AnswerMapEntry(object):
    ...
    def __init__(self, choice=None, value=None, local_vars_configuration=None):  # noqa: E501
        """AnswerMapEntry - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def choice(self):
        """Gets the choice of this AnswerMapEntry.  # noqa: E501

        Label attached to the chooice. Will be displayed on a button in Web UI  # noqa: E501

        :return: The choice of this AnswerMapEntry.  # noqa: E501
        :rtype: str
        """
        return self._choice
    ...
    def choice(self, choice):
        """Sets the choice of this AnswerMapEntry.

        Label attached to the chooice. Will be displayed on a button in Web UI  # noqa: E501

        :param choice: The choice of this AnswerMapEntry.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                choice is not None and len(choice) > 32):
            raise ValueError("Invalid value for `choice`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                choice is not None and len(choice) < 1):
            raise ValueError("Invalid value for `choice`, length must be greater than or equal to `1`")  # noqa: E501

        self._choice = choice

    @property
    def value(self):
        """Gets the value of this AnswerMapEntry.  # noqa: E501

        value associated with the choice  # noqa: E501

        :return: The value of this AnswerMapEntry.  # noqa: E501
        :rtype: float
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this AnswerMapEntry.

        value associated with the choice  # noqa: E501

        :param value: The value of this AnswerMapEntry.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnswerMapEntry):
            return False
