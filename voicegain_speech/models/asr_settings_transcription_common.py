...
class AsrSettingsTranscriptionCommon(object):
    ...
    def languages(self):
        ...
        Language that should be recognized - this is important for acousticModels that support more than one language.</br> This is a list parameter because we support multiple language recognition -  for those cases where the exact language spoken in the audio is not known up-front.  Please contact us at support@voicegain.ai to find out which mutiple language combinations are supported with which acoustic models.   # noqa: E501
