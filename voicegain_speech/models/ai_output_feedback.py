...
class AiOutputFeedback(object):
    ...
    @property
    def ai_output_id(self):
        """Gets the ai_output_id of this AiOutputFeedback.  # noqa: E501

        UUID of the parent AI Output this feedback belongs to.  # noqa: E501

        :return: The ai_output_id of this AiOutputFeedback.  # noqa: E501
        :rtype: str
        """
        return self._ai_output_id

    @ai_output_id.setter
    def ai_output_id(self, ai_output_id):
        """Sets the ai_output_id of this AiOutputFeedback.

        UUID of the parent AI Output this feedback belongs to.  # noqa: E501

        :param ai_output_id: The ai_output_id of this AiOutputFeedback.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and ai_output_id is None:  # noqa: E501
            raise ValueError("Invalid value for `ai_output_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                ai_output_id is not None and len(ai_output_id) > 48):
            raise ValueError("Invalid value for `ai_output_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                ai_output_id is not None and len(ai_output_id) < 16):
    ...
    @property
    def comment(self):
        """Gets the comment of this AiOutputFeedback.  # noqa: E501

        (optional) Free-form comment from the user.  # noqa: E501

        :return: The comment of this AiOutputFeedback.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AiOutputFeedback.

        (optional) Free-form comment from the user.  # noqa: E501

        :param comment: The comment of this AiOutputFeedback.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                comment is not None and len(comment) > 2048):
    ...
    def correct_value(self):
        """Gets the correct_value of this AiOutputFeedback.  # noqa: E501

        (optional) The \"ideal\" / corrected value that the user thinks the AI should have produced. Same shape as the parent `AiOutput.content`: + string for text outputs (e.g., a corrected summary), + object for structured outputs (e.g., a corrected `callInsightAnswer` body, or a wrapper object containing an array under a key).   # noqa: E501

        :return: The correct_value of this AiOutputFeedback.  # noqa: E501
        :rtype: OneOfstringobject
        """
        return self._correct_value

    @correct_value.setter
    def correct_value(self, correct_value):
        """Sets the correct_value of this AiOutputFeedback.

        (optional) The \"ideal\" / corrected value that the user thinks the AI should have produced. Same shape as the parent `AiOutput.content`: + string for text outputs (e.g., a corrected summary), + object for structured outputs (e.g., a corrected `callInsightAnswer` body, or a wrapper object containing an array under a key).   # noqa: E501

        :param correct_value: The correct_value of this AiOutputFeedback.  # noqa: E501
    ...
    def created_epoch(self, created_epoch):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and created_epoch is None:  # noqa: E501
    ...
    def feedback_id(self):
        """Gets the feedback_id of this AiOutputFeedback.  # noqa: E501

        UUID of this feedback entry.  # noqa: E501

        :return: The feedback_id of this AiOutputFeedback.  # noqa: E501
        :rtype: str
        """
    ...
    def feedback_id(self, feedback_id):
        """Sets the feedback_id of this AiOutputFeedback.

        UUID of this feedback entry.  # noqa: E501

        :param feedback_id: The feedback_id of this AiOutputFeedback.  # noqa: E501
        :type: str
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
                feedback_id is not None and len(feedback_id) > 48):
            raise ValueError("Invalid value for `feedback_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                feedback_id is not None and len(feedback_id) < 16):
    ...
    @property
    def score(self):
        """Gets the score of this AiOutputFeedback.  # noqa: E501

        (optional) Overall quality score, 1 (poor) to 5 (excellent). May be set independently of `thumbs`.   # noqa: E501

        :return: The score of this AiOutputFeedback.  # noqa: E501
        :rtype: int
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this AiOutputFeedback.

        (optional) Overall quality score, 1 (poor) to 5 (excellent). May be set independently of `thumbs`.   # noqa: E501

        :param score: The score of this AiOutputFeedback.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                score is not None and score > 5):  # noqa: E501
            raise ValueError("Invalid value for `score`, must be a value less than or equal to `5`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                score is not None and score < 1):  # noqa: E501
            raise ValueError("Invalid value for `score`, must be a value greater than or equal to `1`")  # noqa: E501

        self._score = score

    @property
    def source(self):
        """Gets the source of this AiOutputFeedback.  # noqa: E501

        (optional) Free-form string identifying where this feedback came from (e.g., a UI page, an external review tool, an automated pipeline).   # noqa: E501

        :return: The source of this AiOutputFeedback.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this AiOutputFeedback.

        (optional) Free-form string identifying where this feedback came from (e.g., a UI page, an external review tool, an automated pipeline).   # noqa: E501

        :param source: The source of this AiOutputFeedback.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def thumbs(self):
        """Gets the thumbs of this AiOutputFeedback.  # noqa: E501

        (optional) Thumbs up/down indicator. May be set independently of `score`.   # noqa: E501

        :return: The thumbs of this AiOutputFeedback.  # noqa: E501
        :rtype: str
        """
        return self._thumbs
    ...
    def thumbs(self, thumbs):
        """Sets the thumbs of this AiOutputFeedback.

        (optional) Thumbs up/down indicator. May be set independently of `score`.   # noqa: E501

        :param thumbs: The thumbs of this AiOutputFeedback.  # noqa: E501
        :type: str
        """
        allowed_values = ["up", "down"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and thumbs not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `thumbs` ({0}), must be one of {1}"  # noqa: E501
                .format(thumbs, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AiOutputFeedback):
            return False
