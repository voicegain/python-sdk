...
class AsrSettingsTranscriptionCommonAllOf(object):
    ...
    def __init__(self, hints=None, lang_model=None, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsTranscriptionCommonAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def hints(self):
        """Gets the hints of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501
        ...
        :return: The hints of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501
        :rtype: list[str]
        """
        return self._hints
    ...
    def hints(self, hints):
        """Sets the hints of this AsrSettingsTranscriptionCommonAllOf.

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input. No special characters allowed except for '_'   # noqa: E501

        :param hints: The hints of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :return: The lang_model of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsTranscriptionCommonAllOf.

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsTranscriptionCommonAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionCommonAllOf):
            return False
