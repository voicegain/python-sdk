...
class S3AudioInput(object):
    ...
    def __init__(self, auth_conf=None, bucket_name=None, key=None, version_id=None, local_vars_configuration=None):  # noqa: E501
        """S3AudioInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def auth_conf(self):
        """Gets the auth_conf of this S3AudioInput.  # noqa: E501

        Name or UUID of the authentication config for accessing the S3 bucket. Can be defined via Voicegain Console. See also [Context API](#operation/contextPut).             # noqa: E501

        :return: The auth_conf of this S3AudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_conf(self, auth_conf):
        """Sets the auth_conf of this S3AudioInput.

        Name or UUID of the authentication config for accessing the S3 bucket. Can be defined via Voicegain Console. See also [Context API](#operation/contextPut).             # noqa: E501

        :param auth_conf: The auth_conf of this S3AudioInput.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and auth_conf is None:  # noqa: E501
            raise ValueError("Invalid value for `auth_conf`, must not be `None`")  # noqa: E501
    ...
    def bucket_name(self):
        """Gets the bucket_name of this S3AudioInput.  # noqa: E501

        The bucket name containing the audio data  # noqa: E501

        :return: The bucket_name of this S3AudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def bucket_name(self, bucket_name):
        """Sets the bucket_name of this S3AudioInput.

        The bucket name containing the audio data  # noqa: E501

        :param bucket_name: The bucket_name of this S3AudioInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key(self):
        """Gets the key of this S3AudioInput.  # noqa: E501

        The key under which the object to be downloaded is stored  # noqa: E501

        :return: The key of this S3AudioInput.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this S3AudioInput.

        The key under which the object to be downloaded is stored  # noqa: E501

        :param key: The key of this S3AudioInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version_id(self):
        """Gets the version_id of this S3AudioInput.  # noqa: E501

        The optional version ID specifying which version of the object to download  # noqa: E501

        :return: The version_id of this S3AudioInput.  # noqa: E501
        :rtype: str
        """
    ...
    def version_id(self, version_id):
        """Sets the version_id of this S3AudioInput.

        The optional version ID specifying which version of the object to download  # noqa: E501

        :param version_id: The version_id of this S3AudioInput.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                version_id is not None and len(version_id) > 1024):
            raise ValueError("Invalid value for `version_id`, length must be less than or equal to `1024`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, S3AudioInput):
            return False
