...
class OfflineSpeechAnalyticsBaseRequest(object):
    ...
    def __init__(self, call_review_config=None, creator=None, label=None, metadata=None, persist_seconds=3600, sa_config=None, settings=None, speakers=None, tags=None, topic_discovery_config=None, voice_signature_speakers=None, local_vars_configuration=None):  # noqa: E501
