...
class OfflineSpeechAnalyticsBaseRequest(object):
    ...
    def __init__(self, call_review_config=None, creator=None, insights_config=None, label=None, metadata=None, obfuscate=False, persist_seconds=3600, sa_config=None, segment_analytics_config=None, settings=None, tags=None, topic_discovery_config=None, voice_signature_speakers=None, speakers=None, local_vars_configuration=None):  # noqa: E501
        """OfflineSpeechAnalyticsBaseRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def call_review_config(self):
        """Gets the call_review_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The call_review_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def call_review_config(self, call_review_config):
        """Sets the call_review_config of this OfflineSpeechAnalyticsBaseRequest.

        (optional) id of the Call Review (Score Card) configuration to use. The Call Review Config will be used to guide the generation of autopopulated Call Review Answers.   # noqa: E501

        :param call_review_config: The call_review_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def creator(self):
        """Gets the creator of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The creator of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this OfflineSpeechAnalyticsBaseRequest.

        (optional) Id of the user who starts this speech analytics. If invoked from Web UI then we will use identity of the logged-in user.   # noqa: E501

        :param creator: The creator of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def insights_config(self):
        """Gets the insights_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The insights_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def insights_config(self, insights_config):
        """Sets the insights_config of this OfflineSpeechAnalyticsBaseRequest.

        (optional) id of the Call Insights configuration to use (reference to `ciConfigId`).</br> The Call Insights Config will be used to guide the generation of Call Insights Answers.   # noqa: E501

        :param insights_config: The insights_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def label(self):
        """Gets the label of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The label of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this OfflineSpeechAnalyticsBaseRequest.

        Label for the result so that it can be easily identified e.g. in the Web UI. </br> Generally follows the same limitations as a file name. </br> Can contain any unicode character except control characters and except < > : \" / \\ |  ? * </br> Moreover, spaces and dots in front and at the end are not allowed.   # noqa: E501

        :param label: The label of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The metadata of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this OfflineSpeechAnalyticsBaseRequest.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
    ...
    @property
    def obfuscate(self):
        """Gets the obfuscate of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The obfuscate of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def obfuscate(self, obfuscate):
        """Sets the obfuscate of this OfflineSpeechAnalyticsBaseRequest.

        If `true`, after all processing is complete, the stored transcript will be obfuscated.</br> The same applies to all `llmJustification` values generated during processing.   # noqa: E501

        :param obfuscate: The obfuscate of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: bool
        """
    ...
    def persist_seconds(self):
        """Gets the persist_seconds of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The persist_seconds of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def persist_seconds(self, persist_seconds):
        """Sets the persist_seconds of this OfflineSpeechAnalyticsBaseRequest.

        Time (in seconds) to retain the result/outcome data after processing has completed. For Cloud, maximum persistence is 315,619,200 seconds (about 10 years). For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.         # noqa: E501

        :param persist_seconds: The persist_seconds of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def sa_config(self):
        """Gets the sa_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The sa_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_config(self, sa_config):
        """Sets the sa_config of this OfflineSpeechAnalyticsBaseRequest.

        id of the Speech Analytics configuration to use. If not provided then default SA Config for the context will be used.   # noqa: E501

        :param sa_config: The sa_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def segment_analytics_config(self):
        """Gets the segment_analytics_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The segment_analytics_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
    ...
    def segment_analytics_config(self, segment_analytics_config):
        """Sets the segment_analytics_config of this OfflineSpeechAnalyticsBaseRequest.

        (optional) Configuration for detailed analytics of specific segment types in the call.</br> If not provided, no segment-specific analytics will be performed.</br> For each segment type (bot/agent), you can specify different analytics configurations.</br> If any of the config fields (saConfig, insightsConfig, callReviewConfig) are missing in a segment config object, the corresponding config from the main request body will be used as fallback.   # noqa: E501

        :param segment_analytics_config: The segment_analytics_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
    ...
    @property
    def settings(self):
        """Gets the settings of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this OfflineSpeechAnalyticsBaseRequest.
    ...
    @property
    def tags(self):
        """Gets the tags of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :return: The tags of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this OfflineSpeechAnalyticsBaseRequest.

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :param tags: The tags of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def topic_discovery_config(self):
        """Gets the topic_discovery_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        ...
        :return: The topic_discovery_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def topic_discovery_config(self, topic_discovery_config):
        """Sets the topic_discovery_config of this OfflineSpeechAnalyticsBaseRequest.

        (optional) id of the Topic Discovery configuration to use. If not provided then default Topic Discovery Config for the context will be used.   # noqa: E501

        :param topic_discovery_config: The topic_discovery_config of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def voice_signature_speakers(self):
        """Gets the voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501

        Optional list of Speakers (Agents) with voice signatures to be used in processing this call.  # noqa: E501

        :return: The voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def voice_signature_speakers(self, voice_signature_speakers):
        """Sets the voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequest.

        Optional list of Speakers (Agents) with voice signatures to be used in processing this call.  # noqa: E501

        :param voice_signature_speakers: The voice_signature_speakers of this OfflineSpeechAnalyticsBaseRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineSpeechAnalyticsBaseRequest):
            return False
