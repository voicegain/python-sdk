...
class VoiceCallSearchResult(object):
    ...
    def aivr_platform(self):
        """Gets the aivr_platform of this VoiceCallSearchResult.  # noqa: E501

        Platform on which the AIVR App runs.</br> Will be absent if the call did not come from an AIVR App.   # noqa: E501

        :return: The aivr_platform of this VoiceCallSearchResult.  # noqa: E501
        :rtype: str
        """
    ...
    def aivr_platform(self, aivr_platform):
        """Sets the aivr_platform of this VoiceCallSearchResult.

        Platform on which the AIVR App runs.</br> Will be absent if the call did not come from an AIVR App.   # noqa: E501

        :param aivr_platform: The aivr_platform of this VoiceCallSearchResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def aivr_vars(self):
        """Gets the aivr_vars of this VoiceCallSearchResult.  # noqa: E501
        ...
        :return: The aivr_vars of this VoiceCallSearchResult.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def aivr_vars(self, aivr_vars):
        """Sets the aivr_vars of this VoiceCallSearchResult.

        (optional) Map with variables collected during AIVR session. </br> This is a copy from AIVR Session (the `vars` field) and we store it in the Call as JSON object (so this is not just a flat map).   # noqa: E501

        :param aivr_vars: The aivr_vars of this VoiceCallSearchResult.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def expiry_time(self):
        """Gets the expiry_time of this VoiceCallSearchResult.  # noqa: E501
        ...
        :return: The expiry_time of this VoiceCallSearchResult.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiry_time(self, expiry_time):
        """Sets the expiry_time of this VoiceCallSearchResult.

        Expiration time of the call (UTC). The call and all call associated data will be deleted within 24-48 hours after this date-time.   # noqa: E501

        :param expiry_time: The expiry_time of this VoiceCallSearchResult.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def team(self):
        """Gets the team of this VoiceCallSearchResult.  # noqa: E501
        ...
        :return: The team of this VoiceCallSearchResult.  # noqa: E501
        :rtype: str
        """
        return self._team
    ...
    @team.setter
    def team(self, team):
        """Sets the team of this VoiceCallSearchResult.

        Data UUID - it will be set based on the membership of the Agent user (from the agent field) in a UserGroup of the type Team (userGroupType).  If user is member of more than one UserGroup of that type then we will chooseUser Group that was most recently created.   # noqa: E501

        :param team: The team of this VoiceCallSearchResult.  # noqa: E501
        :type: str
        """
    ...
    def audit_status(self):
        """Gets the audit_status of this VoiceCallSearchResult.  # noqa: E501
        ...
        :return: The audit_status of this VoiceCallSearchResult.  # noqa: E501
        :rtype: AuditStatus
        """
    ...
    def audit_status(self, audit_status):
        """Sets the audit_status of this VoiceCallSearchResult.

        State of the manual Call Review **audit** of this call — `not_started` when the call has never been audited, so the field is always present.</br> When the audited Call Review Answers are attached to a call segment rather than to the call, this field aggregates over the call's segments: `complete` if any audit on the call or any of its segments is complete, otherwise `in_progress` if any audit exists. Per-segment detail is on the Call Segment object.</br> Use this to filter an audit worklist — see the `AUDIT_STATUS` field of [POST /sa/call/search](#tag/sa-internal/operation/saCallSearchPost).</br> Returns to `not_started` when the last in-progress audit of the call is discarded via [DELETE /sa/call/review/answers/{crAnswersId}](#tag/call-review/operation/saCallReviewAnswersDelete) — a mis-clicked audit does not strand the call in `in_progress`. A call that reached `complete` stays `complete`, since a completed audit cannot be discarded.</br> **Note:** reset when a call is reprocessed (recompute / rerun re-creates the call's segments), in the same way as `score`. The audit records themselves are unaffected.   # noqa: E501

        :param audit_status: The audit_status of this VoiceCallSearchResult.  # noqa: E501
        :type: AuditStatus
        """
    ...
    @property
    def billing(self):
        """Gets the billing of this VoiceCallSearchResult.  # noqa: E501


        :return: The billing of this VoiceCallSearchResult.  # noqa: E501
        :rtype: CallBilling
        """
    ...
    def billing(self, billing):
        """Sets the billing of this VoiceCallSearchResult.


        :param billing: The billing of this VoiceCallSearchResult.  # noqa: E501
        :type: CallBilling
        """
    ...
    def copilot_sent(self):
        """Gets the copilot_sent of this VoiceCallSearchResult.  # noqa: E501

        Number of messages sent to Copilot during the call.   # noqa: E501

        :return: The copilot_sent of this VoiceCallSearchResult.  # noqa: E501
        :rtype: float
        """
    ...
    def copilot_sent(self, copilot_sent):
        """Sets the copilot_sent of this VoiceCallSearchResult.

        Number of messages sent to Copilot during the call.   # noqa: E501

        :param copilot_sent: The copilot_sent of this VoiceCallSearchResult.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def copilot_un_ack(self):
        """Gets the copilot_un_ack of this VoiceCallSearchResult.  # noqa: E501

        Number of missing acknowledgements from Copilot for the messages sent to Copilot.   # noqa: E501

        :return: The copilot_un_ack of this VoiceCallSearchResult.  # noqa: E501
        :rtype: float
        """
    ...
    def copilot_un_ack(self, copilot_un_ack):
        """Sets the copilot_un_ack of this VoiceCallSearchResult.

        Number of missing acknowledgements from Copilot for the messages sent to Copilot.   # noqa: E501

        :param copilot_un_ack: The copilot_un_ack of this VoiceCallSearchResult.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def inbound_rtp_quality(self):
        """Gets the inbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501


        :return: The inbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501
        :rtype: RtpQuality
        """
    ...
    def inbound_rtp_quality(self, inbound_rtp_quality):
        """Sets the inbound_rtp_quality of this VoiceCallSearchResult.


        :param inbound_rtp_quality: The inbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501
        :type: RtpQuality
        """
    ...
    def merged_audio_id(self):
        """Gets the merged_audio_id of this VoiceCallSearchResult.  # noqa: E501
        ...
        :return: The merged_audio_id of this VoiceCallSearchResult.  # noqa: E501
        :rtype: str
        """
    ...
    def merged_audio_id(self, merged_audio_id):
        """Sets the merged_audio_id of this VoiceCallSearchResult.

        Data UUID - reference to the merged call audio in Voicegain Data Store. This comes from the mergedAudio field in Speech Analytics session. If PII redaction was enabled on the SA session then this audio will be redacted. This field will be absent if Speech Analytics has not been run on the call.   # noqa: E501

        :param merged_audio_id: The merged_audio_id of this VoiceCallSearchResult.  # noqa: E501
        :type: str
        """
    ...
    def num_segments(self):
        """Gets the num_segments of this VoiceCallSearchResult.  # noqa: E501

        Number of segments in this call (bot, agent, or system segments).   # noqa: E501

        :return: The num_segments of this VoiceCallSearchResult.  # noqa: E501
        :rtype: int
        """
    ...
    def num_segments(self, num_segments):
        """Sets the num_segments of this VoiceCallSearchResult.

        Number of segments in this call (bot, agent, or system segments).   # noqa: E501

        :param num_segments: The num_segments of this VoiceCallSearchResult.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def outbound_rtp_quality(self):
        """Gets the outbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501


        :return: The outbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501
        :rtype: RtpQuality
        """
    ...
    def outbound_rtp_quality(self, outbound_rtp_quality):
        """Sets the outbound_rtp_quality of this VoiceCallSearchResult.


        :param outbound_rtp_quality: The outbound_rtp_quality of this VoiceCallSearchResult.  # noqa: E501
        :type: RtpQuality
        """
