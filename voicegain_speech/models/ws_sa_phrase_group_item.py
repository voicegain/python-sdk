...
class WsSAPhraseGroupItem(object):
    ...
    openapi_types = {
        'end': 'int',
        'start': 'int',
        'components': 'list[WsSAPhraseItemInsideGroup]',
        'tag': 'str'
    }
    ...
    def __init__(self, end=None, start=None, components=None, tag=None, local_vars_configuration=None):  # noqa: E501
        """WsSAPhraseGroupItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end(self):
        """Gets the end of this WsSAPhraseGroupItem.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end of this WsSAPhraseGroupItem.  # noqa: E501
        :rtype: int
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this WsSAPhraseGroupItem.

        end time in msec since start of audio  # noqa: E501

        :param end: The end of this WsSAPhraseGroupItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start(self):
        """Gets the start of this WsSAPhraseGroupItem.  # noqa: E501

        start time in msec since start of audio  # noqa: E501

        :return: The start of this WsSAPhraseGroupItem.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WsSAPhraseGroupItem.

        start time in msec since start of audio  # noqa: E501

        :param start: The start of this WsSAPhraseGroupItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def components(self):
        """Gets the components of this WsSAPhraseGroupItem.  # noqa: E501


        :return: The components of this WsSAPhraseGroupItem.  # noqa: E501
        :rtype: list[WsSAPhraseItemInsideGroup]
        """
        return self._components

    @components.setter
    def components(self, components):
        """Sets the components of this WsSAPhraseGroupItem.


        :param components: The components of this WsSAPhraseGroupItem.  # noqa: E501
        :type: list[WsSAPhraseItemInsideGroup]
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this WsSAPhraseGroupItem.  # noqa: E501

        Tag associated with the phrase group  # noqa: E501

        :return: The tag of this WsSAPhraseGroupItem.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this WsSAPhraseGroupItem.

        Tag associated with the phrase group  # noqa: E501

        :param tag: The tag of this WsSAPhraseGroupItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WsSAPhraseGroupItem):
            return False
