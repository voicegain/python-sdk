...
class MeetingWordsItem(object):
    ...
    def __init__(self, confidence=None, spk=None, utterance=None, local_vars_configuration=None):  # noqa: E501
        """MeetingWordsItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def confidence(self):
        """Gets the confidence of this MeetingWordsItem.  # noqa: E501

        confidence of the recognition  # noqa: E501

        :return: The confidence of this MeetingWordsItem.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence(self, confidence):
        """Sets the confidence of this MeetingWordsItem.

        confidence of the recognition  # noqa: E501

        :param confidence: The confidence of this MeetingWordsItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this MeetingWordsItem.  # noqa: E501
        ...
        :return: The spk of this MeetingWordsItem.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this MeetingWordsItem.

        Speaker id.</br> Range from 1 to 99 corresponds to speakers that were provided in the POST /asr/meeting (or POST /sa/offline) requests in the `speakers` array. (It is the index into that array, with first element having index 1.)</br> Range 100 and above corresponds to Speakers not identified up-font  (either single speaker per audio or diarized speaker).</br>   `floor( spk / 100 )` will identify the input audio file.</br> `spk modulo 100` will be speaker id within single audio file</br>   # noqa: E501

        :param spk: The spk of this MeetingWordsItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def utterance(self):
        """Gets the utterance of this MeetingWordsItem.  # noqa: E501

        word (or words) that were recognized  # noqa: E501

        :return: The utterance of this MeetingWordsItem.  # noqa: E501
        :rtype: str
        """
    ...
    def utterance(self, utterance):
        """Sets the utterance of this MeetingWordsItem.

        word (or words) that were recognized  # noqa: E501

        :param utterance: The utterance of this MeetingWordsItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingWordsItem):
            return False
