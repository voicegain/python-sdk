...
class ResourceUriLocalAuthConf(object):
    ...
    def __init__(self, credential=None, credential_name=None, host=None, type='basic', local_vars_configuration=None):  # noqa: E501
        """ResourceUriLocalAuthConf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def credential_name(self):
        """Gets the credential_name of this ResourceUriLocalAuthConf.  # noqa: E501

        Name of the credential to be used for authentication. Required only for `aws` type - AccessKeyId </br>   # noqa: E501

        :return: The credential_name of this ResourceUriLocalAuthConf.  # noqa: E501
        :rtype: str
        """
    ...
    def credential_name(self, credential_name):
        """Sets the credential_name of this ResourceUriLocalAuthConf.

        Name of the credential to be used for authentication. Required only for `aws` type - AccessKeyId </br>   # noqa: E501

        :param credential_name: The credential_name of this ResourceUriLocalAuthConf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def host(self):
        """Gets the host of this ResourceUriLocalAuthConf.  # noqa: E501

        (Optional) name of the host to which this set of credentials applies. For example, in Google Storage URL.</br>   # noqa: E501

        :return: The host of this ResourceUriLocalAuthConf.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this ResourceUriLocalAuthConf.

        (Optional) name of the host to which this set of credentials applies. For example, in Google Storage URL.</br>   # noqa: E501

        :param host: The host of this ResourceUriLocalAuthConf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                host is not None and len(host) > 512):
            raise ValueError("Invalid value for `host`, length must be less than or equal to `512`")  # noqa: E501

        self._host = host

    @property
    def type(self):
        """Gets the type of this ResourceUriLocalAuthConf.  # noqa: E501

        Type of the authentication: + _basic_ is basic http, + _bearer_ is e.g. JWT, + _twilio-rec-encrypted_ is used when a URL points to an encrypted Twilio recording + _aws_ is used to e.g. access S3 storage via AWS SDK   # noqa: E501

        :return: The type of this ResourceUriLocalAuthConf.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ResourceUriLocalAuthConf.

        Type of the authentication: + _basic_ is basic http, + _bearer_ is e.g. JWT, + _twilio-rec-encrypted_ is used when a URL points to an encrypted Twilio recording + _aws_ is used to e.g. access S3 storage via AWS SDK   # noqa: E501

        :param type: The type of this ResourceUriLocalAuthConf.  # noqa: E501
        :type: str
        """
        allowed_values = ["basic", "bearer", "twilio-rec-encrypted", "aws"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceUriLocalAuthConf):
            return False
