...
class SpeechAnalyticsInputSpeaker(object):
    ...
    def __init__(self, is_agent=None, metadata=None, name=None, spk_user_id=None, user_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def is_agent(self):
        """Gets the is_agent of this SpeechAnalyticsInputSpeaker.  # noqa: E501

        true if the speaker is the Agent  # noqa: E501

        :return: The is_agent of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_agent(self, is_agent):
        """Sets the is_agent of this SpeechAnalyticsInputSpeaker.

        true if the speaker is the Agent  # noqa: E501

        :param is_agent: The is_agent of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this SpeechAnalyticsInputSpeaker.  # noqa: E501

        Name of the speaker  # noqa: E501

        :return: The name of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SpeechAnalyticsInputSpeaker.

        Name of the speaker  # noqa: E501

        :param name: The name of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :type: str
        """
    ...
    def spk_user_id(self):
        """Gets the spk_user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501

        External ID of the speaking user that is provided upfront.   # noqa: E501

        :return: The spk_user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :rtype: float
        """
    ...
    def spk_user_id(self, spk_user_id):
        """Sets the spk_user_id of this SpeechAnalyticsInputSpeaker.

        External ID of the speaking user that is provided upfront.   # noqa: E501

        :param spk_user_id: The spk_user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :type: float
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature).</br> If provided, the value is echoed back in `speakers[].userId` of [GET /sa/offline/{saSessionId}/data](#tag/sa-offline/operation/saOfflineGetData).</br> **Validation:** the back end verifies that the user exists and belongs to the same Account as the SA session's Context. The request is rejected with 400 (`reason: \"Invalid userId\"`) if the user does not exist or belongs to a different Account.</br> **Note:** `userId` on input speakers is currently honored only by [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost). Other endpoints that share this schema ignore the field.   # noqa: E501

        :return: The user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this SpeechAnalyticsInputSpeaker.

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature).</br> If provided, the value is echoed back in `speakers[].userId` of [GET /sa/offline/{saSessionId}/data](#tag/sa-offline/operation/saOfflineGetData).</br> **Validation:** the back end verifies that the user exists and belongs to the same Account as the SA session's Context. The request is rejected with 400 (`reason: \"Invalid userId\"`) if the user does not exist or belongs to a different Account.</br> **Note:** `userId` on input speakers is currently honored only by [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost). Other endpoints that share this schema ignore the field.   # noqa: E501

        :param user_id: The user_id of this SpeechAnalyticsInputSpeaker.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsInputSpeaker):
            return False
