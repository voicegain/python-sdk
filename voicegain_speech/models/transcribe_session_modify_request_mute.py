...
class TranscribeSessionModifyRequestMute(object):
    ...
    def __init__(self, action=None, at_time=None, local_vars_configuration=None):  # noqa: E501
        """TranscribeSessionModifyRequestMute - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this TranscribeSessionModifyRequestMute.  # noqa: E501

        start mute or stop mute  # noqa: E501

        :return: The action of this TranscribeSessionModifyRequestMute.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this TranscribeSessionModifyRequestMute.

        start mute or stop mute  # noqa: E501

        :param action: The action of this TranscribeSessionModifyRequestMute.  # noqa: E501
        :type: str
        """
    ...
    @property
    def at_time(self):
        """Gets the at_time of this TranscribeSessionModifyRequestMute.  # noqa: E501

        Time (in milliseconds) at which to start mute or to stop mute. Must be relative to the start of audio. You should ensure that the time passed at start of mute matches the duration of audio sent from client.   # noqa: E501

        :return: The at_time of this TranscribeSessionModifyRequestMute.  # noqa: E501
        :rtype: int
        """
    ...
    def at_time(self, at_time):
        """Sets the at_time of this TranscribeSessionModifyRequestMute.

        Time (in milliseconds) at which to start mute or to stop mute. Must be relative to the start of audio. You should ensure that the time passed at start of mute matches the duration of audio sent from client.   # noqa: E501

        :param at_time: The at_time of this TranscribeSessionModifyRequestMute.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TranscribeSessionModifyRequestMute):
            return False
