...
class SpeechAnalyticsConfigModifiableBaseCsatQuestion(object):
    ...
    def __init__(self, answer_mapping=None, custom_response_format_json=None, prompt=None, response_format=None, local_vars_configuration=None):  # noqa: E501
    ...
    def custom_response_format_json(self):
        """Gets the custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501

        (future) Must only be provided when `responseFormat` is set to `custom`.   # noqa: E501

        :return: The custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_response_format_json(self, custom_response_format_json):
        """Sets the custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.

        (future) Must only be provided when `responseFormat` is set to `custom`.   # noqa: E501

        :param custom_response_format_json: The custom_response_format_json of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prompt(self):
        """Gets the prompt of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501

        LLM prompt to be used to answer the question.   # noqa: E501

        :return: The prompt of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501
        :rtype: str
        """
        return self._prompt
    ...
    def prompt(self, prompt):
        """Sets the prompt of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.

        LLM prompt to be used to answer the question.   # noqa: E501

        :param prompt: The prompt of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501
        :type: str
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
                prompt is not None and len(prompt) > 2048):
            raise ValueError("Invalid value for `prompt`, length must be less than or equal to `2048`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def response_format(self):
        """Gets the response_format of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.  # noqa: E501
    ...
    def response_format(self, response_format):
        """Sets the response_format of this SpeechAnalyticsConfigModifiableBaseCsatQuestion.
