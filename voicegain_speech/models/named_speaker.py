...
class NamedSpeaker(object):
    ...
    def __init__(self, speaker_id=None, spk=None, spk_name=None, user_id=None, vs_conf=None, local_vars_configuration=None):  # noqa: E501
        """NamedSpeaker - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def speaker_id(self):
        """Gets the speaker_id of this NamedSpeaker.  # noqa: E501

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI and we will use the speaker audio in the Voice Signature   # noqa: E501

        :return: The speaker_id of this NamedSpeaker.  # noqa: E501
        :rtype: str
        """
    ...
    def speaker_id(self, speaker_id):
        """Sets the speaker_id of this NamedSpeaker.

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI and we will use the speaker audio in the Voice Signature   # noqa: E501

        :param speaker_id: The speaker_id of this NamedSpeaker.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this NamedSpeaker.  # noqa: E501

        The speaker id (internal)  # noqa: E501

        :return: The spk of this NamedSpeaker.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this NamedSpeaker.

        The speaker id (internal)  # noqa: E501

        :param spk: The spk of this NamedSpeaker.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def spk_name(self):
        """Gets the spk_name of this NamedSpeaker.  # noqa: E501

        Name of the speaker. Typically provided manually via Web UI.</br>   (Note: we are moving away from simply setting the `spkName` towards creating a [Speaker](#tag/speaker) instance and setting the `speakerId`)   # noqa: E501

        :return: The spk_name of this NamedSpeaker.  # noqa: E501
        :rtype: str
        """
    ...
    def spk_name(self, spk_name):
        """Sets the spk_name of this NamedSpeaker.

        Name of the speaker. Typically provided manually via Web UI.</br>   (Note: we are moving away from simply setting the `spkName` towards creating a [Speaker](#tag/speaker) instance and setting the `speakerId`)   # noqa: E501

        :param spk_name: The spk_name of this NamedSpeaker.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def user_id(self):
        """Gets the user_id of this NamedSpeaker.  # noqa: E501

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature). May be set on diarized speakers as well as on speakers that came from the original `POST /sa/offline` request.</br> **Validation:** the back end verifies that the user exists and belongs to the same Account as the SA session's Context. The request is rejected with 400 (`reason: \"Invalid userId\"`) if the user does not exist or belongs to a different Account.</br> Set the field to `null` to clear a previously assigned `userId`.   # noqa: E501

        :return: The user_id of this NamedSpeaker.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this NamedSpeaker.

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature). May be set on diarized speakers as well as on speakers that came from the original `POST /sa/offline` request.</br> **Validation:** the back end verifies that the user exists and belongs to the same Account as the SA session's Context. The request is rejected with 400 (`reason: \"Invalid userId\"`) if the user does not exist or belongs to a different Account.</br> Set the field to `null` to clear a previously assigned `userId`.   # noqa: E501

        :param user_id: The user_id of this NamedSpeaker.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def vs_conf(self):
        """Gets the vs_conf of this NamedSpeaker.  # noqa: E501

        Voice Signature confidence - present only if `speakerId` was set based on a Voice Signature match. Set it to null to explicitely indicate that setting `speakerId` is not based on Voice Signature.   # noqa: E501

        :return: The vs_conf of this NamedSpeaker.  # noqa: E501
        :rtype: float
        """
    ...
    def vs_conf(self, vs_conf):
        """Sets the vs_conf of this NamedSpeaker.

        Voice Signature confidence - present only if `speakerId` was set based on a Voice Signature match. Set it to null to explicitely indicate that setting `speakerId` is not based on Voice Signature.   # noqa: E501

        :param vs_conf: The vs_conf of this NamedSpeaker.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NamedSpeaker):
            return False
