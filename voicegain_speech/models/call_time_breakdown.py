...
class CallTimeBreakdown(object):
    ...
    def __init__(self, agent_segments=None, caller_in_agent_seg_sec=None, caller_sec=None, excessive_silence_sec=None, silence_sec=None, system_sec=None, voicebot_sec=None, voicebot_seg_sec=None, local_vars_configuration=None):  # noqa: E501
        ...
        if excessive_silence_sec is not None:
            self.excessive_silence_sec = excessive_silence_sec
        if silence_sec is not None:
            self.silence_sec = silence_sec
        if system_sec is not None:
    ...
    def agent_segments(self):
        """Gets the agent_segments of this CallTimeBreakdown.  # noqa: E501

        One entry per agent segment in the call, in segment order.</br> A single agent may appear in multiple segments (e.g. agent transfers back) — in that case the same `userId` will appear in multiple rows.</br> Empty array if the call had no agent segments (e.g. fully bot-handled call).   # noqa: E501

        :return: The agent_segments of this CallTimeBreakdown.  # noqa: E501
        :rtype: list[CallTimeBreakdownAgentSegments]
        """
        return self._agent_segments

    @agent_segments.setter
    def agent_segments(self, agent_segments):
        """Sets the agent_segments of this CallTimeBreakdown.

        One entry per agent segment in the call, in segment order.</br> A single agent may appear in multiple segments (e.g. agent transfers back) — in that case the same `userId` will appear in multiple rows.</br> Empty array if the call had no agent segments (e.g. fully bot-handled call).   # noqa: E501

        :param agent_segments: The agent_segments of this CallTimeBreakdown.  # noqa: E501
        :type: list[CallTimeBreakdownAgentSegments]
        """
    ...
    def caller_sec(self, caller_sec):
        ...
        self._caller_sec = caller_sec

    @property
    def excessive_silence_sec(self):
        """Gets the excessive_silence_sec of this CallTimeBreakdown.  # noqa: E501

        Combined excessive silence over all agent segments, in seconds.</br> Excessive silence is silence exceeding the thresholds defined in the SA Config (see also the `silence` field).</br> `0` if the call had no agent segments.   # noqa: E501

        :return: The excessive_silence_sec of this CallTimeBreakdown.  # noqa: E501
        :rtype: float
        """
        return self._excessive_silence_sec

    @excessive_silence_sec.setter
    def excessive_silence_sec(self, excessive_silence_sec):
        """Sets the excessive_silence_sec of this CallTimeBreakdown.

        Combined excessive silence over all agent segments, in seconds.</br> Excessive silence is silence exceeding the thresholds defined in the SA Config (see also the `silence` field).</br> `0` if the call had no agent segments.   # noqa: E501

        :param excessive_silence_sec: The excessive_silence_sec of this CallTimeBreakdown.  # noqa: E501
        :type: float
        """

        self._excessive_silence_sec = excessive_silence_sec
    ...
    @property
    def system_sec(self):
        """Gets the system_sec of this CallTimeBreakdown.  # noqa: E501

        Combined duration of all system segments (typically queue / hold / routing), in seconds.</br> `0` if there were no system segments.   # noqa: E501

        :return: The system_sec of this CallTimeBreakdown.  # noqa: E501
        :rtype: float
        """
        return self._system_sec

    @system_sec.setter
    def system_sec(self, system_sec):
        """Sets the system_sec of this CallTimeBreakdown.

        Combined duration of all system segments (typically queue / hold / routing), in seconds.</br> `0` if there were no system segments.   # noqa: E501

        :param system_sec: The system_sec of this CallTimeBreakdown.  # noqa: E501
        :type: float
        """

        self._system_sec = system_sec
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallTimeBreakdown):
            return False
