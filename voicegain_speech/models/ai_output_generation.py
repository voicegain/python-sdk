...
class AiOutputGeneration(object):
    ...
    def __init__(self, epoch=None, labels=None, latency_ms=None, llm_prompt=None, model_name=None, prompt_version=None, local_vars_configuration=None):  # noqa: E501
        """AiOutputGeneration - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def epoch(self):
        """Gets the epoch of this AiOutputGeneration.  # noqa: E501

        (optional) Epoch time (milliseconds since 1970-01-01T00:00:00Z) when the AI output was produced. May differ from `createdEpoch` on the parent AI Output record (e.g. when the output was produced earlier and captured later).   # noqa: E501

        :return: The epoch of this AiOutputGeneration.  # noqa: E501
        :rtype: int
        """
        return self._epoch
    ...
    def epoch(self, epoch):
        """Sets the epoch of this AiOutputGeneration.

        (optional) Epoch time (milliseconds since 1970-01-01T00:00:00Z) when the AI output was produced. May differ from `createdEpoch` on the parent AI Output record (e.g. when the output was produced earlier and captured later).   # noqa: E501

        :param epoch: The epoch of this AiOutputGeneration.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                epoch is not None and epoch < 0):  # noqa: E501
            raise ValueError("Invalid value for `epoch`, must be a value greater than or equal to `0`")  # noqa: E501

        self._epoch = epoch

    @property
    def labels(self):
        """Gets the labels of this AiOutputGeneration.  # noqa: E501

        (optional) Free-form key/value labels capturing additional generation context (e.g. A/B-test bucket, deployment region, feature-flag state). Keys are strings; values are strings up to 256 characters.   # noqa: E501

        :return: The labels of this AiOutputGeneration.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this AiOutputGeneration.

        (optional) Free-form key/value labels capturing additional generation context (e.g. A/B-test bucket, deployment region, feature-flag state). Keys are strings; values are strings up to 256 characters.   # noqa: E501

        :param labels: The labels of this AiOutputGeneration.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def latency_ms(self):
        """Gets the latency_ms of this AiOutputGeneration.  # noqa: E501

        (optional) Wall-clock latency of the model call that produced the output, in milliseconds.   # noqa: E501

        :return: The latency_ms of this AiOutputGeneration.  # noqa: E501
        :rtype: int
        """
    ...
    def latency_ms(self, latency_ms):
        """Sets the latency_ms of this AiOutputGeneration.

        (optional) Wall-clock latency of the model call that produced the output, in milliseconds.   # noqa: E501

        :param latency_ms: The latency_ms of this AiOutputGeneration.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                latency_ms is not None and latency_ms < 0):  # noqa: E501
            raise ValueError("Invalid value for `latency_ms`, must be a value greater than or equal to `0`")  # noqa: E501

        self._latency_ms = latency_ms

    @property
    def llm_prompt(self):
        """Gets the llm_prompt of this AiOutputGeneration.  # noqa: E501

        (optional) The actual prompt text sent to the LLM. Useful for debugging and for re-running the same prompt against a different model. Stored verbatim, so changes to prompt templates do not retroactively alter this field.   # noqa: E501

        :return: The llm_prompt of this AiOutputGeneration.  # noqa: E501
        :rtype: str
        """
        return self._llm_prompt

    @llm_prompt.setter
    def llm_prompt(self, llm_prompt):
        """Sets the llm_prompt of this AiOutputGeneration.

        (optional) The actual prompt text sent to the LLM. Useful for debugging and for re-running the same prompt against a different model. Stored verbatim, so changes to prompt templates do not retroactively alter this field.   # noqa: E501

        :param llm_prompt: The llm_prompt of this AiOutputGeneration.  # noqa: E501
        :type: str
        """
    ...
    @property
    def model_name(self):
        """Gets the model_name of this AiOutputGeneration.  # noqa: E501

        (optional) Name and version of the model that produced the output. Free-form, but should be specific enough to reproduce the result (e.g. include a version date or revision).   # noqa: E501

        :return: The model_name of this AiOutputGeneration.  # noqa: E501
        :rtype: str
        """
    ...
    def model_name(self, model_name):
        """Sets the model_name of this AiOutputGeneration.

        (optional) Name and version of the model that produced the output. Free-form, but should be specific enough to reproduce the result (e.g. include a version date or revision).   # noqa: E501

        :param model_name: The model_name of this AiOutputGeneration.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def prompt_version(self):
        """Gets the prompt_version of this AiOutputGeneration.  # noqa: E501

        (optional) Identifier of the prompt template that was used (e.g. `summary_v3`). Useful when correlating feedback to a specific prompt revision.   # noqa: E501

        :return: The prompt_version of this AiOutputGeneration.  # noqa: E501
        :rtype: str
        """
    ...
    def prompt_version(self, prompt_version):
        """Sets the prompt_version of this AiOutputGeneration.

        (optional) Identifier of the prompt template that was used (e.g. `summary_v3`). Useful when correlating feedback to a specific prompt revision.   # noqa: E501

        :param prompt_version: The prompt_version of this AiOutputGeneration.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                prompt_version is not None and len(prompt_version) > 64):
            raise ValueError("Invalid value for `prompt_version`, length must be less than or equal to `64`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AiOutputGeneration):
            return False
