...
class MeetingSearchField(object):
    ...
    def __init__(self, collection_type=None, field=None, intermediate_values=None, max_value=None, min_value=None, possible_values=None, type=None, local_vars_configuration=None):  # noqa: E501
        """MeetingSearchField - a model defined in OpenAPI"""  # noqa: E501
    ...
    def collection_type(self):
        """Gets the collection_type of this MeetingSearchField.  # noqa: E501

        Collection Type of the field. For some fields, the values are held in collections, e.g. `TAG`, `KEYWORD` and `SPEAKER` have a set of values , and `METADATA` has a map of values. + none - single value + set - set of values + map - map of values   # noqa: E501

        :return: The collection_type of this MeetingSearchField.  # noqa: E501
        :rtype: str
        """
    ...
    def collection_type(self, collection_type):
        """Sets the collection_type of this MeetingSearchField.

        Collection Type of the field. For some fields, the values are held in collections, e.g. `TAG`, `KEYWORD` and `SPEAKER` have a set of values , and `METADATA` has a map of values. + none - single value + set - set of values + map - map of values   # noqa: E501

        :param collection_type: The collection_type of this MeetingSearchField.  # noqa: E501
        :type: str
        """
        allowed_values = ["none", "set", "map"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and collection_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    @property
    def field(self):
        """Gets the field of this MeetingSearchField.  # noqa: E501


        :return: The field of this MeetingSearchField.  # noqa: E501
        :rtype: MeetingField
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this MeetingSearchField.


        :param field: The field of this MeetingSearchField.  # noqa: E501
        :type: MeetingField
        """
    ...
    def intermediate_values(self):
        """Gets the intermediate_values of this MeetingSearchField.  # noqa: E501

        List of intermediate values for the field (values between `minValue` and `maxValue`). </br> Present only if the field returns `minValue` and `maxValue` and if the `minValue` is **different** from the `maxValue`. </br> The `intermediateValues` array will contain the values of the 20th, 40th, 60th, and 80th percentiles computed over  the set of **distinct** field values. </br> After computing the percentile values, if the percentile values are floating point values, they will be rounded to nearest integer. </br>  The values are expressed as strings. The field `type` determines the type and conversion from string. Returned for: DURATION, SIZE   # noqa: E501

        :return: The intermediate_values of this MeetingSearchField.  # noqa: E501
        :rtype: list[str]
        """
        return self._intermediate_values

    @intermediate_values.setter
    def intermediate_values(self, intermediate_values):
        """Sets the intermediate_values of this MeetingSearchField.

        List of intermediate values for the field (values between `minValue` and `maxValue`). </br> Present only if the field returns `minValue` and `maxValue` and if the `minValue` is **different** from the `maxValue`. </br> The `intermediateValues` array will contain the values of the 20th, 40th, 60th, and 80th percentiles computed over  the set of **distinct** field values. </br> After computing the percentile values, if the percentile values are floating point values, they will be rounded to nearest integer. </br>  The values are expressed as strings. The field `type` determines the type and conversion from string. Returned for: DURATION, SIZE   # noqa: E501

        :param intermediate_values: The intermediate_values of this MeetingSearchField.  # noqa: E501
        :type: list[str]
        """
    ...
    def max_value(self, max_value):
        """Sets the max_value of this MeetingSearchField.

        Maximum value for the field. Present only if the field has a meaningful ordering and a maximum value. The value is expressed as string. The field `type` determines the type and conversion from string. Dates should be in ISO format, e.g.: \"2019-09-18T17:57:43.110Z\".</br> Returned for: START_TIME, EXPIRY_TIME, DURATION, SIZE   # noqa: E501

        :param max_value: The max_value of this MeetingSearchField.  # noqa: E501
        :type: str
        """
    ...
    @property
    def min_value(self):
        """Gets the min_value of this MeetingSearchField.  # noqa: E501
        ...
        :return: The min_value of this MeetingSearchField.  # noqa: E501
        :rtype: str
        """
    ...
    def min_value(self, min_value):
        """Sets the min_value of this MeetingSearchField.

        Minimum value for the field. Present only if the field has a meaningful ordering and a minimum value. The value is expressed as string. The field `type` determines the type and conversion from string. Dates should be in ISO format, e.g.: \"2019-09-18T17:57:43.110Z\".</br> Returned for: START_TIME, EXPIRY_TIME, DURATION, SIZE   # noqa: E501

        :param min_value: The min_value of this MeetingSearchField.  # noqa: E501
        :type: str
        """
    ...
    def possible_values(self):
        """Gets the possible_values of this MeetingSearchField.  # noqa: E501

        List of all possible values for the field. Present only if the number of values is limited. The values are expressed as strings. Returned for: CONTEXT_ID, CREATOR_ID, AUDIO_SRC, PHASE, METADATA (return keys), LANG, TAG (returns individual tag values),  KEYWORD (returns individual keyword values), SILENT (returns individual names), SPEAKER (returns individual names)   # noqa: E501

        :return: The possible_values of this MeetingSearchField.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def possible_values(self, possible_values):
        """Sets the possible_values of this MeetingSearchField.

        List of all possible values for the field. Present only if the number of values is limited. The values are expressed as strings. Returned for: CONTEXT_ID, CREATOR_ID, AUDIO_SRC, PHASE, METADATA (return keys), LANG, TAG (returns individual tag values),  KEYWORD (returns individual keyword values), SILENT (returns individual names), SPEAKER (returns individual names)   # noqa: E501

        :param possible_values: The possible_values of this MeetingSearchField.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this MeetingSearchField.  # noqa: E501

        Value Type of the field.  + uuid - id value + datetime - date and time value + string - string value + number - number value + duration - duration value, e.g. 1m3s + size - byte size value, e.g. 1.5M   # noqa: E501

        :return: The type of this MeetingSearchField.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this MeetingSearchField.

        Value Type of the field.  + uuid - id value + datetime - date and time value + string - string value + number - number value + duration - duration value, e.g. 1m3s + size - byte size value, e.g. 1.5M   # noqa: E501

        :param type: The type of this MeetingSearchField.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["uuid", "string", "datetime", "number", "duration", "size"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeetingSearchField):
            return False
