...
class AsrSettingsRecognitionAllOf(object):
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsRecognitionAllOf.  # noqa: E501
        ...
        :return: The lang_model of this AsrSettingsRecognitionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsRecognitionAllOf.

        (Only applicable if large-vocabulary recognition has been enabled by using the special transcribe grammar.) </br> Name or UUID of the language model to use. If absent then will use default language model.   # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsRecognitionAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def start_input_timers(self):
        """Gets the start_input_timers of this AsrSettingsRecognitionAllOf.  # noqa: E501
        ...
        :return: The start_input_timers of this AsrSettingsRecognitionAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def start_input_timers(self, start_input_timers):
        """Sets the start_input_timers of this AsrSettingsRecognitionAllOf.

        (Optional) By default input timers are started immediately after recognizer is ready to listen. This parameter can be used to disable automatic start of input timers. </br> Currently meant mainly for internal use only as there is no web api to start the input timers on demand.   # noqa: E501

        :param start_input_timers: The start_input_timers of this AsrSettingsRecognitionAllOf.  # noqa: E501
        :type: bool
        """
