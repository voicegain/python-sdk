...
class WSSentenceHypothesisOrRecognition(object):
    ...
    def __init__(self, alternatives=None, duration=None, time=None, type=None, spk=None, ss_id=None, local_vars_configuration=None):  # noqa: E501
        """WSSentenceHypothesisOrRecognition - a model defined in OpenAPI"""  # noqa: E501
    ...
    def alternatives(self):
        """Gets the alternatives of this WSSentenceHypothesisOrRecognition.  # noqa: E501

        recognition result - possibly multiple alternatives  # noqa: E501

        :return: The alternatives of this WSSentenceHypothesisOrRecognition.  # noqa: E501
    ...
    def alternatives(self, alternatives):
        """Sets the alternatives of this WSSentenceHypothesisOrRecognition.

        recognition result - possibly multiple alternatives  # noqa: E501

        :param alternatives: The alternatives of this WSSentenceHypothesisOrRecognition.  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this WSSentenceHypothesisOrRecognition.  # noqa: E501

        indicates either hypothesis or recognition result  # noqa: E501

        :return: The type of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WSSentenceHypothesisOrRecognition.

        indicates either hypothesis or recognition result  # noqa: E501

        :param type: The type of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this session. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.              # noqa: E501
        ...
        :return: The spk of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WSSentenceHypothesisOrRecognition.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this session. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.              # noqa: E501

        :param spk: The spk of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def ss_id(self):
        """Gets the ss_id of this WSSentenceHypothesisOrRecognition.  # noqa: E501

        A short string that is relevant only to scenarios where: - there is more than 1 session for transcription - websocket mode is transceiver or predefined   This string is put in the messages to distinguish between results generated from different sessions. Some example values would be: \"left\"/\"right\", \"inbound\"/\"outbound\".    # noqa: E501

        :return: The ss_id of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :rtype: str
        """
        return self._ss_id
    ...
    def ss_id(self, ss_id):
        """Sets the ss_id of this WSSentenceHypothesisOrRecognition.

        A short string that is relevant only to scenarios where: - there is more than 1 session for transcription - websocket mode is transceiver or predefined   This string is put in the messages to distinguish between results generated from different sessions. Some example values would be: \"left\"/\"right\", \"inbound\"/\"outbound\".    # noqa: E501

        :param ss_id: The ss_id of this WSSentenceHypothesisOrRecognition.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                ss_id is not None and len(ss_id) > 64):
            raise ValueError("Invalid value for `ss_id`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                ss_id is not None and len(ss_id) < 1):
            raise ValueError("Invalid value for `ss_id`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WSSentenceHypothesisOrRecognition):
            return False
