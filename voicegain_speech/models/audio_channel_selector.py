...
class AudioChannelSelector(object):
    ...
    allowable_values = [LEFT, RIGHT, MIX]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudioChannelSelector - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioChannelSelector):
            return False
