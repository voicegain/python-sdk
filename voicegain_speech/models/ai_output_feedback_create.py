...
class AiOutputFeedbackCreate(object):
    ...
    def __init__(self, comment=None, correct_value=None, score=None, source=None, thumbs=None, user_id=None, local_vars_configuration=None):  # noqa: E501
        """AiOutputFeedbackCreate - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this AiOutputFeedbackCreate.  # noqa: E501

        (optional) Free-form comment from the user explaining the feedback.  # noqa: E501

        :return: The comment of this AiOutputFeedbackCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AiOutputFeedbackCreate.

        (optional) Free-form comment from the user explaining the feedback.  # noqa: E501

        :param comment: The comment of this AiOutputFeedbackCreate.  # noqa: E501
        :type: str
        """
    ...
    def correct_value(self):
        """Gets the correct_value of this AiOutputFeedbackCreate.  # noqa: E501

        (optional) The \"ideal\" / corrected value the user thinks the AI should have produced. Same shape rules as `AiOutput.content` (string or object — wrap arrays in an object). See `AiOutputFeedback.correctValue`.   # noqa: E501

        :return: The correct_value of this AiOutputFeedbackCreate.  # noqa: E501
    ...
    def correct_value(self, correct_value):
        """Sets the correct_value of this AiOutputFeedbackCreate.

        (optional) The \"ideal\" / corrected value the user thinks the AI should have produced. Same shape rules as `AiOutput.content` (string or object — wrap arrays in an object). See `AiOutputFeedback.correctValue`.   # noqa: E501

        :param correct_value: The correct_value of this AiOutputFeedbackCreate.  # noqa: E501
    ...
    @property
    def score(self):
        """Gets the score of this AiOutputFeedbackCreate.  # noqa: E501

        (optional) Overall quality score, 1 (poor) to 5 (excellent). May be set independently of `thumbs`. See `AiOutputFeedback.score`.   # noqa: E501

        :return: The score of this AiOutputFeedbackCreate.  # noqa: E501
        :rtype: int
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this AiOutputFeedbackCreate.

        (optional) Overall quality score, 1 (poor) to 5 (excellent). May be set independently of `thumbs`. See `AiOutputFeedback.score`.   # noqa: E501

        :param score: The score of this AiOutputFeedbackCreate.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def source(self):
        """Gets the source of this AiOutputFeedbackCreate.  # noqa: E501

        (optional) Free-form string identifying where this feedback came from (e.g. a UI page, an external review tool, an automated pipeline). See `AiOutputFeedback.source`.   # noqa: E501

        :return: The source of this AiOutputFeedbackCreate.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this AiOutputFeedbackCreate.

        (optional) Free-form string identifying where this feedback came from (e.g. a UI page, an external review tool, an automated pipeline). See `AiOutputFeedback.source`.   # noqa: E501

        :param source: The source of this AiOutputFeedbackCreate.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def thumbs(self):
        """Gets the thumbs of this AiOutputFeedbackCreate.  # noqa: E501

        (optional) Thumbs up/down indicator. May be set independently of `score`. See `AiOutputFeedback.thumbs`.   # noqa: E501

        :return: The thumbs of this AiOutputFeedbackCreate.  # noqa: E501
        :rtype: str
        """
        return self._thumbs
    ...
    def thumbs(self, thumbs):
        """Sets the thumbs of this AiOutputFeedbackCreate.

        (optional) Thumbs up/down indicator. May be set independently of `score`. See `AiOutputFeedback.thumbs`.   # noqa: E501

        :param thumbs: The thumbs of this AiOutputFeedbackCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this AiOutputFeedbackCreate.  # noqa: E501

        UUID of the Voicegain User providing the feedback. Validated to exist on the same Account as the parent AI Output; rejected with 400 (`reason: \"Invalid userId\"`) otherwise.   # noqa: E501

        :return: The user_id of this AiOutputFeedbackCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this AiOutputFeedbackCreate.

        UUID of the Voicegain User providing the feedback. Validated to exist on the same Account as the parent AI Output; rejected with 400 (`reason: \"Invalid userId\"`) otherwise.   # noqa: E501

        :param user_id: The user_id of this AiOutputFeedbackCreate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AiOutputFeedbackCreate):
            return False
