...
class OfflineSASpeakerResultBase(object):
    ...
    def __init__(self, external_user_id=None, from_diarization=None, is_agent=None, metadata=None, name=None, speaker_id=None, spk=None, user_id=None, local_vars_configuration=None):  # noqa: E501
        """OfflineSASpeakerResultBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    def external_user_id(self):
        """Gets the external_user_id of this OfflineSASpeakerResultBase.  # noqa: E501

        (optional) External id of the speaking user. Corresponds to `speakers[].skpUserId` in POST /sa/offline   # noqa: E501

        :return: The external_user_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: float
        """
    ...
    def external_user_id(self, external_user_id):
        """Sets the external_user_id of this OfflineSASpeakerResultBase.

        (optional) External id of the speaking user. Corresponds to `speakers[].skpUserId` in POST /sa/offline   # noqa: E501

        :param external_user_id: The external_user_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: float
        """
    ...
    def from_diarization(self):
        """Gets the from_diarization of this OfflineSASpeakerResultBase.  # noqa: E501

        (optional) True if the speaker was output from diarization.   # noqa: E501

        :return: The from_diarization of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def from_diarization(self, from_diarization):
        """Sets the from_diarization of this OfflineSASpeakerResultBase.

        (optional) True if the speaker was output from diarization.   # noqa: E501

        :param from_diarization: The from_diarization of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def is_agent(self):
        """Gets the is_agent of this OfflineSASpeakerResultBase.  # noqa: E501

        (optional) True if the speaker is a Call Center Agent   # noqa: E501

        :return: The is_agent of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_agent(self, is_agent):
        """Sets the is_agent of this OfflineSASpeakerResultBase.

        (optional) True if the speaker is a Call Center Agent   # noqa: E501

        :param is_agent: The is_agent of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this OfflineSASpeakerResultBase.  # noqa: E501
        ...
        :return: The metadata of this OfflineSASpeakerResultBase.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this OfflineSASpeakerResultBase.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this OfflineSASpeakerResultBase.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this OfflineSASpeakerResultBase.  # noqa: E501

        (optional) Name of the speaker. May be modified using PUT /sa/offline/{saSessionId}/spk    # noqa: E501

        :return: The name of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OfflineSASpeakerResultBase.

        (optional) Name of the speaker. May be modified using PUT /sa/offline/{saSessionId}/spk    # noqa: E501

        :param name: The name of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def speaker_id(self):
        """Gets the speaker_id of this OfflineSASpeakerResultBase.  # noqa: E501
        ...
        :return: The speaker_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: str
        """
    ...
    def speaker_id(self, speaker_id):
        """Sets the speaker_id of this OfflineSASpeakerResultBase.

        UUID of the Speaker - see [/speaker API](#tag/speaker) </br> If present it will usually mean that we identified the given Speaker using a Voice Signature, but may also mean that the Speaker was manually assigned using the Web UI.   # noqa: E501

        :param speaker_id: The speaker_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this OfflineSASpeakerResultBase.  # noqa: E501
        ...
        :return: The spk of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this OfflineSASpeakerResultBase.

        Speaker id that will be used in `words` output (associates each word with a speaker)</br> Range from 1 to 99 corresponds to speakers that were provided in the POST /sa/offline requests in the `speakers` array. (It is the index into that array, with first element having index 1.)</br> Range 100 and above corresponds to Speakers not identified up-font  (either single speaker per audio or diarized speaker).</br>   `floor( spk / 100 )` will identify the input audio file.</br> `spk modulo 100` will be speaker id within single audio file</br>   # noqa: E501

        :param spk: The spk of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def user_id(self):
        """Gets the user_id of this OfflineSASpeakerResultBase.  # noqa: E501
        ...
        :return: The user_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this OfflineSASpeakerResultBase.

        (optional) UUID of a Voicegain User on the same Account that this speaker corresponds to (see [GET /user/{uuid}](#tag/user/operation/userGet)).</br> Independent of `speakerId` (which references a Voicegain Speaker / voice signature).</br> Set initially from `speakers[].userId` provided in the [POST /sa/offline](#tag/sa-offline/operation/saOfflinePost) request, or assigned/changed later via [PUT /sa/offline/{saSessionId}/spk](#tag/sa-offline/operation/saOfflineSpkPut).</br> For diarized speakers (no input speaker upfront), `userId` will be absent unless set later via PUT spk.   # noqa: E501

        :param user_id: The user_id of this OfflineSASpeakerResultBase.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineSASpeakerResultBase):
            return False
