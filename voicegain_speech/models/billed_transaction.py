...
class BilledTransaction(object):
    ...
    """
    openapi_types = {
        'agent': 'BilledTransactionAgent',
        'duration_sec': 'int',
        'end_time': 'datetime',
        'of': 'int',
        'queue': 'BilledTransactionQueue',
        'segment_seq': 'int',
        'seq': 'int',
        'start_time': 'datetime',
        'type': 'BilledTransactionType'
    }
    ...
    def __init__(self, agent=None, duration_sec=None, end_time=None, of=None, queue=None, segment_seq=None, seq=None, start_time=None, type=None, local_vars_configuration=None):  # noqa: E501
        """BilledTransaction - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def agent(self):
        """Gets the agent of this BilledTransaction.  # noqa: E501


        :return: The agent of this BilledTransaction.  # noqa: E501
        :rtype: BilledTransactionAgent
        """
        return self._agent

    @agent.setter
    def agent(self, agent):
        """Sets the agent of this BilledTransaction.


        :param agent: The agent of this BilledTransaction.  # noqa: E501
        :type: BilledTransactionAgent
        """
    ...
    def duration_sec(self):
        """Gets the duration_sec of this BilledTransaction.  # noqa: E501

        Length of this transaction in seconds.  # noqa: E501

        :return: The duration_sec of this BilledTransaction.  # noqa: E501
        :rtype: int
        """
    ...
    def duration_sec(self, duration_sec):
        """Sets the duration_sec of this BilledTransaction.

        Length of this transaction in seconds.  # noqa: E501

        :param duration_sec: The duration_sec of this BilledTransaction.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and duration_sec is None:  # noqa: E501
            raise ValueError("Invalid value for `duration_sec`, must not be `None`")  # noqa: E501

        self._duration_sec = duration_sec

    @property
    def end_time(self):
        """Gets the end_time of this BilledTransaction.  # noqa: E501


        :return: The end_time of this BilledTransaction.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this BilledTransaction.


        :param end_time: The end_time of this BilledTransaction.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def of(self):
        """Gets the of of this BilledTransaction.  # noqa: E501

        Number of transactions of this `type` on this call, so `seq` of `of` reads as \"1 of 2\".  # noqa: E501

        :return: The of of this BilledTransaction.  # noqa: E501
        :rtype: int
        """
        return self._of
    ...
    @of.setter
    def of(self, of):
        """Sets the of of this BilledTransaction.

        Number of transactions of this `type` on this call, so `seq` of `of` reads as \"1 of 2\".  # noqa: E501

        :param of: The of of this BilledTransaction.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and of is None:  # noqa: E501
            raise ValueError("Invalid value for `of`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                of is not None and of < 1):  # noqa: E501
            raise ValueError("Invalid value for `of`, must be a value greater than or equal to `1`")  # noqa: E501

        self._of = of

    @property
    def queue(self):
        """Gets the queue of this BilledTransaction.  # noqa: E501


        :return: The queue of this BilledTransaction.  # noqa: E501
        :rtype: BilledTransactionQueue
        """
        return self._queue

    @queue.setter
    def queue(self, queue):
        """Sets the queue of this BilledTransaction.


        :param queue: The queue of this BilledTransaction.  # noqa: E501
        :type: BilledTransactionQueue
        """
    ...
    def segment_seq(self):
        """Gets the segment_seq of this BilledTransaction.  # noqa: E501

        `segmentSeq` of the call segment this transaction was attributed to. Omitted on automated transactions, and on augmented ones that could not be attributed to a segment.   # noqa: E501

        :return: The segment_seq of this BilledTransaction.  # noqa: E501
        :rtype: int
        """
    ...
    def segment_seq(self, segment_seq):
        """Sets the segment_seq of this BilledTransaction.

        `segmentSeq` of the call segment this transaction was attributed to. Omitted on automated transactions, and on augmented ones that could not be attributed to a segment.   # noqa: E501

        :param segment_seq: The segment_seq of this BilledTransaction.  # noqa: E501
        :type: int
        """
    ...
    @property
    def seq(self):
        """Gets the seq of this BilledTransaction.  # noqa: E501

        1-based position of this transaction among transactions of the same `type` on this call.  # noqa: E501

        :return: The seq of this BilledTransaction.  # noqa: E501
        :rtype: int
        """
        return self._seq
    ...
    @seq.setter
    def seq(self, seq):
        """Sets the seq of this BilledTransaction.

        1-based position of this transaction among transactions of the same `type` on this call.  # noqa: E501

        :param seq: The seq of this BilledTransaction.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and seq is None:  # noqa: E501
            raise ValueError("Invalid value for `seq`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                seq is not None and seq < 1):  # noqa: E501
            raise ValueError("Invalid value for `seq`, must be a value greater than or equal to `1`")  # noqa: E501

        self._seq = seq

    @property
    def start_time(self):
        """Gets the start_time of this BilledTransaction.  # noqa: E501


        :return: The start_time of this BilledTransaction.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this BilledTransaction.


        :param start_time: The start_time of this BilledTransaction.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def type(self):
        """Gets the type of this BilledTransaction.  # noqa: E501


        :return: The type of this BilledTransaction.  # noqa: E501
        :rtype: BilledTransactionType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this BilledTransaction.


        :param type: The type of this BilledTransaction.  # noqa: E501
        :type: BilledTransactionType
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BilledTransaction):
            return False
