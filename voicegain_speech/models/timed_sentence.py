...
class TimedSentence(object):
    ...
    def __init__(self, end=None, spk=None, start=None, text=None, local_vars_configuration=None):  # noqa: E501
        """TimedSentence - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end(self):
        """Gets the end of this TimedSentence.  # noqa: E501

        end time in msec of this sentence  # noqa: E501

        :return: The end of this TimedSentence.  # noqa: E501
        :rtype: int
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this TimedSentence.

        end time in msec of this sentence  # noqa: E501

        :param end: The end of this TimedSentence.  # noqa: E501
        :type: int
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this TimedSentence.  # noqa: E501

        id that references the speaker within the meeting  # noqa: E501

        :return: The spk of this TimedSentence.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this TimedSentence.

        id that references the speaker within the meeting  # noqa: E501

        :param spk: The spk of this TimedSentence.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start(self):
        """Gets the start of this TimedSentence.  # noqa: E501

        start time in msec of this sentence  # noqa: E501

        :return: The start of this TimedSentence.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this TimedSentence.

        start time in msec of this sentence  # noqa: E501

        :param start: The start of this TimedSentence.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def text(self):
        """Gets the text of this TimedSentence.  # noqa: E501

        selected sentence from the transcript  # noqa: E501

        :return: The text of this TimedSentence.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this TimedSentence.

        selected sentence from the transcript  # noqa: E501

        :param text: The text of this TimedSentence.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimedSentence):
            return False
