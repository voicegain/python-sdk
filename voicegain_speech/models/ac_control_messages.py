...
class ACControlMessages(object):
    ...
    openapi_types = {
        ...
        'sample_rate_hz': 'int',
        'stt_context_id': 'str',
        'stt_generic_data': 'str',
        'stt_speech_contexts': 'list[ACStartSttSpeechContexts]',
        'type': 'str'
    }
    ...
    attribute_map = {
        ...
        'stt_context_id': 'sttContextId',
        'stt_generic_data': 'sttGenericData',
        'stt_speech_contexts': 'sttSpeechContexts',
        'type': 'type'
    }

    def __init__(self, context=None, encoding='LINEAR16', format='raw', language='en-US', sample_rate_hz=16000, stt_context_id=None, stt_generic_data=None, stt_speech_contexts=None, type=None, local_vars_configuration=None):  # noqa: E501
        """ACControlMessages - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._stt_context_id = None
        self._stt_generic_data = None
        self._stt_speech_contexts = None
        self._type = None
        ...
        if stt_context_id is not None:
            self.stt_context_id = stt_context_id
        if stt_generic_data is not None:
            self.stt_generic_data = stt_generic_data
        if stt_speech_contexts is not None:
            self.stt_speech_contexts = stt_speech_contexts
        self.type = type

    @property
    def context(self):
        """Gets the context of this ACControlMessages.  # noqa: E501

        Replaced with `sttGenericData`  # noqa: E501

        :return: The context of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
    ...
    def context(self, context):
        """Sets the context of this ACControlMessages.

        Replaced with `sttGenericData`  # noqa: E501

        :param context: The context of this ACControlMessages.  # noqa: E501
        :type: str
        """
    ...
    @property
    def encoding(self):
        """Gets the encoding of this ACControlMessages.  # noqa: E501

        How the audio is stored and transmitted.  Currently, only 16-bit linear pulse-code modulation (PCM) encoding (LINEAR16) is supported.   # noqa: E501

        :return: The encoding of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
    ...
    def encoding(self, encoding):
        """Sets the encoding of this ACControlMessages.

        How the audio is stored and transmitted.  Currently, only 16-bit linear pulse-code modulation (PCM) encoding (LINEAR16) is supported.   # noqa: E501

        :param encoding: The encoding of this ACControlMessages.  # noqa: E501
        :type: str
        """
        allowed_values = ["LINEAR16"]  # noqa: E501
    ...
    @property
    def format(self):
        """Gets the format of this ACControlMessages.  # noqa: E501

        the format of the audio file: + raw: audio without headers + wav: audio with WAV headers   # noqa: E501

        :return: The format of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this ACControlMessages.

        the format of the audio file: + raw: audio without headers + wav: audio with WAV headers   # noqa: E501

        :param format: The format of this ACControlMessages.  # noqa: E501
        :type: str
        """
        allowed_values = ["raw", "wav"]  # noqa: E501
    ...
    @property
    def language(self):
        """Gets the language of this ACControlMessages.  # noqa: E501

        a BCP-47 language code for speech recognition of the supplied audio.  # noqa: E501

        :return: The language of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this ACControlMessages.

        a BCP-47 language code for speech recognition of the supplied audio.  # noqa: E501

        :param language: The language of this ACControlMessages.  # noqa: E501
        :type: str
        """
        allowed_values = ["en-US", "es-MX", "de-DE"]  # noqa: E501
    ...
    def sample_rate_hz(self):
        """Gets the sample_rate_hz of this ACControlMessages.  # noqa: E501

        The sample rate (in Hertz) of the supplied audio. Currently, only 16,000 Hz is supported.  # noqa: E501

        :return: The sample_rate_hz of this ACControlMessages.  # noqa: E501
        :rtype: int
        """
        return self._sample_rate_hz

    @sample_rate_hz.setter
    def sample_rate_hz(self, sample_rate_hz):
        """Sets the sample_rate_hz of this ACControlMessages.

        The sample rate (in Hertz) of the supplied audio. Currently, only 16,000 Hz is supported.  # noqa: E501

        :param sample_rate_hz: The sample_rate_hz of this ACControlMessages.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                sample_rate_hz is not None and sample_rate_hz > 16000):  # noqa: E501
            raise ValueError("Invalid value for `sample_rate_hz`, must be a value less than or equal to `16000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sample_rate_hz is not None and sample_rate_hz < 16000):  # noqa: E501
            raise ValueError("Invalid value for `sample_rate_hz`, must be a value greater than or equal to `16000`")  # noqa: E501

        self._sample_rate_hz = sample_rate_hz

    @property
    def stt_context_id(self):
        """Gets the stt_context_id of this ACControlMessages.  # noqa: E501

        Future use. Currently ignored.     # noqa: E501

        :return: The stt_context_id of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
        return self._stt_context_id

    @stt_context_id.setter
    def stt_context_id(self, stt_context_id):
        """Sets the stt_context_id of this ACControlMessages.

        Future use. Currently ignored.     # noqa: E501

        :param stt_context_id: The stt_context_id of this ACControlMessages.  # noqa: E501
        :type: str
        """

        self._stt_context_id = stt_context_id
    ...
    def stt_generic_data(self):
        ...
        :rtype: str
        """
        return self._stt_generic_data

    @stt_generic_data.setter
    def stt_generic_data(self, stt_generic_data):
        ...
        self._stt_generic_data = stt_generic_data

    @property
    def stt_speech_contexts(self):
        """Gets the stt_speech_contexts of this ACControlMessages.  # noqa: E501

        Used to pass data to the recognizer that is used to modify speech recognition.  # noqa: E501

        :return: The stt_speech_contexts of this ACControlMessages.  # noqa: E501
        :rtype: list[ACStartSttSpeechContexts]
        """
        return self._stt_speech_contexts

    @stt_speech_contexts.setter
    def stt_speech_contexts(self, stt_speech_contexts):
        """Sets the stt_speech_contexts of this ACControlMessages.

        Used to pass data to the recognizer that is used to modify speech recognition.  # noqa: E501

        :param stt_speech_contexts: The stt_speech_contexts of this ACControlMessages.  # noqa: E501
        :type: list[ACStartSttSpeechContexts]
        """

        self._stt_speech_contexts = stt_speech_contexts

    @property
    def type(self):
        """Gets the type of this ACControlMessages.  # noqa: E501

        Command to stop recognition session. If session is not in progress then error will be returned.  # noqa: E501

        :return: The type of this ACControlMessages.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ACControlMessages.

        Command to stop recognition session. If session is not in progress then error will be returned.  # noqa: E501

        :param type: The type of this ACControlMessages.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ACControlMessages):
            return False
