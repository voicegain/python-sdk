...
class CopilotDisplayResolvedElement(object):
    ...
    def __init__(self, auto_open=None, copiable=None, format=None, id=None, label=None, label_style=None, max_lines=None, transform=None, values=None, local_vars_configuration=None):  # noqa: E501
    ...
    def auto_open(self):
        ...
        Auto-open hint for `format: link`, passed through from the element's `autoOpen` key in the display YAML - the server never opens anything; the Copilot extension does. + **newTabBackground** - the Copilot opens the URL in a new browser tab **without** taking focus,   leaving the agent on the tab they are working in (typically the CCaaS/softphone page).   Recommended when auto-opening during a live call. + **newTabForeground** - the Copilot opens the URL in a new browser tab and switches to it. Copilot   itself stays visible either way, since it runs as a browser side panel rather than in a tab.  Absent when the YAML sets `never` (the default) or omits the key. The YAML value is matched case-insensitively and emitted here in the canonical spelling above; an unknown value, or `autoOpen` on an element whose `format` isn't `link`, is rejected at save time (`PUT /aivr-app/{uuid}`) and by `POST /aivr-app/copilot-display-preview` alike.</br> **Fires at most once per call**, the first time this element appears in the resolved display (i.e. its card's conditions are met and the element has a value). Later re-resolutions - as call variables update - never re-open it: from that point the element behaves as an ordinary clickable link.</br> If a tab opened by this element's earlier auto-open is still open, it is reused rather than a second tab being opened. Tabs are never closed automatically when the call ends.</br> If the element resolves to several `values`, only the first is auto-opened.</br> Auto-opening requires the Copilot browser extension to hold permission to open tabs. Where it does not - or on a host that cannot open tabs - the element still renders as an ordinary clickable link, so the URL is never silently dropped.</br> When a link element bound to `account_crmUrl` carries `autoOpen`, the Copilot skips its built-in CRM auto-open for that call so the URL isn't opened twice. Copilot builds older than 1.141.0 ignore it and render a normal link.   # noqa: E501
    ...
    def auto_open(self, auto_open):
        ...
        :type: str
        """
        allowed_values = [None,"newTabBackground", "newTabForeground"]  # noqa: E501
    ...
    @property
    def copiable(self):
        """Gets the copiable of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The copiable of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: bool
        """
        return self._copiable

    @copiable.setter
    def copiable(self, copiable):
        """Sets the copiable of this CopilotDisplayResolvedElement.


        :param copiable: The copiable of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: bool
        """

        self._copiable = copiable
    ...
    @property
    def id(self):
        """Gets the id of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The id of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CopilotDisplayResolvedElement.


        :param id: The id of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The label of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this CopilotDisplayResolvedElement.


        :param label: The label of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: str
        """
    ...
    def label_style(self):
        """Gets the label_style of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The label_style of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def label_style(self, label_style):
        """Sets the label_style of this CopilotDisplayResolvedElement.


        :param label_style: The label_style of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: list[str]
        """
        allowed_values = [None,"bold", "italic", "underline"]  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                not set(label_style).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
                "Invalid values for `label_style` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(label_style) - set(allowed_values))),  # noqa: E501
    ...
    @property
    def transform(self):
        """Gets the transform of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The transform of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: str
        """
    ...
    def transform(self, transform):
        """Sets the transform of this CopilotDisplayResolvedElement.


        :param transform: The transform of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: str
        """
        allowed_values = [None,"titlecase", "date", "number"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and transform not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    @property
    def values(self):
        """Gets the values of this CopilotDisplayResolvedElement.  # noqa: E501


        :return: The values of this CopilotDisplayResolvedElement.  # noqa: E501
        :rtype: list[CopilotDisplayResolvedValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this CopilotDisplayResolvedElement.


        :param values: The values of this CopilotDisplayResolvedElement.  # noqa: E501
        :type: list[CopilotDisplayResolvedValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopilotDisplayResolvedElement):
            return False
