...
class AudioZoneClass(object):
    ...
    allowable_values = [SILENCE, SOUND, SPEECH, NOMATCH, MUSIC]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudioZoneClass - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioZoneClass):
            return False
