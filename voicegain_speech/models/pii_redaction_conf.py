...
class PIIRedactionConf(object):
    ...
    def __init__(self, named_entity=None, redact_audio=None, redact_transcript=None, local_vars_configuration=None):  # noqa: E501
    ...
    def redact_transcript(self):
        ...
        If not null then the value of `redactTranscript` will be used to replace the entity matched  # noqa: E501
